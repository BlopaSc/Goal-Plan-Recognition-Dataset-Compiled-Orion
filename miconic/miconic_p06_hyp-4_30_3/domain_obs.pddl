(define
	...
	(:action observe7_depart_f32_p15
		:parameters ()
		:precondition (and
			(lift-at f32)
			(boarded p15)
	...
	(:action observe10_depart_f39_p9
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p9)
	...
	(:action observe14_depart_f39_p2
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p2)
