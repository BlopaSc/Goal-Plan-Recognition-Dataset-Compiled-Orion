(define
	...
	(:action observe10_depart_f32_p15
		:parameters ()
		:precondition (and
			(lift-at f32)
			(boarded p15)
	...
	(:action observe11_depart_f39_p6
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p6)
