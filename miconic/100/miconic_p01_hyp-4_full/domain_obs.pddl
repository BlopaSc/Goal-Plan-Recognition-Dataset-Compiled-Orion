...
(define
	...
	(:action observe12_depart_f15_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f15)
	...
	(:action observe13_depart_f15_p3
		:parameters ()
		:precondition (and
			(boarded p3)
			(lift-at f15)
