...
(define
	...
	(:action observe11_depart_f16_p1
		:parameters ()
		:precondition (and
			(boarded p1)
			(lift-at f16)
	...
	(:action observe18_depart_f37_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f37)
	...
	(:action observe23_board_f43_p13
		:parameters ()
		:precondition (and
			(lift-at f43)
			(observed obs22)
	...
	(:action observe25_depart_f5_p13
		:parameters ()
		:precondition (and
			(boarded p13)
			(lift-at f5)
	...
	(:action observe31_depart_f18_p3
		:parameters ()
		:precondition (and
			(boarded p3)
			(lift-at f18)
	...
	(:action observe37_board_f41_p16
		:parameters ()
		:precondition (and
			(lift-at f41)
			(observed obs36)
	...
	(:action observe39_depart_f37_p16
		:parameters ()
		:precondition (and
			(boarded p16)
			(lift-at f37)
	...
	(:action observe44_depart_f39_p2
		:parameters ()
		:precondition (and
			(boarded p2)
			(lift-at f39)
	...
	(:action observe53_board_f38_p10
		:parameters ()
		:precondition (and
			(lift-at f38)
			(observed obs52)
	...
	(:action observe55_depart_f13_p10
		:parameters ()
		:precondition (and
			(boarded p10)
			(lift-at f13)
