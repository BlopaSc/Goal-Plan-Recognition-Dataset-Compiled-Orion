...
(define
	...
	(:constants
		f0 f1 f10 f11 f12 f13 f14 f15 f16 f17 f2 f3 f4 f5 f6 f7 f8 f9 - floor__inferred_type
		p0 p1 p2 p3 p4 p5 p6 p7 p8 - passenger__inferred_type
	...
	(:action observe20_depart_f13_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f13)
	...
	(:action observe24_depart_f15_p0
		:parameters ()
		:precondition (and
			(boarded p0)
			(lift-at f15)
