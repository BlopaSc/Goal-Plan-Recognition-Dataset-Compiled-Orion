(define
	...
	(:action observe14_depart_f39_p6
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p6)
	...
	(:action observe25_board_f32_p18
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observation24)
	...
	(:action observe27_depart_f14_p18
		:parameters ()
		:precondition (and
			(lift-at f14)
			(boarded p18)
