(define
	...
	(:action observe12_depart_f14_p7
		:parameters ()
		:precondition (and
			(lift-at f14)
			(boarded p7)
	...
	(:action observe24_depart_f33_p4
		:parameters ()
		:precondition (and
			(lift-at f33)
			(boarded p4)
	...
	(:action observe26_depart_f37_p20
		:parameters ()
		:precondition (and
			(lift-at f37)
			(boarded p20)
	...
	(:action observe27_depart_f29_p11
		:parameters ()
		:precondition (and
			(lift-at f29)
			(boarded p11)
