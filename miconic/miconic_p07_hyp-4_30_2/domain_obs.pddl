(define
	...
	(:action observe10_depart_f14_p7
		:parameters ()
		:precondition (and
			(lift-at f14)
			(boarded p7)
	...
	(:action observe17_board_f42_p12
		:parameters ()
		:precondition (and
			(lift-at f42)
			(observation16)
	...
	(:action observe19_depart_f18_p12
		:parameters ()
		:precondition (and
			(lift-at f18)
			(boarded p12)
