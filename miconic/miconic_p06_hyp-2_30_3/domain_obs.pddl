(define
	...
	(:action observe11_depart_f37_p16
		:parameters ()
		:precondition (and
			(lift-at f37)
			(boarded p16)
	...
	(:action observe13_depart_f39_p2
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p2)
