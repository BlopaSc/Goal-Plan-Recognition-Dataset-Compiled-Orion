(define
	...
	(:action observe13_board_f26_p12
		:parameters ()
		:precondition (and
			(lift-at f26)
			(observation12)
	...
	(:action observe23_depart_f23_p5
		:parameters ()
		:precondition (and
			(lift-at f23)
			(boarded p5)
