(define
	...
	(:action observe19_depart_f43_p6
		:parameters ()
		:precondition (and
			(lift-at f43)
			(boarded p6)
	...
	(:action observe21_depart_f10_p8
		:parameters ()
		:precondition (and
			(lift-at f10)
			(boarded p8)
