(define
	...
	(:action observe11_depart_f39_p9
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p9)
	...
	(:action observe14_depart_f1_p17
		:parameters ()
		:precondition (and
			(lift-at f1)
			(boarded p17)
	...
	(:action observe16_depart_f11_p11
		:parameters ()
		:precondition (and
			(lift-at f11)
			(boarded p11)
