(define
	...
	(:action observe20_board_f14_p12
		:parameters ()
		:precondition (and
			(lift-at f14)
			(observation19)
	...
	(:action observe22_depart_f5_p12
		:parameters ()
		:precondition (and
			(lift-at f5)
			(boarded p12)
