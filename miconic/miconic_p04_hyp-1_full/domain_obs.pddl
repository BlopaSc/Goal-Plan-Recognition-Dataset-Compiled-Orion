(define
	...
	(:action observe16_depart_f13_p8
		:parameters ()
		:precondition (and
			(lift-at f13)
			(boarded p8)
	...
	(:action observe20_depart_f15_p0
		:parameters ()
		:precondition (and
			(lift-at f15)
			(boarded p0)
