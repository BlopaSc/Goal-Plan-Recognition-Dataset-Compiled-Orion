(define
	...
	(:action observe10_depart_f19_p8
		:parameters ()
		:precondition (and
			(lift-at f19)
			(boarded p8)
	...
	(:action observe12_board_f12_p10
		:parameters ()
		:precondition (and
			(lift-at f12)
			(observation11)
