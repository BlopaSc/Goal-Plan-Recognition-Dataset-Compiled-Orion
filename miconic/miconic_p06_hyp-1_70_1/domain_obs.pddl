(define
	...
	(:action observe30_depart_f39_p9
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p9)
	...
	(:action observe32_board_f14_p12
		:parameters ()
		:precondition (and
			(lift-at f14)
			(observation31)
	...
	(:action observe33_depart_f5_p12
		:parameters ()
		:precondition (and
			(lift-at f5)
			(boarded p12)
