(define
	...
	(:action observe31_board_f24_p17
		:parameters ()
		:precondition (and
			(lift-at f24)
			(observation30)
	...
	(:action observe33_board_f32_p11
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observation32)
	...
	(:action observe34_depart_f1_p17
		:parameters ()
		:precondition (and
			(lift-at f1)
			(boarded p17)
	...
	(:action observe36_depart_f11_p11
		:parameters ()
		:precondition (and
			(lift-at f11)
			(boarded p11)
