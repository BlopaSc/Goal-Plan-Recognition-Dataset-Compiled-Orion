(define
	...
	(:action observe15_depart_f39_p9
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p9)
	...
	(:action observe24_depart_f39_p2
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p2)
