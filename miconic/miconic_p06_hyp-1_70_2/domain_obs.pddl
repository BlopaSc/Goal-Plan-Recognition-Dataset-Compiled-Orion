(define
	...
	(:action observe32_depart_f5_p12
		:parameters ()
		:precondition (and
			(lift-at f5)
			(boarded p12)
	...
	(:action observe37_board_f32_p18
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observation36)
