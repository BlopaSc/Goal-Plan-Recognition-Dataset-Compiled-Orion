(define
	...
	(:action observe14_depart_f43_p1
		:parameters ()
		:precondition (and
			(lift-at f43)
			(boarded p1)
	...
	(:action observe24_depart_f43_p6
		:parameters ()
		:precondition (and
			(lift-at f43)
			(boarded p6)
	...
	(:action observe27_depart_f10_p8
		:parameters ()
		:precondition (and
			(lift-at f10)
			(boarded p8)
	...
	(:action observe32_depart_f24_p9
		:parameters ()
		:precondition (and
			(lift-at f24)
			(boarded p9)
