(define
	...
	(:action observe19_depart_f10_p8
		:parameters ()
		:precondition (and
			(lift-at f10)
			(boarded p8)
	...
	(:action observe26_depart_f33_p4
		:parameters ()
		:precondition (and
			(lift-at f33)
			(boarded p4)
