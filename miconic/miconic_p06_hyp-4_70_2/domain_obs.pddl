(define
	...
	(:action observe11_board_f26_p15
		:parameters ()
		:precondition (and
			(lift-at f26)
			(observation10)
	...
	(:action observe13_depart_f32_p15
		:parameters ()
		:precondition (and
			(lift-at f32)
			(boarded p15)
	...
	(:action observe15_depart_f37_p7
		:parameters ()
		:precondition (and
			(lift-at f37)
			(boarded p7)
	...
	(:action observe19_board_f43_p13
		:parameters ()
		:precondition (and
			(lift-at f43)
			(observation18)
	...
	(:action observe21_depart_f5_p13
		:parameters ()
		:precondition (and
			(lift-at f5)
			(boarded p13)
	...
	(:action observe34_depart_f39_p2
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p2)
