...
(define
	...
	(:action observe2_depart_f27_p21
		:parameters ()
		:precondition (and
			(boarded p21)
			(lift-at f27)
	...
	(:action observe13_depart_f43_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f43)
