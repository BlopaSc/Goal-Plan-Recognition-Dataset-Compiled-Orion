...
(define
	...
	(:action observe14_board_f14_p12
		:parameters ()
		:precondition (and
			(lift-at f14)
			(observed obs13)
	...
	(:action observe15_depart_f5_p12
		:parameters ()
		:precondition (and
			(boarded p12)
			(lift-at f5)
	...
	(:action observe16_board_f32_p18
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observed obs15)
