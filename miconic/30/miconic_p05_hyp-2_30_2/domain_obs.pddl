...
(define
	...
	(:action observe14_depart_f23_p5
		:parameters ()
		:precondition (and
			(boarded p5)
			(lift-at f23)
	...
	(:action observe17_depart_f22_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f22)
