...
(define
	...
	(:action observe12_depart_f10_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f10)
	...
	(:action observe15_depart_f37_p20
		:parameters ()
		:precondition (and
			(boarded p20)
			(lift-at f37)
