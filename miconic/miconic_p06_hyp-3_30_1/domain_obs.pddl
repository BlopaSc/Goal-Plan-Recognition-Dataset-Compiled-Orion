(define
	...
	(:action observe14_board_f32_p11
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observation13)
	...
	(:action observe15_depart_f1_p17
		:parameters ()
		:precondition (and
			(lift-at f1)
			(boarded p17)
