(define
	...
	(:action observe10_depart_f37_p16
		:parameters ()
		:precondition (and
			(lift-at f37)
			(boarded p16)
	...
	(:action observe16_board_f38_p10
		:parameters ()
		:precondition (and
			(lift-at f38)
			(observation15)
