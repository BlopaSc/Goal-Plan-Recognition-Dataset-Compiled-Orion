(define
	...
	(:action observe18_depart_f19_p8
		:parameters ()
		:precondition (and
			(lift-at f19)
			(boarded p8)
	...
	(:action observe21_depart_f23_p5
		:parameters ()
		:precondition (and
			(lift-at f23)
			(boarded p5)
