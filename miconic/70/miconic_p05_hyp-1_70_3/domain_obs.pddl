...
(define
	...
	(:action observe10_board_f21_p11
		:parameters ()
		:precondition (and
			(lift-at f21)
			(observed obs9)
	...
	(:action observe30_depart_f19_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f19)
