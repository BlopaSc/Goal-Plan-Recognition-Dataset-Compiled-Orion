...
(define
	...
	(:action observe12_depart_f37_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f37)
	...
	(:action observe15_board_f43_p13
		:parameters ()
		:precondition (and
			(lift-at f43)
			(observed obs14)
	...
	(:action observe27_depart_f37_p16
		:parameters ()
		:precondition (and
			(boarded p16)
			(lift-at f37)
	...
	(:action observe31_depart_f39_p2
		:parameters ()
		:precondition (and
			(boarded p2)
			(lift-at f39)
