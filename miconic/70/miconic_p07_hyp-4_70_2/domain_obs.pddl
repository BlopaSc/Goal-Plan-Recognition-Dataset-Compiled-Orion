...
(define
	...
	(:action observe12_depart_f27_p21
		:parameters ()
		:precondition (and
			(boarded p21)
			(lift-at f27)
	...
	(:action observe19_depart_f14_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f14)
	...
	(:action observe29_depart_f43_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f43)
	...
	(:action observe31_depart_f10_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f10)
	...
	(:action observe34_depart_f24_p9
		:parameters ()
		:precondition (and
			(boarded p9)
			(lift-at f24)
