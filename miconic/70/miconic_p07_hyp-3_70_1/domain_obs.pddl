...
(define
	...
	(:action observe15_depart_f43_p1
		:parameters ()
		:precondition (and
			(boarded p1)
			(lift-at f43)
	...
	(:action observe27_depart_f43_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f43)
	...
	(:action observe28_depart_f10_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f10)
	...
	(:action observe35_depart_f33_p4
		:parameters ()
		:precondition (and
			(boarded p4)
			(lift-at f33)
	...
	(:action observe36_depart_f37_p20
		:parameters ()
		:precondition (and
			(boarded p20)
			(lift-at f37)
