...
(define
	...
	(:action observe11_depart_f43_p1
		:parameters ()
		:precondition (and
			(boarded p1)
			(lift-at f43)
	...
	(:action observe13_depart_f14_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f14)
	...
	(:action observe22_depart_f43_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f43)
	...
	(:action observe27_depart_f22_p0
		:parameters ()
		:precondition (and
			(boarded p0)
			(lift-at f22)
