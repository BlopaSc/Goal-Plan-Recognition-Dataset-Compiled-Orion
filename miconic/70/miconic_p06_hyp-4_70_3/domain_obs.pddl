...
(define
	...
	(:action observe19_depart_f5_p13
		:parameters ()
		:precondition (and
			(boarded p13)
			(lift-at f5)
	...
	(:action observe25_depart_f39_p9
		:parameters ()
		:precondition (and
			(boarded p9)
			(lift-at f39)
