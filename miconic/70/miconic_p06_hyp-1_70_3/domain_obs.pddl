...
(define
	...
	(:action observe14_depart_f37_p7
		:parameters ()
		:precondition (and
			(boarded p7)
			(lift-at f37)
	...
	(:action observe16_depart_f39_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f39)
	...
	(:action observe28_depart_f39_p9
		:parameters ()
		:precondition (and
			(boarded p9)
			(lift-at f39)
	...
	(:action observe30_board_f14_p12
		:parameters ()
		:precondition (and
			(lift-at f14)
			(observed obs29)
	...
	(:action observe38_depart_f14_p18
		:parameters ()
		:precondition (and
			(boarded p18)
			(lift-at f14)
