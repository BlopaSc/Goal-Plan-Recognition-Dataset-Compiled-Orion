...
(define
	...
	(:action observe17_depart_f39_p6
		:parameters ()
		:precondition (and
			(boarded p6)
			(lift-at f39)
	...
	(:action observe34_board_f32_p11
		:parameters ()
		:precondition (and
			(lift-at f32)
			(observed obs33)
	...
	(:action observe39_depart_f39_p2
		:parameters ()
		:precondition (and
			(boarded p2)
			(lift-at f39)
