...
(define
	...
	(:action observe17_depart_f10_p8
		:parameters ()
		:precondition (and
			(boarded p8)
			(lift-at f10)
	...
	(:action observe21_depart_f24_p9
		:parameters ()
		:precondition (and
			(boarded p9)
			(lift-at f24)
