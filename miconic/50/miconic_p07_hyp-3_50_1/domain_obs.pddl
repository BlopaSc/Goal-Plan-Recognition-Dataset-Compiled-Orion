...
(define
	...
	(:action observe21_depart_f22_p0
		:parameters ()
		:precondition (and
			(boarded p0)
			(lift-at f22)
	...
	(:action observe23_depart_f33_p4
		:parameters ()
		:precondition (and
			(boarded p4)
			(lift-at f33)
