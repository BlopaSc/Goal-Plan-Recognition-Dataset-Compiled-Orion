...
(define
	...
	(:action observe11_board_f43_p13
		:parameters ()
		:precondition (and
			(lift-at f43)
			(observed obs10)
	...
	(:action observe16_depart_f18_p3
		:parameters ()
		:precondition (and
			(boarded p3)
			(lift-at f18)
	...
	(:action observe22_depart_f37_p16
		:parameters ()
		:precondition (and
			(boarded p16)
			(lift-at f37)
	...
	(:action observe23_depart_f39_p2
		:parameters ()
		:precondition (and
			(boarded p2)
			(lift-at f39)
	...
	(:action observe27_depart_f13_p10
		:parameters ()
		:precondition (and
			(boarded p10)
			(lift-at f13)
