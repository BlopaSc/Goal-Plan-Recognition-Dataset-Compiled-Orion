...
(define
	...
	(:action observe26_depart_f24_p9
		:parameters ()
		:precondition (and
			(boarded p9)
			(lift-at f24)
	...
	(:action observe29_depart_f18_p12
		:parameters ()
		:precondition (and
			(boarded p12)
			(lift-at f18)
	...
	(:action observe31_depart_f22_p0
		:parameters ()
		:precondition (and
			(boarded p0)
			(lift-at f22)
	...
	(:action observe34_depart_f16_p3
		:parameters ()
		:precondition (and
			(boarded p3)
			(lift-at f16)
	...
	(:action observe36_depart_f33_p4
		:parameters ()
		:precondition (and
			(boarded p4)
			(lift-at f33)
