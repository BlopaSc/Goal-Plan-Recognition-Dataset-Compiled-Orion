(define
	...
	(:action observe17_depart_f13_p7
		:parameters ()
		:precondition (and
			(lift-at f13)
			(boarded p7)
	...
	(:action observe18_depart_f13_p5
		:parameters ()
		:precondition (and
			(lift-at f13)
			(boarded p5)
