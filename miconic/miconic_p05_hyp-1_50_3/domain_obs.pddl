(define
	...
	(:action observe16_depart_f22_p7
		:parameters ()
		:precondition (and
			(lift-at f22)
			(boarded p7)
	...
	(:action observe24_depart_f4_p10
		:parameters ()
		:precondition (and
			(lift-at f4)
			(boarded p10)
