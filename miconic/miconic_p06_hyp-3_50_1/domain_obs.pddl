(define
	...
	(:action observe18_depart_f39_p9
		:parameters ()
		:precondition (and
			(lift-at f39)
			(boarded p9)
	...
	(:action observe21_board_f24_p17
		:parameters ()
		:precondition (and
			(lift-at f24)
			(observation20)
