(define
	...
	(:action observe12_board_f26_p12
		:parameters ()
		:precondition (and
			(lift-at f26)
			(observation11)
	...
	(:action observe14_depart_f14_p12
		:parameters ()
		:precondition (and
			(lift-at f14)
			(boarded p12)
