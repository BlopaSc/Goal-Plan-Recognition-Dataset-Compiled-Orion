(define
	...
	(:action observe11_depart_f43_p6
		:parameters ()
		:precondition (and
			(lift-at f43)
			(boarded p6)
	...
	(:action observe16_depart_f14_p7
		:parameters ()
		:precondition (and
			(lift-at f14)
			(boarded p7)
	...
	(:action observe26_depart_f3_p13
		:parameters ()
		:precondition (and
			(lift-at f3)
			(boarded p13)
