...
(define
	...
	(:action observe0_move_place_1_4_place_1_5
		:parameters ()
		:precondition (and
			(at-robot place_1_4)
			(not (observed obs0))
	...
	(:action observe2_move_place_2_1_place_2_2
		:parameters ()
		:precondition (and
			(open place_2_2)
			(at-robot place_2_1)
	...
	(:action observe3_move_place_2_2_place_2_1
		:parameters ()
		:precondition (and
			(at-robot place_2_2)
			(observed obs2)
	...
	(:action observe5_move_place_4_2_place_4_3
		:parameters ()
		:precondition (and
			(at-robot place_4_2)
			(observed obs4)
