...
(define
	...
	(:action observe0_move_place_1_2_place_1_1
		:parameters ()
		:precondition (and
			(at-robot place_1_2)
			(not (observed obs0))
	...
	(:action observe1_move_place_3_0_place_4_0
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observed obs0)
	...
	(:action observe2_move_place_2_3_place_3_3
		:parameters ()
		:precondition (and
			(at-robot place_2_3)
			(observed obs1)
	...
	(:action observe3_move_place_3_7_place_3_8
		:parameters ()
		:precondition (and
			(at-robot place_3_7)
			(observed obs2)
