...
(define
	...
	(:action observe0_move_place_1_8_place_1_7
		:parameters ()
		:precondition (and
			(at-robot place_1_8)
			(not (observed obs0))
	...
	(:action observe1_move_place_1_7_place_1_6
		:parameters ()
		:precondition (and
			(at-robot place_1_7)
			(observed obs0)
	...
	(:action observe2_move_place_6_0_place_7_0
		:parameters ()
		:precondition (and
			(at-robot place_6_0)
			(observed obs1)
	...
	(:action observe3_unlock_place_8_2_place_8_3_key_6_shape_6
		:parameters ()
		:precondition (and
			(locked place_8_3)
			(carrying key_6)
	...
	(:action observe6_move_place_2_0_place_1_0
		:parameters ()
		:precondition (and
			(at-robot place_2_0)
			(observed obs5)
	...
	(:action observe7_move_place_8_3_place_8_4
		:parameters ()
		:precondition (and
			(at-robot place_8_3)
			(observed obs6)
