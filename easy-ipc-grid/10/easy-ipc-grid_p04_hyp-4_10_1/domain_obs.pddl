...
(define
	...
	(:action observe2_unlock_place_1_0_place_2_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(locked place_2_0)
			(carrying key_10)
	...
	(:action observe4_move_place_8_3_place_8_4
		:parameters ()
		:precondition (and
			(at-robot place_8_3)
			(observed obs3)
	...
	(:action observe5_pickup_place_0_0_key_21
		:parameters ()
		:precondition (and
			(at-robot place_0_0)
			(at key_21 place_0_0)
	...
	(:action observe6_move_place_8_4_place_9_4
		:parameters ()
		:precondition (and
			(at-robot place_8_4)
			(observed obs5)
