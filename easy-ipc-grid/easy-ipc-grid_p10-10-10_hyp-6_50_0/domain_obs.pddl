(define
	...
	(:action observe3_move_place_6_4_place_6_5
		:parameters ()
		:precondition (and
			(at-robot place_6_4)
			(observation2)
	...
	(:action observe4_move_place_6_5_place_6_6
		:parameters ()
		:precondition (and
			(at-robot place_6_5)
			(observation3)
	...
	(:action observe5_move_place_6_6_place_6_7
		:parameters ()
		:precondition (and
			(at-robot place_6_6)
			(observation4)
	...
	(:action observe6_move_place_6_7_place_6_8
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observation5)
	...
	(:action observe7_move_place_6_8_place_6_9
		:parameters ()
		:precondition (and
			(at-robot place_6_8)
			(observation6)
