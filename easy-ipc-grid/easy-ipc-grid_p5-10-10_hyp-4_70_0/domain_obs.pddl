(define
	...
	(:action observe5_pickup_place_5_0_key_7
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(at key_7 place_5_0)
	...
	(:action observe7_unlock_place_4_0_place_4_1_key_7_shape_7
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(locked place_4_1)
	...
	(:action observe8_move_place_4_0_place_4_1
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(open place_4_1)
	...
	(:action observe9_move_place_4_1_place_4_2
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(open place_4_2)
