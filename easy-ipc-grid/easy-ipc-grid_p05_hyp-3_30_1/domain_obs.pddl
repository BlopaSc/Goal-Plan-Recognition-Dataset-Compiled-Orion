(define
	...
	(:action observe1_move_place_3_2_place_3_3
		:parameters ()
		:precondition (and
			(at-robot place_3_2)
			(observation0)
	...
	(:action observe2_move_place_3_3_place_3_2
		:parameters ()
		:precondition (and
			(at-robot place_3_3)
			(observation1)
	...
	(:action observe7_move_place_6_3_place_6_2
		:parameters ()
		:precondition (and
			(at-robot place_6_3)
			(observation6)
	...
	(:action observe9_move_place_6_7_place_7_7
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observation8)
