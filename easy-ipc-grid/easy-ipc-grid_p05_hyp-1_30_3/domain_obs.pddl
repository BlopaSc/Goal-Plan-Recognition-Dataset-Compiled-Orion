(define
	...
	(:action observe1_move_place_3_3_place_2_3
		:parameters ()
		:precondition (and
			(at-robot place_3_3)
			(observation0)
	...
	(:action observe3_unlock_place_5_0_place_6_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(locked place_6_0)
	...
	(:action observe7_move_place_3_0_place_3_1
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observation6)
	...
	(:action observe8_move_place_3_4_place_3_3
		:parameters ()
		:precondition (and
			(at-robot place_3_4)
			(observation7)
