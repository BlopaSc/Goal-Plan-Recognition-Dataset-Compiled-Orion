(define
	...
	(:action observe1_move_place_4_0_place_4_1
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(observation0)
	...
	(:action observe4_move_place_4_4_place_4_5
		:parameters ()
		:precondition (and
			(at-robot place_4_4)
			(observation3)
	...
	(:action observe5_move_place_4_5_place_4_6
		:parameters ()
		:precondition (and
			(at-robot place_4_5)
			(observation4)
	...
	(:action observe6_move_place_4_8_place_4_9
		:parameters ()
		:precondition (and
			(at-robot place_4_8)
			(observation5)
