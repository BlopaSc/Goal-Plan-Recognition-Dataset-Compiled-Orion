(define
	...
	(:action observe3_pickup_place_5_0_key_7
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(at key_7 place_5_0)
	...
	(:action observe4_unlock_place_4_0_place_4_1_key_7_shape_7
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(locked place_4_1)
	...
	(:action observe5_unlock_place_4_1_place_4_2_key_6_shape_6
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(locked place_4_2)
	...
	(:action observe6_move_place_4_1_place_4_2
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(open place_4_2)
