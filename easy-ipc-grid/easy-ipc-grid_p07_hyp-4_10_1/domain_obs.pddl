(define
	...
	(:action observe0_move_place_1_6_place_1_7
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_1_6)
	...
	(:action observe1_move_place_1_8_place_0_8
		:parameters ()
		:precondition (and
			(at-robot place_1_8)
			(observation0)
	...
	(:action observe5_move_place_2_5_place_2_6
		:parameters ()
		:precondition (and
			(at-robot place_2_5)
			(open place_2_6)
	...
	(:action observe6_move_place_3_7_place_3_8
		:parameters ()
		:precondition (and
			(at-robot place_3_7)
			(observation5)
