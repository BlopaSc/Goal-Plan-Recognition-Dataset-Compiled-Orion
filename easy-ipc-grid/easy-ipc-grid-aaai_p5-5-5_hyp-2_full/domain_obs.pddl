(define
	...
	(:action observe3_pickup_place_3_0_key_4
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(at key_4 place_3_0)
	...
	(:action observe5_move_place_3_1_place_2_1
		:parameters ()
		:precondition (and
			(at-robot place_3_1)
			(observation4)
	...
	(:action observe6_unlock_place_2_1_place_2_2_key_4_shape_4
		:parameters ()
		:precondition (and
			(at-robot place_2_1)
			(locked place_2_2)
	...
	(:action observe7_move_place_2_1_place_2_2
		:parameters ()
		:precondition (and
			(at-robot place_2_1)
			(open place_2_2)
	...
	(:action observe8_move_place_2_2_place_2_3
		:parameters ()
		:precondition (and
			(at-robot place_2_2)
			(observation7)
	...
	(:action observe9_move_place_2_3_place_2_4
		:parameters ()
		:precondition (and
			(at-robot place_2_3)
			(observation8)
