(define
	...
	(:action observe0_pickup_place_1_0_key_1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_1_0)
	...
	(:action observe6_move_place_0_3_place_0_4
		:parameters ()
		:precondition (and
			(at-robot place_0_3)
			(observation5)
	...
	(:action observe7_move_place_0_4_place_0_5
		:parameters ()
		:precondition (and
			(at-robot place_0_4)
			(observation6)
	...
	(:action observe8_move_place_0_7_place_0_8
		:parameters ()
		:precondition (and
			(at-robot place_0_7)
			(observation7)
