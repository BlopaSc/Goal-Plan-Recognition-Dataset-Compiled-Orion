(define
	...
	(:action observe0_move_place_2_0_place_3_0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_2_0)
	...
	(:action observe5_move_place_8_0_place_8_1
		:parameters ()
		:precondition (and
			(at-robot place_8_0)
			(observation4)
	...
	(:action observe6_move_place_8_1_place_8_2
		:parameters ()
		:precondition (and
			(at-robot place_8_1)
			(observation5)
	...
	(:action observe7_move_place_8_2_place_8_3
		:parameters ()
		:precondition (and
			(at-robot place_8_2)
			(observation6)
	...
	(:action observe8_move_place_8_3_place_9_3
		:parameters ()
		:precondition (and
			(at-robot place_8_3)
			(observation7)
