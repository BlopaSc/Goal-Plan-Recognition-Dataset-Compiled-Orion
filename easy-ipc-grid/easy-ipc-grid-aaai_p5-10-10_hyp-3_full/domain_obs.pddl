(define
	...
	(:action observe9_pickup_place_9_0_key_5
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(at key_5 place_9_0)
	...
	(:action observe14_unlock_place_5_0_place_5_1_key_5_shape_5
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(locked place_5_1)
	...
	(:action observe15_move_place_5_0_place_5_1
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(open place_5_1)
	...
	(:action observe16_move_place_5_1_place_5_2
		:parameters ()
		:precondition (and
			(at-robot place_5_1)
			(observation15)
	...
	(:action observe17_move_place_5_2_place_5_3
		:parameters ()
		:precondition (and
			(at-robot place_5_2)
			(observation16)
	...
	(:action observe18_move_place_5_3_place_5_4
		:parameters ()
		:precondition (and
			(at-robot place_5_3)
			(observation17)
