(define
	...
	(:action observe2_pickup_place_3_0_key_6
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(at key_6 place_3_0)
	...
	(:action observe6_unlock_place_4_0_place_4_1_key_7_shape_7
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(locked place_4_1)
	...
	(:action observe8_move_place_4_1_place_4_2
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(open place_4_2)
	...
	(:action observe9_move_place_4_2_place_4_3
		:parameters ()
		:precondition (and
			(at-robot place_4_2)
			(observation8)
