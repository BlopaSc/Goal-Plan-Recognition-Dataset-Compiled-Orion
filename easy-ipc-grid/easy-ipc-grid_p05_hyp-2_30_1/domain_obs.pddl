(define
	...
	(:action observe0_move_place_2_3_place_3_3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_2_3)
	...
	(:action observe1_move_place_3_3_place_3_2
		:parameters ()
		:precondition (and
			(at-robot place_3_3)
			(observation0)
	...
	(:action observe2_move_place_3_2_place_3_1
		:parameters ()
		:precondition (and
			(at-robot place_3_2)
			(observation1)
	...
	(:action observe9_move_place_6_8_place_6_7
		:parameters ()
		:precondition (and
			(at-robot place_6_8)
			(observation8)
