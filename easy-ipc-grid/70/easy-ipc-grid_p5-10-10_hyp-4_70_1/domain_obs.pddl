...
(define
	...
	(:action observe4_pickup_place_5_0_key_7
		:parameters ()
		:precondition (and
			(at key_7 place_5_0)
			(at-robot place_5_0)
	...
	(:action observe5_unlock_place_4_0_place_4_1_key_7_shape_7
		:parameters ()
		:precondition (and
			(locked place_4_1)
			(carrying key_7)
	...
	(:action observe6_move_place_4_0_place_4_1
		:parameters ()
		:precondition (and
			(open place_4_1)
			(at-robot place_4_0)
	...
	(:action observe7_unlock_place_4_1_place_4_2_key_6_shape_6
		:parameters ()
		:precondition (and
			(locked place_4_2)
			(carrying key_6)
	...
	(:action observe8_move_place_4_2_place_4_3
		:parameters ()
		:precondition (and
			(at-robot place_4_2)
			(observed obs7)
	...
	(:action observe9_move_place_4_3_place_4_4
		:parameters ()
		:precondition (and
			(at-robot place_4_3)
			(observed obs8)
