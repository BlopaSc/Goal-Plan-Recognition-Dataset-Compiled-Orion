...
(define
	...
	(:action observe2_move_place_4_0_place_4_1
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(observed obs1)
	...
	(:action observe3_move_place_4_1_place_4_2
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(observed obs2)
	...
	(:action observe4_move_place_4_3_place_4_4
		:parameters ()
		:precondition (and
			(at-robot place_4_3)
			(observed obs3)
	...
	(:action observe5_move_place_4_4_place_5_4
		:parameters ()
		:precondition (and
			(at-robot place_4_4)
			(observed obs4)
	...
	(:action observe6_move_place_5_4_place_5_5
		:parameters ()
		:precondition (and
			(at-robot place_5_4)
			(observed obs5)
	...
	(:action observe7_move_place_5_5_place_5_6
		:parameters ()
		:precondition (and
			(at-robot place_5_5)
			(observed obs6)
	...
	(:action observe8_move_place_5_7_place_5_8
		:parameters ()
		:precondition (and
			(at-robot place_5_7)
			(observed obs7)
	...
	(:action observe9_move_place_5_8_place_5_9
		:parameters ()
		:precondition (and
			(at-robot place_5_8)
			(observed obs8)
