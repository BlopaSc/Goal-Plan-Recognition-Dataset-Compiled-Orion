...
(define
	...
	(:action observe2_move_place_3_0_place_3_1
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observed obs1)
	...
	(:action observe4_move_place_3_3_place_3_4
		:parameters ()
		:precondition (and
			(at-robot place_3_3)
			(observed obs3)
	...
	(:action observe5_move_place_3_4_place_3_5
		:parameters ()
		:precondition (and
			(at-robot place_3_4)
			(observed obs4)
	...
	(:action observe6_move_place_3_5_place_3_6
		:parameters ()
		:precondition (and
			(at-robot place_3_5)
			(observed obs5)
	...
	(:action observe8_move_place_3_8_place_3_9
		:parameters ()
		:precondition (and
			(at-robot place_3_8)
			(observed obs7)
