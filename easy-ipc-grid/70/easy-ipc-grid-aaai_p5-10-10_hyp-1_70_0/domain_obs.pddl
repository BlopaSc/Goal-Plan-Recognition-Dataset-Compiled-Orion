...
(define
	...
	(:action observe10_pickup_place_6_0_key_0
		:parameters ()
		:precondition (and
			(at key_0 place_6_0)
			(at-robot place_6_0)
	...
	(:action observe11_move_place_6_0_place_6_1
		:parameters ()
		:precondition (and
			(open place_6_1)
			(at-robot place_6_0)
	...
	(:action observe12_move_place_6_1_place_6_2
		:parameters ()
		:precondition (and
			(open place_6_2)
			(at-robot place_6_1)
	...
	(:action observe13_move_place_6_2_place_6_3
		:parameters ()
		:precondition (and
			(at-robot place_6_2)
			(observed obs12)
