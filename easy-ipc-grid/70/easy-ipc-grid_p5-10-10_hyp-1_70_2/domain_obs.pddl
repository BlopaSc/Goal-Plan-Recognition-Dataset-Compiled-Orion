...
(define
	...
	(:action observe7_move_place_2_0_place_1_0
		:parameters ()
		:precondition (and
			(at-robot place_2_0)
			(observed obs6)
	...
	(:action observe8_move_place_1_0_place_1_1
		:parameters ()
		:precondition (and
			(at-robot place_1_0)
			(observed obs7)
	...
	(:action observe9_unlock_place_1_1_place_1_2_key_1_shape_1
		:parameters ()
		:precondition (and
			(locked place_1_2)
			(carrying key_1)
	...
	(:action observe10_move_place_1_1_place_1_2
		:parameters ()
		:precondition (and
			(open place_1_2)
			(at-robot place_1_1)
	...
	(:action observe11_move_place_1_2_place_1_3
		:parameters ()
		:precondition (and
			(at-robot place_1_2)
			(observed obs10)
