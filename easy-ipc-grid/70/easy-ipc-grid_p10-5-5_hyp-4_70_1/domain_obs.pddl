...
(define
	...
	(:action observe6_move_place_4_3_place_4_4
		:parameters ()
		:precondition (and
			(at-robot place_4_3)
			(observed obs5)
	...
	(:action observe7_move_place_4_4_place_4_5
		:parameters ()
		:precondition (and
			(at-robot place_4_4)
			(observed obs6)
	...
	(:action observe8_move_place_4_6_place_4_7
		:parameters ()
		:precondition (and
			(at-robot place_4_6)
			(observed obs7)
	...
	(:action observe9_move_place_4_7_place_4_8
		:parameters ()
		:precondition (and
			(at-robot place_4_7)
			(observed obs8)
