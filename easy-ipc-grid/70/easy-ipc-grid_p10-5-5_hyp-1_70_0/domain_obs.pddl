...
(define
	...
	(:action observe1_move_place_1_0_place_0_0
		:parameters ()
		:precondition (and
			(at-robot place_1_0)
			(observed obs0)
	...
	(:action observe2_move_place_0_0_place_0_1
		:parameters ()
		:precondition (and
			(at-robot place_0_0)
			(observed obs1)
	...
	(:action observe3_unlock_place_0_1_place_0_2_key_1_shape_1
		:parameters ()
		:precondition (and
			(locked place_0_2)
			(carrying key_1)
	...
	(:action observe4_move_place_0_1_place_0_2
		:parameters ()
		:precondition (and
			(open place_0_2)
			(at-robot place_0_1)
	...
	(:action observe5_move_place_0_2_place_0_3
		:parameters ()
		:precondition (and
			(at-robot place_0_2)
			(observed obs4)
	...
	(:action observe6_move_place_0_6_place_1_6
		:parameters ()
		:precondition (and
			(at-robot place_0_6)
			(observed obs5)
	...
	(:action observe9_move_place_1_8_place_1_9
		:parameters ()
		:precondition (and
			(at-robot place_1_8)
			(observed obs8)
