(define
	...
	(:action observe5_move_place_7_1_place_7_2
		:parameters ()
		:precondition (and
			(at-robot place_7_1)
			(observation4)
	...
	(:action observe6_move_place_7_2_place_7_3
		:parameters ()
		:precondition (and
			(at-robot place_7_2)
			(observation5)
	...
	(:action observe7_move_place_7_3_place_7_4
		:parameters ()
		:precondition (and
			(at-robot place_7_3)
			(observation6)
	...
	(:action observe8_move_place_7_4_place_7_5
		:parameters ()
		:precondition (and
			(at-robot place_7_4)
			(observation7)
	...
	(:action observe9_move_place_7_5_place_7_6
		:parameters ()
		:precondition (and
			(at-robot place_7_5)
			(observation8)
	...
	(:action observe10_move_place_7_6_place_7_7
		:parameters ()
		:precondition (and
			(at-robot place_7_6)
			(observation9)
