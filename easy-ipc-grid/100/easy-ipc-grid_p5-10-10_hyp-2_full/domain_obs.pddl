...
(define
	...
	(:action observe1_pickup_place_1_0_key_2
		:parameters ()
		:precondition (and
			(at key_2 place_1_0)
			(at-robot place_1_0)
	...
	(:action observe3_unlock_place_2_0_place_2_1_key_2_shape_2
		:parameters ()
		:precondition (and
			(locked place_2_1)
			(carrying key_2)
	...
	(:action observe5_move_place_2_1_place_2_2
		:parameters ()
		:precondition (and
			(at-robot place_2_1)
			(observed obs4)
	...
	(:action observe6_move_place_2_2_place_2_3
		:parameters ()
		:precondition (and
			(at-robot place_2_2)
			(observed obs5)
	...
	(:action observe7_move_place_2_3_place_2_4
		:parameters ()
		:precondition (and
			(at-robot place_2_3)
			(observed obs6)
