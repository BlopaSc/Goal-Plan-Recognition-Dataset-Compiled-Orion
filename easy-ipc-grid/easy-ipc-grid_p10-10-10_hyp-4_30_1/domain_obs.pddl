(define
	...
	(:action observe0_move_place_4_2_place_4_3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_4_2)
	...
	(:action observe1_move_place_4_3_place_4_4
		:parameters ()
		:precondition (and
			(at-robot place_4_3)
			(observation0)
	...
	(:action observe2_move_place_4_4_place_4_5
		:parameters ()
		:precondition (and
			(at-robot place_4_4)
			(observation1)
	...
	(:action observe3_move_place_4_8_place_4_9
		:parameters ()
		:precondition (and
			(at-robot place_4_8)
			(observation2)
