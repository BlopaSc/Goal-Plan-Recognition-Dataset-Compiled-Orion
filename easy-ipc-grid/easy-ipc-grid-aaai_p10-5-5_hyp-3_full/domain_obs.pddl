(define
	...
	(:action observe3_move_place_3_0_place_3_1
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observation2)
	...
	(:action observe6_move_place_3_3_place_3_4
		:parameters ()
		:precondition (and
			(at-robot place_3_3)
			(observation5)
	...
	(:action observe7_move_place_3_4_place_3_5
		:parameters ()
		:precondition (and
			(at-robot place_3_4)
			(observation6)
	...
	(:action observe10_move_place_3_7_place_3_8
		:parameters ()
		:precondition (and
			(at-robot place_3_7)
			(observation9)
	...
	(:action observe11_move_place_3_8_place_3_9
		:parameters ()
		:precondition (and
			(at-robot place_3_8)
			(observation10)
