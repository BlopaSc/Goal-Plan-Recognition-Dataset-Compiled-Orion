(define
	...
	(:action observe2_move_place_3_1_place_2_1
		:parameters ()
		:precondition (and
			(at-robot place_3_1)
			(observation1)
	...
	(:action observe3_unlock_place_2_1_place_2_2_key_4_shape_4
		:parameters ()
		:precondition (and
			(at-robot place_2_1)
			(locked place_2_2)
	...
	(:action observe4_move_place_2_1_place_2_2
		:parameters ()
		:precondition (and
			(at-robot place_2_1)
			(open place_2_2)
	...
	(:action observe5_move_place_2_2_place_2_3
		:parameters ()
		:precondition (and
			(at-robot place_2_2)
			(observation4)
	...
	(:action observe6_move_place_2_3_place_2_4
		:parameters ()
		:precondition (and
			(at-robot place_2_3)
			(observation5)
