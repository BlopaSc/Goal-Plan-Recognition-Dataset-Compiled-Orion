(define
	...
	(:action observe1_move_place_1_6_place_1_5
		:parameters ()
		:precondition (and
			(at-robot place_1_6)
			(observation0)
	...
	(:action observe2_pickup_place_9_1_key_19
		:parameters ()
		:precondition (and
			(at-robot place_9_1)
			(at key_19 place_9_1)
	...
	(:action observe4_move_place_2_6_place_3_6
		:parameters ()
		:precondition (and
			(at-robot place_2_6)
			(observation3)
	...
	(:action observe5_move_place_3_6_place_3_7
		:parameters ()
		:precondition (and
			(at-robot place_3_6)
			(open place_3_7)
