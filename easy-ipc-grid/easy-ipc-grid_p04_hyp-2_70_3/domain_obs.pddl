(define
	...
	(:action observe16_move_place_0_1_place_0_0
		:parameters ()
		:precondition (and
			(at-robot place_0_1)
			(observation15)
	...
	(:action observe22_move_place_4_0_place_4_1
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(observation21)
	...
	(:action observe23_pickup_place_4_1_key_14
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(at key_14 place_4_1)
	...
	(:action observe24_move_place_4_1_place_4_2
		:parameters ()
		:precondition (and
			(at-robot place_4_1)
			(observation23)
