(define
	...
	(:action observe0_move_place_1_5_place_1_4
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_1_5)
	...
	(:action observe1_unlock_place_1_0_place_2_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(at-robot place_1_0)
			(locked place_2_0)
	...
	(:action observe2_move_place_6_2_place_6_3
		:parameters ()
		:precondition (and
			(at-robot place_6_2)
			(observation1)
	...
	(:action observe3_move_place_7_8_place_7_9
		:parameters ()
		:precondition (and
			(at-robot place_7_8)
			(observation2)
