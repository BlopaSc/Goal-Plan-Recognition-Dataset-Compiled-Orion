...
(define
	...
	(:action observe8_move_place_9_0_place_9_1
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(observed obs7)
	...
	(:action observe9_move_place_9_4_place_8_4
		:parameters ()
		:precondition (and
			(at-robot place_9_4)
			(observed obs8)
	...
	(:action observe10_move_place_8_5_place_8_6
		:parameters ()
		:precondition (and
			(at-robot place_8_5)
			(observed obs9)
	...
	(:action observe11_move_place_8_7_place_8_8
		:parameters ()
		:precondition (and
			(at-robot place_8_7)
			(observed obs10)
