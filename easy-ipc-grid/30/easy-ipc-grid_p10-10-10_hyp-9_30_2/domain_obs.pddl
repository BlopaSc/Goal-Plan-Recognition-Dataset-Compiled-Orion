...
(define
	...
	(:action observe1_move_place_8_0_place_9_0
		:parameters ()
		:precondition (and
			(at-robot place_8_0)
			(observed obs0)
	...
	(:action observe2_pickup_place_9_0_key_1
		:parameters ()
		:precondition (and
			(at key_1 place_9_0)
			(at-robot place_9_0)
	...
	(:action observe4_move_place_9_3_place_9_4
		:parameters ()
		:precondition (and
			(at-robot place_9_3)
			(observed obs3)
	...
	(:action observe5_move_place_9_6_place_9_7
		:parameters ()
		:precondition (and
			(at-robot place_9_6)
			(observed obs4)
