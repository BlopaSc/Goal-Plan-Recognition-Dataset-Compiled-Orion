...
(define
	...
	(:action observe1_move_place_1_8_place_1_7
		:parameters ()
		:precondition (and
			(at-robot place_1_8)
			(observed obs0)
	...
	(:action observe9_move_place_6_0_place_6_1
		:parameters ()
		:precondition (and
			(at-robot place_6_0)
			(observed obs8)
	...
	(:action observe10_move_place_6_3_place_7_3
		:parameters ()
		:precondition (and
			(at-robot place_6_3)
			(observed obs9)
	...
	(:action observe11_move_place_7_8_place_7_9
		:parameters ()
		:precondition (and
			(at-robot place_7_8)
			(observed obs10)
