...
(define
	...
	(:action observe3_move_place_7_0_place_6_0
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs2)
	...
	(:action observe4_unlock_place_6_0_place_6_1_key_9_shape_9
		:parameters ()
		:precondition (and
			(locked place_6_1)
			(carrying key_9)
	...
	(:action observe5_unlock_place_6_1_place_6_2_key_0_shape_0
		:parameters ()
		:precondition (and
			(locked place_6_2)
			(carrying key_0)
