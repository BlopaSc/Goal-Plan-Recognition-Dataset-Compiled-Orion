...
(define
	...
	(:action observe3_move_place_1_0_place_2_0
		:parameters ()
		:precondition (and
			(at-robot place_1_0)
			(observed obs2)
	...
	(:action observe5_unlock_place_5_0_place_6_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(locked place_6_0)
			(carrying key_10)
	...
	(:action observe7_move_place_3_0_place_2_0
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observed obs6)
	...
	(:action observe8_move_place_2_1_place_2_2
		:parameters ()
		:precondition (and
			(open place_2_2)
			(at-robot place_2_1)
	...
	(:action observe9_move_place_2_2_place_2_3
		:parameters ()
		:precondition (and
			(at-robot place_2_2)
			(observed obs8)
