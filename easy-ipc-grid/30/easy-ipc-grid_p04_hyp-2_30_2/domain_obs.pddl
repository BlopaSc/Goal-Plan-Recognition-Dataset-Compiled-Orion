...
(define
	...
	(:action observe2_move_place_1_6_place_1_5
		:parameters ()
		:precondition (and
			(at-robot place_1_6)
			(observed obs1)
	...
	(:action observe3_move_place_1_5_place_1_4
		:parameters ()
		:precondition (and
			(at-robot place_1_5)
			(observed obs2)
	...
	(:action observe5_move_place_1_2_place_0_2
		:parameters ()
		:precondition (and
			(at-robot place_1_2)
			(observed obs4)
	...
	(:action observe7_move_place_0_0_place_1_0
		:parameters ()
		:precondition (and
			(at-robot place_0_0)
			(observed obs6)
	...
	(:action observe11_move_place_4_2_place_4_3
		:parameters ()
		:precondition (and
			(open place_4_3)
			(at-robot place_4_2)
	...
	(:action observe12_move_place_5_7_place_5_8
		:parameters ()
		:precondition (and
			(at-robot place_5_7)
			(observed obs11)
