...
(define
	...
	(:action observe0_move_place_6_0_place_7_0
		:parameters ()
		:precondition (and
			(at-robot place_6_0)
			(not (observed obs0))
	...
	(:action observe2_unlock_place_5_0_place_5_1_key_5_shape_5
		:parameters ()
		:precondition (and
			(locked place_5_1)
			(carrying key_5)
	...
	(:action observe3_move_place_5_0_place_5_1
		:parameters ()
		:precondition (and
			(open place_5_1)
			(at-robot place_5_0)
	...
	(:action observe4_move_place_5_1_place_5_2
		:parameters ()
		:precondition (and
			(at-robot place_5_1)
			(observed obs3)
	...
	(:action observe5_move_place_5_2_place_5_3
		:parameters ()
		:precondition (and
			(at-robot place_5_2)
			(observed obs4)
