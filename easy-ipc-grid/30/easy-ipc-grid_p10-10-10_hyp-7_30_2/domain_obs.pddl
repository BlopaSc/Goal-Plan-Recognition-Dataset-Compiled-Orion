...
(define
	...
	(:action observe0_move_place_4_0_place_5_0
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(not (observed obs0))
	...
	(:action observe2_move_place_7_0_place_7_1
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs1)
	...
	(:action observe3_move_place_7_3_place_7_4
		:parameters ()
		:precondition (and
			(at-robot place_7_3)
			(observed obs2)
	...
	(:action observe4_move_place_7_4_place_7_5
		:parameters ()
		:precondition (and
			(at-robot place_7_4)
			(observed obs3)
