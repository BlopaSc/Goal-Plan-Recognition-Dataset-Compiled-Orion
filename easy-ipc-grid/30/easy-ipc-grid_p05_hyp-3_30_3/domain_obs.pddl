...
(define
	...
	(:action observe5_move_place_6_1_place_6_2
		:parameters ()
		:precondition (and
			(at-robot place_6_1)
			(observed obs4)
	...
	(:action observe6_move_place_6_3_place_6_2
		:parameters ()
		:precondition (and
			(at-robot place_6_3)
			(observed obs5)
	...
	(:action observe7_move_place_6_3_place_6_4
		:parameters ()
		:precondition (and
			(at-robot place_6_3)
			(observed obs6)
	...
	(:action observe8_move_place_6_4_place_6_5
		:parameters ()
		:precondition (and
			(at-robot place_6_4)
			(observed obs7)
	...
	(:action observe9_move_place_6_6_place_6_7
		:parameters ()
		:precondition (and
			(at-robot place_6_6)
			(observed obs8)
	...
	(:action observe10_move_place_6_7_place_6_6
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observed obs9)
