...
(define
	...
	(:action observe3_move_place_9_0_place_9_1
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(observed obs2)
	...
	(:action observe4_move_place_9_4_place_9_5
		:parameters ()
		:precondition (and
			(at-robot place_9_4)
			(observed obs3)
	...
	(:action observe5_move_place_9_7_place_9_8
		:parameters ()
		:precondition (and
			(at-robot place_9_7)
			(observed obs4)
	...
	(:action observe6_move_place_9_8_place_8_8
		:parameters ()
		:precondition (and
			(at-robot place_9_8)
			(observed obs5)
