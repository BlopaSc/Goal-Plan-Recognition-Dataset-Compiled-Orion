(define
	...
	(:action observe0_pickup_place_2_3_key_10
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot place_2_3)
	...
	(:action observe1_unlock_place_5_0_place_6_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(locked place_6_0)
	...
	(:action observe2_move_place_6_7_place_7_7
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observation1)
	...
	(:action observe3_move_place_7_7_place_7_8
		:parameters ()
		:precondition (and
			(at-robot place_7_7)
			(observation2)
