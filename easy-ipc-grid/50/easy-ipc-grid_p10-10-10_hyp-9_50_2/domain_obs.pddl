...
(define
	...
	(:action observe5_move_place_9_0_place_9_1
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(observed obs4)
	...
	(:action observe7_move_place_9_5_place_9_6
		:parameters ()
		:precondition (and
			(at-robot place_9_5)
			(observed obs6)
	...
	(:action observe8_move_place_9_6_place_9_7
		:parameters ()
		:precondition (and
			(at-robot place_9_6)
			(observed obs7)
	...
	(:action observe9_move_place_9_7_place_9_8
		:parameters ()
		:precondition (and
			(at-robot place_9_7)
			(observed obs8)
