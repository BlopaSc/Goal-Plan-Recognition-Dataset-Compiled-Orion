...
(define
	...
	(:action observe1_move_place_6_0_place_7_0
		:parameters ()
		:precondition (and
			(at-robot place_6_0)
			(observed obs0)
	...
	(:action observe2_move_place_7_0_place_8_0
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs1)
	...
	(:action observe3_move_place_8_1_place_8_2
		:parameters ()
		:precondition (and
			(at-robot place_8_1)
			(observed obs2)
	...
	(:action observe4_move_place_8_2_place_8_3
		:parameters ()
		:precondition (and
			(at-robot place_8_2)
			(observed obs3)
	...
	(:action observe5_move_place_8_3_place_8_4
		:parameters ()
		:precondition (and
			(at-robot place_8_3)
			(observed obs4)
