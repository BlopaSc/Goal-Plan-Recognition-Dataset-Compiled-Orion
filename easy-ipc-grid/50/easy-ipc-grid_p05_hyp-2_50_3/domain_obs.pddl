...
(define
	...
	(:action observe7_move_place_3_1_place_3_0
		:parameters ()
		:precondition (and
			(at-robot place_3_1)
			(observed obs6)
	...
	(:action observe9_unlock_place_5_0_place_6_0_key_10_shape_10
		:parameters ()
		:precondition (and
			(locked place_6_0)
			(carrying key_10)
	...
	(:action observe10_move_place_6_0_place_6_1
		:parameters ()
		:precondition (and
			(at-robot place_6_0)
			(observed obs9)
	...
	(:action observe11_move_place_6_1_place_6_2
		:parameters ()
		:precondition (and
			(at-robot place_6_1)
			(observed obs10)
	...
	(:action observe14_move_place_6_7_place_6_8
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observed obs13)
	...
	(:action observe15_move_place_6_8_place_6_7
		:parameters ()
		:precondition (and
			(at-robot place_6_8)
			(observed obs14)
	...
	(:action observe16_move_place_6_7_place_6_8
		:parameters ()
		:precondition (and
			(at-robot place_6_7)
			(observed obs15)
