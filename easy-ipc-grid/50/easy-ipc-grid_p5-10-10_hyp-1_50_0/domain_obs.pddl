...
(define
	...
	(:action observe2_pickup_place_6_0_key_1
		:parameters ()
		:precondition (and
			(at key_1 place_6_0)
			(at-robot place_6_0)
	...
	(:action observe5_move_place_2_0_place_1_0
		:parameters ()
		:precondition (and
			(at-robot place_2_0)
			(observed obs4)
	...
	(:action observe6_unlock_place_1_1_place_1_2_key_1_shape_1
		:parameters ()
		:precondition (and
			(locked place_1_2)
			(carrying key_1)
	...
	(:action observe7_move_place_1_1_place_1_2
		:parameters ()
		:precondition (and
			(open place_1_2)
			(at-robot place_1_1)
