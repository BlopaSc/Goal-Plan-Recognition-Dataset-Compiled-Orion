...
(define
	...
	(:action observe2_move_place_5_0_place_4_0
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(observed obs1)
	...
	(:action observe4_move_place_3_0_place_2_0
		:parameters ()
		:precondition (and
			(at-robot place_3_0)
			(observed obs3)
	...
	(:action observe5_unlock_place_1_1_place_1_2_key_1_shape_1
		:parameters ()
		:precondition (and
			(locked place_1_2)
			(carrying key_1)
	...
	(:action observe6_move_place_1_1_place_1_2
		:parameters ()
		:precondition (and
			(open place_1_2)
			(at-robot place_1_1)
	...
	(:action observe7_move_place_1_2_place_1_3
		:parameters ()
		:precondition (and
			(at-robot place_1_2)
			(observed obs6)
	...
	(:action observe8_move_place_1_3_place_1_4
		:parameters ()
		:precondition (and
			(at-robot place_1_3)
			(observed obs7)
