...
(define
	...
	(:action observe3_move_place_4_0_place_3_0
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(observed obs2)
	...
	(:action observe6_move_place_3_4_place_3_5
		:parameters ()
		:precondition (and
			(at-robot place_3_4)
			(observed obs5)
	...
	(:action observe7_move_place_3_5_place_3_6
		:parameters ()
		:precondition (and
			(at-robot place_3_5)
			(observed obs6)
	...
	(:action observe8_move_place_3_6_place_3_7
		:parameters ()
		:precondition (and
			(open place_3_7)
			(at-robot place_3_6)
	...
	(:action observe9_move_place_3_7_place_3_8
		:parameters ()
		:precondition (and
			(at-robot place_3_7)
			(observed obs8)
