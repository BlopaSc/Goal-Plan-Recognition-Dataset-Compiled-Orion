...
(define
	...
	(:action observe1_move_place_4_0_place_5_0
		:parameters ()
		:precondition (and
			(at-robot place_4_0)
			(observed obs0)
	...
	(:action observe2_move_place_5_0_place_6_0
		:parameters ()
		:precondition (and
			(at-robot place_5_0)
			(observed obs1)
	...
	(:action observe6_pickup_place_6_0_key_0
		:parameters ()
		:precondition (and
			(at key_0 place_6_0)
			(at-robot place_6_0)
	...
	(:action observe7_unlock_place_6_1_place_6_2_key_0_shape_0
		:parameters ()
		:precondition (and
			(locked place_6_2)
			(carrying key_0)
