...
(define
	...
	(:action observe5_move_place_9_1_place_9_2
		:parameters ()
		:precondition (and
			(at-robot place_9_1)
			(observed obs4)
	...
	(:action observe7_move_place_9_2_place_9_3
		:parameters ()
		:precondition (and
			(open place_9_3)
			(at-robot place_9_2)
	...
	(:action observe8_move_place_9_3_place_9_4
		:parameters ()
		:precondition (and
			(at-robot place_9_3)
			(observed obs7)
	...
	(:action observe10_move_place_9_8_place_8_8
		:parameters ()
		:precondition (and
			(at-robot place_9_8)
			(observed obs9)
