...
(define
	...
	(:action observe5_pickup_place_9_0_key_5
		:parameters ()
		:precondition (and
			(at key_5 place_9_0)
			(at-robot place_9_0)
	...
	(:action observe6_move_place_9_0_place_8_0
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(observed obs5)
	...
	(:action observe7_move_place_7_0_place_6_0
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs6)
	...
	(:action observe8_move_place_5_0_place_5_1
		:parameters ()
		:precondition (and
			(open place_5_1)
			(at-robot place_5_0)
