...
(define
	...
	(:action observe5_move_place_8_0_place_7_0
		:parameters ()
		:precondition (and
			(at-robot place_8_0)
			(observed obs4)
	...
	(:action observe6_move_place_7_0_place_6_0
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs5)
	...
	(:action observe7_move_place_5_0_place_5_1
		:parameters ()
		:precondition (and
			(open place_5_1)
			(at-robot place_5_0)
	...
	(:action observe8_move_place_5_1_place_5_2
		:parameters ()
		:precondition (and
			(at-robot place_5_1)
			(observed obs7)
	...
	(:action observe9_move_place_5_3_place_5_4
		:parameters ()
		:precondition (and
			(at-robot place_5_3)
			(observed obs8)
