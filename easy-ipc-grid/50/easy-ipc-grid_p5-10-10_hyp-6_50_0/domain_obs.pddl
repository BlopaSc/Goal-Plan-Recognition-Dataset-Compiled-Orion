...
(define
	...
	(:action observe3_move_place_7_0_place_8_0
		:parameters ()
		:precondition (and
			(at-robot place_7_0)
			(observed obs2)
	...
	(:action observe5_move_place_9_0_place_8_0
		:parameters ()
		:precondition (and
			(at-robot place_9_0)
			(observed obs4)
	...
	(:action observe6_move_place_8_0_place_7_0
		:parameters ()
		:precondition (and
			(at-robot place_8_0)
			(observed obs5)
	...
	(:action observe7_move_place_6_0_place_6_1
		:parameters ()
		:precondition (and
			(open place_6_1)
			(at-robot place_6_0)
	...
	(:action observe8_unlock_place_6_1_place_6_2_key_0_shape_0
		:parameters ()
		:precondition (and
			(locked place_6_2)
			(carrying key_0)
