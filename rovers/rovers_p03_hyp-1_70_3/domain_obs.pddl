(define
	...
	(:action observe1_navigate_rover1_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint0)
	...
	(:action observe2_sample_soil_rover1_rover1store_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(at_soil_sample waypoint1)
	...
	(:action observe7_take_image_rover0_waypoint0_objective2_camera2_low_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
