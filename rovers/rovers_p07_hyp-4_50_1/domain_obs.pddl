(define
	...
	(:action observe12_navigate_rover3_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint4)
	...
	(:action observe14_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe15_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_rock_analysis rover3 waypoint9)
	...
	(:action observe17_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe20_navigate_rover0_waypoint4_waypoint10
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint4)
