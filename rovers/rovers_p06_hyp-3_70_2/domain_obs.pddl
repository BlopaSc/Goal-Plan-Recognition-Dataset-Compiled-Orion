(define
	...
	(:action observe23_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(calibrated camera1 rover0)
			(at rover0 waypoint0)
	...
	(:action observe24_navigate_rover0_waypoint0_waypoint7
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
	...
	(:action observe25_communicate_image_data_rover0_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(at rover0 waypoint7)
			(have_image rover0 objective2 high_res)
