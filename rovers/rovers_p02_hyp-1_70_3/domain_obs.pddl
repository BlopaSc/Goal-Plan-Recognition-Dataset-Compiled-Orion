(define
	...
	(:action observe3_communicate_rock_data_rover0_general_waypoint0_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(have_rock_analysis rover0 waypoint0)
	...
	(:action observe4_take_image_rover0_waypoint0_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
