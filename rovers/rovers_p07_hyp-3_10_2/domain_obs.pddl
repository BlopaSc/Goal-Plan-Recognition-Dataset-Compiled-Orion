(define
	...
	(:action observe0_take_image_rover1_waypoint6_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated camera2 rover1)
	...
	(:action observe1_navigate_rover3_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint4)
	...
	(:action observe4_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint5)
			(at_soil_sample waypoint5)
