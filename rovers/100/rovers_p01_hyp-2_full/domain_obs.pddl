...
(define
	...
	(:constants
		rover0 rover1 - equipped_for_soil_analysis__inferred_type
	...
	(:action observe0_sample_soil_rover1_rover1store_waypoint2
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint2)
			(at rover1 waypoint2)
	...
	(:action observe1_drop_rover1_rover1store
		:parameters ()
		:precondition (and
			(full rover1store)
			(observed obs0)
	...
	(:action observe2_navigate_rover1_waypoint2_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(available rover1)
	...
	(:action observe3_communicate_soil_data_rover1_general_waypoint2_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe4_sample_rock_rover1_rover1store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover1store)
	...
	(:action observe5_calibrate_rover1_camera0_objective0_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs4)
	...
	(:action observe6_communicate_rock_data_rover1_general_waypoint1_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe7_take_image_rover1_waypoint1_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
	...
	(:action observe8_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
