...
(define
	...
	(:constants
		...
		rover1 - equipped_for_rock_analysis__inferred_type
		rover0 rover1 rover2 rover3 - equipped_for_imaging__inferred_type
		rover0 rover1 rover2 rover3 - rover__inferred_type
		waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 waypoint6 waypoint7 - waypoint__inferred_type
	...
	(:action observe3_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint0)
			(empty rover0store)
	...
	(:action observe4_take_image_rover1_waypoint0_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint0)
			(calibrated camera0 rover1)
	...
	(:action observe5_communicate_soil_data_rover0_general_waypoint0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe6_communicate_image_data_rover1_general_objective1_high_res_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe7_navigate_rover1_waypoint0_waypoint6
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint0)
	...
	(:action observe8_navigate_rover2_waypoint3_waypoint6
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(available rover2)
	...
	(:action observe9_navigate_rover1_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe10_sample_soil_rover2_rover2store_waypoint6
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint6)
			(empty rover2store)
	...
	(:action observe11_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint4)
			(empty rover1store)
	...
	(:action observe12_navigate_rover2_waypoint6_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
	...
	(:action observe13_communicate_rock_data_rover1_general_waypoint4_waypoint4_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe14_communicate_soil_data_rover2_general_waypoint6_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover2 waypoint3)
