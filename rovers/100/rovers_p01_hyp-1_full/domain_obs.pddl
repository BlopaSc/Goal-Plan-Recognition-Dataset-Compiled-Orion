...
(define
	...
	(:action observe0_sample_soil_rover0_rover0store_waypoint3
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint3)
			(at rover0 waypoint3)
	...
	(:action observe1_navigate_rover1_waypoint2_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(available rover1)
	...
	(:action observe2_communicate_soil_data_rover0_general_waypoint3_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint3)
	...
	(:action observe3_sample_rock_rover1_rover1store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover1store)
	...
	(:action observe4_calibrate_rover1_camera0_objective0_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs3)
	...
	(:action observe5_communicate_rock_data_rover1_general_waypoint1_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe6_take_image_rover1_waypoint1_objective0_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
	...
	(:action observe7_communicate_image_data_rover1_general_objective0_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
