...
(define
	...
	(:action observe1_navigate_rover1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint1)
	...
	(:action observe2_sample_soil_rover1_rover1store_waypoint3
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint3)
			(empty rover1store)
	...
	(:action observe3_navigate_rover1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint3)
	...
	(:action observe4_communicate_soil_data_rover1_general_waypoint3_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe5_sample_rock_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint0)
			(at rover0 waypoint0)
	...
	(:action observe6_calibrate_rover0_camera2_objective1_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observed obs5)
	...
	(:action observe7_communicate_rock_data_rover0_general_waypoint0_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe8_take_image_rover0_waypoint0_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera2 rover0)
	...
	(:action observe9_calibrate_rover1_camera0_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs8)
	...
	(:action observe10_communicate_image_data_rover0_general_objective0_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe11_take_image_rover1_waypoint1_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
	...
	(:action observe12_communicate_image_data_rover1_general_objective2_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
