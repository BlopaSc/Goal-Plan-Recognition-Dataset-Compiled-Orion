(define
	...
	(:action observe6_sample_soil_rover2_rover2store_waypoint5
		:parameters ()
		:precondition (and
			(at rover2 waypoint5)
			(at_soil_sample waypoint5)
	...
	(:action observe15_calibrate_rover1_camera2_objective4_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observation14)
	...
	(:action observe16_take_image_rover1_waypoint1_objective2_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover1)
			(at rover1 waypoint1)
