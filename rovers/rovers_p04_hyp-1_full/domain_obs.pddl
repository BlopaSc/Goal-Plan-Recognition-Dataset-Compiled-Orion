(define
	...
	(:action observe0_navigate_rover0_waypoint1_waypoint0
		:parameters ()
		:precondition (and
			(not (observation0))
			(available rover0)
	...
	(:action observe1_calibrate_rover2_camera1_objective0_waypoint3
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(observation0)
	...
	(:action observe2_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(at_soil_sample waypoint0)
	...
	(:action observe3_take_image_rover2_waypoint3_objective0_camera1_high_res
		:parameters ()
		:precondition (and
			(calibrated camera1 rover2)
			(at rover2 waypoint3)
	...
	(:action observe4_communicate_soil_data_rover0_general_waypoint0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(have_soil_analysis rover0 waypoint0)
	...
	(:action observe5_communicate_image_data_rover2_general_objective0_high_res_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(have_image rover2 objective0 high_res)
	...
	(:action observe6_navigate_rover1_waypoint3_waypoint0
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint3)
	...
	(:action observe7_navigate_rover2_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint3)
	...
	(:action observe8_navigate_rover1_waypoint0_waypoint6
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint0)
	...
	(:action observe9_sample_soil_rover2_rover2store_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint1)
			(at_soil_sample waypoint1)
	...
	(:action observe10_navigate_rover1_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe11_navigate_rover2_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint1)
	...
	(:action observe12_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(at_rock_sample waypoint4)
	...
	(:action observe13_communicate_soil_data_rover2_general_waypoint1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(have_soil_analysis rover2 waypoint1)
	...
	(:action observe14_communicate_rock_data_rover1_general_waypoint4_waypoint4_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(have_rock_analysis rover1 waypoint4)
