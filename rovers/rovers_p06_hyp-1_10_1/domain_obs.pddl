(define
	...
	(:action observe0_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover3 waypoint4)
	...
	(:action observe2_take_image_rover1_waypoint1_objective2_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover1)
			(at rover1 waypoint1)
	...
	(:action observe3_communicate_image_data_rover1_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(at rover1 waypoint7)
			(have_image rover1 objective2 high_res)
