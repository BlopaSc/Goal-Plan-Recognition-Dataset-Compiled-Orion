(define
	...
	(:action observe3_sample_soil_rover2_rover2store_waypoint6
		:parameters ()
		:precondition (and
			(at rover2 waypoint6)
			(at_soil_sample waypoint6)
	...
	(:action observe4_navigate_rover2_waypoint6_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
	...
	(:action observe5_sample_rock_rover1_rover1store_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(at_rock_sample waypoint2)
	...
	(:action observe6_communicate_soil_data_rover2_general_waypoint6_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(have_soil_analysis rover2 waypoint6)
