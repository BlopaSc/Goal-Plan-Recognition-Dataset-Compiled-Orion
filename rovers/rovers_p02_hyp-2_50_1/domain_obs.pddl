(define
	...
	(:action observe1_navigate_rover0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
	...
	(:action observe3_sample_rock_rover0_rover0store_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(at_rock_sample waypoint1)
	...
	(:action observe4_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(have_rock_analysis rover0 waypoint1)
	...
	(:action observe6_communicate_image_data_rover0_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(have_image rover0 objective1 high_res)
