(define
	...
	(:action observe4_sample_rock_rover1_rover1store_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(at_rock_sample waypoint2)
	...
	(:action observe5_communicate_soil_data_rover2_general_waypoint6_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(have_soil_analysis rover2 waypoint6)
	...
	(:action observe6_communicate_rock_data_rover1_general_waypoint2_waypoint2_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(have_rock_analysis rover1 waypoint2)
