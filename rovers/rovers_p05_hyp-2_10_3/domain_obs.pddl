(define
	...
	(:action observe0_drop_rover3_rover3store
		:parameters ()
		:precondition (and
			(not (observation0))
			(full rover3store)
	...
	(:action observe1_navigate_rover0_waypoint1_waypoint5
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint1)
	...
	(:action observe2_navigate_rover3_waypoint3_waypoint8
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint3)
	...
	(:action observe3_navigate_rover2_waypoint2_waypoint8
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint2)
	...
	(:action observe4_communicate_rock_data_rover2_general_waypoint2_waypoint8_waypoint2
		:parameters ()
		:precondition (and
			(at rover2 waypoint8)
			(have_rock_analysis rover2 waypoint2)
