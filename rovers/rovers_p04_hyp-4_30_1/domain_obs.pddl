(define
	...
	(:action observe1_calibrate_rover1_camera0_objective1_waypoint0
		:parameters ()
		:precondition (and
			(at rover1 waypoint0)
			(observation0)
	...
	(:action observe3_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(at_rock_sample waypoint4)
	...
	(:action observe4_communicate_soil_data_rover2_general_waypoint6_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(have_soil_analysis rover2 waypoint6)
