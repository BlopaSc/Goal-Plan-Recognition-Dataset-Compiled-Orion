(define
	...
	(:action observe0_calibrate_rover0_camera2_objective1_waypoint0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover0 waypoint0)
	...
	(:action observe1_communicate_image_data_rover0_general_objective0_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(have_image rover0 objective0 high_res)
