(define
	...
	(:action observe0_communicate_rock_data_rover2_general_waypoint6_waypoint6_waypoint2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover2 waypoint6)
	...
	(:action observe1_sample_soil_rover0_rover0store_waypoint7
		:parameters ()
		:precondition (and
			(at rover0 waypoint7)
			(at_soil_sample waypoint7)
	...
	(:action observe2_calibrate_rover3_camera2_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover3 waypoint1)
			(observation1)
	...
	(:action observe3_navigate_rover1_waypoint6_waypoint0
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe4_communicate_image_data_rover1_general_objective0_low_res_waypoint0_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint0)
			(have_image rover1 objective0 low_res)
	...
	(:action observe5_navigate_rover1_waypoint0_waypoint2
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint0)
	...
	(:action observe9_navigate_rover2_waypoint0_waypoint4
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint0)
	...
	(:action observe10_navigate_rover3_waypoint8_waypoint3
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe12_communicate_rock_data_rover3_general_waypoint7_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint7)
			(have_rock_analysis rover3 waypoint7)
