(define
	...
	(:action observe0_navigate_rover1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(not (observation0))
			(available rover1)
	...
	(:action observe2_navigate_rover1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint3)
	...
	(:action observe3_communicate_soil_data_rover1_general_waypoint3_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_soil_analysis rover1 waypoint3)
