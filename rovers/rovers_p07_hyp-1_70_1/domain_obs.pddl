(define
	...
	(:action observe2_take_image_rover1_waypoint6_objective4_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover1)
			(at rover1 waypoint6)
	...
	(:action observe3_communicate_image_data_rover1_general_objective4_high_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(have_image rover1 objective4 high_res)
	...
	(:action observe28_navigate_rover0_waypoint10_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint10)
