(define
	...
	(:action observe0_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover0 waypoint1)
	...
	(:action observe1_take_image_rover0_waypoint1_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint1)
