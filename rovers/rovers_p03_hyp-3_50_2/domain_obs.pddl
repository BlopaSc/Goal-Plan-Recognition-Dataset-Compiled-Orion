(define
	...
	(:action observe3_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(have_rock_analysis rover0 waypoint1)
	...
	(:action observe4_take_image_rover0_waypoint1_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint1)
	...
	(:action observe6_communicate_image_data_rover0_general_objective0_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(have_image rover0 objective0 high_res)
