(define
	...
	(:action observe9_communicate_image_data_rover0_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(at rover0 waypoint7)
			(have_image rover0 objective2 high_res)
	...
	(:action observe10_communicate_rock_data_rover3_general_waypoint10_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_rock_analysis rover3 waypoint10)
	...
	(:action observe12_navigate_rover0_waypoint5_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint5)
