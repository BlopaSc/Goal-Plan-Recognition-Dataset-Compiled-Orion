(define
	...
	(:action observe4_navigate_rover2_waypoint5_waypoint6
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint5)
	...
	(:action observe9_take_image_rover1_waypoint1_objective2_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover1)
			(at rover1 waypoint1)
	...
	(:action observe10_communicate_image_data_rover1_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(at rover1 waypoint7)
			(have_image rover1 objective2 high_res)
