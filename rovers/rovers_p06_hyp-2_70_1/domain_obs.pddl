(define
	...
	(:action observe6_take_image_rover0_waypoint4_objective4_camera1_colour
		:parameters ()
		:precondition (and
			(calibrated camera1 rover0)
			(at rover0 waypoint4)
	...
	(:action observe7_communicate_image_data_rover0_general_objective4_colour_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(have_image rover0 objective4 colour)
	...
	(:action observe18_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(at_soil_sample waypoint0)
	...
	(:action observe19_navigate_rover0_waypoint0_waypoint7
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
