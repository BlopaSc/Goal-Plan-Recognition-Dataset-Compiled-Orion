(define
	...
	(:action observe0_communicate_soil_data_rover0_general_waypoint3_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover0 waypoint3)
	...
	(:action observe1_communicate_rock_data_rover1_general_waypoint1_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_rock_analysis rover1 waypoint1)
	...
	(:action observe2_take_image_rover1_waypoint1_objective0_camera0_high_res
		:parameters ()
		:precondition (and
			(calibrated camera0 rover1)
			(at rover1 waypoint1)
	...
	(:action observe3_communicate_image_data_rover1_general_objective0_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_image rover1 objective0 high_res)
