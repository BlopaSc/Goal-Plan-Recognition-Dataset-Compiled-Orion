(define
	...
	(:action observe5_take_image_rover0_waypoint0_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
	...
	(:action observe7_communicate_image_data_rover0_general_objective1_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(have_image rover0 objective1 high_res)
