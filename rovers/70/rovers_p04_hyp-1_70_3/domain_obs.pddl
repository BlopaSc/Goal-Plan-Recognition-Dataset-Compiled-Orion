...
(define
	...
	(:action observe5_navigate_rover1_waypoint3_waypoint0
		:parameters ()
		:precondition (and
			(at rover1 waypoint3)
			(available rover1)
	...
	(:action observe6_sample_soil_rover2_rover2store_waypoint1
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint1)
			(empty rover2store)
	...
	(:action observe7_navigate_rover1_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe8_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint4)
			(empty rover1store)
	...
	(:action observe9_communicate_soil_data_rover2_general_waypoint1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover2 waypoint3)
	...
	(:action observe10_communicate_rock_data_rover1_general_waypoint4_waypoint4_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
