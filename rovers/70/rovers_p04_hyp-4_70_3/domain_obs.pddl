...
(define
	...
	(:action observe3_take_image_rover1_waypoint0_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint0)
			(calibrated camera0 rover1)
	...
	(:action observe6_navigate_rover1_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe9_navigate_rover2_waypoint6_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
