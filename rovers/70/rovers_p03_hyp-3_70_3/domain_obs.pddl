...
(define
	...
	(:action observe5_calibrate_rover0_camera2_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(observed obs4)
	...
	(:action observe6_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe7_take_image_rover0_waypoint1_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(calibrated camera2 rover0)
	...
	(:action observe8_communicate_image_data_rover0_general_objective0_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe9_communicate_image_data_rover1_general_objective1_high_res_waypoint2_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
