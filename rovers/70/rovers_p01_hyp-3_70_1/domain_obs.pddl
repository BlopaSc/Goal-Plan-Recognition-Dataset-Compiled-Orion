...
(define
	...
	(:action observe2_communicate_soil_data_rover1_general_waypoint2_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe3_calibrate_rover1_camera0_objective0_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs2)
	...
	(:action observe4_communicate_rock_data_rover1_general_waypoint1_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe5_take_image_rover1_waypoint1_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
	...
	(:action observe6_communicate_image_data_rover1_general_objective2_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
