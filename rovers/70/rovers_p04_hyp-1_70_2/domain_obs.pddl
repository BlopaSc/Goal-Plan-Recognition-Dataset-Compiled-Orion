...
(define
	...
	(:action observe4_navigate_rover1_waypoint3_waypoint0
		:parameters ()
		:precondition (and
			(at rover1 waypoint3)
			(available rover1)
	...
	(:action observe5_navigate_rover2_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(available rover2)
	...
	(:action observe8_navigate_rover2_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint1)
