...
(define
	...
	(:action observe2_take_image_rover1_waypoint6_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(calibrated camera2 rover1)
	...
	(:action observe3_communicate_image_data_rover1_general_objective1_high_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint6)
	...
	(:action observe4_navigate_rover2_waypoint6_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint6)
			(available rover2)
	...
	(:action observe5_navigate_rover2_waypoint1_waypoint7
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint1)
	...
	(:action observe6_sample_soil_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint7)
			(empty rover2store)
	...
	(:action observe7_navigate_rover3_waypoint4_waypoint1
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(available rover3)
	...
	(:action observe8_sample_rock_rover3_rover3store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover3store)
	...
	(:action observe10_navigate_rover3_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(available rover3)
	...
	(:action observe11_navigate_rover0_waypoint4_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe13_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe14_navigate_rover3_waypoint1_waypoint10
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint1)
	...
	(:action observe15_calibrate_rover0_camera1_objective4_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observed obs14)
	...
	(:action observe16_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
	...
	(:action observe17_communicate_image_data_rover0_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe18_sample_rock_rover3_rover3store_waypoint10
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint10)
			(empty rover3store)
	...
	(:action observe19_navigate_rover3_waypoint10_waypoint1
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint10)
	...
	(:action observe20_navigate_rover0_waypoint7_waypoint0
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint7)
	...
	(:action observe21_navigate_rover0_waypoint0_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
	...
	(:action observe22_drop_rover0_rover0store
		:parameters ()
		:precondition (and
			(full rover0store)
			(observed obs21)
	...
	(:action observe23_sample_soil_rover0_rover0store_waypoint8
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint8)
			(empty rover0store)
	...
	(:action observe24_communicate_soil_data_rover0_general_waypoint8_waypoint8_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe25_navigate_rover0_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint8)
	...
	(:action observe26_navigate_rover0_waypoint4_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe28_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint5)
			(empty rover0store)
	...
	(:action observe29_communicate_soil_data_rover0_general_waypoint5_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
	...
	(:action observe30_navigate_rover0_waypoint4_waypoint10
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe32_communicate_soil_data_rover0_general_waypoint10_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
