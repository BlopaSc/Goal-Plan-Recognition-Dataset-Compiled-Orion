...
(define
	...
	(:action observe2_navigate_rover0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(available rover0)
	...
	(:action observe6_take_image_rover0_waypoint1_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(calibrated camera2 rover0)
	...
	(:action observe8_communicate_image_data_rover0_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe9_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
