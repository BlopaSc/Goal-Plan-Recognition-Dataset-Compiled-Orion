...
(define
	...
	(:action observe1_communicate_soil_data_rover1_general_waypoint3_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint3)
	...
	(:action observe2_navigate_rover1_waypoint3_waypoint7
		:parameters ()
		:precondition (and
			(at rover1 waypoint3)
			(available rover1)
	...
	(:action observe3_navigate_rover0_waypoint1_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(available rover0)
	...
	(:action observe4_navigate_rover1_waypoint7_waypoint1
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint7)
	...
	(:action observe5_calibrate_rover2_camera1_objective0_waypoint3
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(observed obs4)
	...
	(:action observe6_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint0)
			(empty rover0store)
	...
	(:action observe7_sample_rock_rover1_rover1store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover1store)
	...
	(:action observe8_navigate_rover1_waypoint1_waypoint7
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint1)
	...
	(:action observe9_communicate_rock_data_rover1_general_waypoint1_waypoint7_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
