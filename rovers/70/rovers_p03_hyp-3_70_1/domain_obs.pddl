...
(define
	...
	(:action observe6_take_image_rover0_waypoint1_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(calibrated camera2 rover0)
	...
	(:action observe7_calibrate_rover1_camera0_objective1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(observed obs6)
	...
	(:action observe9_take_image_rover1_waypoint2_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
