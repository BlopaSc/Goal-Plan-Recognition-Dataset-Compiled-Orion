...
(define
	...
	(:action observe4_sample_rock_rover0_rover0store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover0store)
	...
	(:action observe5_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe6_calibrate_rover1_camera0_objective1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(observed obs5)
	...
	(:action observe7_communicate_image_data_rover0_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe8_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
	...
	(:action observe9_communicate_image_data_rover1_general_objective2_high_res_waypoint2_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
