...
(define
	...
	(:action observe0_calibrate_rover1_camera0_objective0_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(not (observed obs0))
	...
	(:action observe1_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
	...
	(:action observe3_sample_rock_rover1_rover1store_waypoint3
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint3)
			(empty rover1store)
	...
	(:action observe4_communicate_rock_data_rover1_general_waypoint3_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe5_communicate_image_data_rover1_general_objective2_high_res_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
