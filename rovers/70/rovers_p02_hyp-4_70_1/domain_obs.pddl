...
(define
	...
	(:action observe6_take_image_rover0_waypoint0_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera2 rover0)
	...
	(:action observe8_communicate_image_data_rover0_general_objective1_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
