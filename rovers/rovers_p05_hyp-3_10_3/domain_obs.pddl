(define
	...
	(:action observe0_calibrate_rover3_camera2_objective1_waypoint1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover3 waypoint1)
	...
	(:action observe1_calibrate_rover1_camera3_objective2_waypoint0
		:parameters ()
		:precondition (and
			(at rover1 waypoint0)
			(observation0)
	...
	(:action observe2_communicate_soil_data_rover1_general_waypoint4_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(have_soil_analysis rover1 waypoint4)
