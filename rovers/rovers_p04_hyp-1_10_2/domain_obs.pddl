(define
	...
	(:action observe0_communicate_soil_data_rover2_general_waypoint1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover2 waypoint3)
	...
	(:action observe1_communicate_rock_data_rover1_general_waypoint4_waypoint4_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(have_rock_analysis rover1 waypoint4)
