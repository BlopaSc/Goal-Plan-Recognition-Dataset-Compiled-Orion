(define
	...
	(:action observe1_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(calibrated camera1 rover0)
			(at rover0 waypoint0)
	...
	(:action observe3_sample_rock_rover3_rover3store_waypoint10
		:parameters ()
		:precondition (and
			(at rover3 waypoint10)
			(at_rock_sample waypoint10)
	...
	(:action observe4_navigate_rover0_waypoint4_waypoint10
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint4)
