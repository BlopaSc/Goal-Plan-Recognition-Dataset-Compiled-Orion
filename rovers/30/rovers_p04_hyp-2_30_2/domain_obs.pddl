...
(define
	...
	(:action observe0_communicate_image_data_rover2_general_objective0_high_res_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover2 waypoint3)
	...
	(:action observe1_navigate_rover2_waypoint3_waypoint6
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(available rover2)
	...
	(:action observe3_communicate_soil_data_rover2_general_waypoint6_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover2 waypoint3)
	...
	(:action observe4_communicate_rock_data_rover1_general_waypoint2_waypoint2_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
