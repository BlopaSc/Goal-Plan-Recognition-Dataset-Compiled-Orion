...
(define
	...
	(:action observe1_take_image_rover1_waypoint6_objective4_camera2_low_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(calibrated camera2 rover1)
	...
	(:action observe2_communicate_soil_data_rover2_general_waypoint7_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
	...
	(:action observe3_sample_rock_rover3_rover3store_waypoint2
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint2)
			(empty rover3store)
	...
	(:action observe4_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe5_drop_rover3_rover3store
		:parameters ()
		:precondition (and
			(full rover3store)
			(observed obs4)
	...
	(:action observe6_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe7_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe10_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
