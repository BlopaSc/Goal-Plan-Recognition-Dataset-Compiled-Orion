...
(define
	...
	(:action observe6_navigate_rover3_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint2)
	...
	(:action observe8_drop_rover0_rover0store
		:parameters ()
		:precondition (and
			(full rover0store)
			(observed obs7)
	...
	(:action observe9_navigate_rover0_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint8)
	...
	(:action observe10_navigate_rover0_waypoint4_waypoint10
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe11_sample_soil_rover0_rover0store_waypoint10
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint10)
			(empty rover0store)
	...
	(:action observe12_communicate_soil_data_rover0_general_waypoint10_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
