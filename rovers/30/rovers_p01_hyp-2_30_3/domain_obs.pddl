...
(define
	...
	(:action observe1_take_image_rover1_waypoint1_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
	...
	(:action observe2_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
