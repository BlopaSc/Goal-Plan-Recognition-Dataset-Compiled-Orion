...
(define
	...
	(:action observe4_sample_rock_rover3_rover3store_waypoint2
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint2)
			(empty rover3store)
	...
	(:action observe5_navigate_rover0_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe7_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe8_calibrate_rover0_camera1_objective4_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observed obs7)
	...
	(:action observe9_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
