...
(define
	...
	(:action observe0_navigate_rover0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(available rover0)
	...
	(:action observe1_communicate_rock_data_rover0_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe2_communicate_image_data_rover0_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe3_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
