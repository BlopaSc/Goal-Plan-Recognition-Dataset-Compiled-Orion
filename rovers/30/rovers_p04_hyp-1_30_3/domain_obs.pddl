...
(define
	...
	(:action observe1_navigate_rover1_waypoint0_waypoint6
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint0)
	...
	(:action observe2_sample_soil_rover2_rover2store_waypoint1
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint1)
			(empty rover2store)
	...
	(:action observe3_navigate_rover1_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint6)
	...
	(:action observe4_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint4)
			(empty rover1store)
