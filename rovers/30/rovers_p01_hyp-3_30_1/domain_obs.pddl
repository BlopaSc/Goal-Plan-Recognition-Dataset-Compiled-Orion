...
(define
	...
	(:action observe1_calibrate_rover1_camera0_objective0_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs0)
	...
	(:action observe2_communicate_image_data_rover1_general_objective2_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
