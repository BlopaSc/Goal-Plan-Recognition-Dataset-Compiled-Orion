...
(define
	...
	(:action observe2_take_image_rover0_waypoint4_objective3_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(calibrated camera1 rover0)
	...
	(:action observe3_communicate_image_data_rover0_general_objective3_high_res_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
	...
	(:action observe5_take_image_rover0_waypoint4_objective4_camera1_colour
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(calibrated camera1 rover0)
	...
	(:action observe8_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint0)
			(empty rover0store)
	...
	(:action observe10_communicate_soil_data_rover2_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
