...
(define
	...
	(:action observe0_communicate_image_data_rover1_general_objective1_high_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint6)
	...
	(:action observe4_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe5_navigate_rover3_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(available rover3)
	...
	(:action observe8_communicate_soil_data_rover0_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
