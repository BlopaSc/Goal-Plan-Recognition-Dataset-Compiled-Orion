...
(define
	...
	(:action observe1_navigate_rover2_waypoint6_waypoint1
		:parameters ()
		:precondition (and
			(at rover2 waypoint6)
			(available rover2)
	...
	(:action observe3_communicate_rock_data_rover3_general_waypoint1_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe4_drop_rover3_rover3store
		:parameters ()
		:precondition (and
			(full rover3store)
			(observed obs3)
	...
	(:action observe6_communicate_image_data_rover0_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe8_sample_rock_rover3_rover3store_waypoint10
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint10)
			(empty rover3store)
	...
	(:action observe9_navigate_rover3_waypoint10_waypoint1
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint10)
	...
	(:action observe11_navigate_rover0_waypoint0_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
	...
	(:action observe12_sample_soil_rover0_rover0store_waypoint8
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint8)
			(empty rover0store)
