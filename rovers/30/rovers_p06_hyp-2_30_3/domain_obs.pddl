...
(define
	...
	(:action observe2_communicate_image_data_rover1_general_objective0_low_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint6)
	...
	(:action observe8_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe10_navigate_rover2_waypoint6_waypoint4
		:parameters ()
		:precondition (and
			(at rover2 waypoint6)
			(available rover2)
