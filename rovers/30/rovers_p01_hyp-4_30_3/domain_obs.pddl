...
(define
	...
	(:action observe0_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
	...
	(:action observe1_communicate_rock_data_rover1_general_waypoint3_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe2_communicate_image_data_rover1_general_objective2_high_res_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
