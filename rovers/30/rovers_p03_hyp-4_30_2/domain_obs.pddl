...
(define
	...
	(:action observe1_calibrate_rover0_camera2_objective1_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observed obs0)
	...
	(:action observe2_communicate_image_data_rover0_general_objective0_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe3_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
