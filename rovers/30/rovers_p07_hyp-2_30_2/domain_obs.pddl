...
(define
	...
	(:action observe3_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe6_drop_rover0_rover0store
		:parameters ()
		:precondition (and
			(full rover0store)
			(observed obs5)
	...
	(:action observe7_communicate_soil_data_rover0_general_waypoint0_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe8_navigate_rover0_waypoint4_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe9_drop_rover0_rover0store
		:parameters ()
		:precondition (and
			(full rover0store)
			(observed obs8)
	...
	(:action observe10_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint5)
			(empty rover0store)
	...
	(:action observe11_communicate_soil_data_rover0_general_waypoint5_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
	...
	(:action observe12_navigate_rover0_waypoint4_waypoint10
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe13_sample_soil_rover0_rover0store_waypoint10
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint10)
			(empty rover0store)
