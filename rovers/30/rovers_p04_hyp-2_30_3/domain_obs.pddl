...
(define
	...
	(:action observe0_take_image_rover2_waypoint3_objective0_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(calibrated camera1 rover2)
	...
	(:action observe2_sample_soil_rover2_rover2store_waypoint6
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint6)
			(empty rover2store)
	...
	(:action observe3_drop_rover1_rover1store
		:parameters ()
		:precondition (and
			(full rover1store)
			(observed obs2)
