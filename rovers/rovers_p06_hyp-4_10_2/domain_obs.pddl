(define
	...
	(:action observe0_communicate_soil_data_rover2_general_waypoint7_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover2 waypoint7)
	...
	(:action observe1_calibrate_rover0_camera1_objective4_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observation0)
	...
	(:action observe2_take_image_rover0_waypoint0_objective2_camera1_low_res
		:parameters ()
		:precondition (and
			(calibrated camera1 rover0)
			(at rover0 waypoint0)
	...
	(:action observe3_navigate_rover0_waypoint0_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
