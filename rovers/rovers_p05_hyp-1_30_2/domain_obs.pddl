(define
	...
	(:action observe8_calibrate_rover3_camera2_objective1_waypoint0
		:parameters ()
		:precondition (and
			(at rover3 waypoint0)
			(observation7)
	...
	(:action observe10_communicate_soil_data_rover3_general_waypoint4_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_soil_analysis rover3 waypoint4)
	...
	(:action observe12_communicate_soil_data_rover0_general_waypoint5_waypoint5_waypoint2
		:parameters ()
		:precondition (and
			(at rover0 waypoint5)
			(have_soil_analysis rover0 waypoint5)
	...
	(:action observe13_navigate_rover2_waypoint6_waypoint2
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
