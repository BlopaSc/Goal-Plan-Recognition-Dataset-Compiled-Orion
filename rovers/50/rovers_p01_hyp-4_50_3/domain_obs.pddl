...
(define
	...
	(:action observe1_sample_soil_rover0_rover0store_waypoint3
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint3)
			(at rover0 waypoint3)
	...
	(:action observe2_sample_rock_rover1_rover1store_waypoint3
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint3)
			(empty rover1store)
	...
	(:action observe3_communicate_rock_data_rover1_general_waypoint3_waypoint3_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
