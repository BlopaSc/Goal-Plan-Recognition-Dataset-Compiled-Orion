...
(define
	...
	(:action observe3_navigate_rover2_waypoint3_waypoint6
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(available rover2)
	...
	(:action observe4_navigate_rover1_waypoint3_waypoint7
		:parameters ()
		:precondition (and
			(at rover1 waypoint3)
			(available rover1)
	...
	(:action observe5_sample_soil_rover2_rover2store_waypoint6
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint6)
			(empty rover2store)
	...
	(:action observe6_sample_rock_rover1_rover1store_waypoint2
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint2)
			(empty rover1store)
