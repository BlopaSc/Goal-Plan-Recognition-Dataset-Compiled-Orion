...
(define
	...
	(:action observe0_drop_rover1_rover1store
		:parameters ()
		:precondition (and
			(full rover1store)
			(not (observed obs0))
	...
	(:action observe1_communicate_soil_data_rover1_general_waypoint2_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe4_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
