...
(define
	...
	(:action observe1_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint0)
			(empty rover0store)
	...
	(:action observe2_communicate_soil_data_rover0_general_waypoint0_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe3_communicate_image_data_rover1_general_objective1_high_res_waypoint0_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
	...
	(:action observe5_sample_rock_rover1_rover1store_waypoint4
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint4)
			(empty rover1store)
	...
	(:action observe6_navigate_rover2_waypoint6_waypoint3
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
