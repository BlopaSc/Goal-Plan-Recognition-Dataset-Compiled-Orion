...
(define
	...
	(:action observe8_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe13_sample_rock_rover3_rover3store_waypoint9
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint9)
			(empty rover3store)
	...
	(:action observe15_sample_soil_rover0_rover0store_waypoint2
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint2)
			(empty rover0store)
	...
	(:action observe16_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe17_communicate_soil_data_rover0_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
