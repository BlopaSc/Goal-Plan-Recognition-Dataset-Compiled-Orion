...
(define
	...
	(:action observe8_communicate_rock_data_rover3_general_waypoint1_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe16_communicate_soil_data_rover0_general_waypoint8_waypoint8_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
	...
	(:action observe18_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe20_communicate_soil_data_rover0_general_waypoint10_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
