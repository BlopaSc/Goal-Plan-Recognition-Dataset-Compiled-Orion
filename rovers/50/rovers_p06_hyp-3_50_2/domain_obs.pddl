...
(define
	...
	(:action observe5_communicate_image_data_rover1_general_objective4_low_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint6)
	...
	(:action observe8_sample_rock_rover3_rover3store_waypoint2
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint2)
			(empty rover3store)
	...
	(:action observe12_navigate_rover0_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
