...
(define
	...
	(:action observe2_drop_rover1_rover1store
		:parameters ()
		:precondition (and
			(full rover1store)
			(observed obs1)
	...
	(:action observe3_calibrate_rover2_camera1_objective0_waypoint3
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(observed obs2)
	...
	(:action observe4_take_image_rover2_waypoint3_objective0_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover2 waypoint3)
			(calibrated camera1 rover2)
	...
	(:action observe5_navigate_rover1_waypoint1_waypoint7
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint1)
	...
	(:action observe6_communicate_rock_data_rover1_general_waypoint1_waypoint7_waypoint1
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
