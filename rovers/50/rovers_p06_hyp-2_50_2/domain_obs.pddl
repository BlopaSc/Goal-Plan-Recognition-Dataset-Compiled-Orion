...
(define
	...
	(:action observe5_take_image_rover0_waypoint4_objective3_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(calibrated camera1 rover0)
	...
	(:action observe7_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe12_navigate_rover3_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint2)
	...
	(:action observe17_sample_soil_rover2_rover2store_waypoint2
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint2)
			(empty rover2store)
