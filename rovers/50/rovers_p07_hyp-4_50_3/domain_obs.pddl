...
(define
	...
	(:action observe3_communicate_image_data_rover0_general_objective3_low_res_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
	...
	(:action observe5_sample_soil_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint7)
			(empty rover2store)
	...
	(:action observe6_communicate_soil_data_rover2_general_waypoint7_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
	...
	(:action observe10_sample_rock_rover3_rover3store_waypoint10
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint10)
			(empty rover3store)
	...
	(:action observe12_navigate_rover3_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint1)
	...
	(:action observe13_navigate_rover3_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint3)
	...
	(:action observe16_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe18_navigate_rover0_waypoint4_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
