...
(define
	...
	(:action observe3_communicate_rock_data_rover2_general_waypoint7_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
	...
	(:action observe6_calibrate_rover2_camera1_objective1_waypoint7
		:parameters ()
		:precondition (and
			(at rover2 waypoint7)
			(observed obs5)
	...
	(:action observe7_take_image_rover2_waypoint7_objective1_camera1_low_res
		:parameters ()
		:precondition (and
			(at rover2 waypoint7)
			(calibrated camera1 rover2)
	...
	(:action observe12_sample_rock_rover3_rover3store_waypoint4
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint4)
			(empty rover3store)
	...
	(:action observe16_communicate_soil_data_rover0_general_waypoint2_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint7)
	...
	(:action observe18_navigate_rover3_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint0)
	...
	(:action observe22_navigate_rover2_waypoint6_waypoint2
		:parameters ()
		:precondition (and
			(at rover2 waypoint6)
			(available rover2)
