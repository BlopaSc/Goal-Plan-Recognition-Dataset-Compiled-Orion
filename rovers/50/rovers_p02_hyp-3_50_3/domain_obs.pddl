...
(define
	...
	(:action observe1_navigate_rover1_waypoint3_waypoint1
		:parameters ()
		:precondition (and
			(available rover1)
			(at rover1 waypoint3)
	...
	(:action observe5_calibrate_rover1_camera0_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs4)
	...
	(:action observe6_communicate_image_data_rover0_general_objective0_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
