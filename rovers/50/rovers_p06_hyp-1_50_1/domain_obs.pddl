...
(define
	...
	(:action observe7_navigate_rover2_waypoint5_waypoint6
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint5)
	...
	(:action observe13_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe14_navigate_rover0_waypoint4_waypoint8
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(available rover0)
	...
	(:action observe15_navigate_rover1_waypoint6_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(available rover1)
	...
	(:action observe16_calibrate_rover1_camera2_objective4_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observed obs15)
	...
	(:action observe17_communicate_image_data_rover1_general_objective2_high_res_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
