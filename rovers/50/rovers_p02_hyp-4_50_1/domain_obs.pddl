...
(define
	...
	(:action observe0_communicate_rock_data_rover0_general_waypoint0_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe1_take_image_rover0_waypoint0_objective1_camera2_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera2 rover0)
	...
	(:action observe2_calibrate_rover1_camera0_objective1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(observed obs1)
	...
	(:action observe3_communicate_image_data_rover0_general_objective1_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe4_take_image_rover1_waypoint2_objective2_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(calibrated camera0 rover1)
	...
	(:action observe5_communicate_image_data_rover1_general_objective2_high_res_waypoint2_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover1)
