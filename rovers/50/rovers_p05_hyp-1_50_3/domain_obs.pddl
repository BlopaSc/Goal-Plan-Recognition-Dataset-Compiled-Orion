...
(define
	...
	(:action observe4_sample_rock_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint7)
			(empty rover2store)
	...
	(:action observe14_navigate_rover0_waypoint2_waypoint7
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe15_communicate_soil_data_rover0_general_waypoint2_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint7)
	...
	(:action observe16_navigate_rover0_waypoint7_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint7)
			(available rover0)
	...
	(:action observe17_navigate_rover3_waypoint4_waypoint0
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint4)
	...
	(:action observe19_sample_rock_rover3_rover3store_waypoint8
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint8)
			(empty rover3store)
	...
	(:action observe20_drop_rover2_rover2store
		:parameters ()
		:precondition (and
			(full rover2store)
			(observed obs19)
	...
	(:action observe21_sample_rock_rover2_rover2store_waypoint2
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint2)
			(empty rover2store)
	...
	(:action observe22_communicate_rock_data_rover2_general_waypoint2_waypoint8_waypoint2
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
