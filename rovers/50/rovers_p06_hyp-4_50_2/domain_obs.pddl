...
(define
	...
	(:action observe10_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe11_sample_rock_rover3_rover3store_waypoint1
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint1)
			(empty rover3store)
	...
	(:action observe13_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe16_calibrate_rover0_camera1_objective4_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(observed obs15)
	...
	(:action observe17_take_image_rover0_waypoint0_objective2_camera1_low_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
	...
	(:action observe19_communicate_soil_data_rover0_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
