...
(define
	...
	(:action observe3_communicate_image_data_rover0_general_objective0_high_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint0)
	...
	(:action observe4_take_image_rover1_waypoint1_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(calibrated camera0 rover1)
