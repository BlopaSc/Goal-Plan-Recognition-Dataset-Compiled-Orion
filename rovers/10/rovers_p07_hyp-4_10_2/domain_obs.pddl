...
(define
	...
	(:action observe0_take_image_rover1_waypoint6_objective1_camera2_low_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(calibrated camera2 rover1)
	...
	(:action observe1_communicate_soil_data_rover2_general_waypoint7_waypoint7_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover2)
	...
	(:action observe2_navigate_rover3_waypoint10_waypoint1
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint10)
	...
	(:action observe3_communicate_soil_data_rover0_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
	...
	(:action observe4_communicate_soil_data_rover0_general_waypoint5_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover0 waypoint4)
