...
(define
	...
	(:action observe1_drop_rover3_rover3store
		:parameters ()
		:precondition (and
			(full rover3store)
			(observed obs0)
	...
	(:action observe2_navigate_rover3_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint2)
	...
	(:action observe3_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
