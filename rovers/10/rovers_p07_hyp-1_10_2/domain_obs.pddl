...
(define
	...
	(:action observe2_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe3_sample_soil_rover0_rover0store_waypoint8
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint8)
			(empty rover0store)
	...
	(:action observe4_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
