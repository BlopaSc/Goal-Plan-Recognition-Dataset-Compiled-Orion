...
(define
	...
	(:action observe0_sample_soil_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint7)
			(empty rover2store)
	...
	(:action observe1_navigate_rover3_waypoint8_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint8)
	...
	(:action observe2_navigate_rover3_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(available rover3)
	...
	(:action observe3_take_image_rover0_waypoint0_objective2_camera1_high_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
