...
(define
	...
	(:action observe1_take_image_rover1_waypoint6_objective0_camera2_low_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(calibrated camera2 rover1)
	...
	(:action observe3_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
