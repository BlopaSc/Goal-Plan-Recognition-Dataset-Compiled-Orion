...
(define
	...
	(:action observe0_navigate_rover2_waypoint1_waypoint7
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint1)
	...
	(:action observe1_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe3_navigate_rover0_waypoint2_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint2)
	...
	(:action observe4_navigate_rover0_waypoint10_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint10)
