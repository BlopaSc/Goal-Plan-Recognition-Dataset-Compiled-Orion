...
(define
	...
	(:action observe0_take_image_rover1_waypoint6_objective0_camera2_low_res
		:parameters ()
		:precondition (and
			(at rover1 waypoint6)
			(calibrated camera2 rover1)
	...
	(:action observe1_communicate_image_data_rover1_general_objective0_low_res_waypoint6_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover1 waypoint6)
