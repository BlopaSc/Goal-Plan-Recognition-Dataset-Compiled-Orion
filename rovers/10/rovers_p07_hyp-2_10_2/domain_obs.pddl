...
(define
	...
	(:action observe1_sample_soil_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint7)
			(empty rover2store)
	...
	(:action observe3_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint5)
			(empty rover0store)
	...
	(:action observe4_sample_soil_rover0_rover0store_waypoint10
		:parameters ()
		:precondition (and
			(at_soil_sample waypoint10)
			(empty rover0store)
