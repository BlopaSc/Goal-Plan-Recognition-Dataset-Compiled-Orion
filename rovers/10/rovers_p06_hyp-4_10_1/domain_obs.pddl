...
(define
	...
	(:action observe2_communicate_rock_data_rover3_general_waypoint1_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe3_take_image_rover0_waypoint0_objective2_camera1_low_res
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(calibrated camera1 rover0)
