...
(define
	...
	(:action observe1_navigate_rover3_waypoint1_waypoint10
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint1)
	...
	(:action observe2_sample_rock_rover3_rover3store_waypoint10
		:parameters ()
		:precondition (and
			(at_rock_sample waypoint10)
			(empty rover3store)
	...
	(:action observe3_navigate_rover3_waypoint10_waypoint1
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint10)
	...
	(:action observe4_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
