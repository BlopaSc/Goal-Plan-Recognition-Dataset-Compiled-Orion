...
(define
	...
	(:action observe2_communicate_rock_data_rover3_general_waypoint2_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(at rover3 waypoint4)
	...
	(:action observe4_communicate_soil_data_rover0_general_waypoint8_waypoint8_waypoint9
		:parameters ()
		:precondition (and
			(channel_free general)
			(available rover0)
