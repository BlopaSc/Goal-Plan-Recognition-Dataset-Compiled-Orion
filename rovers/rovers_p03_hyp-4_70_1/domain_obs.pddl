(define
	...
	(:action observe0_communicate_soil_data_rover1_general_waypoint1_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover1 waypoint1)
	...
	(:action observe3_take_image_rover0_waypoint0_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
	...
	(:action observe4_calibrate_rover1_camera0_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observation3)
	...
	(:action observe6_take_image_rover1_waypoint1_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(calibrated camera0 rover1)
			(at rover1 waypoint1)
	...
	(:action observe7_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_image rover1 objective1 high_res)
