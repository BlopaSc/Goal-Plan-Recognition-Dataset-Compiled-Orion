(define
	...
	(:action observe4_take_image_rover0_waypoint0_objective2_camera2_low_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
	...
	(:action observe5_communicate_image_data_rover0_general_objective2_low_res_waypoint0_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(have_image rover0 objective2 low_res)
