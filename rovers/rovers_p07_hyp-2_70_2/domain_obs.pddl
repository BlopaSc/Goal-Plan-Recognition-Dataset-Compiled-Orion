(define
	...
	(:action observe21_sample_soil_rover0_rover0store_waypoint0
		:parameters ()
		:precondition (and
			(at rover0 waypoint0)
			(at_soil_sample waypoint0)
	...
	(:action observe22_navigate_rover0_waypoint0_waypoint7
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint0)
	...
	(:action observe25_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint5)
			(at_soil_sample waypoint5)
