(define
	...
	(:action observe1_take_image_rover0_waypoint0_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover0)
			(at rover0 waypoint0)
	...
	(:action observe2_calibrate_rover1_camera0_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observation1)
	...
	(:action observe3_communicate_image_data_rover1_general_objective2_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_image rover1 objective2 high_res)
