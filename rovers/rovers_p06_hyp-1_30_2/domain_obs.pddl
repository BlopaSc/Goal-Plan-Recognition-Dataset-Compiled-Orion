(define
	...
	(:action observe1_communicate_image_data_rover0_general_objective3_colour_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(have_image rover0 objective3 colour)
	...
	(:action observe2_navigate_rover2_waypoint6_waypoint5
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint6)
	...
	(:action observe3_navigate_rover2_waypoint5_waypoint6
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint5)
	...
	(:action observe6_navigate_rover3_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint4)
	...
	(:action observe8_sample_rock_rover3_rover3store_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint9)
			(at_rock_sample waypoint9)
	...
	(:action observe10_calibrate_rover1_camera2_objective4_waypoint1
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(observation9)
