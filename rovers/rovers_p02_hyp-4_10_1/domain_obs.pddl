(define
	...
	(:action observe0_calibrate_rover1_camera0_objective1_waypoint2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover1 waypoint2)
	...
	(:action observe1_communicate_image_data_rover1_general_objective2_high_res_waypoint2_waypoint3
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(have_image rover1 objective2 high_res)
