(define
	...
	(:action observe3_calibrate_rover0_camera2_objective1_waypoint1
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(observation2)
	...
	(:action observe5_communicate_image_data_rover0_general_objective1_high_res_waypoint1_waypoint3
		:parameters ()
		:precondition (and
			(at rover0 waypoint1)
			(have_image rover0 objective1 high_res)
	...
	(:action observe6_communicate_image_data_rover1_general_objective2_high_res_waypoint2_waypoint3
		:parameters ()
		:precondition (and
			(at rover1 waypoint2)
			(have_image rover1 objective2 high_res)
