(define
	...
	(:action observe0_take_image_rover0_waypoint4_objective3_camera1_low_res
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated camera1 rover0)
	...
	(:action observe1_communicate_image_data_rover0_general_objective3_low_res_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover0 waypoint4)
			(have_image rover0 objective3 low_res)
	...
	(:action observe2_sample_soil_rover2_rover2store_waypoint7
		:parameters ()
		:precondition (and
			(at rover2 waypoint7)
			(at_soil_sample waypoint7)
	...
	(:action observe8_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_rock_analysis rover3 waypoint9)
	...
	(:action observe11_navigate_rover0_waypoint10_waypoint4
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint10)
