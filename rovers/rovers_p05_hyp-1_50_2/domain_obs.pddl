(define
	...
	(:action observe9_take_image_rover3_waypoint0_objective0_camera2_high_res
		:parameters ()
		:precondition (and
			(calibrated camera2 rover3)
			(at rover3 waypoint0)
	...
	(:action observe10_communicate_image_data_rover3_general_objective0_high_res_waypoint0_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint0)
			(have_image rover3 objective0 high_res)
	...
	(:action observe15_sample_soil_rover0_rover0store_waypoint5
		:parameters ()
		:precondition (and
			(at rover0 waypoint5)
			(at_soil_sample waypoint5)
