(define
	...
	(:action observe0_navigate_rover2_waypoint6_waypoint7
		:parameters ()
		:precondition (and
			(not (observation0))
			(available rover2)
	...
	(:action observe1_navigate_rover0_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint7)
	...
	(:action observe2_communicate_soil_data_rover3_general_waypoint4_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_soil_analysis rover3 waypoint4)
	...
	(:action observe4_navigate_rover3_waypoint4_waypoint0
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint4)
