(define
	...
	(:action observe5_take_image_rover1_waypoint1_objective1_camera0_high_res
		:parameters ()
		:precondition (and
			(calibrated camera0 rover1)
			(at rover1 waypoint1)
	...
	(:action observe6_communicate_image_data_rover1_general_objective1_high_res_waypoint1_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint1)
			(have_image rover1 objective1 high_res)
