(define
	...
	(:action observe0_take_image_rover2_waypoint7_objective3_camera0_high_res
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated camera0 rover2)
	...
	(:action observe1_sample_soil_rover3_rover3store_waypoint4
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(at_soil_sample waypoint4)
	...
	(:action observe2_navigate_rover0_waypoint1_waypoint5
		:parameters ()
		:precondition (and
			(available rover0)
			(at rover0 waypoint1)
	...
	(:action observe3_communicate_soil_data_rover0_general_waypoint5_waypoint5_waypoint2
		:parameters ()
		:precondition (and
			(at rover0 waypoint5)
			(have_soil_analysis rover0 waypoint5)
