(define
	...
	(:action observe0_communicate_image_data_rover2_general_objective1_high_res_waypoint6_waypoint2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover2 waypoint6)
	...
	(:action observe1_communicate_soil_data_rover1_general_waypoint4_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(have_soil_analysis rover1 waypoint4)
	...
	(:action observe2_navigate_rover2_waypoint0_waypoint4
		:parameters ()
		:precondition (and
			(available rover2)
			(at rover2 waypoint0)
	...
	(:action observe3_drop_rover2_rover2store
		:parameters ()
		:precondition (and
			(full rover2store)
			(observation2)
	...
	(:action observe4_communicate_soil_data_rover1_general_waypoint2_waypoint4_waypoint2
		:parameters ()
		:precondition (and
			(at rover1 waypoint4)
			(have_soil_analysis rover1 waypoint2)
