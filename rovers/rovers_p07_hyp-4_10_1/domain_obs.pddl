(define
	...
	(:action observe0_navigate_rover3_waypoint1_waypoint4
		:parameters ()
		:precondition (and
			(not (observation0))
			(available rover3)
	...
	(:action observe1_navigate_rover3_waypoint9_waypoint4
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint9)
	...
	(:action observe2_communicate_rock_data_rover3_general_waypoint9_waypoint4_waypoint9
		:parameters ()
		:precondition (and
			(at rover3 waypoint4)
			(have_rock_analysis rover3 waypoint9)
	...
	(:action observe4_drop_rover0_rover0store
		:parameters ()
		:precondition (and
			(full rover0store)
			(observation3)
