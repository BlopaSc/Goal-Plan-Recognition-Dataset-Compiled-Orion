(define
	...
	(:action observe0_communicate_image_data_rover1_general_objective0_low_res_waypoint0_waypoint2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at rover1 waypoint0)
	...
	(:action observe2_navigate_rover3_waypoint3_waypoint7
		:parameters ()
		:precondition (and
			(available rover3)
			(at rover3 waypoint3)
	...
	(:action observe4_communicate_rock_data_rover3_general_waypoint7_waypoint7_waypoint2
		:parameters ()
		:precondition (and
			(at rover3 waypoint7)
			(have_rock_analysis rover3 waypoint7)
