(define
	...
	(:action observe0_move_bank_angazi_cafe
		:parameters ()
		:precondition (and
			(not (observation0))
			(at bank)
	...
	(:action observe1_move_watson_theater_hayman_theater
		:parameters ()
		:precondition (and
			(at watson_theater)
			(observation0)
	...
	(:action observe2_move_hayman_theater_cbs
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observation1)
	...
	(:action observe3_move_cbs_angazi_cafe
		:parameters ()
		:precondition (and
			(at cbs)
			(observation2)
