(define
	...
	(:action observe0_move_bank_watson_theater
		:parameters ()
		:precondition (and
			(not (observation0))
			(at bank)
	...
	(:action observe2_move_bookmark_cafe_hayman_theater
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observation1)
	...
	(:action observe3_move_hayman_theater_library
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observation2)
	...
	(:action observe4_move_library_angazi_cafe
		:parameters ()
		:precondition (and
			(at library)
			(observation3)
