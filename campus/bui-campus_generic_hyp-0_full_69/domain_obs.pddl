(define
	...
	(:action observe0_move_tav_angazi_cafe
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tav)
	...
	(:action observe1_move_angazi_cafe_watson_theater
		:parameters ()
		:precondition (and
			(at angazi_cafe)
			(observation0)
	...
	(:action observe2_move_watson_theater_hayman_theater
		:parameters ()
		:precondition (and
			(at watson_theater)
			(observation1)
	...
	(:action observe3_move_hayman_theater_bookmark_cafe
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observation2)
	...
	(:action observe4_move_bookmark_cafe_angazi_cafe
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observation3)
