...
(define
	...
	(:action observe0_move_hayman_theater_watson_theater
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(not (observed obs0))
	...
	(:action observe1_move_watson_theater_bookmark_cafe
		:parameters ()
		:precondition (and
			(at watson_theater)
			(observed obs0)
	...
	(:action observe2_move_bookmark_cafe_cbs
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observed obs1)
	...
	(:action observe3_move_cbs_hayman_theater
		:parameters ()
		:precondition (and
			(at cbs)
			(observed obs2)
	...
	(:action observe4_move_hayman_theater_bookmark_cafe
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observed obs3)
