...
(define
	...
	(:action observe0_move_bookmark_cafe_bookmark_cafe
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(not (observed obs0))
	...
	(:action observe1_move_bookmark_cafe_watson_theater
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observed obs0)
	...
	(:action observe3_move_hayman_theater_cbs
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observed obs2)
