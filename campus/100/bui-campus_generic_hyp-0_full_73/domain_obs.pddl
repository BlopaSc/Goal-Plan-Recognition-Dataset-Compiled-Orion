...
(define
	...
	(:action observe0_move_davis_theater_psychology_bldg
		:parameters ()
		:precondition (and
			(at davis_theater)
			(not (observed obs0))
	...
	(:action observe1_move_psychology_bldg_bank
		:parameters ()
		:precondition (and
			(at psychology_bldg)
			(observed obs0)
	...
	(:action observe4_move_jones_theater_psychology_bldg
		:parameters ()
		:precondition (and
			(at jones_theater)
			(observed obs3)
	...
	(:action observe5_move_psychology_bldg_bookmark_cafe
		:parameters ()
		:precondition (and
			(at psychology_bldg)
			(observed obs4)
