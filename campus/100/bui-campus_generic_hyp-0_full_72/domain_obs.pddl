...
(define
	...
	(:action observe0_move_psychology_bldg_bank
		:parameters ()
		:precondition (and
			(at psychology_bldg)
			(not (observed obs0))
	...
	(:action observe1_move_bank_library
		:parameters ()
		:precondition (and
			(at bank)
			(observed obs0)
	...
	(:action observe2_move_library_davis_theater
		:parameters ()
		:precondition (and
			(at library)
			(observed obs1)
	...
	(:action observe3_move_davis_theater_jones_theater
		:parameters ()
		:precondition (and
			(at davis_theater)
			(observed obs2)
	...
	(:action observe4_move_jones_theater_bookmark_cafe
		:parameters ()
		:precondition (and
			(at jones_theater)
			(observed obs3)
	...
	(:action observe5_move_bookmark_cafe_angazi_cafe
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observed obs4)
