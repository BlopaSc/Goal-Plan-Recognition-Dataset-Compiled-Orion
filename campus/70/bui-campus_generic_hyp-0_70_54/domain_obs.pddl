...
(define
	...
	(:action observe1_move_cbs_davis_theater
		:parameters ()
		:precondition (and
			(at cbs)
			(observed obs0)
	...
	(:action observe2_move_davis_theater_jones_theater
		:parameters ()
		:precondition (and
			(at davis_theater)
			(observed obs1)
	...
	(:action observe3_move_jones_theater_psychology_bldg
		:parameters ()
		:precondition (and
			(at jones_theater)
			(observed obs2)
	...
	(:action observe4_move_psychology_bldg_tav
		:parameters ()
		:precondition (and
			(at psychology_bldg)
			(observed obs3)
