(define
	...
	(:action observe1_move_watson_theater_tav
		:parameters ()
		:precondition (and
			(at watson_theater)
			(observation0)
	...
	(:action observe2_move_tav_bookmark_cafe
		:parameters ()
		:precondition (and
			(at tav)
			(observation1)
	...
	(:action observe3_move_bookmark_cafe_hayman_theater
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observation2)
	...
	(:action observe4_move_hayman_theater_angazi_cafe
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observation3)
