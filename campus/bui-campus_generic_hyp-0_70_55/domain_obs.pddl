(define
	...
	(:action observe0_move_watson_theater_tav
		:parameters ()
		:precondition (and
			(not (observation0))
			(at watson_theater)
	...
	(:action observe1_move_tav_hayman_theater
		:parameters ()
		:precondition (and
			(at tav)
			(observation0)
	...
	(:action observe2_move_hayman_theater_bookmark_cafe
		:parameters ()
		:precondition (and
			(at hayman_theater)
			(observation1)
	...
	(:action observe3_move_bookmark_cafe_tav
		:parameters ()
		:precondition (and
			(at bookmark_cafe)
			(observation2)
