(define
	...
	(:action observe0_push_f4-1f_f4-2f_f4-3f_right_box1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot f4-1f)
	...
	(:action observe1_push_f4-4f_f4-5f_f4-6f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f4-4f)
			(at box1 f4-5f)
	...
	(:action observe2_push_f3-6f_f4-6f_f5-6f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f3-6f)
			(at box1 f4-6f)
	...
	(:action observe3_move_f5-6f_f5-5f_left
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f5-6f)
	...
	(:action observe4_push_f5-5f_f5-4f_f5-3f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f5-5f)
			(at box0 f5-4f)
	...
	(:action observe7_push_f0-3f_f0-2f_f0-1f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f0-3f)
			(at box0 f0-2f)
