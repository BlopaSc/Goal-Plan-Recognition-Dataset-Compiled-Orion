...
(define
	...
	(:action observe1_move_f7-5f_f6-5f_up
		:parameters ()
		:precondition (and
			(clear f6-5f)
			(at-robot f7-5f)
	...
	(:action observe2_move_f8-3f_f9-3f_down
		:parameters ()
		:precondition (and
			(clear f9-3f)
			(at-robot f8-3f)
	...
	(:action observe3_move_f9-3f_f9-4f_right
		:parameters ()
		:precondition (and
			(clear f9-4f)
			(at-robot f9-3f)
	...
	(:action observe4_push_f7-6f_f6-6f_f5-6f_up_box0
		:parameters ()
		:precondition (and
			(clear f5-6f)
			(at-robot f7-6f)
