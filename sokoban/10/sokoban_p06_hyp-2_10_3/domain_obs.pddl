...
(define
	...
	(:action observe0_push_f4-3f_f3-3f_f2-3f_up_box1
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f4-3f)
	...
	(:action observe1_push_f0-2f_f0-3f_f0-4f_right_box1
		:parameters ()
		:precondition (and
			(clear f0-4f)
			(at-robot f0-2f)
	...
	(:action observe2_move_f5-4f_f6-4f_down
		:parameters ()
		:precondition (and
			(clear f6-4f)
			(at-robot f5-4f)
	...
	(:action observe3_push_f1-2f_f1-3f_f1-4f_right_box0
		:parameters ()
		:precondition (and
			(clear f1-4f)
			(at-robot f1-2f)
