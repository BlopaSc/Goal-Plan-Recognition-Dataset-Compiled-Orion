...
(define
	...
	(:action observe0_move_f7-5f_f6-5f_up
		:parameters ()
		:precondition (and
			(clear f6-5f)
			(at-robot f7-5f)
	...
	(:action observe1_move_f5-6f_f4-6f_up
		:parameters ()
		:precondition (and
			(clear f4-6f)
			(at-robot f5-6f)
	...
	(:action observe2_push_f3-4f_f3-3f_f3-2f_left_box1
		:parameters ()
		:precondition (and
			(clear f3-2f)
			(at-robot f3-4f)
	...
	(:action observe3_push_f2-1f_f3-1f_f4-1f_down_box1
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f2-1f)
	...
	(:action observe4_move_f7-3f_f8-3f_down
		:parameters ()
		:precondition (and
			(clear f8-3f)
			(at-robot f7-3f)
	...
	(:action observe5_move_f7-6f_f6-6f_up
		:parameters ()
		:precondition (and
			(clear f6-6f)
			(at-robot f7-6f)
