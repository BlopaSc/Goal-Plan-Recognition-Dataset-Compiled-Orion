(define
	...
	(:action observe3_move_f1-2f_f1-3f_right
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f1-2f)
	...
	(:action observe4_move_f1-3f_f1-4f_right
		:parameters ()
		:precondition (and
			(clear f1-4f)
			(at-robot f1-3f)
	...
	(:action observe5_push_f1-4f_f1-5f_f1-6f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box0 f1-5f)
	...
	(:action observe6_move_f1-5f_f0-5f_up
		:parameters ()
		:precondition (and
			(clear f0-5f)
			(at-robot f1-5f)
	...
	(:action observe7_move_f0-5f_f0-6f_right
		:parameters ()
		:precondition (and
			(clear f0-6f)
			(at-robot f0-5f)
	...
	(:action observe8_push_f1-6f_f2-6f_f3-6f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f1-6f)
			(at box0 f2-6f)
	...
	(:action observe9_move_f4-5f_f4-4f_left
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f4-5f)
	...
	(:action observe12_move_f2-3f_f2-4f_right
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f2-3f)
	...
	(:action observe13_push_f1-3f_f1-2f_f1-1f_left_box1
		:parameters ()
		:precondition (and
			(at-robot f1-3f)
			(at box1 f1-2f)
