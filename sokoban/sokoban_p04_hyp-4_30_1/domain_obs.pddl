(define
	...
	(:action observe1_push_f7-3f_f6-3f_f5-3f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f7-3f)
			(at box0 f6-3f)
	...
	(:action observe3_push_f4-4f_f5-4f_f6-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f4-4f)
			(at box1 f5-4f)
	...
	(:action observe4_move_f5-3f_f6-3f_down
		:parameters ()
		:precondition (and
			(clear f6-3f)
			(at-robot f5-3f)
	...
	(:action observe5_push_f6-4f_f6-5f_f6-6f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f6-4f)
			(at box1 f6-5f)
