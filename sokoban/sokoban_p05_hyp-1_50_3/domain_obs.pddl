(define
	...
	(:action observe3_move_f2-3f_f3-3f_down
		:parameters ()
		:precondition (and
			(clear f3-3f)
			(at-robot f2-3f)
	...
	(:action observe4_push_f3-3f_f4-3f_f5-3f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f3-3f)
			(at box1 f4-3f)
	...
	(:action observe7_move_f6-4f_f7-4f_down
		:parameters ()
		:precondition (and
			(clear f7-4f)
			(at-robot f6-4f)
	...
	(:action observe10_move_f7-2f_f7-3f_right
		:parameters ()
		:precondition (and
			(clear f7-3f)
			(at-robot f7-2f)
	...
	(:action observe15_move_f3-3f_f3-4f_right
		:parameters ()
		:precondition (and
			(clear f3-4f)
			(at-robot f3-3f)
