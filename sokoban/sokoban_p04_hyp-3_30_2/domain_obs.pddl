(define
	...
	(:action observe0_move_f8-2f_f8-3f_right
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f8-3f)
	...
	(:action observe1_push_f5-3f_f4-3f_f3-3f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box0 f4-3f)
	...
	(:action observe2_push_f4-3f_f3-3f_f2-3f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f4-3f)
			(at box0 f3-3f)
	...
	(:action observe3_move_f2-3f_f2-4f_right
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f2-3f)
	...
	(:action observe4_push_f7-4f_f7-5f_f7-6f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f7-4f)
			(at box1 f7-5f)
	...
	(:action observe5_push_f7-5f_f7-6f_f7-7f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f7-5f)
			(at box1 f7-6f)
