(define
	...
	(:action observe1_push_f5-1f_f5-2f_f5-3f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f5-1f)
			(at box1 f5-2f)
	...
	(:action observe2_push_f5-3f_f5-4f_f5-5f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box1 f5-4f)
	...
	(:action observe4_move_f0-3f_f0-4f_right
		:parameters ()
		:precondition (and
			(clear f0-4f)
			(at-robot f0-3f)
	...
	(:action observe7_move_f5-6f_f5-5f_left
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f5-6f)
