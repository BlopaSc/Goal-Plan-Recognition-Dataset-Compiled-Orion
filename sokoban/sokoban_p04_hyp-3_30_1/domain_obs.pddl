(define
	...
	(:action observe0_push_f5-3f_f4-3f_f3-3f_up_box0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot f5-3f)
	...
	(:action observe1_push_f2-4f_f3-4f_f4-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f2-4f)
			(at box1 f3-4f)
	...
	(:action observe2_push_f4-4f_f5-4f_f6-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f4-4f)
			(at box1 f5-4f)
	...
	(:action observe4_push_f7-5f_f7-6f_f7-7f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f7-5f)
			(at box1 f7-6f)
	...
	(:action observe5_push_f7-6f_f7-7f_f7-8f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f7-6f)
			(at box1 f7-7f)
