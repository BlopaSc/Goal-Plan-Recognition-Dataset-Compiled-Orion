(define
	...
	(:action observe3_move_f0-1f_f0-0f_left
		:parameters ()
		:precondition (and
			(clear f0-0f)
			(at-robot f0-1f)
	...
	(:action observe4_push_f2-0f_f3-0f_f4-0f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f2-0f)
			(at box0 f3-0f)
	...
	(:action observe5_move_f5-0f_f4-0f_up
		:parameters ()
		:precondition (and
			(clear f4-0f)
			(at-robot f5-0f)
	...
	(:action observe6_move_f3-0f_f2-0f_up
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f3-0f)
	...
	(:action observe7_move_f1-1f_f1-2f_right
		:parameters ()
		:precondition (and
			(clear f1-2f)
			(at-robot f1-1f)
	...
	(:action observe8_move_f2-4f_f3-4f_down
		:parameters ()
		:precondition (and
			(clear f3-4f)
			(at-robot f2-4f)
	...
	(:action observe9_move_f3-4f_f4-4f_down
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f3-4f)
	...
	(:action observe10_move_f5-4f_f5-3f_left
		:parameters ()
		:precondition (and
			(clear f5-3f)
			(at-robot f5-4f)
	...
	(:action observe11_push_f5-3f_f4-3f_f3-3f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box1 f4-3f)
	...
	(:action observe12_push_f2-3f_f1-3f_f0-3f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f2-3f)
			(at box1 f1-3f)
