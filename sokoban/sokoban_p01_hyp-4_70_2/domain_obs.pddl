(define
	...
	(:action observe8_move_f3-4f_f3-5f_right
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f3-4f)
	...
	(:action observe9_move_f2-5f_f1-5f_up
		:parameters ()
		:precondition (and
			(clear f1-5f)
			(at-robot f2-5f)
	...
	(:action observe10_push_f1-4f_f1-3f_f1-2f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box0 f1-3f)
	...
	(:action observe13_move_f3-2f_f2-2f_up
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f3-2f)
	...
	(:action observe14_move_f2-2f_f2-3f_right
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-2f)
	...
	(:action observe15_push_f2-3f_f2-4f_f2-5f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f2-3f)
			(at box1 f2-4f)
	...
	(:action observe16_move_f2-4f_f3-4f_down
		:parameters ()
		:precondition (and
			(clear f3-4f)
			(at-robot f2-4f)
	...
	(:action observe17_move_f3-4f_f3-5f_right
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f3-4f)
