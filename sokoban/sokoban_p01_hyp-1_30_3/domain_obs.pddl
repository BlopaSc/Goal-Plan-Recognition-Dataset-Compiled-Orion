(define
	...
	(:action observe3_move_f5-4f_f5-5f_right
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f5-4f)
	...
	(:action observe4_move_f2-6f_f1-6f_up
		:parameters ()
		:precondition (and
			(clear f1-6f)
			(at-robot f2-6f)
	...
	(:action observe5_push_f0-2f_f1-2f_f2-2f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f0-2f)
			(at box0 f1-2f)
	...
	(:action observe6_move_f5-2f_f5-1f_left
		:parameters ()
		:precondition (and
			(clear f5-1f)
			(at-robot f5-2f)
	...
	(:action observe7_push_f6-1f_f6-2f_f6-3f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f6-1f)
			(at box0 f6-2f)
