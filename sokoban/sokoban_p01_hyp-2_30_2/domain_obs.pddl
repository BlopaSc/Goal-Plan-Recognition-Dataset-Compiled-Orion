(define
	...
	(:action observe0_move_f6-1f_f7-1f_down
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f7-1f)
	...
	(:action observe1_push_f5-2f_f5-3f_f5-4f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f5-2f)
			(at box1 f5-3f)
	...
	(:action observe6_move_f5-5f_f6-5f_down
		:parameters ()
		:precondition (and
			(clear f6-5f)
			(at-robot f5-5f)
	...
	(:action observe7_push_f6-5f_f6-4f_f6-3f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f6-5f)
			(at box0 f6-4f)
