(define
	...
	(:action observe6_move_f1-0f_f2-0f_down
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f1-0f)
	...
	(:action observe7_move_f2-0f_f3-0f_down
		:parameters ()
		:precondition (and
			(clear f3-0f)
			(at-robot f2-0f)
	...
	(:action observe8_push_f3-0f_f3-1f_f3-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f3-0f)
			(at box0 f3-1f)
	...
	(:action observe10_move_f4-1f_f4-2f_right
		:parameters ()
		:precondition (and
			(clear f4-2f)
			(at-robot f4-1f)
