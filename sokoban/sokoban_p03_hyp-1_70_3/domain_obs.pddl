(define
	...
	(:action observe0_move_f4-1f_f5-1f_down
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f5-1f)
	...
	(:action observe1_move_f5-1f_f6-1f_down
		:parameters ()
		:precondition (and
			(clear f6-1f)
			(at-robot f5-1f)
	...
	(:action observe2_push_f6-2f_f5-2f_f4-2f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f6-2f)
			(at box1 f5-2f)
	...
	(:action observe3_move_f4-2f_f4-1f_left
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f4-2f)
	...
	(:action observe4_move_f4-1f_f3-1f_up
		:parameters ()
		:precondition (and
			(clear f3-1f)
			(at-robot f4-1f)
	...
	(:action observe5_push_f3-1f_f3-2f_f3-3f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-1f)
			(at box1 f3-2f)
	...
	(:action observe6_move_f3-2f_f2-2f_up
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f3-2f)
	...
	(:action observe7_move_f2-2f_f2-1f_left
		:parameters ()
		:precondition (and
			(clear f2-1f)
			(at-robot f2-2f)
	...
	(:action observe8_move_f2-1f_f2-0f_left
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f2-1f)
	...
	(:action observe9_move_f2-0f_f1-0f_up
		:parameters ()
		:precondition (and
			(clear f1-0f)
			(at-robot f2-0f)
	...
	(:action observe10_push_f1-0f_f1-1f_f1-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-0f)
			(at box0 f1-1f)
	...
	(:action observe11_push_f1-1f_f1-2f_f1-3f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-1f)
			(at box0 f1-2f)
	...
	(:action observe12_push_f1-2f_f1-3f_f1-4f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-2f)
			(at box0 f1-3f)
