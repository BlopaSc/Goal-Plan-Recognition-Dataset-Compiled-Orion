(define
	...
	(:action observe7_move_f3-0f_f2-0f_up
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f3-0f)
	...
	(:action observe8_push_f2-0f_f2-1f_f2-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f2-0f)
			(at box0 f2-1f)
	...
	(:action observe11_move_f2-3f_f1-3f_up
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f2-3f)
	...
	(:action observe13_move_f1-2f_f1-3f_right
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f1-2f)
	...
	(:action observe15_push_f1-4f_f2-4f_f3-4f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box0 f2-4f)
