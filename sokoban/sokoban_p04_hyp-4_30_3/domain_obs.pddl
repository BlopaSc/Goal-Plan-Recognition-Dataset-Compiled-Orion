(define
	...
	(:action observe0_push_f7-3f_f6-3f_f5-3f_up_box0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot f7-3f)
	...
	(:action observe1_push_f6-3f_f5-3f_f4-3f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f6-3f)
			(at box0 f5-3f)
	...
	(:action observe2_move_f2-3f_f2-4f_right
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f2-3f)
	...
	(:action observe3_push_f2-4f_f3-4f_f4-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f2-4f)
			(at box1 f3-4f)
	...
	(:action observe4_push_f3-4f_f4-4f_f5-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f3-4f)
			(at box1 f4-4f)
	...
	(:action observe5_push_f6-3f_f6-4f_f6-5f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f6-3f)
			(at box1 f6-4f)
