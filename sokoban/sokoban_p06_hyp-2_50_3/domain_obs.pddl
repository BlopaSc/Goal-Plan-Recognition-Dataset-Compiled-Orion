(define
	...
	(:action observe1_push_f3-0f_f3-1f_f3-2f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-0f)
			(at box1 f3-1f)
	...
	(:action observe4_push_f0-3f_f0-4f_f0-5f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f0-3f)
			(at box1 f0-4f)
	...
	(:action observe5_push_f0-4f_f0-5f_f0-6f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f0-4f)
			(at box1 f0-5f)
	...
	(:action observe6_move_f1-5f_f2-5f_down
		:parameters ()
		:precondition (and
			(clear f2-5f)
			(at-robot f1-5f)
	...
	(:action observe7_move_f2-5f_f3-5f_down
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f2-5f)
	...
	(:action observe8_move_f3-5f_f4-5f_down
		:parameters ()
		:precondition (and
			(clear f4-5f)
			(at-robot f3-5f)
	...
	(:action observe11_move_f2-2f_f1-2f_up
		:parameters ()
		:precondition (and
			(clear f1-2f)
			(at-robot f2-2f)
	...
	(:action observe12_push_f1-3f_f1-4f_f1-5f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-3f)
			(at box0 f1-4f)
	...
	(:action observe13_move_f1-4f_f0-4f_up
		:parameters ()
		:precondition (and
			(clear f0-4f)
			(at-robot f1-4f)
	...
	(:action observe14_move_f0-4f_f0-5f_right
		:parameters ()
		:precondition (and
			(clear f0-5f)
			(at-robot f0-4f)
