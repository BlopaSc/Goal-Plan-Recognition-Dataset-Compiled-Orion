(define
	...
	(:action observe1_push_f5-2f_f4-2f_f3-2f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-2f)
			(at box1 f4-2f)
	...
	(:action observe2_move_f4-2f_f4-1f_left
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f4-2f)
	...
	(:action observe4_move_f1-5f_f0-5f_up
		:parameters ()
		:precondition (and
			(clear f0-5f)
			(at-robot f1-5f)
	...
	(:action observe5_move_f0-5f_f0-6f_right
		:parameters ()
		:precondition (and
			(clear f0-6f)
			(at-robot f0-5f)
