(define
	...
	(:action observe0_push_f8-3f_f7-3f_f6-3f_up_box0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot f8-3f)
	...
	(:action observe1_move_f0-4f_f0-3f_left
		:parameters ()
		:precondition (and
			(clear f0-3f)
			(at-robot f0-4f)
	...
	(:action observe2_move_f1-3f_f2-3f_down
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f1-3f)
	...
	(:action observe3_push_f3-3f_f3-4f_f3-5f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-3f)
			(at box1 f3-4f)
	...
	(:action observe4_push_f3-7f_f3-8f_f3-9f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-7f)
			(at box1 f3-8f)
