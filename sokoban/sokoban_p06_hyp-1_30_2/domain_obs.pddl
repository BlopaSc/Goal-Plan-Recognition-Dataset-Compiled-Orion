(define
	...
	(:action observe4_move_f5-4f_f5-3f_left
		:parameters ()
		:precondition (and
			(clear f5-3f)
			(at-robot f5-4f)
	...
	(:action observe5_push_f4-3f_f4-4f_f4-5f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f4-3f)
			(at box0 f4-4f)
	...
	(:action observe6_move_f4-5f_f5-5f_down
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f4-5f)
	...
	(:action observe7_push_f4-6f_f3-6f_f2-6f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f4-6f)
			(at box0 f3-6f)
	...
	(:action observe8_move_f2-6f_f2-5f_left
		:parameters ()
		:precondition (and
			(clear f2-5f)
			(at-robot f2-6f)
	...
	(:action observe9_move_f6-2f_f6-1f_left
		:parameters ()
		:precondition (and
			(clear f6-1f)
			(at-robot f6-2f)
