(define
	...
	(:action observe0_move_f7-2f_f6-2f_up
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f6-2f)
	...
	(:action observe1_move_f2-8f_f2-7f_left
		:parameters ()
		:precondition (and
			(clear f2-7f)
			(at-robot f2-8f)
	...
	(:action observe2_move_f1-7f_f0-7f_up
		:parameters ()
		:precondition (and
			(clear f0-7f)
			(at-robot f1-7f)
	...
	(:action observe3_move_f0-7f_f0-6f_left
		:parameters ()
		:precondition (and
			(clear f0-6f)
			(at-robot f0-7f)
	...
	(:action observe4_move_f2-3f_f3-3f_down
		:parameters ()
		:precondition (and
			(clear f3-3f)
			(at-robot f2-3f)
