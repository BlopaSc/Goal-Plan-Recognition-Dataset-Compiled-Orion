(define
	...
	(:action observe3_move_f2-1f_f2-2f_right
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f2-1f)
	...
	(:action observe4_move_f2-2f_f2-3f_right
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-2f)
	...
	(:action observe7_move_f0-3f_f0-2f_left
		:parameters ()
		:precondition (and
			(clear f0-2f)
			(at-robot f0-3f)
	...
	(:action observe8_push_f0-2f_f1-2f_f2-2f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f0-2f)
			(at box1 f1-2f)
