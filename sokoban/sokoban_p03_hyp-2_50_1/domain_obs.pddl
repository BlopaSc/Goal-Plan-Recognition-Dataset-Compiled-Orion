(define
	...
	(:action observe0_move_f5-1f_f6-1f_down
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f6-1f)
	...
	(:action observe5_move_f2-0f_f1-0f_up
		:parameters ()
		:precondition (and
			(clear f1-0f)
			(at-robot f2-0f)
	...
	(:action observe6_push_f1-0f_f1-1f_f1-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-0f)
			(at box0 f1-1f)
	...
	(:action observe7_push_f1-1f_f1-2f_f1-3f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-1f)
			(at box0 f1-2f)
	...
	(:action observe8_push_f1-4f_f1-5f_f1-6f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box0 f1-5f)
	...
	(:action observe9_move_f0-5f_f0-6f_right
		:parameters ()
		:precondition (and
			(clear f0-6f)
			(at-robot f0-5f)
