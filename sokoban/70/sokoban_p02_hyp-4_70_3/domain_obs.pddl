...
(define
	...
	(:action observe1_move_f1-0f_f2-0f_down
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f1-0f)
	...
	(:action observe3_move_f4-0f_f4-1f_right
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f4-0f)
	...
	(:action observe4_push_f4-1f_f3-1f_f2-1f_up_box0
		:parameters ()
		:precondition (and
			(at box0 f3-1f)
			(clear f2-1f)
	...
	(:action observe7_push_f2-1f_f2-2f_f2-3f_right_box0
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-1f)
	...
	(:action observe8_push_f2-2f_f2-3f_f2-4f_right_box0
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f2-2f)
	...
	(:action observe10_push_f1-3f_f1-2f_f1-1f_left_box1
		:parameters ()
		:precondition (and
			(at box1 f1-2f)
			(clear f1-1f)
	...
	(:action observe11_move_f1-2f_f1-3f_right
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f1-2f)
