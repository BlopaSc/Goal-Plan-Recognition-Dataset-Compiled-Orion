...
(define
	...
	(:action observe7_push_f0-6f_f1-6f_f2-6f_down_box0
		:parameters ()
		:precondition (and
			(clear f2-6f)
			(at-robot f0-6f)
	...
	(:action observe9_push_f2-6f_f3-6f_f4-6f_down_box0
		:parameters ()
		:precondition (and
			(clear f4-6f)
			(at-robot f2-6f)
	...
	(:action observe10_push_f3-6f_f4-6f_f5-6f_down_box0
		:parameters ()
		:precondition (and
			(clear f5-6f)
			(at-robot f3-6f)
	...
	(:action observe11_move_f4-6f_f4-5f_left
		:parameters ()
		:precondition (and
			(clear f4-5f)
			(at-robot f4-6f)
	...
	(:action observe13_push_f3-3f_f2-3f_f1-3f_up_box1
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f3-3f)
