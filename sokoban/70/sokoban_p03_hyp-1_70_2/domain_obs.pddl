...
(define
	...
	(:action observe3_push_f5-2f_f4-2f_f3-2f_up_box1
		:parameters ()
		:precondition (and
			(clear f3-2f)
			(at-robot f5-2f)
	...
	(:action observe6_push_f3-1f_f3-2f_f3-3f_right_box1
		:parameters ()
		:precondition (and
			(clear f3-3f)
			(at box1 f3-2f)
	...
	(:action observe7_move_f3-2f_f2-2f_up
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f3-2f)
	...
	(:action observe8_move_f2-2f_f2-1f_left
		:parameters ()
		:precondition (and
			(clear f2-1f)
			(at-robot f2-2f)
