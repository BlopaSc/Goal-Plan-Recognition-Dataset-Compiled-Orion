(define
	...
	(:action observe3_push_f5-3f_f6-3f_f7-3f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box1 f6-3f)
	...
	(:action observe5_push_f7-2f_f7-1f_f7-0f_left_box1
		:parameters ()
		:precondition (and
			(at-robot f7-2f)
			(at box1 f7-1f)
	...
	(:action observe7_move_f5-3f_f5-4f_right
		:parameters ()
		:precondition (and
			(clear f5-4f)
			(at-robot f5-3f)
	...
	(:action observe8_move_f3-3f_f3-4f_right
		:parameters ()
		:precondition (and
			(clear f3-4f)
			(at-robot f3-3f)
	...
	(:action observe10_push_f4-4f_f4-3f_f4-2f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f4-4f)
			(at box0 f4-3f)
