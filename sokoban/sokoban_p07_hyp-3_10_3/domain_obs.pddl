(define
	...
	(:action observe1_push_f8-6f_f7-6f_f6-6f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f8-6f)
			(at box0 f7-6f)
	...
	(:action observe2_move_f6-3f_f6-2f_left
		:parameters ()
		:precondition (and
			(clear f6-2f)
			(at-robot f6-3f)
	...
	(:action observe3_move_f8-3f_f8-4f_right
		:parameters ()
		:precondition (and
			(clear f8-4f)
			(at-robot f8-3f)
	...
	(:action observe4_move_f8-5f_f8-6f_right
		:parameters ()
		:precondition (and
			(clear f8-6f)
			(at-robot f8-5f)
	...
	(:action observe5_push_f5-6f_f4-6f_f3-6f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f5-6f)
			(at box0 f4-6f)
