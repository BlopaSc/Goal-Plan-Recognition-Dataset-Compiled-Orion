(define
	...
	(:action observe2_move_f1-3f_f1-4f_right
		:parameters ()
		:precondition (and
			(clear f1-4f)
			(at-robot f1-3f)
	...
	(:action observe3_move_f2-4f_f2-5f_right
		:parameters ()
		:precondition (and
			(clear f2-5f)
			(at-robot f2-4f)
	...
	(:action observe5_push_f1-6f_f1-5f_f1-4f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f1-6f)
			(at box0 f1-5f)
	...
	(:action observe8_move_f1-1f_f0-1f_up
		:parameters ()
		:precondition (and
			(clear f0-1f)
			(at-robot f1-1f)
	...
	(:action observe9_push_f0-0f_f1-0f_f2-0f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f0-0f)
			(at box0 f1-0f)
	...
	(:action observe13_move_f3-0f_f2-0f_up
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f3-0f)
	...
	(:action observe14_move_f2-0f_f1-0f_up
		:parameters ()
		:precondition (and
			(clear f1-0f)
			(at-robot f2-0f)
	...
	(:action observe15_move_f1-4f_f2-4f_down
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f1-4f)
	...
	(:action observe18_push_f5-3f_f4-3f_f3-3f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box1 f4-3f)
	...
	(:action observe19_move_f1-3f_f1-2f_left
		:parameters ()
		:precondition (and
			(clear f1-2f)
			(at-robot f1-3f)
	...
	(:action observe20_move_f1-2f_f0-2f_up
		:parameters ()
		:precondition (and
			(clear f0-2f)
			(at-robot f1-2f)
