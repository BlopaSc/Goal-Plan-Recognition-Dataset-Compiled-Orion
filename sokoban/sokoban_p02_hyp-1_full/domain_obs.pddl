(define
	...
	(:action observe2_push_f1-1f_f1-2f_f1-3f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f1-1f)
			(at box1 f1-2f)
	...
	(:action observe4_move_f0-2f_f0-3f_right
		:parameters ()
		:precondition (and
			(clear f0-3f)
			(at-robot f0-2f)
	...
	(:action observe5_push_f0-3f_f1-3f_f2-3f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f0-3f)
			(at box1 f1-3f)
	...
	(:action observe7_move_f1-2f_f1-1f_left
		:parameters ()
		:precondition (and
			(clear f1-1f)
			(at-robot f1-2f)
	...
	(:action observe8_move_f1-1f_f1-0f_left
		:parameters ()
		:precondition (and
			(clear f1-0f)
			(at-robot f1-1f)
	...
	(:action observe9_move_f1-0f_f2-0f_down
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f1-0f)
	...
	(:action observe10_move_f2-0f_f3-0f_down
		:parameters ()
		:precondition (and
			(clear f3-0f)
			(at-robot f2-0f)
	...
	(:action observe11_push_f3-0f_f3-1f_f3-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f3-0f)
			(at box0 f3-1f)
	...
	(:action observe12_move_f3-1f_f4-1f_down
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f3-1f)
	...
	(:action observe13_move_f4-1f_f4-2f_right
		:parameters ()
		:precondition (and
			(clear f4-2f)
			(at-robot f4-1f)
	...
	(:action observe14_push_f4-2f_f3-2f_f2-2f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f4-2f)
			(at box0 f3-2f)
	...
	(:action observe15_push_f3-2f_f2-2f_f1-2f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f3-2f)
			(at box0 f2-2f)
