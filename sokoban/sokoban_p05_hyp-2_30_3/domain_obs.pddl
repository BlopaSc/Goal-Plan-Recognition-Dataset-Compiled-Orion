(define
	...
	(:action observe0_move_f1-2f_f1-3f_right
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f1-3f)
	...
	(:action observe1_move_f0-5f_f0-6f_right
		:parameters ()
		:precondition (and
			(clear f0-6f)
			(at-robot f0-5f)
	...
	(:action observe2_push_f1-6f_f2-6f_f3-6f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f1-6f)
			(at box0 f2-6f)
	...
	(:action observe3_push_f3-6f_f4-6f_f5-6f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f3-6f)
			(at box0 f4-6f)
	...
	(:action observe5_push_f1-4f_f1-3f_f1-2f_left_box1
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box1 f1-3f)
	...
	(:action observe6_push_f1-3f_f1-2f_f1-1f_left_box1
		:parameters ()
		:precondition (and
			(at-robot f1-3f)
			(at box1 f1-2f)
	...
	(:action observe8_move_f0-2f_f0-1f_left
		:parameters ()
		:precondition (and
			(clear f0-1f)
			(at-robot f0-2f)
