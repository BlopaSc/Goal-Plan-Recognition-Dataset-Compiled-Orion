...
(define
	...
	(:action observe4_push_f5-0f_f5-1f_f5-2f_right_box1
		:parameters ()
		:precondition (and
			(clear f5-2f)
			(at-robot f5-0f)
	...
	(:action observe5_push_f5-4f_f5-3f_f5-2f_left_box1
		:parameters ()
		:precondition (and
			(clear f5-2f)
			(at box1 f5-3f)
	...
	(:action observe6_push_f4-4f_f4-5f_f4-6f_right_box0
		:parameters ()
		:precondition (and
			(clear f4-6f)
			(at-robot f4-4f)
	...
	(:action observe11_push_f5-3f_f5-4f_f5-5f_right_box1
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f5-3f)
