...
(define
	...
	(:action observe2_move_f2-4f_f2-3f_left
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-4f)
	...
	(:action observe4_push_f0-4f_f1-4f_f2-4f_down_box0
		:parameters ()
		:precondition (and
			(at box0 f1-4f)
			(clear f2-4f)
	...
	(:action observe5_push_f6-5f_f7-5f_f8-5f_down_box1
		:parameters ()
		:precondition (and
			(clear f8-5f)
			(at-robot f6-5f)
	...
	(:action observe7_move_f7-2f_f7-1f_left
		:parameters ()
		:precondition (and
			(clear f7-1f)
			(at-robot f7-2f)
	...
	(:action observe8_push_f7-1f_f6-1f_f5-1f_up_box0
		:parameters ()
		:precondition (and
			(clear f5-1f)
			(at box0 f6-1f)
