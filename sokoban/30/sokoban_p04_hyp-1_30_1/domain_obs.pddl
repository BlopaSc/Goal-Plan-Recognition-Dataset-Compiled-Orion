...
(define
	...
	(:action observe0_move_f7-0f_f6-0f_up
		:parameters ()
		:precondition (and
			(clear f6-0f)
			(at-robot f7-0f)
	...
	(:action observe6_push_f8-3f_f8-2f_f8-1f_left_box0
		:parameters ()
		:precondition (and
			(clear f8-1f)
			(at-robot f8-3f)
	...
	(:action observe7_push_f3-4f_f3-5f_f3-6f_right_box1
		:parameters ()
		:precondition (and
			(clear f3-6f)
			(at-robot f3-4f)
	...
	(:action observe8_move_f4-9f_f5-9f_down
		:parameters ()
		:precondition (and
			(clear f5-9f)
			(at-robot f4-9f)
