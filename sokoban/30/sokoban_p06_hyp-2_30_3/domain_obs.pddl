...
(define
	...
	(:action observe0_move_f3-2f_f4-2f_down
		:parameters ()
		:precondition (and
			(clear f4-2f)
			(at-robot f3-2f)
	...
	(:action observe1_move_f4-2f_f4-3f_right
		:parameters ()
		:precondition (and
			(clear f4-3f)
			(at-robot f4-2f)
	...
	(:action observe4_move_f4-5f_f5-5f_down
		:parameters ()
		:precondition (and
			(clear f5-5f)
			(at-robot f4-5f)
	...
	(:action observe5_move_f5-4f_f6-4f_down
		:parameters ()
		:precondition (and
			(clear f6-4f)
			(at-robot f5-4f)
	...
	(:action observe6_push_f6-3f_f5-3f_f4-3f_up_box0
		:parameters ()
		:precondition (and
			(clear f4-3f)
			(at-robot f6-3f)
