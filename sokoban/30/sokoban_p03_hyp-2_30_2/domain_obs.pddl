...
(define
	...
	(:action observe0_move_f4-2f_f4-1f_left
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f4-2f)
	...
	(:action observe1_move_f4-1f_f3-1f_up
		:parameters ()
		:precondition (and
			(clear f3-1f)
			(at-robot f4-1f)
	...
	(:action observe2_move_f3-1f_f2-1f_up
		:parameters ()
		:precondition (and
			(clear f2-1f)
			(at-robot f3-1f)
	...
	(:action observe4_push_f1-1f_f1-2f_f1-3f_right_box0
		:parameters ()
		:precondition (and
			(clear f1-3f)
			(at-robot f1-1f)
