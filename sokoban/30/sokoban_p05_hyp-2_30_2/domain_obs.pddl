...
(define
	...
	(:action observe3_push_f2-6f_f3-6f_f4-6f_down_box0
		:parameters ()
		:precondition (and
			(clear f4-6f)
			(at-robot f2-6f)
	...
	(:action observe4_move_f4-5f_f4-4f_left
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f4-5f)
	...
	(:action observe6_push_f5-3f_f4-3f_f3-3f_up_box1
		:parameters ()
		:precondition (and
			(at box1 f4-3f)
			(clear f3-3f)
	...
	(:action observe7_move_f2-4f_f1-4f_up
		:parameters ()
		:precondition (and
			(clear f1-4f)
			(at-robot f2-4f)
