...
(define
	...
	(:action observe4_move_f7-2f_f6-2f_up
		:parameters ()
		:precondition (and
			(clear f6-2f)
			(at-robot f7-2f)
	...
	(:action observe6_push_f3-3f_f3-4f_f3-5f_right_box1
		:parameters ()
		:precondition (and
			(at box1 f3-4f)
			(clear f3-5f)
	...
	(:action observe7_move_f3-7f_f2-7f_up
		:parameters ()
		:precondition (and
			(clear f2-7f)
			(at-robot f3-7f)
	...
	(:action observe8_move_f2-7f_f2-8f_right
		:parameters ()
		:precondition (and
			(clear f2-8f)
			(at-robot f2-7f)
