...
(define
	...
	(:action observe1_push_f1-5f_f2-5f_f3-5f_down_box0
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f1-5f)
	...
	(:action observe2_move_f2-5f_f2-4f_left
		:parameters ()
		:precondition (and
			(clear f2-4f)
			(at-robot f2-5f)
	...
	(:action observe3_move_f4-4f_f5-4f_down
		:parameters ()
		:precondition (and
			(clear f5-4f)
			(at-robot f4-4f)
	...
	(:action observe5_push_f0-4f_f0-3f_f0-2f_left_box1
		:parameters ()
		:precondition (and
			(clear f0-2f)
			(at-robot f0-4f)
	...
	(:action observe10_push_f3-7f_f3-6f_f3-5f_left_box0
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f3-7f)
