...
(define
	...
	(:action observe0_push_f7-3f_f7-4f_f7-5f_right_box0
		:parameters ()
		:precondition (and
			(clear f7-5f)
			(at-robot f7-3f)
	...
	(:action observe1_push_f7-5f_f7-6f_f7-7f_right_box0
		:parameters ()
		:precondition (and
			(clear f7-7f)
			(at-robot f7-5f)
	...
	(:action observe2_push_f7-9f_f8-9f_f9-9f_down_box0
		:parameters ()
		:precondition (and
			(clear f9-9f)
			(at box0 f8-9f)
	...
	(:action observe3_move_f8-9f_f7-9f_up
		:parameters ()
		:precondition (and
			(clear f7-9f)
			(at-robot f8-9f)
	...
	(:action observe4_move_f7-9f_f6-9f_up
		:parameters ()
		:precondition (and
			(clear f6-9f)
			(at-robot f7-9f)
	...
	(:action observe5_move_f3-9f_f3-8f_left
		:parameters ()
		:precondition (and
			(clear f3-8f)
			(at-robot f3-9f)
