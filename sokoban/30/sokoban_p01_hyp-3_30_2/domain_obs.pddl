...
(define
	...
	(:action observe1_move_f5-4f_f4-4f_up
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f5-4f)
	...
	(:action observe3_move_f0-3f_f0-4f_right
		:parameters ()
		:precondition (and
			(clear f0-4f)
			(at-robot f0-3f)
	...
	(:action observe4_push_f2-4f_f3-4f_f4-4f_down_box0
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f2-4f)
	...
	(:action observe6_push_f6-5f_f7-5f_f8-5f_down_box1
		:parameters ()
		:precondition (and
			(clear f8-5f)
			(at-robot f6-5f)
