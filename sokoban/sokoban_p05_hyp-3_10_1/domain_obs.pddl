(define
	...
	(:action observe0_push_f1-3f_f1-2f_f1-1f_left_box0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at-robot f1-3f)
	...
	(:action observe1_move_f0-1f_f0-0f_left
		:parameters ()
		:precondition (and
			(clear f0-0f)
			(at-robot f0-1f)
	...
	(:action observe2_move_f3-4f_f4-4f_down
		:parameters ()
		:precondition (and
			(clear f4-4f)
			(at-robot f3-4f)
	...
	(:action observe3_move_f5-4f_f5-3f_left
		:parameters ()
		:precondition (and
			(clear f5-3f)
			(at-robot f5-4f)
	...
	(:action observe4_push_f5-3f_f4-3f_f3-3f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-3f)
			(at box1 f4-3f)
