(define
	...
	(:action observe0_move_f6-1f_f6-2f_right
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f6-2f)
	...
	(:action observe1_push_f6-2f_f5-2f_f4-2f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f6-2f)
			(at box1 f5-2f)
	...
	(:action observe2_push_f5-2f_f4-2f_f3-2f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-2f)
			(at box1 f4-2f)
	...
	(:action observe3_move_f4-1f_f3-1f_up
		:parameters ()
		:precondition (and
			(clear f3-1f)
			(at-robot f4-1f)
	...
	(:action observe4_push_f3-1f_f3-2f_f3-3f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-1f)
			(at box1 f3-2f)
	...
	(:action observe6_move_f2-1f_f2-0f_left
		:parameters ()
		:precondition (and
			(clear f2-0f)
			(at-robot f2-1f)
	...
	(:action observe7_move_f2-0f_f1-0f_up
		:parameters ()
		:precondition (and
			(clear f1-0f)
			(at-robot f2-0f)
	...
	(:action observe8_push_f1-0f_f1-1f_f1-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-0f)
			(at box0 f1-1f)
	...
	(:action observe9_push_f1-1f_f1-2f_f1-3f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-1f)
			(at box0 f1-2f)
	...
	(:action observe10_push_f1-2f_f1-3f_f1-4f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-2f)
			(at box0 f1-3f)
	...
	(:action observe11_push_f1-3f_f1-4f_f1-5f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f1-3f)
			(at box0 f1-4f)
