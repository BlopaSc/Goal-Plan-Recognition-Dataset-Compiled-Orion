(define
	...
	(:action observe2_move_f5-3f_f4-3f_up
		:parameters ()
		:precondition (and
			(clear f4-3f)
			(at-robot f5-3f)
	...
	(:action observe3_push_f4-3f_f4-4f_f4-5f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f4-3f)
			(at box0 f4-4f)
	...
	(:action observe4_push_f3-6f_f2-6f_f1-6f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f3-6f)
			(at box0 f2-6f)
	...
	(:action observe5_move_f6-2f_f6-1f_left
		:parameters ()
		:precondition (and
			(clear f6-1f)
			(at-robot f6-2f)
	...
	(:action observe6_move_f6-1f_f6-0f_left
		:parameters ()
		:precondition (and
			(clear f6-0f)
			(at-robot f6-1f)
	...
	(:action observe7_move_f6-0f_f5-0f_up
		:parameters ()
		:precondition (and
			(clear f5-0f)
			(at-robot f6-0f)
	...
	(:action observe8_push_f5-0f_f5-1f_f5-2f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f5-0f)
			(at box1 f5-1f)
