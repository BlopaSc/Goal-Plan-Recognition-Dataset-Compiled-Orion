(define
	...
	(:action observe0_move_f1-2f_f0-2f_up
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f0-2f)
	...
	(:action observe1_move_f1-2f_f1-1f_left
		:parameters ()
		:precondition (and
			(clear f1-1f)
			(at-robot f1-2f)
	...
	(:action observe3_push_f3-0f_f3-1f_f3-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f3-0f)
			(at box0 f3-1f)
	...
	(:action observe4_move_f3-1f_f4-1f_down
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f3-1f)
