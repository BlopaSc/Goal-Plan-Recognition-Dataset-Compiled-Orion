(define
	...
	(:action observe6_push_f3-4f_f4-4f_f5-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f3-4f)
			(at box1 f4-4f)
	...
	(:action observe7_push_f4-4f_f5-4f_f6-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f4-4f)
			(at box1 f5-4f)
	...
	(:action observe8_push_f5-4f_f6-4f_f7-4f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f5-4f)
			(at box1 f6-4f)
	...
	(:action observe9_move_f6-4f_f6-3f_left
		:parameters ()
		:precondition (and
			(clear f6-3f)
			(at-robot f6-4f)
	...
	(:action observe10_move_f6-3f_f7-3f_down
		:parameters ()
		:precondition (and
			(clear f7-3f)
			(at-robot f6-3f)
