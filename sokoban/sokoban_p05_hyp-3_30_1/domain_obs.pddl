(define
	...
	(:action observe8_push_f1-0f_f2-0f_f3-0f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f1-0f)
			(at box0 f2-0f)
	...
	(:action observe9_push_f3-0f_f4-0f_f5-0f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f3-0f)
			(at box0 f4-0f)
	...
	(:action observe10_move_f1-0f_f1-1f_right
		:parameters ()
		:precondition (and
			(clear f1-1f)
			(at-robot f1-0f)
	...
	(:action observe12_move_f1-2f_f0-2f_up
		:parameters ()
		:precondition (and
			(clear f0-2f)
			(at-robot f1-2f)
