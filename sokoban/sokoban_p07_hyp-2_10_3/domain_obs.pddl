(define
	...
	(:action observe0_move_f6-7f_f7-7f_down
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f7-7f)
	...
	(:action observe1_move_f0-5f_f0-4f_left
		:parameters ()
		:precondition (and
			(clear f0-4f)
			(at-robot f0-5f)
	...
	(:action observe2_move_f0-4f_f0-3f_left
		:parameters ()
		:precondition (and
			(clear f0-3f)
			(at-robot f0-4f)
	...
	(:action observe3_push_f3-5f_f3-6f_f3-7f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-5f)
			(at box1 f3-6f)
	...
	(:action observe4_push_f6-9f_f7-9f_f8-9f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f6-9f)
			(at box1 f7-9f)
