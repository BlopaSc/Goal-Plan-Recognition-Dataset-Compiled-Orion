(define
	...
	(:action observe5_push_f7-5f_f7-6f_f7-7f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f7-5f)
			(at box0 f7-6f)
	...
	(:action observe7_push_f7-7f_f7-8f_f7-9f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f7-7f)
			(at box0 f7-8f)
	...
	(:action observe8_move_f7-8f_f6-8f_up
		:parameters ()
		:precondition (and
			(clear f6-8f)
			(at-robot f7-8f)
	...
	(:action observe9_move_f6-8f_f6-9f_right
		:parameters ()
		:precondition (and
			(clear f6-9f)
			(at-robot f6-8f)
	...
	(:action observe10_push_f6-9f_f7-9f_f8-9f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f6-9f)
			(at box0 f7-9f)
