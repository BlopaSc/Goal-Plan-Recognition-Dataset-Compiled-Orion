(define
	...
	(:action observe7_push_f8-3f_f8-2f_f8-1f_left_box0
		:parameters ()
		:precondition (and
			(at-robot f8-3f)
			(at box0 f8-2f)
	...
	(:action observe8_move_f8-2f_f7-2f_up
		:parameters ()
		:precondition (and
			(clear f7-2f)
			(at-robot f8-2f)
	...
	(:action observe13_push_f3-6f_f3-7f_f3-8f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f3-6f)
			(at box1 f3-7f)
	...
	(:action observe16_move_f4-8f_f4-9f_right
		:parameters ()
		:precondition (and
			(clear f4-9f)
			(at-robot f4-8f)
	...
	(:action observe17_move_f4-9f_f5-9f_down
		:parameters ()
		:precondition (and
			(clear f5-9f)
			(at-robot f4-9f)
