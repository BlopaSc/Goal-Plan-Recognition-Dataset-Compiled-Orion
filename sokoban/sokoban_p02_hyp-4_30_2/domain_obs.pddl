(define
	...
	(:action observe0_move_f3-0f_f4-0f_down
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f4-0f)
	...
	(:action observe1_push_f4-1f_f3-1f_f2-1f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f4-1f)
			(at box0 f3-1f)
	...
	(:action observe3_push_f2-2f_f2-3f_f2-4f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f2-2f)
			(at box0 f2-3f)
	...
	(:action observe4_push_f1-4f_f2-4f_f3-4f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f1-4f)
			(at box0 f2-4f)
