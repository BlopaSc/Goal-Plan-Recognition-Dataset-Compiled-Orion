(define
	...
	(:action observe1_push_f0-4f_f0-5f_f0-6f_right_box1
		:parameters ()
		:precondition (and
			(at-robot f0-4f)
			(at box1 f0-5f)
	...
	(:action observe2_move_f2-6f_f3-6f_down
		:parameters ()
		:precondition (and
			(clear f3-6f)
			(at-robot f2-6f)
	...
	(:action observe3_push_f7-9f_f6-9f_f5-9f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f7-9f)
			(at box0 f6-9f)
	...
	(:action observe4_push_f6-9f_f5-9f_f4-9f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f6-9f)
			(at box0 f5-9f)
