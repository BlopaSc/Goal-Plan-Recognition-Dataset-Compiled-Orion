(define
	...
	(:action observe2_push_f0-1f_f1-1f_f2-1f_down_box0
		:parameters ()
		:precondition (and
			(at-robot f0-1f)
			(at box0 f1-1f)
	...
	(:action observe3_move_f4-1f_f5-1f_down
		:parameters ()
		:precondition (and
			(clear f5-1f)
			(at-robot f4-1f)
	...
	(:action observe7_push_f6-4f_f5-4f_f4-4f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f6-4f)
			(at box1 f5-4f)
	...
	(:action observe8_push_f5-4f_f4-4f_f3-4f_up_box1
		:parameters ()
		:precondition (and
			(at-robot f5-4f)
			(at box1 f4-4f)
