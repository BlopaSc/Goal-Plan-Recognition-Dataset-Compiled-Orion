(define
	...
	(:action observe4_move_f4-0f_f4-1f_right
		:parameters ()
		:precondition (and
			(clear f4-1f)
			(at-robot f4-0f)
	...
	(:action observe6_push_f3-1f_f2-1f_f1-1f_up_box0
		:parameters ()
		:precondition (and
			(at-robot f3-1f)
			(at box0 f2-1f)
	...
	(:action observe7_move_f2-1f_f2-2f_right
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f2-1f)
	...
	(:action observe8_move_f2-2f_f2-3f_right
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-2f)
	...
	(:action observe12_push_f0-2f_f1-2f_f2-2f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f0-2f)
			(at box1 f1-2f)
	...
	(:action observe13_push_f1-2f_f2-2f_f3-2f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f1-2f)
			(at box1 f2-2f)
	...
	(:action observe14_push_f2-2f_f3-2f_f4-2f_down_box1
		:parameters ()
		:precondition (and
			(at-robot f2-2f)
			(at box1 f3-2f)
