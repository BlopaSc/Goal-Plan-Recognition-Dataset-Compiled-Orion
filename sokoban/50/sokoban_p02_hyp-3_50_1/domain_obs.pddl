...
(define
	...
	(:action observe1_push_f1-2f_f1-3f_f1-4f_right_box1
		:parameters ()
		:precondition (and
			(clear f1-4f)
			(at-robot f1-2f)
	...
	(:action observe3_move_f2-2f_f3-2f_down
		:parameters ()
		:precondition (and
			(clear f3-2f)
			(at-robot f2-2f)
	...
	(:action observe4_move_f3-2f_f4-2f_down
		:parameters ()
		:precondition (and
			(clear f4-2f)
			(at-robot f3-2f)
	...
	(:action observe5_push_f4-1f_f3-1f_f2-1f_up_box0
		:parameters ()
		:precondition (and
			(at box0 f3-1f)
			(clear f2-1f)
	...
	(:action observe7_push_f2-0f_f2-1f_f2-2f_right_box0
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f2-0f)
