...
(define
	...
	(:action observe9_push_f1-2f_f2-2f_f3-2f_down_box0
		:parameters ()
		:precondition (and
			(clear f3-2f)
			(at-robot f1-2f)
	...
	(:action observe11_move_f3-2f_f2-2f_up
		:parameters ()
		:precondition (and
			(clear f2-2f)
			(at-robot f3-2f)
	...
	(:action observe12_move_f2-2f_f2-3f_right
		:parameters ()
		:precondition (and
			(clear f2-3f)
			(at-robot f2-2f)
	...
	(:action observe13_move_f3-4f_f3-5f_right
		:parameters ()
		:precondition (and
			(clear f3-5f)
			(at-robot f3-4f)
