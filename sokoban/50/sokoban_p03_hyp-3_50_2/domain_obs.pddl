...
(define
	...
	(:action observe4_move_f3-0f_f4-0f_down
		:parameters ()
		:precondition (and
			(clear f4-0f)
			(at-robot f3-0f)
	...
	(:action observe5_push_f4-0f_f4-1f_f4-2f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f4-0f)
			(clear f4-2f)
	...
	(:action observe8_move_f5-1f_f6-1f_down
		:parameters ()
		:precondition (and
			(clear f6-1f)
			(at-robot f5-1f)
	...
	(:action observe9_push_f6-2f_f5-2f_f4-2f_up_box1
		:parameters ()
		:precondition (and
			(at box1 f5-2f)
			(clear f4-2f)
