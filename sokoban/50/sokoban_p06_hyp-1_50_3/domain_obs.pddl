...
(define
	...
	(:action observe0_move_f4-1f_f4-2f_right
		:parameters ()
		:precondition (and
			(clear f4-2f)
			(at-robot f4-1f)
	...
	(:action observe2_move_f5-2f_f6-2f_down
		:parameters ()
		:precondition (and
			(clear f6-2f)
			(at-robot f5-2f)
	...
	(:action observe12_move_f5-5f_f5-4f_left
		:parameters ()
		:precondition (and
			(clear f5-4f)
			(at-robot f5-5f)
	...
	(:action observe13_move_f5-3f_f5-2f_left
		:parameters ()
		:precondition (and
			(clear f5-2f)
			(at-robot f5-3f)
	...
	(:action observe14_move_f6-1f_f6-0f_left
		:parameters ()
		:precondition (and
			(clear f6-0f)
			(at-robot f6-1f)
