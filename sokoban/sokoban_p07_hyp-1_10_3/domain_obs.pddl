(define
	...
	(:action observe0_move_f3-5f_f3-4f_left
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f3-4f)
	...
	(:action observe1_move_f8-4f_f8-3f_left
		:parameters ()
		:precondition (and
			(clear f8-3f)
			(at-robot f8-4f)
	...
	(:action observe2_push_f6-6f_f6-7f_f6-8f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f6-6f)
			(at box0 f6-7f)
	...
	(:action observe3_move_f6-8f_f7-8f_down
		:parameters ()
		:precondition (and
			(clear f7-8f)
			(at-robot f6-8f)
