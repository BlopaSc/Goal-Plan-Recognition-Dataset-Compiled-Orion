(define
	...
	(:action observe0_move_f1-4f_f1-3f_left
		:parameters ()
		:precondition (and
			(not (observation0))
			(clear f1-3f)
	...
	(:action observe1_move_f7-4f_f8-4f_down
		:parameters ()
		:precondition (and
			(clear f8-4f)
			(at-robot f7-4f)
	...
	(:action observe2_push_f6-2f_f6-3f_f6-4f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f6-2f)
			(at box0 f6-3f)
	...
	(:action observe3_push_f6-4f_f6-5f_f6-6f_right_box0
		:parameters ()
		:precondition (and
			(at-robot f6-4f)
			(at box0 f6-5f)
