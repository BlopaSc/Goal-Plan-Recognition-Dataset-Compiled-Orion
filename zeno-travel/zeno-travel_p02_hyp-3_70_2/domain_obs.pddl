(define
	...
	(:action observe5_fly_plane1_city0_city3_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl4)
	...
	(:action observe6_debark_person4_plane1_city3
		:parameters ()
		:precondition (and
			(in person4 plane1)
			(at plane1 city3)
	...
	(:action observe7_board_person5_plane1_city3
		:parameters ()
		:precondition (and
			(at person5 city3)
			(at plane1 city3)
	...
	(:action observe8_fly_plane1_city3_city4_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city3)
			(fuellevel plane1 fl3)
