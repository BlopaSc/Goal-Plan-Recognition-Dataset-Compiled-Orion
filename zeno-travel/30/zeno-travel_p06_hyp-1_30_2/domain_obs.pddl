...
(define
	...
	(:action observe3_debark_person6_plane1_city3
		:parameters ()
		:precondition (and
			(at plane1 city3)
			(in person6 plane1)
	...
	(:action observe6_fly_plane3_city1_city0_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane3 city1)
			(fuellevel plane3 fl1)
	...
	(:action observe7_debark_person1_plane3_city0
		:parameters ()
		:precondition (and
			(in person1 plane3)
			(at plane3 city0)
	...
	(:action observe9_debark_person5_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person5 plane1)
