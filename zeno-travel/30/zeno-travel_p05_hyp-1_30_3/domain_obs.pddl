...
(define
	...
	(:action observe0_fly_plane1_city2_city5_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl1)
	...
	(:action observe1_debark_person6_plane1_city5
		:parameters ()
		:precondition (and
			(at plane1 city5)
			(in person6 plane1)
	...
	(:action observe2_board_person2_plane2_city4
		:parameters ()
		:precondition (and
			(at person2 city4)
			(at plane2 city4)
	...
	(:action observe3_zoom_plane2_city1_city0_fl2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl2)
	...
	(:action observe4_refuel_plane3_city0_fl0_fl1
		:parameters ()
		:precondition (and
			(at plane3 city0)
			(fuellevel plane3 fl0)
	...
	(:action observe5_refuel_plane1_city5_fl0_fl1
		:parameters ()
		:precondition (and
			(at plane1 city5)
			(fuellevel plane1 fl0)
	...
	(:action observe8_debark_person1_plane3_city2
		:parameters ()
		:precondition (and
			(in person1 plane3)
			(at plane3 city2)
