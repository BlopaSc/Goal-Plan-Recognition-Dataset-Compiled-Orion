...
(define
	...
	(:action observe5_debark_person4_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person4 plane1)
	...
	(:action observe6_fly_plane1_city2_city0_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl1)
	...
	(:action observe7_refuel_plane1_city0_fl1_fl2
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl1)
	...
	(:action observe8_fly_plane1_city0_city4_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl2)
