...
(define
	...
	(:action observe2_debark_person8_plane1_city3
		:parameters ()
		:precondition (and
			(at plane1 city3)
			(in person8 plane1)
	...
	(:action observe3_board_person7_plane3_city4
		:parameters ()
		:precondition (and
			(at person7 city4)
			(at plane3 city4)
	...
	(:action observe6_refuel_plane3_city2_fl1_fl2
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(fuellevel plane3 fl1)
	...
	(:action observe7_fly_plane3_city2_city5_fl2_fl1
		:parameters ()
		:precondition (and
			(fuellevel plane3 fl2)
			(at plane3 city2)
