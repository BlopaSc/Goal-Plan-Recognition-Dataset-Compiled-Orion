...
(define
	...
	(:action observe2_board_person8_plane2_city5
		:parameters ()
		:precondition (and
			(at person8 city5)
			(at plane2 city5)
	...
	(:action observe3_refuel_plane2_city4_fl0_fl1
		:parameters ()
		:precondition (and
			(at plane2 city4)
			(fuellevel plane2 fl0)
	...
	(:action observe4_fly_plane2_city4_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city4)
			(fuellevel plane2 fl1)
	...
	(:action observe7_fly_plane3_city1_city3_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane3 city1)
			(fuellevel plane3 fl1)
