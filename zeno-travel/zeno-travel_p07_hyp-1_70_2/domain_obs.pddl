(define
	...
	(:action observe7_board_person1_plane2_city5
		:parameters ()
		:precondition (and
			(at person1 city5)
			(at plane2 city5)
	...
	(:action observe8_fly_plane2_city5_city4_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city5)
			(fuellevel plane2 fl1)
	...
	(:action observe9_debark_person8_plane2_city4
		:parameters ()
		:precondition (and
			(in person8 plane2)
			(at plane2 city4)
	...
	(:action observe10_refuel_plane3_city0_fl0_fl1
		:parameters ()
		:precondition (and
			(fuellevel plane3 fl0)
			(at plane3 city0)
