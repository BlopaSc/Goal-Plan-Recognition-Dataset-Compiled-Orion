(define
	...
	(:action observe3_debark_person5_plane1_city0
		:parameters ()
		:precondition (and
			(in person5 plane1)
			(at plane1 city0)
	...
	(:action observe4_debark_person2_plane1_city0
		:parameters ()
		:precondition (and
			(in person2 plane1)
			(at plane1 city0)
	...
	(:action observe6_board_person3_plane1_city0
		:parameters ()
		:precondition (and
			(at person3 city0)
			(at plane1 city0)
	...
	(:action observe7_fly_plane1_city0_city1_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl3)
