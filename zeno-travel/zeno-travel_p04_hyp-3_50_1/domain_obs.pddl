(define
	...
	(:action observe2_debark_person3_plane3_city3
		:parameters ()
		:precondition (and
			(in person3 plane3)
			(at plane3 city3)
	...
	(:action observe3_board_person1_plane1_city4
		:parameters ()
		:precondition (and
			(at person1 city4)
			(at plane1 city4)
	...
	(:action observe4_debark_person1_plane1_city1
		:parameters ()
		:precondition (and
			(in person1 plane1)
			(at plane1 city1)
	...
	(:action observe5_fly_plane3_city2_city5_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(fuellevel plane3 fl2)
	...
	(:action observe6_board_person7_plane3_city5
		:parameters ()
		:precondition (and
			(at person7 city5)
			(at plane3 city5)
	...
	(:action observe8_debark_person4_plane1_city4
		:parameters ()
		:precondition (and
			(in person4 plane1)
			(at plane1 city4)
