...
(define
	...
	(:action observe0_debark_person4_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person4 plane1)
	...
	(:action observe1_debark_person2_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person2 plane1)
	...
	(:action observe2_board_person3_plane1_city2
		:parameters ()
		:precondition (and
			(at person3 city2)
			(at plane1 city2)
	...
	(:action observe3_fly_plane1_city2_city0_fl5_fl4
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl5)
	...
	(:action observe4_debark_person3_plane1_city0
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(in person3 plane1)
