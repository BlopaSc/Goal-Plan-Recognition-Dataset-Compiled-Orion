(define
	...
	(:action observe4_board_person2_plane1_city2
		:parameters ()
		:precondition (and
			(at person2 city2)
			(at plane1 city2)
	...
	(:action observe5_debark_person1_plane1_city2
		:parameters ()
		:precondition (and
			(in person1 plane1)
			(at plane1 city2)
	...
	(:action observe9_fly_plane1_city5_city4_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city5)
			(fuellevel plane1 fl2)
	...
	(:action observe10_fly_plane3_city0_city1_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane3 city0)
			(fuellevel plane3 fl3)
