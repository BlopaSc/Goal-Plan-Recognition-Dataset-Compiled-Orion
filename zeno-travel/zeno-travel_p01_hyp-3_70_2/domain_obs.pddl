(define
	...
	(:action observe0_fly_plane2_city1_city0_fl3_fl2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at plane2 city1)
	...
	(:action observe1_board_person2_plane2_city0
		:parameters ()
		:precondition (and
			(at person2 city0)
			(at plane2 city0)
	...
	(:action observe2_board_person1_plane2_city0
		:parameters ()
		:precondition (and
			(at person1 city0)
			(at plane2 city0)
	...
	(:action observe3_fly_plane2_city0_city1_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane2 city0)
			(fuellevel plane2 fl2)
	...
	(:action observe4_debark_person1_plane2_city1
		:parameters ()
		:precondition (and
			(in person1 plane2)
			(at plane2 city1)
	...
	(:action observe5_board_person5_plane1_city2
		:parameters ()
		:precondition (and
			(at person5 city2)
			(at plane1 city2)
	...
	(:action observe7_debark_person4_plane2_city2
		:parameters ()
		:precondition (and
			(in person4 plane2)
			(at plane2 city2)
	...
	(:action observe8_debark_person2_plane2_city2
		:parameters ()
		:precondition (and
			(in person2 plane2)
			(at plane2 city2)
