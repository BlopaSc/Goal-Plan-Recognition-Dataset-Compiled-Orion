(define
	...
	(:action observe0_board_person1_plane2_city0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at person1 city0)
	...
	(:action observe1_fly_plane2_city0_city1_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane2 city0)
			(fuellevel plane2 fl2)
	...
	(:action observe2_debark_person1_plane2_city1
		:parameters ()
		:precondition (and
			(in person1 plane2)
			(at plane2 city1)
	...
	(:action observe3_fly_plane1_city2_city3_fl5_fl4
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl5)
	...
	(:action observe4_debark_person4_plane2_city2
		:parameters ()
		:precondition (and
			(in person4 plane2)
			(at plane2 city2)
	...
	(:action observe5_debark_person5_plane1_city3
		:parameters ()
		:precondition (and
			(in person5 plane1)
			(at plane1 city3)
