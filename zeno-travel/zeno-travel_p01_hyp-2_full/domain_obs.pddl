(define
	...
	(:constants
		city0 city1 city2 city3 fl0 fl1 fl2 fl3 fl4 fl5 fl6 person1 person2 person3 person4 person5 plane1 plane2
	)
	(:predicates
		(at ?x ?c)
		(in ?p ?a)
	...
	(:action observe0_board_person5_plane1_city2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at person5 city2)
	...
	(:action observe1_fly_plane1_city2_city0_fl5_fl4
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl5)
	...
	(:action observe2_board_person2_plane1_city0
		:parameters ()
		:precondition (and
			(at person2 city0)
			(at plane1 city0)
	...
	(:action observe3_board_person1_plane1_city0
		:parameters ()
		:precondition (and
			(at person1 city0)
			(at plane1 city0)
	...
	(:action observe4_fly_plane1_city0_city1_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl4)
	...
	(:action observe5_debark_person2_plane1_city1
		:parameters ()
		:precondition (and
			(in person2 plane1)
			(at plane1 city1)
	...
	(:action observe6_fly_plane1_city1_city3_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(fuellevel plane1 fl3)
	...
	(:action observe7_debark_person5_plane1_city3
		:parameters ()
		:precondition (and
			(in person5 plane1)
			(at plane1 city3)
	...
	(:action observe8_board_person3_plane1_city3
		:parameters ()
		:precondition (and
			(at person3 city3)
			(at plane1 city3)
	...
	(:action observe9_fly_plane1_city3_city2_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city3)
			(fuellevel plane1 fl2)
	...
	(:action observe10_debark_person3_plane1_city2
		:parameters ()
		:precondition (and
			(in person3 plane1)
			(at plane1 city2)
	...
	(:action observe11_debark_person1_plane1_city2
		:parameters ()
		:precondition (and
			(in person1 plane1)
			(at plane1 city2)
