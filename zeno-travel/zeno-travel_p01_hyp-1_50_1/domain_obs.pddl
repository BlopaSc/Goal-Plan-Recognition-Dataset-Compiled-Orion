(define
	...
	(:action observe1_board_person4_plane2_city1
		:parameters ()
		:precondition (and
			(at person4 city1)
			(at plane2 city1)
	...
	(:action observe2_debark_person5_plane1_city1
		:parameters ()
		:precondition (and
			(in person5 plane1)
			(at plane1 city1)
	...
	(:action observe4_fly_plane2_city1_city0_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl3)
	...
	(:action observe5_debark_person1_plane1_city3
		:parameters ()
		:precondition (and
			(in person1 plane1)
			(at plane1 city3)
