(define
	...
	(:action observe2_debark_person2_plane2_city1
		:parameters ()
		:precondition (and
			(in person2 plane2)
			(at plane2 city1)
	...
	(:action observe4_debark_person5_plane2_city0
		:parameters ()
		:precondition (and
			(in person5 plane2)
			(at plane2 city0)
	...
	(:action observe5_board_person8_plane1_city5
		:parameters ()
		:precondition (and
			(at person8 city5)
			(at plane1 city5)
	...
	(:action observe6_debark_person8_plane1_city3
		:parameters ()
		:precondition (and
			(in person8 plane1)
			(at plane1 city3)
	...
	(:action observe8_fly_plane3_city4_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane3 city4)
			(fuellevel plane3 fl1)
