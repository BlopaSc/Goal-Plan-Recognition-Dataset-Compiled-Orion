(define
	...
	(:action observe4_debark_person1_plane1_city0
		:parameters ()
		:precondition (and
			(in person1 plane1)
			(at plane1 city0)
	...
	(:action observe5_fly_plane1_city0_city4_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl3)
	...
	(:action observe6_fly_plane1_city4_city3_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city4)
			(fuellevel plane1 fl2)
	...
	(:action observe7_debark_person6_plane1_city3
		:parameters ()
		:precondition (and
			(in person6 plane1)
			(at plane1 city3)
