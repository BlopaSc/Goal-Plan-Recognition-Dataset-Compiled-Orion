(define
	...
	(:action observe0_fly_plane1_city3_city0_fl3_fl2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at plane1 city3)
	...
	(:action observe2_fly_plane1_city0_city2_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl2)
	...
	(:action observe6_debark_person7_plane3_city2
		:parameters ()
		:precondition (and
			(in person7 plane3)
			(at plane3 city2)
	...
	(:action observe8_fly_plane2_city4_city1_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane2 city4)
			(fuellevel plane2 fl3)
