(define
	...
	(:action observe0_board_person2_plane3_city3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at person2 city3)
	...
	(:action observe5_board_person8_plane2_city5
		:parameters ()
		:precondition (and
			(at person8 city5)
			(at plane2 city5)
	...
	(:action observe11_debark_person1_plane2_city1
		:parameters ()
		:precondition (and
			(in person1 plane2)
			(at plane2 city1)
	...
	(:action observe12_fly_plane2_city1_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl1)
