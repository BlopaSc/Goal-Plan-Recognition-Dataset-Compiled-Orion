...
(define
	...
	(:action observe1_board_person3_plane1_city2
		:parameters ()
		:precondition (and
			(at person3 city2)
			(at plane1 city2)
	...
	(:action observe2_fly_plane1_city2_city1_fl5_fl4
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl5)
	...
	(:action observe4_board_person1_plane1_city1
		:parameters ()
		:precondition (and
			(at person1 city1)
			(at plane1 city1)
	...
	(:action observe5_fly_plane1_city1_city0_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(fuellevel plane1 fl4)
	...
	(:action observe6_debark_person1_plane1_city0
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(in person1 plane1)
	...
	(:action observe7_fly_plane1_city0_city4_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl3)
	...
	(:action observe9_fly_plane1_city4_city3_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city4)
			(fuellevel plane1 fl2)
