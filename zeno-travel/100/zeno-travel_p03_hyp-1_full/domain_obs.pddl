...
(define
	...
	(:action observe1_board_person4_plane1_city0
		:parameters ()
		:precondition (and
			(at person4 city0)
			(at plane1 city0)
	...
	(:action observe3_fly_plane1_city0_city1_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl4)
	...
	(:action observe4_debark_person4_plane1_city1
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(in person4 plane1)
	...
	(:action observe5_debark_person1_plane1_city1
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(in person1 plane1)
	...
	(:action observe6_board_person2_plane1_city1
		:parameters ()
		:precondition (and
			(at person2 city1)
			(at plane1 city1)
	...
	(:action observe8_debark_person2_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person2 plane1)
	...
	(:action observe9_fly_plane1_city2_city0_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl2)
