...
(define
	...
	(:constants
		...
		city0 city1 city2 fl0 fl1 fl2 fl3 fl4 fl5 fl6 person1 person2 person3 person4 person5 plane1 plane2
	)
	...
	(:action observe2_board_person4_plane1_city0
		:parameters ()
		:precondition (and
			(at person4 city0)
			(at plane1 city0)
	...
	(:action observe4_board_person1_plane1_city0
		:parameters ()
		:precondition (and
			(at person1 city0)
			(at plane1 city0)
	...
	(:action observe5_fly_plane1_city0_city1_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl4)
	...
	(:action observe6_debark_person5_plane1_city1
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(in person5 plane1)
	...
	(:action observe7_fly_plane1_city1_city2_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(fuellevel plane1 fl3)
	...
	(:action observe8_debark_person4_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person4 plane1)
	...
	(:action observe9_debark_person3_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person3 plane1)
	...
	(:action observe10_debark_person1_plane1_city2
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(in person1 plane1)
