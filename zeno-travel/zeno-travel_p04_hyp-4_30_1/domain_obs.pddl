(define
	...
	(:action observe3_fly_plane3_city2_city0_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(fuellevel plane3 fl4)
	...
	(:action observe4_debark_person6_plane3_city0
		:parameters ()
		:precondition (and
			(in person6 plane3)
			(at plane3 city0)
	...
	(:action observe5_fly_plane3_city0_city1_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane3 city0)
			(fuellevel plane3 fl3)
	...
	(:action observe6_debark_person4_plane2_city1
		:parameters ()
		:precondition (and
			(in person4 plane2)
			(at plane2 city1)
