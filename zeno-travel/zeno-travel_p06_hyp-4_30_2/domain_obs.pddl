(define
	...
	(:action observe1_refuel_plane2_city0_fl0_fl1
		:parameters ()
		:precondition (and
			(fuellevel plane2 fl0)
			(at plane2 city0)
	...
	(:action observe2_board_person6_plane1_city4
		:parameters ()
		:precondition (and
			(at person6 city4)
			(at plane1 city4)
	...
	(:action observe5_board_person1_plane2_city1
		:parameters ()
		:precondition (and
			(at person1 city1)
			(at plane2 city1)
	...
	(:action observe8_board_person4_plane3_city0
		:parameters ()
		:precondition (and
			(at person4 city0)
			(at plane3 city0)
	...
	(:action observe9_debark_person4_plane3_city1
		:parameters ()
		:precondition (and
			(in person4 plane3)
			(at plane3 city1)
