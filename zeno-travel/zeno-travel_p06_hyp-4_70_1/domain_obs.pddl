(define
	...
	(:action observe6_debark_person3_plane2_city1
		:parameters ()
		:precondition (and
			(in person3 plane2)
			(at plane2 city1)
	...
	(:action observe7_refuel_plane1_city4_fl2_fl3
		:parameters ()
		:precondition (and
			(fuellevel plane1 fl2)
			(at plane1 city4)
	...
	(:action observe17_fly_plane2_city1_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl1)
	...
	(:action observe18_debark_person1_plane2_city2
		:parameters ()
		:precondition (and
			(in person1 plane2)
			(at plane2 city2)
