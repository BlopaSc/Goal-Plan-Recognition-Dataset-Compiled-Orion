(define
	...
	(:action observe5_board_person4_plane2_city1
		:parameters ()
		:precondition (and
			(at person4 city1)
			(at plane2 city1)
	...
	(:action observe8_fly_plane2_city1_city0_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl3)
	...
	(:action observe9_fly_plane1_city1_city3_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(fuellevel plane1 fl3)
	...
	(:action observe10_debark_person4_plane2_city0
		:parameters ()
		:precondition (and
			(in person4 plane2)
			(at plane2 city0)
