(define
	...
	(:action observe7_board_person6_plane1_city2
		:parameters ()
		:precondition (and
			(at person6 city2)
			(at plane1 city2)
	...
	(:action observe8_zoom_plane2_city0_city2_fl2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city0)
			(fuellevel plane2 fl2)
	...
	(:action observe9_refuel_plane1_city2_fl0_fl1
		:parameters ()
		:precondition (and
			(fuellevel plane1 fl0)
			(at plane1 city2)
	...
	(:action observe10_refuel_plane2_city2_fl1_fl2
		:parameters ()
		:precondition (and
			(fuellevel plane2 fl1)
			(at plane2 city2)
