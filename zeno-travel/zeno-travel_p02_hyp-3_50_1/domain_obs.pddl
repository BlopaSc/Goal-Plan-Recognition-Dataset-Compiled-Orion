(define
	...
	(:action observe2_fly_plane1_city2_city0_fl5_fl4
		:parameters ()
		:precondition (and
			(at plane1 city2)
			(fuellevel plane1 fl5)
	...
	(:action observe3_debark_person3_plane1_city0
		:parameters ()
		:precondition (and
			(in person3 plane1)
			(at plane1 city0)
	...
	(:action observe4_fly_plane1_city3_city4_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city3)
			(fuellevel plane1 fl3)
	...
	(:action observe5_debark_person5_plane1_city4
		:parameters ()
		:precondition (and
			(in person5 plane1)
			(at plane1 city4)
