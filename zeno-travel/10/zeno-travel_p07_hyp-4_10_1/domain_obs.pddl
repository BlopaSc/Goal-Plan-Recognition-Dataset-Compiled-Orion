...
(define
	...
	(:action observe0_fly_plane1_city0_city5_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl1)
	...
	(:action observe1_refuel_plane1_city5_fl0_fl1
		:parameters ()
		:precondition (and
			(at plane1 city5)
			(fuellevel plane1 fl0)
	...
	(:action observe2_debark_person5_plane3_city2
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(in person5 plane3)
	...
	(:action observe3_refuel_plane3_city2_fl0_fl1
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(fuellevel plane3 fl0)
