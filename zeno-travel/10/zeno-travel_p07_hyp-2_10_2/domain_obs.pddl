...
(define
	...
	(:action observe0_debark_person2_plane1_city4
		:parameters ()
		:precondition (and
			(at plane1 city4)
			(in person2 plane1)
	...
	(:action observe1_fly_plane1_city4_city1_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane1 city4)
			(fuellevel plane1 fl1)
	...
	(:action observe2_fly_plane2_city0_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city0)
			(fuellevel plane2 fl1)
	...
	(:action observe3_debark_person4_plane3_city3
		:parameters ()
		:precondition (and
			(at plane3 city3)
			(in person4 plane3)
