(define
	...
	(:action observe0_fly_plane1_city0_city2_fl1_fl0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at plane1 city0)
	...
	(:action observe1_zoom_plane2_city1_city4_fl2_fl1_fl0
		:parameters ()
		:precondition (and
			(at plane2 city1)
			(fuellevel plane2 fl2)
	...
	(:action observe2_debark_person7_plane2_city1
		:parameters ()
		:precondition (and
			(in person7 plane2)
			(at plane2 city1)
	...
	(:action observe3_board_person8_plane1_city5
		:parameters ()
		:precondition (and
			(at person8 city5)
			(at plane1 city5)
