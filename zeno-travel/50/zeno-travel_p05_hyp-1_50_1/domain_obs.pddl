...
(define
	...
	(:action observe6_board_person5_plane2_city1
		:parameters ()
		:precondition (and
			(at person5 city1)
			(at plane2 city1)
	...
	(:action observe11_refuel_plane3_city2_fl1_fl2
		:parameters ()
		:precondition (and
			(at plane3 city2)
			(fuellevel plane3 fl1)
	...
	(:action observe12_board_person7_plane3_city4
		:parameters ()
		:precondition (and
			(at person7 city4)
			(at plane3 city4)
	...
	(:action observe14_fly_plane3_city2_city5_fl2_fl1
		:parameters ()
		:precondition (and
			(fuellevel plane3 fl2)
			(at plane3 city2)
