...
(define
	...
	(:action observe1_fly_plane1_city1_city0_fl4_fl3
		:parameters ()
		:precondition (and
			(at plane1 city1)
			(fuellevel plane1 fl4)
	...
	(:action observe2_fly_plane1_city0_city4_fl3_fl2
		:parameters ()
		:precondition (and
			(at plane1 city0)
			(fuellevel plane1 fl3)
	...
	(:action observe3_board_person6_plane1_city4
		:parameters ()
		:precondition (and
			(at person6 city4)
			(at plane1 city4)
	...
	(:action observe4_fly_plane1_city4_city3_fl2_fl1
		:parameters ()
		:precondition (and
			(at plane1 city4)
			(fuellevel plane1 fl2)
