(define
	...
	(:action observe10_board_c10_l10
		:parameters ()
		:precondition (and
			(at c10 l10)
			(at-ferry l10)
	...
	(:action observe12_debark_c10_l2
		:parameters ()
		:precondition (and
			(on c10)
			(at-ferry l2)
