(define
	...
	(:action observe11_debark_c11_l8
		:parameters ()
		:precondition (and
			(on c11)
			(at-ferry l8)
	...
	(:action observe12_board_c14_l13
		:parameters ()
		:precondition (and
			(at c14 l13)
			(at-ferry l13)
