...
(define
	...
	(:constants
		c0 c1 c10 c11 c12 c13 c14 c2 c3 c4 c5 c6 c7 c8 c9 - car__inferred_type
		l0 l1 l10 l11 l12 l13 l14 l2 l3 l4 l5 l6 l7 l8 l9 - location__inferred_type
		obs0 obs1 obs2 obs3 obs4 obs5 obs6 obs7 obs8 obs9 obs10 obs11 obs12 obs13 obs14 obs15 obs16 obs17 obs18 obs19 obs20 obs21 obs22 obs23 obs24 obs25 obs26 obs27 obs28 obs29 obs30 obs31 obs32 obs33 obs34 obs35 - observation
	)
	(:action sail_l0_l1
		:parameters ()
	...
	(:action observe20_debark_c4_l10
		:parameters ()
		:precondition (and
			(at-ferry l10)
			(on c4)
	...
	(:action observe21_board_c10_l10
		:parameters ()
		:precondition (and
			(empty-ferry)
			(at c10 l10)
	...
	(:action observe23_debark_c10_l2
		:parameters ()
		:precondition (and
			(at-ferry l2)
			(on c10)
	...
	(:action observe27_debark_c9_l10
		:parameters ()
		:precondition (and
			(at-ferry l10)
			(on c9)
	...
	(:action observe35_debark_c1_l12
		:parameters ()
		:precondition (and
			(at-ferry l12)
			(on c1)
