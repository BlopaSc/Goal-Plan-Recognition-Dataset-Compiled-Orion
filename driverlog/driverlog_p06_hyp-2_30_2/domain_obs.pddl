(define
	...
	(:action observe0_load-truck_package4_truck2_s6
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s6)
	...
	(:action observe4_drive-truck_truck2_s4_s1_driver2
		:parameters ()
		:precondition (and
			(at truck2 s4)
			(driving driver2 truck2)
	...
	(:action observe6_unload-truck_package1_truck2_s5
		:parameters ()
		:precondition (and
			(at truck2 s5)
			(in package1 truck2)
	...
	(:action observe8_load-truck_package6_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(at package6 s2)
