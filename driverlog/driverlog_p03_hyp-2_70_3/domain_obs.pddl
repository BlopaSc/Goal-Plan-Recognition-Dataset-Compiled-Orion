(define
	...
	(:action observe2_walk_driver2_p1-0_s0
		:parameters ()
		:precondition (and
			(at driver2 p1-0)
			(observation1)
	...
	(:action observe3_board-truck_driver2_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at driver2 s0)
	...
	(:action observe5_unload-truck_package2_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package2 truck1)
	...
	(:action observe6_drive-truck_truck1_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver2 truck1)
	...
	(:action observe7_walk_driver1_s2_p1-2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(observation6)
