(define
	...
	(:action observe0_drive-truck_truck3_s3_s9_driver3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck3 s3)
	...
	(:action observe1_drive-truck_truck3_s9_s4_driver3
		:parameters ()
		:precondition (and
			(at truck3 s9)
			(driving driver3 truck3)
	...
	(:action observe2_unload-truck_package1_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(in package1 truck3)
	...
	(:action observe3_drive-truck_truck3_s6_s4_driver3
		:parameters ()
		:precondition (and
			(at truck3 s6)
			(driving driver3 truck3)
	...
	(:action observe4_unload-truck_package4_truck3_s4
		:parameters ()
		:precondition (and
			(at truck3 s4)
			(in package4 truck3)
