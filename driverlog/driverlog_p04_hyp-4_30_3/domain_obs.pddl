(define
	...
	(:action observe0_board-truck_driver3_truck1_s2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 s2)
	...
	(:action observe1_drive-truck_truck1_s2_s0_driver3
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver3 truck1)
	...
	(:action observe2_load-truck_package1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package1 s0)
	...
	(:action observe3_load-truck_package2_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(at package2 s1)
	...
	(:action observe5_unload-truck_package7_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package7 truck1)
	...
	(:action observe8_walk_driver2_s0_p2-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observation7)
