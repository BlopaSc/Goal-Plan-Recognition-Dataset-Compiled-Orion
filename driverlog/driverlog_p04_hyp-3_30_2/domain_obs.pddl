(define
	...
	(:action observe0_drive-truck_truck2_s2_s0_driver3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s2)
	...
	(:action observe1_walk_driver3_s0_p2-0
		:parameters ()
		:precondition (and
			(at driver3 s0)
			(observation0)
	...
	(:action observe2_disembark-truck_driver3_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver3 truck3)
	...
	(:action observe5_drive-truck_truck1_s0_s2_driver3
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver3 truck1)
