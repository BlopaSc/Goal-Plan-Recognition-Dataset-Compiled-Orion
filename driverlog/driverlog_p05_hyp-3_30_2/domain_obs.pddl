(define
	...
	(:action observe0_load-truck_package3_truck2_s0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s0)
	...
	(:action observe2_disembark-truck_driver2_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver2 truck3)
	...
	(:action observe4_drive-truck_truck2_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe6_unload-truck_package5_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package5 truck2)
