(define
	...
	(:action observe0_unload-truck_package4_truck2_s2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s2)
	...
	(:action observe1_drive-truck_truck2_s2_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver1 truck2)
	...
	(:action observe2_unload-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package2 truck2)
	...
	(:action observe3_drive-truck_truck2_s1_s0_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe4_walk_driver2_p0-2_s0
		:parameters ()
		:precondition (and
			(at driver2 p0-2)
			(observation3)
