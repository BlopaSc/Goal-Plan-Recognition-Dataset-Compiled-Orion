(define
	...
	(:action observe0_board-truck_driver2_truck1_s0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 s0)
	...
	(:action observe1_unload-truck_package2_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package2 truck1)
	...
	(:action observe2_drive-truck_truck1_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver2 truck1)
	...
	(:action observe3_walk_driver1_s2_p1-2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(observation2)
