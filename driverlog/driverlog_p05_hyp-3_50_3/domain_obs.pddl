(define
	...
	(:action observe0_drive-truck_truck2_s2_s0_driver1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s2)
	...
	(:action observe1_load-truck_package4_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(at package4 s0)
	...
	(:action observe6_disembark-truck_driver2_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver2 truck3)
	...
	(:action observe7_drive-truck_truck2_s0_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver1 truck2)
	...
	(:action observe9_unload-truck_package4_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(in package4 truck2)
