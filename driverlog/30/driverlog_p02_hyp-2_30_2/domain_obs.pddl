...
(define
	...
	(:action observe0_drive-truck_truck2_s1_s0_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe1_board-truck_driver3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(empty truck1)
	...
	(:action observe2_unload-truck_package1_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package1 truck2)
	...
	(:action observe4_walk_driver2_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver2 p2-1)
			(observed obs3)
