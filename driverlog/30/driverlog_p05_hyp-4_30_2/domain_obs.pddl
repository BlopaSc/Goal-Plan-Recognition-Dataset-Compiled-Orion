...
(define
	...
	(:action observe0_walk_driver2_p2-0_s2
		:parameters ()
		:precondition (and
			(at driver2 p2-0)
			(not (observed obs0))
	...
	(:action observe1_load-truck_package1_truck3_s0
		:parameters ()
		:precondition (and
			(at package1 s0)
			(at truck3 s0)
	...
	(:action observe2_unload-truck_package7_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package7 truck3)
	...
	(:action observe3_unload-truck_package3_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package3 truck3)
