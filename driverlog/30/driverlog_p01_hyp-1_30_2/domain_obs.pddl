...
(define
	...
	(:action observe0_load-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at package3 s2)
			(at truck1 s2)
	...
	(:action observe1_load-truck_package2_truck1_s0
		:parameters ()
		:precondition (and
			(at package2 s0)
			(at truck1 s0)
	...
	(:action observe2_walk_driver2_s0_p0-2
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observed obs1)
	...
	(:action observe3_drive-truck_truck1_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver1 truck1)
