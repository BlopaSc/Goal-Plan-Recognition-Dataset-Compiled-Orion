...
(define
	...
	(:action observe1_load-truck_package3_truck2_s2
		:parameters ()
		:precondition (and
			(at package3 s2)
			(at truck2 s2)
	...
	(:action observe2_unload-truck_package5_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package5 truck2)
	...
	(:action observe3_unload-truck_package4_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package4 truck2)
	...
	(:action observe4_drive-truck_truck2_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver2 truck2)
	...
	(:action observe5_unload-truck_package2_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(in package2 truck2)
