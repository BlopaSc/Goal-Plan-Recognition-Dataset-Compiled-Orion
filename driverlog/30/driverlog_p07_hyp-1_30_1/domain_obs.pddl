...
(define
	...
	(:action observe3_drive-truck_truck2_s0_s7_driver2
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver2 truck2)
	...
	(:action observe4_load-truck_package3_truck2_s9
		:parameters ()
		:precondition (and
			(at package3 s9)
			(at truck2 s9)
	...
	(:action observe5_unload-truck_package4_truck2_s8
		:parameters ()
		:precondition (and
			(at truck2 s8)
			(in package4 truck2)
	...
	(:action observe6_disembark-truck_driver2_truck2_s8
		:parameters ()
		:precondition (and
			(at truck2 s8)
			(driving driver2 truck2)
	...
	(:action observe7_board-truck_driver2_truck3_s8
		:parameters ()
		:precondition (and
			(at truck3 s8)
			(empty truck3)
