...
(define
	...
	(:action observe1_drive-truck_truck1_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver3 truck1)
	...
	(:action observe3_unload-truck_package1_truck1_s1
		:parameters ()
		:precondition (and
			(in package1 truck1)
			(at truck1 s1)
	...
	(:action observe6_walk_driver1_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver1 s0)
			(observed obs5)
	...
	(:action observe8_walk_driver2_p2-0_s2
		:parameters ()
		:precondition (and
			(at driver2 p2-0)
			(observed obs7)
