...
(define
	...
	(:action observe0_board-truck_driver2_truck2_s0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(empty truck2)
	...
	(:action observe2_load-truck_package5_truck2_s1
		:parameters ()
		:precondition (and
			(at package5 s1)
			(at truck2 s1)
	...
	(:action observe3_unload-truck_package3_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package3 truck2)
	...
	(:action observe4_load-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at package2 s1)
			(at truck2 s1)
	...
	(:action observe5_drive-truck_truck2_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver2 truck2)
