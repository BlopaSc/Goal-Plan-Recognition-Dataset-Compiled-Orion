...
(define
	...
	(:action observe3_drive-truck_truck2_s9_s3_driver2
		:parameters ()
		:precondition (and
			(at truck2 s9)
			(driving driver2 truck2)
	...
	(:action observe4_unload-truck_package3_truck2_s3
		:parameters ()
		:precondition (and
			(at truck2 s3)
			(in package3 truck2)
	...
	(:action observe5_unload-truck_package1_truck2_s3
		:parameters ()
		:precondition (and
			(in package1 truck2)
			(at truck2 s3)
	...
	(:action observe6_drive-truck_truck2_s3_s0_driver2
		:parameters ()
		:precondition (and
			(at truck2 s3)
			(driving driver2 truck2)
	...
	(:action observe7_unload-truck_package4_truck2_s8
		:parameters ()
		:precondition (and
			(at truck2 s8)
			(in package4 truck2)
