...
(define
	...
	(:action observe4_unload-truck_package6_truck3_s7
		:parameters ()
		:precondition (and
			(at truck3 s7)
			(in package6 truck3)
	...
	(:action observe5_unload-truck_package4_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(in package4 truck3)
	...
	(:action observe6_drive-truck_truck3_s0_s4_driver1
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(driving driver1 truck3)
	...
	(:action observe7_disembark-truck_driver1_truck3_s4
		:parameters ()
		:precondition (and
			(at truck3 s4)
			(driving driver1 truck3)
	...
	(:action observe8_walk_driver1_s4_p11-4
		:parameters ()
		:precondition (and
			(at driver1 s4)
			(observed obs7)
