(define
	...
	(:action observe0_load-truck_package3_truck1_s1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 s1)
	...
	(:action observe1_drive-truck_truck1_s0_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
	...
	(:action observe2_unload-truck_package1_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package1 truck1)
	...
	(:action observe3_drive-truck_truck1_s2_s1_driver1
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe4_disembark-truck_driver1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
