...
(define
	...
	(:action observe1_load-truck_package1_truck2_s0
		:parameters ()
		:precondition (and
			(at package1 s0)
			(at truck2 s0)
	...
	(:action observe2_walk_driver3_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observed obs1)
	...
	(:action observe5_drive-truck_truck2_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe6_unload-truck_package3_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(in package3 truck1)
	...
	(:action observe7_walk_driver2_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver2 p2-1)
			(observed obs6)
