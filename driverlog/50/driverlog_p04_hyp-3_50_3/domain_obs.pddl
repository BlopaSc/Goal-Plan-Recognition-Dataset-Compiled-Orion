...
(define
	...
	(:action observe1_drive-truck_truck2_s2_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver3 truck2)
	...
	(:action observe2_walk_driver3_p2-0_s2
		:parameters ()
		:precondition (and
			(at driver3 p2-0)
			(observed obs1)
	...
	(:action observe3_board-truck_driver3_truck3_s2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(empty truck3)
	...
	(:action observe4_drive-truck_truck3_s2_s1_driver3
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver3 truck3)
	...
	(:action observe5_walk_driver3_p2-1_s2
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observed obs4)
	...
	(:action observe6_load-truck_package6_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(at package6 s2)
	...
	(:action observe7_drive-truck_truck1_s2_s0_driver3
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver3 truck1)
	...
	(:action observe11_walk_driver2_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observed obs10)
	...
	(:action observe12_unload-truck_package5_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package5 truck1)
	...
	(:action observe13_walk_driver2_p1-0_s1
		:parameters ()
		:precondition (and
			(at driver2 p1-0)
			(observed obs12)
