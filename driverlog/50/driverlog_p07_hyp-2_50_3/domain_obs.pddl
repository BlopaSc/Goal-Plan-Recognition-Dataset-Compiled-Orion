...
(define
	...
	(:action observe2_drive-truck_truck1_s2_s3_driver2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver2 truck1)
	...
	(:action observe3_load-truck_package4_truck1_s3
		:parameters ()
		:precondition (and
			(at package4 s3)
			(at truck1 s3)
	...
	(:action observe4_drive-truck_truck1_s3_s9_driver2
		:parameters ()
		:precondition (and
			(at truck1 s3)
			(driving driver2 truck1)
	...
	(:action observe5_unload-truck_package3_truck1_s4
		:parameters ()
		:precondition (and
			(at truck1 s4)
			(in package3 truck1)
	...
	(:action observe9_drive-truck_truck3_s1_s5_driver2
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver2 truck3)
	...
	(:action observe11_unload-truck_package1_truck3_s0
		:parameters ()
		:precondition (and
			(in package1 truck3)
			(at truck3 s0)
