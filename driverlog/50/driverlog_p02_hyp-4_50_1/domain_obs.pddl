...
(define
	...
	(:action observe0_load-truck_package4_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(at package4 s1)
	...
	(:action observe2_drive-truck_truck1_s0_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
	...
	(:action observe3_unload-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package3 truck1)
	...
	(:action observe4_unload-truck_package1_truck1_s2
		:parameters ()
		:precondition (and
			(in package1 truck1)
			(at truck1 s2)
	...
	(:action observe5_load-truck_package2_truck1_s2
		:parameters ()
		:precondition (and
			(at package2 s2)
			(at truck1 s2)
	...
	(:action observe7_drive-truck_truck1_s1_s0_driver1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver1 truck1)
