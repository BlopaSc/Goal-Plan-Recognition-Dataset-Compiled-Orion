...
(define
	...
	(:action observe3_board-truck_driver2_truck2_s0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(empty truck2)
	...
	(:action observe4_unload-truck_package3_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package3 truck2)
	...
	(:action observe5_drive-truck_truck2_s0_s1_driver2
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver2 truck2)
	...
	(:action observe7_drive-truck_truck2_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver2 truck2)
