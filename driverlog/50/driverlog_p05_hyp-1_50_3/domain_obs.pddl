...
(define
	...
	(:action observe0_walk_driver2_p1-0_s1
		:parameters ()
		:precondition (and
			(at driver2 p1-0)
			(not (observed obs0))
	...
	(:action observe2_board-truck_driver1_truck1_s2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(at truck1 s2)
	...
	(:action observe3_drive-truck_truck1_s2_s0_driver1
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe4_drive-truck_truck2_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe6_load-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at package2 s1)
			(at truck2 s1)
	...
	(:action observe7_unload-truck_package1_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package1 truck2)
	...
	(:action observe8_unload-truck_package7_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package7 truck2)
	...
	(:action observe9_drive-truck_truck1_s0_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
	...
	(:action observe10_unload-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package3 truck1)
	...
	(:action observe11_unload-truck_package2_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package2 truck2)
