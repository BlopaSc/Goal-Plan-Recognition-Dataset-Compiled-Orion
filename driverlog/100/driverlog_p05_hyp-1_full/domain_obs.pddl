...
(define
	...
	(:action observe0_walk_driver2_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(not (observed obs0))
	...
	(:action observe1_walk_driver2_p1-0_s1
		:parameters ()
		:precondition (and
			(at driver2 p1-0)
			(observed obs0)
	...
	(:action observe2_walk_driver3_s1_p2-1
		:parameters ()
		:precondition (and
			(at driver3 s1)
			(observed obs1)
	...
	(:action observe3_walk_driver3_p2-1_s2
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observed obs2)
	...
	(:action observe4_board-truck_driver3_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(empty truck2)
	...
	(:action observe5_drive-truck_truck2_s2_s1_driver3
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver3 truck2)
	...
	(:action observe6_board-truck_driver1_truck1_s2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(at truck1 s2)
	...
	(:action observe7_drive-truck_truck1_s2_s0_driver1
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe9_drive-truck_truck2_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe10_load-truck_package1_truck2_s0
		:parameters ()
		:precondition (and
			(at package1 s0)
			(at truck2 s0)
	...
	(:action observe11_drive-truck_truck2_s0_s2_driver3
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver3 truck2)
	...
	(:action observe12_load-truck_package7_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(at package7 s2)
	...
	(:action observe13_drive-truck_truck2_s2_s1_driver3
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver3 truck2)
	...
	(:action observe14_load-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at package2 s1)
			(at truck2 s1)
	...
	(:action observe15_unload-truck_package1_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package1 truck2)
	...
	(:action observe16_unload-truck_package7_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package7 truck2)
	...
	(:action observe17_drive-truck_truck1_s0_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
	...
	(:action observe18_disembark-truck_driver1_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe19_unload-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package3 truck1)
	...
	(:action observe20_drive-truck_truck2_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe21_unload-truck_package2_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package2 truck2)
	...
	(:action observe22_drive-truck_truck2_s0_s1_driver3
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver3 truck2)
