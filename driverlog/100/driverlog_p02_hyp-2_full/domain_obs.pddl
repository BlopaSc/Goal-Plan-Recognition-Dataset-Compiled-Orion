...
(define
	...
	(:constants
		...
		p0-1 p0-2 p2-1 s0 s1 s2 - location__inferred_type
	...
	(:action observe1_drive-truck_truck2_s1_s0_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe2_walk_driver3_s2_p2-1
		:parameters ()
		:precondition (and
			(at driver3 s2)
			(observed obs1)
	...
	(:action observe3_load-truck_package1_truck2_s0
		:parameters ()
		:precondition (and
			(at package1 s0)
			(at truck2 s0)
	...
	(:action observe4_walk_driver3_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observed obs3)
	...
	(:action observe5_drive-truck_truck2_s0_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver1 truck2)
	...
	(:action observe6_board-truck_driver3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(empty truck1)
	...
	(:action observe7_load-truck_package3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(at package3 s1)
	...
	(:action observe8_unload-truck_package1_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package1 truck2)
	...
	(:action observe9_drive-truck_truck1_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver3 truck1)
	...
	(:action observe10_walk_driver2_s2_p2-1
		:parameters ()
		:precondition (and
			(at driver2 s2)
			(observed obs9)
	...
	(:action observe11_drive-truck_truck2_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe12_unload-truck_package3_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(in package3 truck1)
	...
	(:action observe13_walk_driver2_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver2 p2-1)
			(observed obs12)
	...
	(:action observe14_disembark-truck_driver1_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver1 truck2)
