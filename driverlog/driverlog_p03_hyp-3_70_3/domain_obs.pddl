(define
	...
	(:action observe0_walk_driver1_p1-2_s1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at driver1 p1-2)
	...
	(:action observe1_walk_driver1_s1_p1-0
		:parameters ()
		:precondition (and
			(at driver1 s1)
			(observation0)
	...
	(:action observe2_walk_driver1_p1-0_s0
		:parameters ()
		:precondition (and
			(at driver1 p1-0)
			(observation1)
	...
	(:action observe3_board-truck_driver1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at driver1 s0)
	...
	(:action observe5_unload-truck_package2_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package2 truck1)
	...
	(:action observe6_disembark-truck_driver1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
