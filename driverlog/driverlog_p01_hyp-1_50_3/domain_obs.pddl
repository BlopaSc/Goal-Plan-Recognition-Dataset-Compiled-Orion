(define
	...
	(:action observe3_walk_driver2_s0_p0-2
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observation2)
	...
	(:action observe4_unload-truck_package3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package3 truck1)
	...
	(:action observe5_walk_driver2_p0-2_s2
		:parameters ()
		:precondition (and
			(at driver2 p0-2)
			(observation4)
	...
	(:action observe6_drive-truck_truck1_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver1 truck1)
