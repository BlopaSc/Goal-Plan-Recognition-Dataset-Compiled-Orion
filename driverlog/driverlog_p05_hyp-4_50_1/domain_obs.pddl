(define
	...
	(:action observe4_load-truck_package3_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(at package3 s0)
	...
	(:action observe5_drive-truck_truck3_s0_s1_driver2
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(driving driver2 truck3)
	...
	(:action observe6_unload-truck_package7_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package7 truck3)
	...
	(:action observe7_unload-truck_package3_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package3 truck3)
