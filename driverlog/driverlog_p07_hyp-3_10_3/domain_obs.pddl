(define
	...
	(:action observe0_unload-truck_package5_truck2_s3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s3)
	...
	(:action observe1_load-truck_package2_truck2_s5
		:parameters ()
		:precondition (and
			(at truck2 s5)
			(at package2 s5)
	...
	(:action observe2_drive-truck_truck2_s8_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s8)
			(driving driver3 truck2)
	...
	(:action observe3_walk_driver1_s9_p7-9
		:parameters ()
		:precondition (and
			(at driver1 s9)
			(observation2)
	...
	(:action observe4_drive-truck_truck3_s1_s3_driver1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver1 truck3)
