(define
	...
	(:action observe3_drive-truck_truck1_s0_s1_driver3
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver3 truck1)
	...
	(:action observe4_load-truck_package7_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(at package7 s2)
	...
	(:action observe7_load-truck_package4_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package4 s0)
	...
	(:action observe8_walk_driver1_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver1 s0)
			(observation7)
