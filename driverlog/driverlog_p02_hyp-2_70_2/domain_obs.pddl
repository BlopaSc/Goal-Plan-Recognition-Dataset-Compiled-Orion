(define
	...
	(:action observe0_walk_driver3_s2_p2-1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at driver3 s2)
	...
	(:action observe1_walk_driver3_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observation0)
	...
	(:action observe2_drive-truck_truck2_s0_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver1 truck2)
	...
	(:action observe3_board-truck_driver3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(at driver3 s1)
	...
	(:action observe4_load-truck_package3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(at package3 s1)
	...
	(:action observe5_unload-truck_package1_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package1 truck2)
	...
	(:action observe7_walk_driver2_s2_p2-1
		:parameters ()
		:precondition (and
			(at driver2 s2)
			(observation6)
	...
	(:action observe9_unload-truck_package3_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(in package3 truck1)
	...
	(:action observe10_walk_driver2_p2-1_s1
		:parameters ()
		:precondition (and
			(at driver2 p2-1)
			(observation9)
