(define
	...
	(:action observe1_drive-truck_truck1_s3_s9_driver2
		:parameters ()
		:precondition (and
			(at truck1 s3)
			(driving driver2 truck1)
	...
	(:action observe2_load-truck_package3_truck1_s9
		:parameters ()
		:precondition (and
			(at truck1 s9)
			(at package3 s9)
	...
	(:action observe7_walk_driver2_s6_p6-8
		:parameters ()
		:precondition (and
			(at driver2 s6)
			(observation6)
	...
	(:action observe9_drive-truck_truck3_s5_s0_driver2
		:parameters ()
		:precondition (and
			(at truck3 s5)
			(driving driver2 truck3)
