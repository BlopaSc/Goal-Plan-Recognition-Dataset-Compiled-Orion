(define
	...
	(:action observe6_load-truck_package1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package1 s0)
	...
	(:action observe7_drive-truck_truck1_s0_s1_driver2
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver2 truck1)
	...
	(:action observe9_drive-truck_truck1_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver2 truck1)
	...
	(:action observe10_walk_driver1_s2_p1-2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(observation9)
	...
	(:action observe11_unload-truck_package1_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package1 truck1)
	...
	(:action observe12_walk_driver1_p1-2_s1
		:parameters ()
		:precondition (and
			(at driver1 p1-2)
			(observation11)
