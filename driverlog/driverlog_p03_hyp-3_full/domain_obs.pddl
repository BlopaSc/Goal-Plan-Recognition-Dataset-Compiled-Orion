(define
	...
	(:action observe2_walk_driver1_s1_p1-0
		:parameters ()
		:precondition (and
			(at driver1 s1)
			(observation1)
	...
	(:action observe3_walk_driver1_p1-0_s0
		:parameters ()
		:precondition (and
			(at driver1 p1-0)
			(observation2)
	...
	(:action observe4_board-truck_driver1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at driver1 s0)
	...
	(:action observe7_unload-truck_package2_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package2 truck1)
	...
	(:action observe8_drive-truck_truck1_s2_s0_driver1
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe9_disembark-truck_driver1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
