(define
	...
	(:action observe0_walk_driver2_p2-7_s2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at driver2 p2-7)
	...
	(:action observe1_drive-truck_truck3_s2_s3_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe2_drive-truck_truck3_s2_s0_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe3_unload-truck_package1_truck3_s5
		:parameters ()
		:precondition (and
			(at truck3 s5)
			(in package1 truck3)
	...
	(:action observe4_drive-truck_truck3_s5_s3_driver2
		:parameters ()
		:precondition (and
			(at truck3 s5)
			(driving driver2 truck3)
