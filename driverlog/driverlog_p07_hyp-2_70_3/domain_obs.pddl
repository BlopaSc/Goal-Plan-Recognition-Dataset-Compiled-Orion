(define
	...
	(:action observe7_walk_driver2_p6-8_s8
		:parameters ()
		:precondition (and
			(at driver2 p6-8)
			(observation6)
	...
	(:action observe8_board-truck_driver2_truck3_s8
		:parameters ()
		:precondition (and
			(at truck3 s8)
			(at driver2 s8)
	...
	(:action observe16_unload-truck_package1_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(in package1 truck3)
	...
	(:action observe17_drive-truck_truck3_s0_s3_driver2
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(driving driver2 truck3)
