(define
	...
	(:action observe4_drive-truck_truck2_s2_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver1 truck2)
	...
	(:action observe5_unload-truck_package4_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package4 truck2)
	...
	(:action observe7_walk_driver2_s0_p0-1
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observation6)
	...
	(:action observe9_walk_driver2_p0-1_s1
		:parameters ()
		:precondition (and
			(at driver2 p0-1)
			(observation8)
