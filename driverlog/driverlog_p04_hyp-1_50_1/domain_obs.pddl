(define
	...
	(:action observe2_disembark-truck_driver3_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe3_walk_driver3_s1_p2-1
		:parameters ()
		:precondition (and
			(at driver3 s1)
			(observation2)
	...
	(:action observe7_unload-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package3 truck1)
	...
	(:action observe9_load-truck_package4_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package4 s0)
	...
	(:action observe10_unload-truck_package4_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package4 truck1)
