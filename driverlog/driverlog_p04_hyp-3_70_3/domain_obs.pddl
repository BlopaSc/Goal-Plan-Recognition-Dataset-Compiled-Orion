(define
	...
	(:action observe4_board-truck_driver3_truck3_s2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(at driver3 s2)
	...
	(:action observe5_disembark-truck_driver3_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver3 truck3)
	...
	(:action observe6_walk_driver3_s1_p2-1
		:parameters ()
		:precondition (and
			(at driver3 s1)
			(observation5)
	...
	(:action observe7_walk_driver3_p2-1_s2
		:parameters ()
		:precondition (and
			(at driver3 p2-1)
			(observation6)
	...
	(:action observe9_load-truck_package1_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package1 s0)
	...
	(:action observe10_unload-truck_package6_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(in package6 truck1)
	...
	(:action observe14_load-truck_package3_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package3 s0)
	...
	(:action observe18_walk_driver2_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observation17)
