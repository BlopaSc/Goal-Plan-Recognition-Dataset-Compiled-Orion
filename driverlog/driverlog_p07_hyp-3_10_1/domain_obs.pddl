(define
	...
	(:action observe0_load-truck_package2_truck2_s5
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s5)
	...
	(:action observe1_load-truck_package1_truck2_s5
		:parameters ()
		:precondition (and
			(at truck2 s5)
			(at package1 s5)
	...
	(:action observe3_drive-truck_truck2_s0_s8_driver3
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver3 truck2)
	...
	(:action observe4_walk_driver1_s9_p7-9
		:parameters ()
		:precondition (and
			(at driver1 s9)
			(observation3)
