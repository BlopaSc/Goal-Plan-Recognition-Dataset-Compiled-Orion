(define
	...
	(:action observe1_walk_driver1_s0_p0-2
		:parameters ()
		:precondition (and
			(at driver1 s0)
			(observation0)
	...
	(:action observe6_load-truck_package1_truck2_s4
		:parameters ()
		:precondition (and
			(at truck2 s4)
			(at package1 s4)
	...
	(:action observe7_drive-truck_truck2_s4_s1_driver2
		:parameters ()
		:precondition (and
			(at truck2 s4)
			(driving driver2 truck2)
	...
	(:action observe8_unload-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package2 truck2)
	...
	(:action observe9_drive-truck_truck2_s10_s5_driver2
		:parameters ()
		:precondition (and
			(at truck2 s10)
			(driving driver2 truck2)
	...
	(:action observe18_walk_driver1_p2-7_s2
		:parameters ()
		:precondition (and
			(at driver1 p2-7)
			(observation17)
