...
(define
	...
	(:action observe0_drive-truck_truck3_s2_s3_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe1_drive-truck_truck3_s0_s11_driver2
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(driving driver2 truck3)
	...
	(:action observe2_drive-truck_truck3_s11_s3_driver2
		:parameters ()
		:precondition (and
			(at truck3 s11)
			(driving driver2 truck3)
	...
	(:action observe3_unload-truck_package2_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(in package2 truck3)
