(define
	...
	(:action observe0_drive-truck_truck1_s3_s6_driver3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 s3)
	...
	(:action observe1_disembark-truck_driver3_truck1_s6
		:parameters ()
		:precondition (and
			(at truck1 s6)
			(driving driver3 truck1)
	...
	(:action observe2_drive-truck_truck3_s1_s3_driver3
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(driving driver3 truck3)
	...
	(:action observe3_load-truck_package1_truck3_s5
		:parameters ()
		:precondition (and
			(at truck3 s5)
			(at package1 s5)
	...
	(:action observe4_load-truck_package4_truck3_s3
		:parameters ()
		:precondition (and
			(at truck3 s3)
			(at package4 s3)
