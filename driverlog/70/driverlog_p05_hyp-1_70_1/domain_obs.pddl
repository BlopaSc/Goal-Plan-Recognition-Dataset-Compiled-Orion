...
(define
	...
	(:action observe5_board-truck_driver1_truck1_s2
		:parameters ()
		:precondition (and
			(at driver1 s2)
			(at truck1 s2)
	...
	(:action observe6_drive-truck_truck1_s2_s0_driver1
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver1 truck1)
	...
	(:action observe7_load-truck_package3_truck1_s0
		:parameters ()
		:precondition (and
			(at package3 s0)
			(at truck1 s0)
	...
	(:action observe8_drive-truck_truck2_s1_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe10_drive-truck_truck2_s2_s1_driver3
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver3 truck2)
	...
	(:action observe13_unload-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package3 truck1)
