...
(define
	...
	(:action observe1_load-truck_package4_truck1_s2
		:parameters ()
		:precondition (and
			(at package4 s2)
			(at truck1 s2)
	...
	(:action observe2_load-truck_package3_truck1_s2
		:parameters ()
		:precondition (and
			(at package3 s2)
			(at truck1 s2)
	...
	(:action observe4_drive-truck_truck1_s0_s1_driver1
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver1 truck1)
	...
	(:action observe5_walk_driver2_s0_p0-2
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observed obs4)
	...
	(:action observe6_unload-truck_package3_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package3 truck1)
	...
	(:action observe7_unload-truck_package2_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package2 truck1)
	...
	(:action observe8_walk_driver2_p0-2_s2
		:parameters ()
		:precondition (and
			(at driver2 p0-2)
			(observed obs7)
