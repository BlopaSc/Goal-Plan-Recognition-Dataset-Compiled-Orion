...
(define
	...
	(:action observe2_walk_driver2_s1_p1-0
		:parameters ()
		:precondition (and
			(at driver2 s1)
			(observed obs1)
	...
	(:action observe3_walk_driver2_p1-0_s0
		:parameters ()
		:precondition (and
			(at driver2 p1-0)
			(observed obs2)
	...
	(:action observe4_board-truck_driver2_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(empty truck1)
	...
	(:action observe5_load-truck_package2_truck1_s0
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(at package2 s0)
	...
	(:action observe6_drive-truck_truck1_s0_s1_driver2
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver2 truck1)
	...
	(:action observe7_drive-truck_truck1_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver2 truck1)
	...
	(:action observe9_walk_driver1_p1-2_s1
		:parameters ()
		:precondition (and
			(at driver1 p1-2)
			(observed obs8)
