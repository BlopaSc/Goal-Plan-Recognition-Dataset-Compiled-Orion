...
(define
	...
	(:action observe1_load-truck_package7_truck3_s2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(at package7 s2)
	...
	(:action observe2_walk_driver2_s0_p2-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observed obs1)
	...
	(:action observe3_walk_driver2_p2-0_s2
		:parameters ()
		:precondition (and
			(at driver2 p2-0)
			(observed obs2)
	...
	(:action observe4_board-truck_driver2_truck3_s2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(empty truck3)
	...
	(:action observe5_drive-truck_truck3_s2_s0_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe6_load-truck_package3_truck3_s0
		:parameters ()
		:precondition (and
			(at package3 s0)
			(at truck3 s0)
	...
	(:action observe7_load-truck_package1_truck3_s0
		:parameters ()
		:precondition (and
			(at package1 s0)
			(at truck3 s0)
	...
	(:action observe8_unload-truck_package7_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package7 truck3)
	...
	(:action observe9_unload-truck_package3_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package3 truck3)
	...
	(:action observe10_unload-truck_package1_truck3_s1
		:parameters ()
		:precondition (and
			(at truck3 s1)
			(in package1 truck3)
	...
	(:action observe11_load-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at package2 s1)
			(at truck2 s1)
	...
	(:action observe12_drive-truck_truck2_s1_s2_driver3
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver3 truck2)
	...
	(:action observe13_drive-truck_truck2_s2_s0_driver3
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver3 truck2)
