...
(define
	...
	(:action observe6_drive-truck_truck1_s0_s1_driver3
		:parameters ()
		:precondition (and
			(at truck1 s0)
			(driving driver3 truck1)
	...
	(:action observe7_load-truck_package2_truck1_s1
		:parameters ()
		:precondition (and
			(at package2 s1)
			(at truck1 s1)
	...
	(:action observe8_unload-truck_package1_truck1_s1
		:parameters ()
		:precondition (and
			(in package1 truck1)
			(at truck1 s1)
	...
	(:action observe9_load-truck_package7_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(at package7 s2)
	...
	(:action observe10_unload-truck_package2_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package2 truck1)
	...
	(:action observe11_drive-truck_truck1_s2_s1_driver3
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver3 truck1)
	...
	(:action observe12_unload-truck_package7_truck1_s1
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(in package7 truck1)
	...
	(:action observe13_drive-truck_truck1_s1_s2_driver3
		:parameters ()
		:precondition (and
			(at truck1 s1)
			(driving driver3 truck1)
	...
	(:action observe14_unload-truck_package5_truck1_s2
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(in package5 truck1)
	...
	(:action observe16_drive-truck_truck1_s2_s0_driver3
		:parameters ()
		:precondition (and
			(at truck1 s2)
			(driving driver3 truck1)
	...
	(:action observe17_load-truck_package4_truck1_s0
		:parameters ()
		:precondition (and
			(at package4 s0)
			(at truck1 s0)
	...
	(:action observe18_disembark-truck_driver1_truck3_s0
		:parameters ()
		:precondition (and
			(at truck3 s0)
			(driving driver1 truck3)
	...
	(:action observe19_walk_driver1_s0_p1-0
		:parameters ()
		:precondition (and
			(at driver1 s0)
			(observed obs18)
