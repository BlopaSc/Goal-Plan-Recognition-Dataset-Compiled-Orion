...
(define
	...
	(:constants
		package1 package2 package3 package4 package5 - obj__inferred_type
		truck1 truck2 - truck__inferred_type
		p0-1 p0-2 p1-2 s0 s1 s2 - location__inferred_type
	...
	(:action observe0_drive-truck_truck2_s1_s2_driver1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver1 truck2)
	...
	(:action observe1_load-truck_package4_truck2_s2
		:parameters ()
		:precondition (and
			(at package4 s2)
			(at truck2 s2)
	...
	(:action observe2_load-truck_package3_truck2_s2
		:parameters ()
		:precondition (and
			(at package3 s2)
			(at truck2 s2)
	...
	(:action observe5_unload-truck_package5_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package5 truck2)
	...
	(:action observe6_unload-truck_package3_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(in package3 truck2)
	...
	(:action observe7_load-truck_package2_truck2_s0
		:parameters ()
		:precondition (and
			(at package2 s0)
			(at truck2 s0)
	...
	(:action observe11_drive-truck_truck2_s1_s2_driver2
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver2 truck2)
