...
(define
	...
	(:action observe2_load-truck_package7_truck3_s2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(at package7 s2)
	...
	(:action observe3_walk_driver2_s0_p2-0
		:parameters ()
		:precondition (and
			(at driver2 s0)
			(observed obs2)
	...
	(:action observe4_walk_driver2_p2-0_s2
		:parameters ()
		:precondition (and
			(at driver2 p2-0)
			(observed obs3)
	...
	(:action observe6_drive-truck_truck3_s2_s0_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe7_load-truck_package3_truck3_s0
		:parameters ()
		:precondition (and
			(at package3 s0)
			(at truck3 s0)
