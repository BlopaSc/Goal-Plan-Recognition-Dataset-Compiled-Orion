...
(define
	...
	(:action observe2_load-truck_package2_truck2_s2
		:parameters ()
		:precondition (and
			(at package2 s2)
			(at truck2 s2)
	...
	(:action observe3_drive-truck_truck2_s2_s1_driver1
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(driving driver1 truck2)
	...
	(:action observe4_unload-truck_package2_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package2 truck2)
	...
	(:action observe6_walk_driver2_p0-2_s0
		:parameters ()
		:precondition (and
			(at driver2 p0-2)
			(observed obs5)
	...
	(:action observe7_disembark-truck_driver1_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver1 truck2)
