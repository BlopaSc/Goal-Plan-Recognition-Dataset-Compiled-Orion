...
(define
	...
	(:action observe6_drive-truck_truck3_s2_s1_driver2
		:parameters ()
		:precondition (and
			(at truck3 s2)
			(driving driver2 truck3)
	...
	(:action observe8_load-truck_package5_truck2_s1
		:parameters ()
		:precondition (and
			(at package5 s1)
			(at truck2 s1)
	...
	(:action observe9_unload-truck_package3_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(in package3 truck2)
	...
	(:action observe12_unload-truck_package4_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(in package4 truck2)
