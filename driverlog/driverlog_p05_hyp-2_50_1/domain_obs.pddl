(define
	...
	(:action observe0_load-truck_package7_truck2_s2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck2 s2)
	...
	(:action observe2_disembark-truck_driver1_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(driving driver1 truck2)
	...
	(:action observe4_load-truck_package3_truck2_s0
		:parameters ()
		:precondition (and
			(at truck2 s0)
			(at package3 s0)
	...
	(:action observe6_unload-truck_package5_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(in package5 truck2)
	...
	(:action observe7_unload-truck_package4_truck2_s2
		:parameters ()
		:precondition (and
			(at truck2 s2)
			(in package4 truck2)
	...
	(:action observe9_disembark-truck_driver2_truck2_s1
		:parameters ()
		:precondition (and
			(at truck2 s1)
			(driving driver2 truck2)
