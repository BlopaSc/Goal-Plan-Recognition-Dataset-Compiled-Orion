(define
	...
	(:action observe2_turn_to_satellite0_star4_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observation1)
	...
	(:action observe6_turn_to_satellite0_phenomenon8_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observation5)
	...
	(:action observe8_calibrate_satellite1_instrument3_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(power_on instrument3)
	...
	(:action observe11_turn_to_satellite4_phenomenon7_groundstation1
		:parameters ()
		:precondition (and
			(pointing satellite4 groundstation1)
			(observation10)
