...
(define
	...
	(:action observe0_switch_on_instrument3_satellite1
		:parameters ()
		:precondition (and
			(power_avail satellite1)
			(not (observed obs0))
	...
	(:action observe1_calibrate_satellite1_instrument3_star0
		:parameters ()
		:precondition (and
			(pointing satellite1 star0)
			(power_on instrument3)
	...
	(:action observe2_turn_to_satellite1_star3_star0
		:parameters ()
		:precondition (and
			(pointing satellite1 star0)
			(observed obs1)
	...
	(:action observe3_take_image_satellite1_star3_instrument3_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite1 star3)
			(power_on instrument3)
	...
	(:action observe4_turn_to_satellite1_star4_star3
		:parameters ()
		:precondition (and
			(pointing satellite1 star3)
			(observed obs3)
	...
	(:action observe5_turn_to_satellite1_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observed obs4)
