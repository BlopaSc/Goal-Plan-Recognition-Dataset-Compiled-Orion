...
(define
	...
	(:action observe2_take_image_satellite0_star2_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 star2)
			(power_on instrument0)
	...
	(:action observe3_turn_to_satellite0_phenomenon6_star2
		:parameters ()
		:precondition (and
			(pointing satellite0 star2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_phenomenon6_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_phenomenon5_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs4)
