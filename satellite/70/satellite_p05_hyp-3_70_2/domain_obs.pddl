...
(define
	...
	(:action observe1_turn_to_satellite0_star4_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observed obs0)
	...
	(:action observe2_switch_on_instrument1_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observed obs1)
	...
	(:action observe3_calibrate_satellite0_instrument1_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument1)
	...
	(:action observe5_turn_to_satellite0_planet5_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_planet5_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 planet5)
			(power_on instrument1)
	...
	(:action observe7_turn_to_satellite0_phenomenon6_planet5
		:parameters ()
		:precondition (and
			(pointing satellite0 planet5)
			(observed obs6)
	...
	(:action observe8_take_image_satellite0_phenomenon6_instrument1_image4
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe9_take_image_satellite0_phenomenon8_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon8)
			(power_on instrument1)
	...
	(:action observe10_take_image_satellite0_planet10_instrument1_image4
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(power_on instrument1)
	...
	(:action observe11_switch_on_instrument3_satellite1
		:parameters ()
		:precondition (and
			(power_avail satellite1)
			(observed obs10)
	...
	(:action observe12_calibrate_satellite1_instrument3_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(power_on instrument3)
	...
	(:action observe13_turn_to_satellite1_star9_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(observed obs12)
	...
	(:action observe14_take_image_satellite1_star9_instrument3_image3
		:parameters ()
		:precondition (and
			(pointing satellite1 star9)
			(power_on instrument3)
	...
	(:action observe15_switch_on_instrument8_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observed obs14)
	...
	(:action observe16_calibrate_satellite4_instrument8_groundstation1
		:parameters ()
		:precondition (and
			(pointing satellite4 groundstation1)
			(power_on instrument8)
	...
	(:action observe17_take_image_satellite4_phenomenon7_instrument8_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite4 phenomenon7)
			(power_on instrument8)
	...
	(:action observe18_turn_to_satellite4_planet11_phenomenon7
		:parameters ()
		:precondition (and
			(pointing satellite4 phenomenon7)
			(observed obs17)
