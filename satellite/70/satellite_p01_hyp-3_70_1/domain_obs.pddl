...
(define
	...
	(:action observe2_turn_to_satellite0_star4_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs1)
	...
	(:action observe3_take_image_satellite0_star4_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe5_take_image_satellite0_phenomenon6_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite0_phenomenon7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs5)
