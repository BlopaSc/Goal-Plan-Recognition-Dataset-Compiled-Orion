...
(define
	...
	(:action observe0_turn_to_satellite0_star1_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(not (observed obs0))
	...
	(:action observe1_calibrate_satellite0_instrument0_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(power_on instrument0)
	...
	(:action observe2_turn_to_satellite0_star3_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs1)
	...
	(:action observe3_turn_to_satellite0_star4_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_star4_instrument0_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_phenomenon5_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument0)
