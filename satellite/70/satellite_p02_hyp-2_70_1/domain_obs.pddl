...
(define
	...
	(:action observe1_calibrate_satellite0_instrument1_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument1)
	...
	(:action observe2_turn_to_satellite0_planet3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs1)
	...
	(:action observe4_take_image_satellite0_planet4_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(power_on instrument1)
	...
	(:action observe6_take_image_satellite0_phenomenon5_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe8_take_image_satellite0_phenomenon6_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe9_turn_to_satellite0_star7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs8)
