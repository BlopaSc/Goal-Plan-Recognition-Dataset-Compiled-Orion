...
(define
	...
	(:action observe5_turn_to_satellite3_planet8_star6
		:parameters ()
		:precondition (and
			(pointing satellite3 star6)
			(observed obs4)
	...
	(:action observe6_switch_on_instrument2_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observed obs5)
	...
	(:action observe7_take_image_satellite3_planet8_instrument6_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(power_on instrument6)
	...
	(:action observe8_calibrate_satellite0_instrument2_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument2)
	...
	(:action observe9_turn_to_satellite3_planet11_planet8
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(observed obs8)
	...
	(:action observe10_turn_to_satellite0_planet9_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs9)
