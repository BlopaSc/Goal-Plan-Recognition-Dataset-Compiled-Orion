...
(define
	...
	(:action observe3_take_image_satellite0_phenomenon4_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(power_on instrument0)
	...
	(:action observe4_take_image_satellite0_star5_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(power_on instrument0)
	...
	(:action observe5_take_image_satellite0_phenomenon6_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite0_phenomenon3_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs5)
