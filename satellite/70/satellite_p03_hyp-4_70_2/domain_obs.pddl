...
(define
	...
	(:action observe0_calibrate_satellite0_instrument0_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument0)
	...
	(:action observe1_turn_to_satellite0_phenomenon4_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs0)
	...
	(:action observe4_turn_to_satellite0_phenomenon6_star5
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(observed obs3)
