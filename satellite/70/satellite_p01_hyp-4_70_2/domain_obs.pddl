...
(define
	...
	(:action observe1_turn_to_satellite0_star3_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite0_star4_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observed obs1)
	...
	(:action observe3_take_image_satellite0_star4_instrument0_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe4_turn_to_satellite0_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs3)
	...
	(:action observe5_take_image_satellite0_phenomenon5_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument0)
