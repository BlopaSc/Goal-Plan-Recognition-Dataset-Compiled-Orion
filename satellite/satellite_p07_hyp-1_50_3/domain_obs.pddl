(define
	...
	(:action observe4_turn_to_satellite0_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(observation3)
	...
	(:action observe5_turn_to_satellite0_planet10_planet8
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(observation4)
	...
	(:action observe6_take_image_satellite0_planet10_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe7_turn_to_satellite0_phenomenon5_planet10
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(observation6)
