(define
	...
	(:action observe1_take_image_satellite0_star4_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe2_take_image_satellite0_star4_instrument0_infrared0
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe4_take_image_satellite0_phenomenon7_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
