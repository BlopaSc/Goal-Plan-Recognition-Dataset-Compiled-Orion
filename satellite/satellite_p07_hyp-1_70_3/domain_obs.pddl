(define
	...
	(:action observe2_switch_on_instrument2_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observation1)
	...
	(:action observe6_take_image_satellite0_planet8_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe7_turn_to_satellite0_planet10_planet8
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(observation6)
	...
	(:action observe9_turn_to_satellite0_phenomenon5_planet10
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(observation8)
	...
	(:action observe10_turn_to_satellite3_groundstation0_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation2)
			(observation9)
	...
	(:action observe11_switch_on_instrument7_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observation10)
