(define
	...
	(:action observe7_take_image_satellite1_phenomenon12_instrument3_image2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe8_take_image_satellite1_phenomenon13_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe9_turn_to_satellite1_star14_phenomenon13
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon13)
			(observation8)
