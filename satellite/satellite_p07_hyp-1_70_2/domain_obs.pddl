(define
	...
	(:action observe3_calibrate_satellite0_instrument2_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument2)
	...
	(:action observe4_turn_to_satellite0_star1_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observation3)
	...
	(:action observe8_turn_to_satellite0_phenomenon5_planet10
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(observation7)
