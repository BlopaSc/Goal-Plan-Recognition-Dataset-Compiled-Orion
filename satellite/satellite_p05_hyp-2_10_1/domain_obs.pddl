(define
	...
	(:action observe0_turn_to_satellite1_star2_planet11
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite1 planet11)
	...
	(:action observe1_take_image_satellite1_planet10_instrument3_image2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe2_turn_to_satellite1_phenomenon12_planet11
		:parameters ()
		:precondition (and
			(pointing satellite1 planet11)
			(observation1)
