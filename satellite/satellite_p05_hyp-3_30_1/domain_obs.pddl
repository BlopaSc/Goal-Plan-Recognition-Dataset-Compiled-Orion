(define
	...
	(:action observe4_turn_to_satellite0_planet5_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observation3)
	...
	(:action observe5_turn_to_satellite0_phenomenon6_planet5
		:parameters ()
		:precondition (and
			(pointing satellite0 planet5)
			(observation4)
	...
	(:action observe6_turn_to_satellite4_phenomenon7_groundstation1
		:parameters ()
		:precondition (and
			(pointing satellite4 groundstation1)
			(observation5)
	...
	(:action observe7_take_image_satellite4_phenomenon7_instrument8_infrared1
		:parameters ()
		:precondition (and
			(calibrated instrument8)
			(power_on instrument8)
