(define
	...
	(:action observe3_take_image_satellite1_planet10_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe4_turn_to_satellite1_planet11_planet10
		:parameters ()
		:precondition (and
			(pointing satellite1 planet10)
			(observation3)
	...
	(:action observe6_take_image_satellite1_phenomenon12_instrument3_image2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
