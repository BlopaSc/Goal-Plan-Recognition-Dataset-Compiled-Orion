(define
	...
	(:action observe1_calibrate_satellite1_instrument3_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(power_on instrument3)
	...
	(:action observe2_take_image_satellite1_planet5_instrument3_image4
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe3_turn_to_satellite1_phenomenon6_planet5
		:parameters ()
		:precondition (and
			(pointing satellite1 planet5)
			(observation2)
	...
	(:action observe4_take_image_satellite1_planet10_instrument3_image4
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe6_turn_to_satellite0_phenomenon7_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observation5)
