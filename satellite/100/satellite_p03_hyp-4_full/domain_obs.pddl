...
(define
	...
	(:constants
		...
		groundstation1 groundstation2 phenomenon3 phenomenon4 phenomenon6 star0 star5 - direction__inferred_type
		instrument0 - instrument__inferred_type
		image1 spectrograph2 thermograph0 - mode__inferred_type
	...
	(:action observe2_calibrate_satellite0_instrument0_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument0)
	...
	(:action observe3_turn_to_satellite0_phenomenon4_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_phenomenon4_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_star5_phenomenon4
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_star5_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(power_on instrument0)
	...
	(:action observe7_turn_to_satellite0_phenomenon6_star5
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(observed obs6)
	...
	(:action observe8_take_image_satellite0_phenomenon6_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument0)
	...
	(:action observe9_turn_to_satellite0_phenomenon3_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs8)
