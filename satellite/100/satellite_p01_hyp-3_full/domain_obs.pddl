...
(define
	...
	(:constants
		satellite0 satellite1 - satellite__inferred_type
		phenomenon5 phenomenon6 phenomenon7 star0 star1 star2 star3 star4 - direction__inferred_type
		instrument0 instrument1 instrument2 instrument3 - instrument__inferred_type
		image1 infrared0 spectrograph2 - mode__inferred_type
	...
	(:action observe2_calibrate_satellite0_instrument0_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(power_on instrument0)
	...
	(:action observe3_turn_to_satellite0_star4_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_star4_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe5_take_image_satellite0_star4_instrument0_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite0_phenomenon6_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs5)
	...
	(:action observe7_take_image_satellite0_phenomenon6_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument0)
	...
	(:action observe8_turn_to_satellite0_phenomenon7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs7)
	...
	(:action observe9_take_image_satellite0_phenomenon7_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon7)
			(power_on instrument0)
