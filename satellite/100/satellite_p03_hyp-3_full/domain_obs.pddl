...
(define
	...
	(:action observe3_turn_to_satellite0_star0_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_star0_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_phenomenon3_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_phenomenon3_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(power_on instrument0)
	...
	(:action observe7_turn_to_satellite0_phenomenon6_phenomenon3
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(observed obs6)
