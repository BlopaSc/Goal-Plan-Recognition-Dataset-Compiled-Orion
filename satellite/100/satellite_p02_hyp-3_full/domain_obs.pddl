...
(define
	...
	(:action observe3_turn_to_satellite0_planet3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_planet3_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 planet3)
			(power_on instrument1)
	...
	(:action observe5_turn_to_satellite0_planet4_planet3
		:parameters ()
		:precondition (and
			(pointing satellite0 planet3)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_planet4_instrument1_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(power_on instrument1)
	...
	(:action observe7_turn_to_satellite0_phenomenon5_planet4
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(observed obs6)
	...
	(:action observe8_take_image_satellite0_phenomenon5_instrument1_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe9_turn_to_satellite0_phenomenon6_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(observed obs8)
	...
	(:action observe10_take_image_satellite0_phenomenon6_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe11_turn_to_satellite0_star7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs10)
	...
	(:action observe12_take_image_satellite0_star7_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(power_on instrument1)
