...
(define
	...
	(:action observe6_take_image_satellite0_planet4_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(power_on instrument1)
	...
	(:action observe8_take_image_satellite0_phenomenon5_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe10_take_image_satellite0_phenomenon6_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
