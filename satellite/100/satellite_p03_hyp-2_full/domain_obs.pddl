...
(define
	...
	(:action observe3_turn_to_satellite0_phenomenon3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite0_phenomenon3_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_star5_phenomenon3
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(observed obs4)
	...
	(:action observe7_turn_to_satellite0_phenomenon4_star5
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(observed obs6)
	...
	(:action observe8_take_image_satellite0_phenomenon4_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(power_on instrument0)
