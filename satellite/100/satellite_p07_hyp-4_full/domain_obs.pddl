...
(define
	...
	(:constants
		satellite0 satellite1 satellite2 satellite3 - satellite__inferred_type
		groundstation0 groundstation2 groundstation4 phenomenon5 planet10 planet11 planet12 planet8 planet9 star1 star3 star6 star7 star8 - direction__inferred_type
		instrument0 instrument1 instrument2 instrument3 instrument4 instrument5 instrument6 instrument7 - instrument__inferred_type
		image0 image1 image2 image3 - mode__inferred_type
	...
	(:action observe0_turn_to_satellite2_phenomenon5_star6
		:parameters ()
		:precondition (and
			(pointing satellite2 star6)
			(not (observed obs0))
	...
	(:action observe1_turn_to_satellite1_star1_groundstation4
		:parameters ()
		:precondition (and
			(pointing satellite1 groundstation4)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite3_star7_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation2)
			(observed obs1)
	...
	(:action observe3_turn_to_satellite0_star1_star6
		:parameters ()
		:precondition (and
			(pointing satellite0 star6)
			(observed obs2)
	...
	(:action observe4_switch_on_instrument0_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observed obs3)
	...
	(:action observe5_calibrate_satellite0_instrument0_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite0_planet9_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs5)
	...
	(:action observe7_take_image_satellite0_planet9_instrument0_image3
		:parameters ()
		:precondition (and
			(pointing satellite0 planet9)
			(power_on instrument0)
	...
	(:action observe8_turn_to_satellite2_planet8_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(observed obs7)
	...
	(:action observe9_turn_to_satellite2_planet11_planet8
		:parameters ()
		:precondition (and
			(pointing satellite2 planet8)
			(observed obs8)
	...
	(:action observe10_turn_to_satellite2_star1_planet11
		:parameters ()
		:precondition (and
			(pointing satellite2 planet11)
			(observed obs9)
	...
	(:action observe11_switch_on_instrument5_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs10)
	...
	(:action observe12_calibrate_satellite2_instrument5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(power_on instrument5)
	...
	(:action observe13_take_image_satellite3_star7_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(power_on instrument5)
	...
	(:action observe14_turn_to_satellite2_phenomenon5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(observed obs13)
	...
	(:action observe15_take_image_satellite2_phenomenon5_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(power_on instrument5)
	...
	(:action observe16_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observed obs15)
	...
	(:action observe17_take_image_satellite3_planet8_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(power_on instrument5)
	...
	(:action observe18_turn_to_satellite3_planet11_planet8
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(observed obs17)
	...
	(:action observe19_take_image_satellite3_planet11_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet11)
			(power_on instrument5)
