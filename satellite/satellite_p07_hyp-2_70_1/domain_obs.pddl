(define
	...
	(:action observe0_turn_to_satellite1_star7_groundstation4
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite1 groundstation4)
	...
	(:action observe1_turn_to_satellite3_star3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation2)
			(observation0)
	...
	(:action observe4_turn_to_satellite0_planet10_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observation3)
	...
	(:action observe5_turn_to_satellite2_planet11_planet9
		:parameters ()
		:precondition (and
			(pointing satellite2 planet9)
			(observation4)
	...
	(:action observe6_turn_to_satellite2_star1_planet11
		:parameters ()
		:precondition (and
			(pointing satellite2 planet11)
			(observation5)
	...
	(:action observe11_take_image_satellite3_planet9_instrument5_image1
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
