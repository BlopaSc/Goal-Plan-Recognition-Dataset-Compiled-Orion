(define
	...
	(:action observe3_turn_to_satellite0_star7_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(observation2)
	...
	(:action observe4_switch_on_instrument7_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observation3)
	...
	(:action observe6_calibrate_satellite3_instrument7_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(power_on instrument7)
