(define
	...
	(:action observe0_turn_to_satellite4_star2_planet10
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite4 planet10)
	...
	(:action observe3_take_image_satellite0_star7_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe4_turn_to_satellite0_planet10_star7
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(observation3)
	...
	(:action observe5_take_image_satellite0_planet10_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite2_phenomenon8_planet5
		:parameters ()
		:precondition (and
			(pointing satellite2 planet5)
			(observation5)
	...
	(:action observe7_turn_to_satellite2_phenomenon14_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observation6)
	...
	(:action observe8_calibrate_satellite4_instrument9_star2
		:parameters ()
		:precondition (and
			(pointing satellite4 star2)
			(power_on instrument9)
	...
	(:action observe10_turn_to_satellite2_phenomenon14_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation9)
