(define
	...
	(:action observe0_turn_to_satellite0_star4_star0
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite0 star0)
	...
	(:action observe1_turn_to_satellite1_phenomenon6_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(observation0)
	...
	(:action observe2_turn_to_satellite1_planet10_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon6)
			(observation1)
