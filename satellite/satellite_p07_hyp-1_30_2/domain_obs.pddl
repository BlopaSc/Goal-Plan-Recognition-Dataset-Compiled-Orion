(define
	...
	(:action observe0_turn_to_satellite0_star1_groundstation2
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite0 groundstation2)
	...
	(:action observe1_take_image_satellite0_planet10_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe5_take_image_satellite3_planet9_instrument7_image3
		:parameters ()
		:precondition (and
			(calibrated instrument7)
			(power_on instrument7)
