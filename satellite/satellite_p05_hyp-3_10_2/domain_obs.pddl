(define
	...
	(:action observe0_take_image_satellite0_planet5_instrument1_image2
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated instrument1)
	...
	(:action observe1_turn_to_satellite0_phenomenon8_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observation0)
	...
	(:action observe2_switch_on_instrument8_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observation1)
