(define
	...
	(:action observe3_turn_to_satellite2_phenomenon5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(observation2)
	...
	(:action observe4_turn_to_satellite3_planet9_star3
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(observation3)
	...
	(:action observe5_take_image_satellite3_planet9_instrument5_image1
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
