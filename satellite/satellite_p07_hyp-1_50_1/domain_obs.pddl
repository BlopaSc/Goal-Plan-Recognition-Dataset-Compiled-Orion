(define
	...
	(:action observe0_turn_to_satellite1_star3_groundstation4
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite1 groundstation4)
	...
	(:action observe2_turn_to_satellite0_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(observation1)
	...
	(:action observe3_take_image_satellite0_planet8_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe4_turn_to_satellite0_planet10_planet8
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(observation3)
	...
	(:action observe5_turn_to_satellite0_phenomenon5_planet10
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(observation4)
	...
	(:action observe6_take_image_satellite0_phenomenon5_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe9_calibrate_satellite3_instrument7_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(power_on instrument7)
