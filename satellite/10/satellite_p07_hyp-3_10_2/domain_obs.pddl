...
(define
	...
	(:action observe0_turn_to_satellite2_star1_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(not (observed obs0))
	...
	(:action observe1_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite3_planet9_planet8
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(observed obs1)
