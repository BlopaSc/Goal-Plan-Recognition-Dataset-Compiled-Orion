(define
	...
	(:action observe5_take_image_satellite1_star4_instrument3_infrared0
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe6_turn_to_satellite1_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observation5)
	...
	(:action observe7_take_image_satellite1_phenomenon5_instrument3_spectrograph2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe8_turn_to_satellite0_phenomenon6_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observation7)
