(define
	...
	(:action observe2_turn_to_satellite3_star3_groundstation4
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation4)
			(observation1)
	...
	(:action observe3_take_image_satellite3_star3_instrument6_image1
		:parameters ()
		:precondition (and
			(calibrated instrument6)
			(power_on instrument6)
	...
	(:action observe4_take_image_satellite3_phenomenon5_instrument6_image2
		:parameters ()
		:precondition (and
			(calibrated instrument6)
			(power_on instrument6)
	...
	(:action observe5_switch_on_instrument2_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observation4)
