(define
	...
	(:action observe8_take_image_satellite0_planet8_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe9_turn_to_satellite3_planet9_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(observation8)
	...
	(:action observe10_take_image_satellite3_planet9_instrument7_image3
		:parameters ()
		:precondition (and
			(calibrated instrument7)
			(power_on instrument7)
