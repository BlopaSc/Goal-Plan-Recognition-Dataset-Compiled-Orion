(define
	...
	(:action observe1_turn_to_satellite1_planet10_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observation0)
	...
	(:action observe2_turn_to_satellite2_star0_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(observation1)
	...
	(:action observe7_turn_to_satellite0_planet9_star7
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(observation6)
	...
	(:action observe8_take_image_satellite0_planet9_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe9_switch_on_instrument5_satellite2
		:parameters ()
		:precondition (and
			(power_avail satellite2)
			(observation8)
	...
	(:action observe11_turn_to_satellite2_star12_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation10)
	...
	(:action observe12_take_image_satellite2_star12_instrument5_infrared3
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
	...
	(:action observe13_turn_to_satellite2_star15_star12
		:parameters ()
		:precondition (and
			(pointing satellite2 star12)
			(observation12)
