(define
	...
	(:action observe0_take_image_satellite0_phenomenon14_instrument0_image4
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated instrument0)
	...
	(:action observe1_calibrate_satellite1_instrument2_groundstation3
		:parameters ()
		:precondition (and
			(pointing satellite1 groundstation3)
			(power_on instrument2)
	...
	(:action observe2_turn_to_satellite1_star6_groundstation3
		:parameters ()
		:precondition (and
			(pointing satellite1 groundstation3)
			(observation1)
