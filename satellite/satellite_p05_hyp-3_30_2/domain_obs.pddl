(define
	...
	(:action observe3_turn_to_satellite0_star3_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observation2)
	...
	(:action observe4_take_image_satellite0_planet5_instrument1_image2
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
	...
	(:action observe7_switch_on_instrument8_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observation6)
