(define
	...
	(:action observe3_take_image_satellite1_star4_instrument3_infrared0
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe4_turn_to_satellite1_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observation3)
	...
	(:action observe5_take_image_satellite1_phenomenon5_instrument3_spectrograph2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
