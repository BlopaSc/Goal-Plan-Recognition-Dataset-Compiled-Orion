...
(define
	...
	(:action observe0_turn_to_satellite0_planet3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(not (observed obs0))
	...
	(:action observe1_take_image_satellite0_planet3_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 planet3)
			(power_on instrument1)
	...
	(:action observe3_take_image_satellite0_phenomenon6_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
