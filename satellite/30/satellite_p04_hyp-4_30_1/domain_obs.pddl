...
(define
	...
	(:action observe1_turn_to_satellite3_star6_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite3 phenomenon5)
			(observed obs0)
	...
	(:action observe3_turn_to_satellite0_planet9_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_take_image_satellite3_planet11_instrument6_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet11)
			(power_on instrument6)
	...
	(:action observe5_take_image_satellite0_planet9_instrument2_image0
		:parameters ()
		:precondition (and
			(pointing satellite0 planet9)
			(power_on instrument2)
