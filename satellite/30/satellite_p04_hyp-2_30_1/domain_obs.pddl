...
(define
	...
	(:action observe3_take_image_satellite3_phenomenon5_instrument6_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 phenomenon5)
			(power_on instrument6)
	...
	(:action observe4_turn_to_satellite3_planet9_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite3 phenomenon5)
			(observed obs3)
	...
	(:action observe5_take_image_satellite3_planet9_instrument6_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet9)
			(power_on instrument6)
