...
(define
	...
	(:action observe3_turn_to_satellite3_planet9_planet8
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(observed obs2)
	...
	(:action observe5_take_image_satellite2_phenomenon5_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(power_on instrument5)
	...
	(:action observe6_take_image_satellite3_planet8_instrument5_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(power_on instrument5)
