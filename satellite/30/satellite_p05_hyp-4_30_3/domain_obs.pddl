...
(define
	...
	(:action observe0_turn_to_satellite3_star0_planet10
		:parameters ()
		:precondition (and
			(pointing satellite3 planet10)
			(not (observed obs0))
	...
	(:action observe3_calibrate_satellite0_instrument0_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(power_on instrument0)
	...
	(:action observe4_turn_to_satellite0_phenomenon8_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observed obs3)
	...
	(:action observe6_turn_to_satellite1_phenomenon13_phenomenon12
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon12)
			(observed obs5)
