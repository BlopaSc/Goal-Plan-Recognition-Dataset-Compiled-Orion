...
(define
	...
	(:action observe0_turn_to_satellite0_star1_star6
		:parameters ()
		:precondition (and
			(pointing satellite0 star6)
			(not (observed obs0))
	...
	(:action observe1_turn_to_satellite0_planet11_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite3_star7_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(observed obs1)
	...
	(:action observe3_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observed obs2)
	...
	(:action observe5_turn_to_satellite3_star7_planet9
		:parameters ()
		:precondition (and
			(pointing satellite3 planet9)
			(observed obs4)
	...
	(:action observe6_take_image_satellite3_star7_instrument5_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(power_on instrument5)
