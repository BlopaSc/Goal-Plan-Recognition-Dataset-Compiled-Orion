...
(define
	...
	(:action observe1_take_image_satellite0_star3_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(power_on instrument0)
	...
	(:action observe2_turn_to_satellite0_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs1)
	...
	(:action observe3_take_image_satellite0_phenomenon5_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument0)
