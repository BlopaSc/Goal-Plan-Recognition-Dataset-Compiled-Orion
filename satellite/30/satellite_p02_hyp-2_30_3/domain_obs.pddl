...
(define
	...
	(:action observe1_turn_to_satellite0_phenomenon5_planet4
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(observed obs0)
	...
	(:action observe2_take_image_satellite0_phenomenon6_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe3_take_image_satellite0_star7_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(power_on instrument1)
