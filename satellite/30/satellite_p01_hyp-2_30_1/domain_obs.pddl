...
(define
	...
	(:action observe0_take_image_satellite1_star4_instrument3_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(power_on instrument3)
	...
	(:action observe1_turn_to_satellite1_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite0_phenomenon6_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs1)
