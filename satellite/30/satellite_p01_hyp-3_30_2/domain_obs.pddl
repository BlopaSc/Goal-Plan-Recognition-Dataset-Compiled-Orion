...
(define
	...
	(:action observe0_take_image_satellite0_star4_instrument0_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument0)
	...
	(:action observe1_turn_to_satellite0_phenomenon6_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite0_phenomenon7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs1)
