...
(define
	...
	(:action observe1_turn_to_satellite0_planet4_planet3
		:parameters ()
		:precondition (and
			(pointing satellite0 planet3)
			(observed obs0)
	...
	(:action observe2_take_image_satellite0_phenomenon5_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe3_turn_to_satellite0_star7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs2)
