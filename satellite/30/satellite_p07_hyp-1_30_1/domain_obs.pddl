...
(define
	...
	(:action observe1_turn_to_satellite0_star1_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs0)
	...
	(:action observe3_turn_to_satellite0_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(observed obs2)
	...
	(:action observe5_switch_on_instrument7_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs4)
