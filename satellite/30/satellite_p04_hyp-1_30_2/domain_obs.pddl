...
(define
	...
	(:action observe0_calibrate_satellite0_instrument2_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(power_on instrument2)
	...
	(:action observe1_turn_to_satellite0_phenomenon5_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs0)
	...
	(:action observe2_switch_on_instrument7_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs1)
	...
	(:action observe3_calibrate_satellite3_instrument7_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(power_on instrument7)
