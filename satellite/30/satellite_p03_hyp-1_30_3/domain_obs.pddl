...
(define
	...
	(:action observe0_turn_to_satellite0_phenomenon4_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(not (observed obs0))
	...
	(:action observe1_turn_to_satellite0_phenomenon3_phenomenon4
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(observed obs0)
	...
	(:action observe2_take_image_satellite0_phenomenon3_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(power_on instrument0)
