...
(define
	...
	(:action observe1_switch_on_instrument7_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite3_planet9_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation0)
			(observed obs1)
	...
	(:action observe3_turn_to_satellite0_planet10_planet8
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(observed obs2)
	...
	(:action observe4_take_image_satellite3_planet9_instrument7_image3
		:parameters ()
		:precondition (and
			(pointing satellite3 planet9)
			(power_on instrument7)
