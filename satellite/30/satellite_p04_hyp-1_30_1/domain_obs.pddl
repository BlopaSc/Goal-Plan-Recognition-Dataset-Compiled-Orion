...
(define
	...
	(:action observe0_take_image_satellite0_phenomenon5_instrument2_image0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument2)
	...
	(:action observe1_take_image_satellite0_planet8_instrument2_image0
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(power_on instrument2)
	...
	(:action observe2_turn_to_satellite0_planet10_planet8
		:parameters ()
		:precondition (and
			(pointing satellite0 planet8)
			(observed obs1)
	...
	(:action observe3_take_image_satellite3_planet9_instrument7_image3
		:parameters ()
		:precondition (and
			(pointing satellite3 planet9)
			(power_on instrument7)
	...
	(:action observe4_take_image_satellite0_planet10_instrument2_image0
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(power_on instrument2)
	...
	(:action observe5_turn_to_satellite1_star1_groundstation0
		:parameters ()
		:precondition (and
			(pointing satellite1 groundstation0)
			(observed obs4)
