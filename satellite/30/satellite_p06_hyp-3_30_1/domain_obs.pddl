...
(define
	...
	(:action observe4_calibrate_satellite4_instrument9_star2
		:parameters ()
		:precondition (and
			(pointing satellite4 star2)
			(power_on instrument9)
	...
	(:action observe5_switch_on_instrument5_satellite2
		:parameters ()
		:precondition (and
			(power_avail satellite2)
			(observed obs4)
	...
	(:action observe7_turn_to_satellite2_star11_phenomenon8
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon8)
			(observed obs6)
	...
	(:action observe8_take_image_satellite2_phenomenon8_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon8)
			(power_on instrument5)
	...
	(:action observe9_turn_to_satellite2_star11_planet5
		:parameters ()
		:precondition (and
			(pointing satellite2 planet5)
			(observed obs8)
	...
	(:action observe10_turn_to_satellite2_planet5_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observed obs9)
