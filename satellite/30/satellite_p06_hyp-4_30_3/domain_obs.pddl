...
(define
	...
	(:action observe0_turn_to_satellite2_planet9_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(not (observed obs0))
	...
	(:action observe1_take_image_satellite1_planet10_instrument2_image2
		:parameters ()
		:precondition (and
			(pointing satellite1 planet10)
			(power_on instrument2)
	...
	(:action observe2_turn_to_satellite1_star11_planet10
		:parameters ()
		:precondition (and
			(pointing satellite1 planet10)
			(observed obs1)
	...
	(:action observe3_take_image_satellite1_star11_instrument2_image2
		:parameters ()
		:precondition (and
			(pointing satellite1 star11)
			(power_on instrument2)
	...
	(:action observe4_turn_to_satellite3_phenomenon13_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observed obs3)
	...
	(:action observe5_turn_to_satellite3_phenomenon14_phenomenon13
		:parameters ()
		:precondition (and
			(pointing satellite3 phenomenon13)
			(observed obs4)
	...
	(:action observe6_take_image_satellite3_phenomenon14_instrument7_image4
		:parameters ()
		:precondition (and
			(pointing satellite3 phenomenon14)
			(power_on instrument7)
