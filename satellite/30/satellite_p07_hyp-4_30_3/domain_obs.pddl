...
(define
	...
	(:action observe2_turn_to_satellite2_star1_planet11
		:parameters ()
		:precondition (and
			(pointing satellite2 planet11)
			(observed obs1)
	...
	(:action observe3_calibrate_satellite2_instrument5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(power_on instrument5)
	...
	(:action observe4_take_image_satellite3_planet8_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet8)
			(power_on instrument5)
	...
	(:action observe5_take_image_satellite3_planet11_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 planet11)
			(power_on instrument5)
