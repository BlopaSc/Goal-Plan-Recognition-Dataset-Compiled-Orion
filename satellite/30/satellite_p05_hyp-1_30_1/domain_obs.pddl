...
(define
	...
	(:action observe0_turn_to_satellite3_star9_planet10
		:parameters ()
		:precondition (and
			(pointing satellite3 planet10)
			(not (observed obs0))
	...
	(:action observe1_turn_to_satellite1_planet5_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(observed obs0)
	...
	(:action observe2_take_image_satellite1_phenomenon6_instrument3_image3
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon6)
			(power_on instrument3)
	...
	(:action observe3_take_image_satellite1_star9_instrument3_image3
		:parameters ()
		:precondition (and
			(pointing satellite1 star9)
			(power_on instrument3)
	...
	(:action observe4_turn_to_satellite1_planet10_star9
		:parameters ()
		:precondition (and
			(pointing satellite1 star9)
			(observed obs3)
	...
	(:action observe5_take_image_satellite1_phenomenon12_instrument3_image4
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon12)
			(power_on instrument3)
	...
	(:action observe6_take_image_satellite0_phenomenon7_instrument0_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon7)
			(power_on instrument0)
