(define
	...
	(:action observe0_turn_to_satellite2_star2_phenomenon6
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite2 phenomenon6)
	...
	(:action observe2_turn_to_satellite0_phenomenon8_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observation1)
	...
	(:action observe5_turn_to_satellite1_phenomenon12_planet11
		:parameters ()
		:precondition (and
			(pointing satellite1 planet11)
			(observation4)
	...
	(:action observe6_take_image_satellite1_phenomenon12_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe7_turn_to_satellite1_phenomenon6_phenomenon12
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon12)
			(observation6)
