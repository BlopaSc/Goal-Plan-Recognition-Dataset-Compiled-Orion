(define
	...
	(:action observe3_turn_to_satellite0_star3_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observation2)
	...
	(:action observe6_calibrate_satellite1_instrument3_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(power_on instrument3)
	...
	(:action observe7_turn_to_satellite1_planet10_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(observation6)
	...
	(:action observe8_turn_to_satellite1_phenomenon13_phenomenon12
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon12)
			(observation7)
	...
	(:action observe10_take_image_satellite1_star14_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
