(define
	...
	(:action observe0_turn_to_satellite3_star3_planet10
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite3 planet10)
	...
	(:action observe2_calibrate_satellite0_instrument1_star4
		:parameters ()
		:precondition (and
			(pointing satellite0 star4)
			(power_on instrument1)
	...
	(:action observe3_turn_to_satellite0_planet5_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observation2)
	...
	(:action observe4_turn_to_satellite0_phenomenon6_planet5
		:parameters ()
		:precondition (and
			(pointing satellite0 planet5)
			(observation3)
	...
	(:action observe5_take_image_satellite0_phenomenon6_instrument1_image4
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
	...
	(:action observe6_take_image_satellite0_phenomenon8_instrument1_image2
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
	...
	(:action observe7_take_image_satellite0_planet10_instrument1_image4
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
	...
	(:action observe9_turn_to_satellite1_star9_star2
		:parameters ()
		:precondition (and
			(pointing satellite1 star2)
			(observation8)
	...
	(:action observe10_turn_to_satellite4_groundstation1_planet11
		:parameters ()
		:precondition (and
			(pointing satellite4 planet11)
			(observation9)
	...
	(:action observe11_switch_on_instrument8_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observation10)
	...
	(:action observe12_take_image_satellite4_phenomenon7_instrument8_infrared1
		:parameters ()
		:precondition (and
			(calibrated instrument8)
			(power_on instrument8)
