...
(define
	...
	(:action observe2_turn_to_satellite0_planet4_planet3
		:parameters ()
		:precondition (and
			(pointing satellite0 planet3)
			(observed obs1)
	...
	(:action observe5_take_image_satellite0_phenomenon5_instrument1_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe6_take_image_satellite0_phenomenon6_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
