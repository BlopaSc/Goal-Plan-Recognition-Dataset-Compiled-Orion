...
(define
	...
	(:action observe3_turn_to_satellite0_phenomenon5_planet4
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(observed obs2)
	...
	(:action observe4_turn_to_satellite0_phenomenon6_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(observed obs3)
	...
	(:action observe5_take_image_satellite0_phenomenon6_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe6_turn_to_satellite0_star7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs5)
