...
(define
	...
	(:action observe0_turn_to_satellite0_star0_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(not (observed obs0))
	...
	(:action observe1_take_image_satellite0_star0_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(power_on instrument0)
	...
	(:action observe2_turn_to_satellite0_phenomenon4_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observed obs1)
	...
	(:action observe4_turn_to_satellite0_phenomenon3_phenomenon4
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(observed obs3)
