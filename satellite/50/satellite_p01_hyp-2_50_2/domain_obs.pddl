...
(define
	...
	(:action observe0_turn_to_satellite1_star3_star0
		:parameters ()
		:precondition (and
			(pointing satellite1 star0)
			(not (observed obs0))
	...
	(:action observe1_take_image_satellite1_star3_instrument3_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite1 star3)
			(power_on instrument3)
	...
	(:action observe2_turn_to_satellite1_phenomenon5_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observed obs1)
	...
	(:action observe3_take_image_satellite1_phenomenon5_instrument3_spectrograph2
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon5)
			(power_on instrument3)
