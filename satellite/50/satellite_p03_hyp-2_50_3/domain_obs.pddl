...
(define
	...
	(:action observe2_turn_to_satellite0_phenomenon3_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs1)
	...
	(:action observe3_take_image_satellite0_phenomenon3_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon3)
			(power_on instrument0)
	...
	(:action observe4_turn_to_satellite0_phenomenon4_star5
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(observed obs3)
