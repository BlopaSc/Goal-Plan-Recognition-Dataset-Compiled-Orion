...
(define
	...
	(:action observe2_switch_on_instrument0_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observed obs1)
	...
	(:action observe3_turn_to_satellite0_planet9_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observed obs2)
	...
	(:action observe4_turn_to_satellite2_planet11_planet8
		:parameters ()
		:precondition (and
			(pointing satellite2 planet8)
			(observed obs3)
	...
	(:action observe5_switch_on_instrument5_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs4)
	...
	(:action observe6_take_image_satellite3_star7_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(power_on instrument5)
	...
	(:action observe7_turn_to_satellite2_phenomenon5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(observed obs6)
	...
	(:action observe8_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observed obs7)
