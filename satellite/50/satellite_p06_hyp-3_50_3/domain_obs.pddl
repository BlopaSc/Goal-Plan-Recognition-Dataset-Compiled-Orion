...
(define
	...
	(:action observe1_turn_to_satellite1_planet9_star4
		:parameters ()
		:precondition (and
			(pointing satellite1 star4)
			(observed obs0)
	...
	(:action observe2_turn_to_satellite4_star2_planet10
		:parameters ()
		:precondition (and
			(pointing satellite4 planet10)
			(observed obs1)
	...
	(:action observe6_turn_to_satellite2_phenomenon14_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observed obs5)
	...
	(:action observe7_calibrate_satellite4_instrument9_star2
		:parameters ()
		:precondition (and
			(pointing satellite4 star2)
			(power_on instrument9)
	...
	(:action observe8_switch_on_instrument5_satellite2
		:parameters ()
		:precondition (and
			(power_avail satellite2)
			(observed obs7)
	...
	(:action observe9_turn_to_satellite2_star0_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observed obs8)
	...
	(:action observe10_calibrate_satellite2_instrument5_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(power_on instrument5)
	...
	(:action observe11_turn_to_satellite2_phenomenon14_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observed obs10)
	...
	(:action observe12_take_image_satellite2_phenomenon14_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon14)
			(power_on instrument5)
	...
	(:action observe13_turn_to_satellite2_planet5_phenomenon8
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon8)
			(observed obs12)
	...
	(:action observe14_turn_to_satellite2_star11_planet5
		:parameters ()
		:precondition (and
			(pointing satellite2 planet5)
			(observed obs13)
	...
	(:action observe15_take_image_satellite2_star11_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(power_on instrument5)
	...
	(:action observe16_turn_to_satellite2_planet5_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observed obs15)
