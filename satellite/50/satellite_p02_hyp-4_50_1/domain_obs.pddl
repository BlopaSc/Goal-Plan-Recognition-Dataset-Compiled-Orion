...
(define
	...
	(:action observe2_turn_to_satellite0_phenomenon5_planet4
		:parameters ()
		:precondition (and
			(pointing satellite0 planet4)
			(observed obs1)
	...
	(:action observe3_take_image_satellite0_phenomenon5_instrument1_image2
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(power_on instrument1)
	...
	(:action observe4_take_image_satellite0_phenomenon6_instrument1_infrared1
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(power_on instrument1)
	...
	(:action observe5_turn_to_satellite0_star7_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observed obs4)
	...
	(:action observe6_take_image_satellite0_star7_instrument1_infrared0
		:parameters ()
		:precondition (and
			(pointing satellite0 star7)
			(power_on instrument1)
