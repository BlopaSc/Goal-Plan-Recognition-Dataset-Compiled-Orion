...
(define
	...
	(:action observe1_switch_on_instrument2_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observed obs0)
	...
	(:action observe3_turn_to_satellite2_planet11_planet9
		:parameters ()
		:precondition (and
			(pointing satellite2 planet9)
			(observed obs2)
	...
	(:action observe4_switch_on_instrument5_satellite3
		:parameters ()
		:precondition (and
			(power_avail satellite3)
			(observed obs3)
	...
	(:action observe5_calibrate_satellite2_instrument5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(power_on instrument5)
	...
	(:action observe6_take_image_satellite3_star3_instrument5_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(power_on instrument5)
	...
	(:action observe7_take_image_satellite2_phenomenon5_instrument5_image2
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(power_on instrument5)
