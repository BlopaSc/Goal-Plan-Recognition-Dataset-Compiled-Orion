...
(define
	...
	(:action observe3_turn_to_satellite0_planet10_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs2)
	...
	(:action observe4_turn_to_satellite2_planet9_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(observed obs3)
	...
	(:action observe5_turn_to_satellite2_star1_planet11
		:parameters ()
		:precondition (and
			(pointing satellite2 planet11)
			(observed obs4)
	...
	(:action observe6_turn_to_satellite2_phenomenon5_star1
		:parameters ()
		:precondition (and
			(pointing satellite2 star1)
			(observed obs5)
	...
	(:action observe8_turn_to_satellite3_planet9_star3
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(observed obs7)
	...
	(:action observe9_take_image_satellite3_planet9_instrument5_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 planet9)
			(power_on instrument5)
