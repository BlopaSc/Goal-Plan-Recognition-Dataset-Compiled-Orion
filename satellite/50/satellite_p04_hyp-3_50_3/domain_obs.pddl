...
(define
	...
	(:action observe0_turn_to_satellite3_groundstation4_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation2)
			(not (observed obs0))
	...
	(:action observe1_calibrate_satellite3_instrument6_groundstation4
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation4)
			(power_on instrument6)
	...
	(:action observe2_take_image_satellite3_star3_instrument6_image1
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(power_on instrument6)
	...
	(:action observe3_turn_to_satellite3_phenomenon5_star3
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(observed obs2)
	...
	(:action observe7_turn_to_satellite0_planet10_groundstation2
		:parameters ()
		:precondition (and
			(pointing satellite0 groundstation2)
			(observed obs6)
	...
	(:action observe8_take_image_satellite0_planet10_instrument2_image0
		:parameters ()
		:precondition (and
			(pointing satellite0 planet10)
			(power_on instrument2)
