...
(define
	...
	(:action observe5_take_image_satellite1_phenomenon6_instrument3_image3
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon6)
			(power_on instrument3)
	...
	(:action observe6_turn_to_satellite1_star9_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon6)
			(observed obs5)
	...
	(:action observe10_turn_to_satellite0_phenomenon7_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observed obs9)
