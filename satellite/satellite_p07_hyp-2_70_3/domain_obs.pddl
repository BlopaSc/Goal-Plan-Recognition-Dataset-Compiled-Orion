(define
	...
	(:action observe5_take_image_satellite0_planet10_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe6_turn_to_satellite2_planet9_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(observation5)
	...
	(:action observe10_take_image_satellite3_star3_instrument5_image1
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
	...
	(:action observe12_turn_to_satellite3_planet9_star3
		:parameters ()
		:precondition (and
			(pointing satellite3 star3)
			(observation11)
	...
	(:action observe13_take_image_satellite3_planet9_instrument5_image1
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
