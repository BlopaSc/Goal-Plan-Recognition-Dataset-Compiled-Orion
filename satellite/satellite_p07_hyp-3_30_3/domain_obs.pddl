(define
	...
	(:action observe0_calibrate_satellite0_instrument0_star1
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite0 star1)
	...
	(:action observe2_take_image_satellite0_planet11_instrument0_image3
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe6_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observation5)
