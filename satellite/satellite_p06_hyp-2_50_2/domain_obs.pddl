(define
	...
	(:action observe0_turn_to_satellite1_planet10_star4
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite1 star4)
	...
	(:action observe4_take_image_satellite0_planet9_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe5_turn_to_satellite0_phenomenon14_planet9
		:parameters ()
		:precondition (and
			(pointing satellite0 planet9)
			(observation4)
	...
	(:action observe6_take_image_satellite0_phenomenon14_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe7_turn_to_satellite2_star12_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation6)
	...
	(:action observe8_take_image_satellite2_star12_instrument5_infrared3
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
	...
	(:action observe9_take_image_satellite2_star15_instrument5_image2
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
