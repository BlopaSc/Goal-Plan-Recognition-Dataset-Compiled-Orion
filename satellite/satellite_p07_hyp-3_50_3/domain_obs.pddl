(define
	...
	(:action observe3_turn_to_satellite2_star1_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon5)
			(observation2)
	...
	(:action observe4_turn_to_satellite3_planet8_star7
		:parameters ()
		:precondition (and
			(pointing satellite3 star7)
			(observation3)
	...
	(:action observe6_take_image_satellite3_planet9_instrument5_image1
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
