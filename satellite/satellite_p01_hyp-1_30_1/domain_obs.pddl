(define
	...
	(:action observe0_take_image_satellite0_star1_instrument0_infrared0
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated instrument0)
	...
	(:action observe1_turn_to_satellite0_star2_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observation0)
	...
	(:action observe2_turn_to_satellite0_phenomenon6_star2
		:parameters ()
		:precondition (and
			(pointing satellite0 star2)
			(observation1)
