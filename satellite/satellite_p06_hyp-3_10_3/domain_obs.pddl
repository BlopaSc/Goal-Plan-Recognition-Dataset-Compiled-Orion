(define
	...
	(:action observe0_take_image_satellite0_planet10_instrument0_image4
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated instrument0)
	...
	(:action observe1_turn_to_satellite2_phenomenon8_planet5
		:parameters ()
		:precondition (and
			(pointing satellite2 planet5)
			(observation0)
	...
	(:action observe2_turn_to_satellite2_planet5_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation1)
	...
	(:action observe3_turn_to_satellite2_phenomenon14_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation2)
