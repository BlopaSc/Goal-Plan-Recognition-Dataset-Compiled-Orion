(define
	...
	(:action observe2_take_image_satellite0_star5_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe3_turn_to_satellite0_phenomenon6_star5
		:parameters ()
		:precondition (and
			(pointing satellite0 star5)
			(observation2)
	...
	(:action observe4_turn_to_satellite0_phenomenon3_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon6)
			(observation3)
