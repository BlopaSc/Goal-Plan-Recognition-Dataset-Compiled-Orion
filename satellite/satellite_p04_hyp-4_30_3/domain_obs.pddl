(define
	...
	(:action observe0_turn_to_satellite3_phenomenon5_groundstation4
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite3 groundstation4)
	...
	(:action observe2_turn_to_satellite3_planet8_star6
		:parameters ()
		:precondition (and
			(pointing satellite3 star6)
			(observation1)
	...
	(:action observe4_turn_to_satellite0_groundstation2_star6
		:parameters ()
		:precondition (and
			(pointing satellite0 star6)
			(observation3)
