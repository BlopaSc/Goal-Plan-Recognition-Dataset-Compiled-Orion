(define
	...
	(:action observe0_turn_to_satellite1_planet11_planet10
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite1 planet10)
	...
	(:action observe1_take_image_satellite1_planet11_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe2_take_image_satellite1_phenomenon13_instrument3_image3
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
