(define
	...
	(:action observe3_switch_on_instrument1_satellite0
		:parameters ()
		:precondition (and
			(power_avail satellite0)
			(observation2)
	...
	(:action observe4_take_image_satellite0_phenomenon6_instrument1_image4
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
	...
	(:action observe5_turn_to_satellite0_planet10_phenomenon8
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon8)
			(observation4)
	...
	(:action observe6_switch_on_instrument8_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observation5)
	...
	(:action observe7_turn_to_satellite4_planet11_phenomenon7
		:parameters ()
		:precondition (and
			(pointing satellite4 phenomenon7)
			(observation6)
