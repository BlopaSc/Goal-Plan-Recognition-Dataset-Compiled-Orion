(define
	...
	(:action observe12_turn_to_satellite1_planet10_phenomenon6
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon6)
			(observation11)
	...
	(:action observe13_take_image_satellite1_planet10_instrument3_image2
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe15_turn_to_satellite1_phenomenon6_phenomenon12
		:parameters ()
		:precondition (and
			(pointing satellite1 phenomenon12)
			(observation14)
	...
	(:action observe16_turn_to_satellite1_phenomenon6_star14
		:parameters ()
		:precondition (and
			(pointing satellite1 star14)
			(observation15)
