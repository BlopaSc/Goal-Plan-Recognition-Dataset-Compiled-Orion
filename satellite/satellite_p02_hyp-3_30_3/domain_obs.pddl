(define
	...
	(:action observe0_take_image_satellite0_planet4_instrument1_infrared0
		:parameters ()
		:precondition (and
			(not (observation0))
			(calibrated instrument1)
	...
	(:action observe1_turn_to_satellite0_phenomenon6_phenomenon5
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon5)
			(observation0)
	...
	(:action observe2_take_image_satellite0_phenomenon6_instrument1_image2
		:parameters ()
		:precondition (and
			(calibrated instrument1)
			(power_on instrument1)
