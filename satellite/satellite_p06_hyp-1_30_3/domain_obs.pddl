(define
	...
	(:action observe0_turn_to_satellite0_star1_star0
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite0 star0)
	...
	(:action observe1_turn_to_satellite0_star7_star1
		:parameters ()
		:precondition (and
			(pointing satellite0 star1)
			(observation0)
	...
	(:action observe2_take_image_satellite0_phenomenon13_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe4_take_image_satellite1_star6_instrument2_image2
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
	...
	(:action observe6_switch_on_instrument9_satellite4
		:parameters ()
		:precondition (and
			(power_avail satellite4)
			(observation5)
