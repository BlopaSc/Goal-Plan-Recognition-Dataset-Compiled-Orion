(define
	...
	(:action observe5_turn_to_satellite0_phenomenon4_star0
		:parameters ()
		:precondition (and
			(pointing satellite0 star0)
			(observation4)
	...
	(:action observe7_turn_to_satellite0_phenomenon3_phenomenon4
		:parameters ()
		:precondition (and
			(pointing satellite0 phenomenon4)
			(observation6)
	...
	(:action observe8_take_image_satellite0_phenomenon3_instrument0_thermograph0
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
