(define
	...
	(:action observe6_turn_to_satellite3_phenomenon5_groundstation4
		:parameters ()
		:precondition (and
			(pointing satellite3 groundstation4)
			(observation5)
	...
	(:action observe7_turn_to_satellite0_planet10_star3
		:parameters ()
		:precondition (and
			(pointing satellite0 star3)
			(observation6)
	...
	(:action observe9_take_image_satellite3_planet9_instrument6_image2
		:parameters ()
		:precondition (and
			(calibrated instrument6)
			(power_on instrument6)
	...
	(:action observe10_take_image_satellite0_planet11_instrument2_image0
		:parameters ()
		:precondition (and
			(calibrated instrument2)
			(power_on instrument2)
