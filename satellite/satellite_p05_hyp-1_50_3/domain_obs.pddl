(define
	...
	(:action observe0_turn_to_satellite4_planet5_star9
		:parameters ()
		:precondition (and
			(not (observation0))
			(pointing satellite4 star9)
	...
	(:action observe5_turn_to_satellite1_phenomenon6_planet5
		:parameters ()
		:precondition (and
			(pointing satellite1 planet5)
			(observation4)
	...
	(:action observe7_take_image_satellite1_planet10_instrument3_image4
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
	...
	(:action observe9_take_image_satellite1_phenomenon12_instrument3_image4
		:parameters ()
		:precondition (and
			(calibrated instrument3)
			(power_on instrument3)
