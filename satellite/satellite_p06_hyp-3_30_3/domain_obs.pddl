(define
	...
	(:action observe2_take_image_satellite0_planet10_instrument0_image4
		:parameters ()
		:precondition (and
			(calibrated instrument0)
			(power_on instrument0)
	...
	(:action observe3_turn_to_satellite2_star11_phenomenon8
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon8)
			(observation2)
	...
	(:action observe4_turn_to_satellite2_phenomenon14_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observation3)
	...
	(:action observe5_turn_to_satellite4_star7_star2
		:parameters ()
		:precondition (and
			(pointing satellite4 star2)
			(observation4)
	...
	(:action observe6_turn_to_satellite2_planet5_star0
		:parameters ()
		:precondition (and
			(pointing satellite2 star0)
			(observation5)
	...
	(:action observe8_turn_to_satellite2_star0_star11
		:parameters ()
		:precondition (and
			(pointing satellite2 star11)
			(observation7)
	...
	(:action observe9_take_image_satellite2_phenomenon8_instrument5_image2
		:parameters ()
		:precondition (and
			(calibrated instrument5)
			(power_on instrument5)
	...
	(:action observe10_turn_to_satellite2_planet5_phenomenon8
		:parameters ()
		:precondition (and
			(pointing satellite2 phenomenon8)
			(observation9)
