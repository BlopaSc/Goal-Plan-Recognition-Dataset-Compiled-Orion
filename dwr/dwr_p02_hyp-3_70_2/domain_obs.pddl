(define
	...
	(:action observe0_put_k1_cc_q1_pallet_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(holding k1 cc)
	...
	(:action observe1_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe4_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe7_put_k2_cb_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top pallet q2)
