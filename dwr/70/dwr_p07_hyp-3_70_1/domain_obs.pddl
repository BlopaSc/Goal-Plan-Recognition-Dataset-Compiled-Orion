...
(define
	...
	(:action observe7_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cf)
			(top pallet p2)
	...
	(:action observe16_put_k2_cd_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cf p2)
	...
	(:action observe21_put_k2_cc_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top cd p2)
	...
	(:action observe22_put_k3_ce_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 ce)
	...
	(:action observe25_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe29_put_k3_ca_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top ce p3)
	...
	(:action observe30_put_k2_cb_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cc p2)
