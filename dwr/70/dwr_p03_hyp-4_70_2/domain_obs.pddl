...
(define
	...
	(:action observe18_put_k3_cd_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cd)
	...
	(:action observe19_put_k3_cc_p3_cd_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cd p3)
	...
	(:action observe29_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe34_put_k2_ce_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe39_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
