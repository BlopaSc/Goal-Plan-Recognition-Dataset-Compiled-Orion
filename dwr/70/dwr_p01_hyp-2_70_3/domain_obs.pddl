...
(define
	...
	(:action observe7_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(unloaded r1)
	...
	(:action observe8_take_k1_cc_q1_cf_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc q1)
	...
	(:action observe11_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(in cf q1)
			(on cf ce)
	...
	(:action observe12_put_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(top cc p1)
			(holding k1 cf)
	...
	(:action observe14_put_k2_ca_p2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 ca)
	...
	(:action observe16_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe18_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
