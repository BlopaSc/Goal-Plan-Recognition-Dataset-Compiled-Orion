...
(define
	...
	(:action observe5_take_k1_ce_p1_cd_l1
		:parameters ()
		:precondition (and
			(in ce p1)
			(on ce cd)
	...
	(:action observe7_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe16_load_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe35_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(holding k2 cf)
	...
	(:action observe40_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe41_take_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(in cd p2)
			(empty k2)
	...
	(:action observe42_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l3)
	...
	(:action observe45_unload_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(at r1 l1)
	...
	(:action observe46_move_r1_l2_l3
		:parameters ()
		:precondition (and
			(at r1 l2)
			(observed obs45)
	...
	(:action observe47_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs46)
	...
	(:action observe48_load_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe49_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(observed obs48)
