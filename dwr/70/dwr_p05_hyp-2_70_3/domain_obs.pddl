...
(define
	...
	(:action observe7_put_k4_cd_p4_pallet_l6
		:parameters ()
		:precondition (and
			(top pallet p4)
			(holding k4 cd)
	...
	(:action observe11_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cc)
	...
	(:action observe24_unload_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe29_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe30_move_r1_l4_l1
		:parameters ()
		:precondition (and
			(at r1 l4)
			(observed obs29)
	...
	(:action observe33_load_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
