...
(define
	...
	(:action observe6_take_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(in cf p1)
			(on cf ce)
	...
	(:action observe16_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe19_take_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(on ce cf)
	...
	(:action observe20_take_k3_cf_p3_cc_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(on cf cc)
	...
	(:action observe22_unload_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe23_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe24_put_k1_ce_p1_ca_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top ca p1)
	...
	(:action observe27_take_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe30_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(observed obs29)
	...
	(:action observe31_put_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top ce p1)
	...
	(:action observe34_take_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(in cf p1)
			(on cf ce)
	...
	(:action observe35_take_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(in cb p2)
			(on cb cd)
	...
	(:action observe36_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe37_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cf)
	...
	(:action observe44_take_k4_cc_p4_pallet_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(on cc pallet)
	...
	(:action observe45_load_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe50_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe51_put_k3_ca_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top ce p3)
	...
	(:action observe55_load_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l3)
	...
	(:action observe56_move_r1_l3_l2
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs55)
	...
	(:action observe57_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(observed obs56)
	...
	(:action observe58_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
