...
(define
	...
	(:action observe10_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cc)
	...
	(:action observe29_put_k4_ca_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 ca)
			(top ce p4)
	...
	(:action observe30_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs29)
	...
	(:action observe31_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l3)
	...
	(:action observe36_put_k3_cf_p3_cb_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top cb p3)
