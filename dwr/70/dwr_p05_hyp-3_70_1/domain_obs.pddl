...
(define
	...
	(:action observe5_take_k1_cc_p1_cf_l1
		:parameters ()
		:precondition (and
			(on cc cf)
			(in cc p1)
	...
	(:action observe9_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cc)
	...
	(:action observe12_take_k1_ce_p1_cb_l1
		:parameters ()
		:precondition (and
			(in ce p1)
			(on ce cb)
	...
	(:action observe15_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cf)
	...
	(:action observe21_take_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(on cf pallet)
	...
	(:action observe26_unload_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe27_put_k4_cf_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top ce p4)
