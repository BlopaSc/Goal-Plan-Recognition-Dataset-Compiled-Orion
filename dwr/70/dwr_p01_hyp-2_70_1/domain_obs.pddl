...
(define
	...
	(:action observe0_put_k1_cc_q1_cf_l1
		:parameters ()
		:precondition (and
			(top cf q1)
			(holding k1 cc)
	...
	(:action observe5_take_k1_cc_q1_cf_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc q1)
	...
	(:action observe6_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
	...
	(:action observe8_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(in cf q1)
			(on cf ce)
	...
	(:action observe10_put_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(top cc p1)
			(holding k1 cf)
	...
	(:action observe13_put_k2_ca_p2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 ca)
	...
	(:action observe16_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
	...
	(:action observe17_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(unloaded r1)
	...
	(:action observe18_put_k2_ce_p2_ca_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top ca p2)
	...
	(:action observe20_take_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf p1)
	...
	(:action observe21_put_k1_cf_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet q1)
