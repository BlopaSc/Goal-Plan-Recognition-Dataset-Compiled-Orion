...
(define
	...
	(:action observe7_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(in cf q1)
			(on cf ce)
	...
	(:action observe8_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe9_unload_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe10_put_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top cf p1)
	...
	(:action observe11_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(in ce q1)
			(on ce cd)
	...
	(:action observe13_put_k2_cb_p2_cc_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cc p2)
	...
	(:action observe14_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe16_take_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(in ca p1)
			(empty k1)
	...
	(:action observe18_put_k1_cd_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cd)
			(top cf p1)
	...
	(:action observe19_put_k2_ce_p2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe20_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
