...
(define
	...
	(:action observe6_put_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cc)
	...
	(:action observe14_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs13)
	...
	(:action observe15_put_k4_ce_p4_pallet_l6
		:parameters ()
		:precondition (and
			(top pallet p4)
			(holding k4 ce)
	...
	(:action observe16_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(holding k2 cd)
	...
	(:action observe18_unload_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe24_unload_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cf)
	...
	(:action observe28_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe31_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
