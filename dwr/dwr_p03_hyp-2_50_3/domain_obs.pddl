(define
	...
	(:action observe7_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe9_take_k1_cc_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe13_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe17_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe18_put_k2_cb_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cf p2)
	...
	(:action observe20_take_k3_cd_p3_ce_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cd p3)
	...
	(:action observe21_put_k2_cc_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top cb p2)
	...
	(:action observe23_unload_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cd)
	...
	(:action observe27_put_k3_ca_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top ce p3)
	...
	(:action observe29_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe30_put_k3_cd_p3_ca_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top ca p3)
