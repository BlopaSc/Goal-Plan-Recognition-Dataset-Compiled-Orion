(define
	...
	(:action observe10_put_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top pallet p2)
	...
	(:action observe23_put_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cd p2)
	...
	(:action observe32_load_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cb)
	...
	(:action observe35_put_k3_ca_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top cc p3)
	...
	(:action observe38_take_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in ce p2)
	...
	(:action observe40_put_k4_cf_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top pallet p4)
	...
	(:action observe42_take_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
	...
	(:action observe43_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe45_put_k3_cb_p3_ca_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top ca p3)
	...
	(:action observe47_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe48_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe50_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
