(define
	...
	(:action observe3_put_k4_cc_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cc)
			(top pallet p4)
	...
	(:action observe4_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top pallet p3)
	...
	(:action observe7_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ca)
