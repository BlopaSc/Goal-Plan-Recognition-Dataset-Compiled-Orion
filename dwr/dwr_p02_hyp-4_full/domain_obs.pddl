(define
	...
	(:action observe7_put_k2_cc_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet q2)
	...
	(:action observe10_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe11_put_k2_cb_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top pallet p2)
	...
	(:action observe12_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
