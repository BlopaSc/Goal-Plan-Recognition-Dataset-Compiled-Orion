(define
	...
	(:action observe4_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cf)
	...
	(:action observe12_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe14_unload_k2_ca_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ca)
	...
	(:action observe16_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe17_load_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cb)
	...
	(:action observe23_move_r1_l3_l6
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l6))
