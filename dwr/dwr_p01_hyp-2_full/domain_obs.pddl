(define
	...
	(:action observe1_put_k1_cc_q1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top cf q1)
	...
	(:action observe3_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe5_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe6_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe8_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe9_take_k1_cc_q1_cf_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc q1)
	...
	(:action observe10_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
	...
	(:action observe13_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf q1)
	...
	(:action observe14_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ca)
	...
	(:action observe15_put_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top cc p1)
	...
	(:action observe17_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe18_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe19_put_k2_ca_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top pallet p2)
	...
	(:action observe21_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe23_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd q1)
	...
	(:action observe24_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cd)
	...
	(:action observe25_put_k2_ce_p2_ca_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top ca p2)
	...
	(:action observe27_unload_k2_cd_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cd)
	...
	(:action observe28_take_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf p1)
	...
	(:action observe29_put_k2_cd_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cb q2)
	...
	(:action observe30_put_k1_cf_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet q1)
