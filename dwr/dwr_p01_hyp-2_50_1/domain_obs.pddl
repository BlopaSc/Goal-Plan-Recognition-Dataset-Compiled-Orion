(define
	...
	(:action observe1_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe2_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
	...
	(:action observe3_put_k2_cb_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top pallet q2)
	...
	(:action observe4_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf q1)
	...
	(:action observe5_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ca)
	...
	(:action observe6_put_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top cc p1)
	...
	(:action observe12_put_k2_ce_p2_ca_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top ca p2)
	...
	(:action observe13_take_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf p1)
	...
	(:action observe14_put_k2_cd_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cb q2)
	...
	(:action observe15_put_k1_cf_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet q1)
