(define
	...
	(:action observe4_put_k2_cc_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe6_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe9_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe10_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf q1)
	...
	(:action observe11_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe12_unload_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 ca)
	...
	(:action observe13_put_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top cf p1)
	...
	(:action observe14_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe16_put_k2_cb_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top pallet q2)
	...
	(:action observe18_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe20_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cd)
	...
	(:action observe21_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
