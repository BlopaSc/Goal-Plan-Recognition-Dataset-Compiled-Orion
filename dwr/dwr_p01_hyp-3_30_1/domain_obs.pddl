(define
	...
	(:action observe0_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(empty k1)
	...
	(:action observe3_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd q1)
	...
	(:action observe4_put_k2_ce_q2_cf_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cf q2)
	...
	(:action observe5_unload_k2_cd_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cd)
	...
	(:action observe6_put_k1_cc_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet q1)
	...
	(:action observe9_put_k2_cb_q2_ce_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top ce q2)
