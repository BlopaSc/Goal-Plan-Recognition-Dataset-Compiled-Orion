(define
	...
	(:action observe0_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(empty k1)
	...
	(:action observe2_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe6_put_k2_cd_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cf p2)
	...
	(:action observe8_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe9_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
