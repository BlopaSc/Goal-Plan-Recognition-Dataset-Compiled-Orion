(define
	...
	(:action observe1_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe5_put_k2_cd_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cf p2)
	...
	(:action observe7_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe8_put_k3_ce_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top pallet p3)
	...
	(:action observe12_put_k2_cb_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cc p2)
