(define
	...
	(:action observe1_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe5_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe11_put_k3_ce_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top pallet p3)
	...
	(:action observe12_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe17_put_k3_cd_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top ce p3)
	...
	(:action observe19_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe24_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe27_put_k2_cb_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cf p2)
	...
	(:action observe28_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe30_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe31_load_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cd)
	...
	(:action observe32_put_k2_cc_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top cb p2)
	...
	(:action observe33_unload_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cd)
	...
	(:action observe35_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe42_put_k3_cd_p3_ca_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top ca p3)
