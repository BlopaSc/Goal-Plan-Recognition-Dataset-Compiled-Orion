(define
	...
	(:action observe3_take_k1_ce_p1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe5_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd p1)
	...
	(:action observe6_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cd)
	...
	(:action observe16_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe25_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cf)
	...
	(:action observe29_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe30_take_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
