(define
	...
	(:action observe0_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(not (observation0))
			(holding k2 cf)
	...
	(:action observe3_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe4_put_k3_ce_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top pallet p3)
	...
	(:action observe6_take_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cf p2)
	...
	(:action observe7_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cf)
	...
	(:action observe9_put_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top ce p3)
	...
	(:action observe10_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe22_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe23_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe25_load_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cd)
	...
	(:action observe27_unload_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cd)
	...
	(:action observe28_put_k2_cd_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cc p2)
	...
	(:action observe34_put_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top ce p3)
