(define
	...
	(:action observe8_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cf)
	...
	(:action observe11_put_k4_cd_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cd)
			(top pallet p4)
	...
	(:action observe12_unload_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 ce)
	...
	(:action observe13_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l3))
	...
	(:action observe14_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe15_unload_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cb)
	...
	(:action observe16_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cf)
	...
	(:action observe23_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe24_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cf)
	...
	(:action observe25_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe27_put_k3_ca_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top pallet p3)
	...
	(:action observe28_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cf)
	...
	(:action observe29_put_k4_cb_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cb)
			(top ce p4)
	...
	(:action observe30_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe31_load_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 cb)
	...
	(:action observe32_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe35_unload_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cf)
	...
	(:action observe36_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l3))
	...
	(:action observe37_put_k4_cf_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top ce p4)
	...
	(:action observe38_unload_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cb)
