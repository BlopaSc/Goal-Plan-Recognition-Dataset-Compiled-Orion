(define
	...
	(:action observe2_take_k1_cc_p1_cf_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe5_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe16_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe17_unload_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cf)
	...
	(:action observe18_put_k4_cf_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top ce p4)
	...
	(:action observe19_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe24_unload_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cb)
	...
	(:action observe25_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe27_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ca)
