(define
	...
	(:action observe6_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe11_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe12_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cd)
	...
	(:action observe13_put_k2_ce_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top pallet p2)
	...
	(:action observe17_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe18_load_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cc)
	...
	(:action observe22_put_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top ce p2)
	...
	(:action observe23_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe25_put_k2_cc_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top cd p2)
