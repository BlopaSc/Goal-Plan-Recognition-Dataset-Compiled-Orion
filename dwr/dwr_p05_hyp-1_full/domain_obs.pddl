(define
	...
	(:action observe16_unload_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cf)
	...
	(:action observe19_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cf)
			(top pallet p2)
	...
	(:action observe25_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe28_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe30_put_k2_cc_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top cf p2)
	...
	(:action observe33_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe36_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe39_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe40_put_k3_cb_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top pallet p3)
	...
	(:action observe42_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe43_load_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 cd)
	...
	(:action observe45_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe46_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe49_move_r1_l1_l4
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l4))
	...
	(:action observe50_put_k3_cd_p3_cb_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top cb p3)
	...
	(:action observe52_put_k2_ce_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cc p2)
	...
	(:action observe53_put_k3_ca_p3_cd_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top cd p3)
