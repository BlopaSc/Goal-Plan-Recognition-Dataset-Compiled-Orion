(define
	...
	(:action observe2_take_k1_ce_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe7_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe9_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cf)
	...
	(:action observe11_take_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe17_load_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 cc)
