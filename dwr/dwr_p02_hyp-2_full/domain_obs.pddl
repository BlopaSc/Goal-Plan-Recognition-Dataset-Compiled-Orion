(define
	...
	(:action observe4_put_k1_cb_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cb)
			(top pallet q1)
	...
	(:action observe5_unload_k2_cc_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cc)
	...
	(:action observe9_put_k2_cc_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe11_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ca)
	...
	(:action observe12_put_k2_ca_p2_cc_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cc p2)
