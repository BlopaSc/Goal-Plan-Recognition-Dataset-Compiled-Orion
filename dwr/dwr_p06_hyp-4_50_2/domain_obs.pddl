(define
	...
	(:action observe6_put_k3_cf_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top cc p3)
	...
	(:action observe7_take_k1_ce_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe8_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe10_put_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top cf p3)
	...
	(:action observe14_take_k3_cf_p3_cc_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe17_put_k1_ce_p1_ca_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top ca p1)
	...
	(:action observe20_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe21_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe22_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cc)
	...
	(:action observe25_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe26_put_k4_cc_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cc)
			(top pallet p4)
	...
	(:action observe30_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe32_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe33_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe35_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe37_put_k3_ca_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top ce p3)
	...
	(:action observe40_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cc)
