(define
	...
	(:action observe3_take_k1_ce_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe11_unload_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cd)
	...
	(:action observe19_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cc)
	...
	(:action observe27_put_k3_cb_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top pallet p3)
	...
	(:action observe28_load_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 cc)
