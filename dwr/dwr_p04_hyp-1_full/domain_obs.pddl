(define
	...
	(:action observe10_take_k1_ce_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe14_put_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top pallet p2)
	...
	(:action observe16_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe26_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe31_put_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cd p2)
	...
	(:action observe39_move_r1_l4_l1
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l1))
	...
	(:action observe40_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe41_move_r1_l2_l3
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l3))
	...
	(:action observe42_load_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cb)
	...
	(:action observe46_put_k3_ca_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top cc p3)
	...
	(:action observe50_take_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in ce p2)
	...
	(:action observe52_load_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 ce)
	...
	(:action observe54_put_k4_cf_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top pallet p4)
	...
	(:action observe55_unload_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 ce)
	...
	(:action observe56_take_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
	...
	(:action observe57_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l3))
	...
	(:action observe58_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe59_move_r1_l3_l2
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l2))
	...
	(:action observe60_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe62_put_k3_cb_p3_ca_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top ca p3)
	...
	(:action observe63_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe64_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe65_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe66_load_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 ce)
	...
	(:action observe67_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe68_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe69_put_k3_cd_p3_cb_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top cb p3)
	...
	(:action observe70_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe71_put_k3_ce_p3_cd_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top cd p3)
