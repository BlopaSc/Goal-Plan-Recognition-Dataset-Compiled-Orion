(define
	...
	(:action observe6_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe9_take_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in ce p3)
	...
	(:action observe10_load_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 ce)
	...
	(:action observe11_take_k3_cf_p3_cc_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe13_put_k1_ce_p1_ca_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top ca p1)
	...
	(:action observe16_take_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cb p2)
	...
	(:action observe22_take_k4_cc_p4_pallet_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(in cc p4)
