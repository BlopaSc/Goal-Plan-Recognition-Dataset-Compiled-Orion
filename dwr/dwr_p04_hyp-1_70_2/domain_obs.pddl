(define
	...
	(:action observe15_unload_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cf)
	...
	(:action observe20_put_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cd p2)
	...
	(:action observe21_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe28_load_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cb)
	...
	(:action observe33_take_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in ce p2)
	...
	(:action observe37_put_k4_cf_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top pallet p4)
	...
	(:action observe43_put_k3_cb_p3_ca_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top ca p3)
	...
	(:action observe44_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe45_load_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 ce)
	...
	(:action observe46_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe47_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe48_put_k3_cd_p3_cb_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top cb p3)
