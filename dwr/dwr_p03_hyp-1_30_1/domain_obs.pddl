(define
	...
	(:action observe6_put_k2_ce_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top pallet p2)
	...
	(:action observe9_put_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cf p3)
	...
	(:action observe14_put_k2_ca_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top ce p2)
	...
	(:action observe15_unload_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cd)
	...
	(:action observe19_put_k2_cd_p2_ca_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top ca p2)
