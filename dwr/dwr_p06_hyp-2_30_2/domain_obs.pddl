(define
	...
	(:action observe1_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cf)
	...
	(:action observe8_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cf)
	...
	(:action observe14_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe15_put_k3_cb_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top pallet p3)
	...
	(:action observe16_put_k2_ca_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cf p2)
	...
	(:action observe17_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l3))
	...
	(:action observe18_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
