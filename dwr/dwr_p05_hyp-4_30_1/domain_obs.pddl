(define
	...
	(:action observe0_take_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(not (observation0))
			(empty k2)
	...
	(:action observe2_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe3_put_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top pallet p3)
	...
	(:action observe10_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe12_take_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in ce p3)
	...
	(:action observe14_unload_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 ce)
	...
	(:action observe15_unload_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cf)
	...
	(:action observe16_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe18_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cf)
	...
	(:action observe19_take_k1_ce_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe23_load_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cc)
	...
	(:action observe27_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe28_take_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe29_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe30_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cc)
	...
	(:action observe31_take_k4_ce_p4_ca_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(in ce p4)
