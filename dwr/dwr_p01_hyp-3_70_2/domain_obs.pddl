(define
	...
	(:action observe8_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe9_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd q1)
	...
	(:action observe14_put_k2_cd_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top pallet p2)
	...
	(:action observe15_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe21_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ca)
