(define
	...
	(:action observe5_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe8_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe15_put_k2_cb_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top pallet q2)
	...
	(:action observe17_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe19_put_k2_ce_p2_cc_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cc p2)
