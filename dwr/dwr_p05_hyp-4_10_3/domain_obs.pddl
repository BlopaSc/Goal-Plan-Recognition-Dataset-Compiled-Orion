(define
	...
	(:action observe2_put_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top cf p3)
	...
	(:action observe4_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe9_load_k4_ca_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 ca)
	...
	(:action observe11_put_k3_ca_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top cf p3)
