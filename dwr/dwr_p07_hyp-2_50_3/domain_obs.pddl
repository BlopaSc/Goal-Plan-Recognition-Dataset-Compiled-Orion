(define
	...
	(:action observe4_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe5_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cf)
	...
	(:action observe15_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe18_put_k2_cd_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cc p2)
	...
	(:action observe20_take_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe22_put_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top ce p3)
	...
	(:action observe24_put_k3_cb_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cf p3)
