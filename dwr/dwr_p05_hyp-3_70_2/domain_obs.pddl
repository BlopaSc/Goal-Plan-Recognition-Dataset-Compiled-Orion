(define
	...
	(:action observe0_unload_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(not (observation0))
			(at r1 l6)
	...
	(:action observe1_put_k4_cd_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 cd)
			(top pallet p4)
	...
	(:action observe4_take_k1_cc_p1_cf_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe5_load_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cc)
	...
	(:action observe7_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe10_take_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf p1)
	...
	(:action observe13_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top pallet p3)
	...
	(:action observe14_move_r1_l4_l1
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l1))
	...
	(:action observe15_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe18_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe19_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe20_unload_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 ce)
	...
	(:action observe21_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe22_take_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe23_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe24_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cf)
	...
	(:action observe25_put_k4_ce_p4_cd_l6
		:parameters ()
		:precondition (and
			(holding k4 ce)
			(top cd p4)
	...
	(:action observe28_put_k4_cf_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top ce p4)
	...
	(:action observe29_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe30_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe33_unload_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cb)
	...
	(:action observe34_put_k4_cb_p4_cf_l6
		:parameters ()
		:precondition (and
			(holding k4 cb)
			(top cf p4)
	...
	(:action observe38_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ca)
