(define
	...
	(:action observe3_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cf)
			(top pallet p2)
	...
	(:action observe8_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe11_take_k1_cc_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe13_load_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cc)
	...
	(:action observe15_put_k3_cd_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top pallet p3)
	...
	(:action observe19_load_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 ce)
	...
	(:action observe20_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe24_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe26_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe28_load_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 ce)
	...
	(:action observe29_put_k2_cb_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cf p2)
	...
	(:action observe31_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe35_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe36_put_k2_ce_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe38_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe39_put_k2_ca_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top ce p2)
	...
	(:action observe40_put_k2_cc_p2_ca_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top ca p2)
