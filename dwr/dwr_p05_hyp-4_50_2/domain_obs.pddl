(define
	...
	(:action observe10_take_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
	...
	(:action observe15_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe22_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe24_take_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in ce p3)
	...
	(:action observe25_load_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 ce)
	...
	(:action observe26_unload_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 ce)
	...
	(:action observe29_put_k1_ce_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top pallet p1)
	...
	(:action observe30_unload_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cf)
	...
	(:action observe34_take_k1_ce_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce p1)
	...
	(:action observe35_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top pallet p3)
	...
	(:action observe39_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe40_put_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cf p3)
	...
	(:action observe41_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l6))
	...
	(:action observe42_take_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cb p2)
	...
	(:action observe43_put_k4_ca_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 ca)
			(top pallet p4)
	...
	(:action observe44_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe45_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe46_take_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe47_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe48_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cc)
	...
	(:action observe49_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
	...
	(:action observe51_take_k4_ce_p4_ca_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(in ce p4)
	...
	(:action observe52_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe53_put_k1_ce_p1_cc_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top cc p1)
	...
	(:action observe55_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l5))
	...
	(:action observe56_load_k4_ca_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(holding k4 ca)
