(define
	...
	(:action observe10_put_k3_cb_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cf p3)
	...
	(:action observe17_load_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cb)
	...
	(:action observe18_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe19_unload_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cb)
	...
	(:action observe20_put_k1_cb_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cb)
			(top cf p1)
