(define
	...
	(:action observe0_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(empty k1)
	...
	(:action observe1_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe4_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe5_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
	...
	(:action observe7_put_k1_cf_p1_cc_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top cc p1)
	...
	(:action observe8_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe10_put_k2_ca_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top pallet p2)
	...
	(:action observe11_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe14_put_k2_ce_p2_ca_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top ca p2)
	...
	(:action observe15_put_k2_cd_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cb q2)
