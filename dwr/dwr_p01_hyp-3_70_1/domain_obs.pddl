(define
	...
	(:action observe0_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at r1 l1)
	...
	(:action observe2_unload_k2_cf_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cf)
	...
	(:action observe3_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe6_put_k2_cf_q2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cf)
			(top pallet q2)
	...
	(:action observe11_put_k1_cc_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet q1)
	...
	(:action observe13_put_k2_cd_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top pallet p2)
	...
	(:action observe16_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe17_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe18_put_k2_cb_q2_ce_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top ce q2)
	...
	(:action observe20_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ca)
	...
	(:action observe21_put_k2_ca_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cb q2)
