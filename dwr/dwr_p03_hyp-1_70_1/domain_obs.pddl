(define
	...
	(:action observe4_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ce)
	...
	(:action observe8_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd p1)
	...
	(:action observe12_put_k2_ce_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top pallet p2)
	...
	(:action observe13_move_r1_l3_l2
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l2))
	...
	(:action observe14_load_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cc)
	...
	(:action observe17_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe21_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe24_put_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cf p3)
	...
	(:action observe27_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe29_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe30_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cd)
	...
	(:action observe31_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe34_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ca p1)
	...
	(:action observe35_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 ca)
	...
	(:action observe36_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe37_put_k2_ca_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top ce p2)
	...
	(:action observe38_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe39_unload_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cd)
	...
	(:action observe41_load_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cb)
