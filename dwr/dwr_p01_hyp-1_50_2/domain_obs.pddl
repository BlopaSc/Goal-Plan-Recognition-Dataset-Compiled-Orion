(define
	...
	(:action observe1_unload_k2_cc_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cc)
	...
	(:action observe2_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe3_take_k1_cf_q1_ce_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cf q1)
	...
	(:action observe4_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe5_unload_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 ca)
	...
	(:action observe6_put_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top cf p1)
	...
	(:action observe7_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe9_put_k2_cb_p2_cc_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cc p2)
	...
	(:action observe10_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe14_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
