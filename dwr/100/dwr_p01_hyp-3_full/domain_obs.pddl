...
(define
	...
	(:action observe3_unload_k2_cf_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe4_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(in ce q1)
			(on ce cd)
	...
	(:action observe7_put_k2_cf_q2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet q2)
			(holding k2 cf)
	...
	(:action observe9_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe11_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
	...
	(:action observe13_put_k2_ce_q2_cf_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cf q2)
	...
	(:action observe16_unload_k2_cd_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe17_put_k1_cc_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet q1)
	...
	(:action observe21_put_k2_cd_p2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cd)
	...
	(:action observe23_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe27_put_k2_cb_q2_ce_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top ce q2)
	...
	(:action observe29_unload_k2_ca_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe30_put_k2_ca_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cb q2)
