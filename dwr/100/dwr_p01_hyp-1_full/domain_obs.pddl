...
(define
	...
	(:action observe19_put_k2_cb_p2_cc_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cc p2)
	...
	(:action observe23_take_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(in ca p1)
			(empty k1)
	...
	(:action observe25_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
	...
	(:action observe26_put_k1_cd_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cd)
			(top cf p1)
	...
	(:action observe27_unload_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe28_put_k2_ce_p2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe29_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
