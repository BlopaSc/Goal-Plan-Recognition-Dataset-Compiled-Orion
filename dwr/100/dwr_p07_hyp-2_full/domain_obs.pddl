...
(define
	...
	(:action observe10_take_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(on cf pallet)
			(in cf p2)
	...
	(:action observe11_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(holding k2 cf)
	...
	(:action observe14_put_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top ce p3)
	...
	(:action observe18_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(in cd p1)
			(on cd cc)
	...
	(:action observe19_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe24_unload_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe31_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe32_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cc)
	...
	(:action observe33_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(in cb p1)
			(on cb ca)
	...
	(:action observe35_load_k3_cd_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe38_put_k2_cd_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cc p2)
	...
	(:action observe39_move_r1_l3_l2
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs38)
	...
	(:action observe41_take_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe42_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe45_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs44)
	...
	(:action observe46_put_k3_cf_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top ce p3)
	...
	(:action observe47_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe48_put_k3_cb_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cf p3)
