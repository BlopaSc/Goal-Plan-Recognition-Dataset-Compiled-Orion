...
(define
	...
	(:action observe7_put_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cc)
	...
	(:action observe15_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(observed obs14)
	...
	(:action observe17_unload_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe19_put_k4_ce_p4_pallet_l6
		:parameters ()
		:precondition (and
			(top pallet p4)
			(holding k4 ce)
	...
	(:action observe20_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(holding k2 cd)
	...
	(:action observe21_move_r1_l3_l6
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs20)
	...
	(:action observe22_unload_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe25_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe27_put_k4_cd_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cd)
			(top ce p4)
	...
	(:action observe30_unload_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cf)
	...
	(:action observe33_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cf)
	...
	(:action observe35_take_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe36_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe39_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe40_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs39)
	...
	(:action observe43_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe45_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe52_put_k3_cb_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cb)
	...
	(:action observe53_put_k2_ca_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cf p2)
	...
	(:action observe54_move_r1_l3_l6
		:parameters ()
		:precondition (and
			(at r1 l3)
			(observed obs53)
	...
	(:action observe55_load_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe56_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs55)
	...
	(:action observe58_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(observed obs57)
	...
	(:action observe59_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe60_put_k1_cc_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cc)
			(top pallet p1)
