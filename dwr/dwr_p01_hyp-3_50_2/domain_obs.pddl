(define
	...
	(:action observe2_take_k1_ce_q1_cd_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in ce q1)
	...
	(:action observe4_unload_k2_ce_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 ce)
	...
	(:action observe6_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd q1)
	...
	(:action observe7_put_k2_ce_q2_cf_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cf q2)
	...
	(:action observe11_put_k2_cd_p2_pallet_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top pallet p2)
	...
	(:action observe13_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(at r1 l2)
			(loaded r1 cb)
	...
	(:action observe14_put_k2_cb_q2_ce_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top ce q2)
