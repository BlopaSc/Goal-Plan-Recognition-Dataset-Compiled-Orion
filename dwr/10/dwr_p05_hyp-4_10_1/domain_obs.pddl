...
(define
	...
	(:action observe3_unload_k4_ca_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe4_put_k1_ce_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top pallet p1)
	...
	(:action observe5_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cf)
	...
	(:action observe6_put_k3_cc_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cf p3)
	...
	(:action observe7_take_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(in cb p2)
			(on cb cd)
	...
	(:action observe8_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l4)
	...
	(:action observe9_load_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe10_take_k4_ca_p4_pallet_l6
		:parameters ()
		:precondition (and
			(on ca pallet)
			(empty k4)
