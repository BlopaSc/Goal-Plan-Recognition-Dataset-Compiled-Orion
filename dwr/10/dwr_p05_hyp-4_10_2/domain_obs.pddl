...
(define
	...
	(:action observe3_unload_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe4_take_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe6_take_k2_cc_p2_cb_l3
		:parameters ()
		:precondition (and
			(in cc p2)
			(empty k2)
	...
	(:action observe8_take_k4_ce_p4_ca_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(top ce p4)
	...
	(:action observe10_load_k4_ca_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
