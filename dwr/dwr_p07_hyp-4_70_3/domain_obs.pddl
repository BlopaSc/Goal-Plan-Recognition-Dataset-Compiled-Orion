(define
	...
	(:action observe11_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd p1)
	...
	(:action observe22_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe29_put_k3_cb_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cc p3)
	...
	(:action observe39_unload_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cf)
	...
	(:action observe42_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe43_take_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
	...
	(:action observe44_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe46_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe47_move_r1_l2_l3
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l3))
	...
	(:action observe49_load_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 ca)
