...
(define
	...
	(:action observe12_take_k3_cf_p3_cc_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(top cf p3)
	...
	(:action observe14_take_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe17_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe18_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe19_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(top pallet p3)
			(holding k3 cf)
	...
	(:action observe21_take_k2_cc_p2_cb_l3
		:parameters ()
		:precondition (and
			(in cc p2)
			(empty k2)
	...
	(:action observe23_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe29_unload_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
	...
	(:action observe33_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe34_put_k3_ca_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top cf p3)
