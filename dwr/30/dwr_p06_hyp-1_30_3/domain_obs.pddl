...
(define
	...
	(:action observe4_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(unloaded r1)
			(holding k2 cd)
	...
	(:action observe7_put_k3_cd_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top cc p3)
	...
	(:action observe8_load_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe12_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe13_put_k3_cb_p3_cf_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cf p3)
