...
(define
	...
	(:action observe0_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(unloaded r1)
	...
	(:action observe1_unload_k2_cb_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe5_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
	...
	(:action observe7_put_k2_ce_p2_ca_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top ca p2)
	...
	(:action observe8_put_k2_cd_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top cb q2)
