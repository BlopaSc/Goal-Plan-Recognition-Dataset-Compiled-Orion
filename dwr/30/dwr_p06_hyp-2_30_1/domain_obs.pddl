...
(define
	...
	(:action observe7_unload_k4_cd_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe11_unload_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cf)
	...
	(:action observe15_put_k2_ca_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cf p2)
	...
	(:action observe17_unload_k1_cc_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(empty k1)
