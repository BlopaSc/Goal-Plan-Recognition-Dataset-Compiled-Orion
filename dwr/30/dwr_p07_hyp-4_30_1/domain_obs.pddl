...
(define
	...
	(:action observe5_take_k1_cc_p1_cb_l1
		:parameters ()
		:precondition (and
			(in cc p1)
			(on cc cb)
	...
	(:action observe7_put_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top ce p2)
	...
	(:action observe11_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe16_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe19_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
