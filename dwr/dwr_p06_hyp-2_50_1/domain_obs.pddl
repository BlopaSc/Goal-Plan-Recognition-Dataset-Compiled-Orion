(define
	...
	(:action observe0_take_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(empty k1)
	...
	(:action observe9_put_k4_ce_p4_pallet_l6
		:parameters ()
		:precondition (and
			(holding k4 ce)
			(top pallet p4)
	...
	(:action observe10_move_r1_l3_l6
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l6))
	...
	(:action observe11_move_r1_l6_l5
		:parameters ()
		:precondition (and
			(at r1 l6)
			(not (occupied l5))
	...
	(:action observe12_move_r1_l5_l4
		:parameters ()
		:precondition (and
			(at r1 l5)
			(not (occupied l4))
	...
	(:action observe13_put_k4_cd_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cd)
			(top ce p4)
	...
	(:action observe17_put_k2_cf_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cf)
			(top pallet p2)
	...
	(:action observe19_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe21_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(at r1 l6)
			(loaded r1 cc)
	...
	(:action observe29_put_k2_ca_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cf p2)
