(define
	...
	(:action observe22_put_k3_cd_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cd)
			(top pallet p3)
	...
	(:action observe24_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe26_load_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 ce)
	...
	(:action observe27_put_k3_cc_p3_cd_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top cd p3)
	...
	(:action observe29_unload_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ce)
	...
	(:action observe34_load_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cb)
	...
	(:action observe37_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe39_load_k3_ce_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 ce)
	...
	(:action observe40_put_k2_cb_p2_cf_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cf p2)
	...
	(:action observe42_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe48_put_k2_ce_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe49_move_r1_l2_l3
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l3))
	...
	(:action observe50_unload_k2_ca_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ca)
	...
	(:action observe52_take_k3_cc_p3_cd_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe53_load_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cc)
	...
	(:action observe56_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe57_put_k2_cc_p2_ca_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top ca p2)
