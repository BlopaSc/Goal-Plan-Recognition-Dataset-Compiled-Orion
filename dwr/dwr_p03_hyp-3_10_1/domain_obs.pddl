(define
	...
	(:action observe0_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at r1 l1)
	...
	(:action observe1_load_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 ce)
	...
	(:action observe2_take_k1_cc_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe3_put_k3_ce_p3_cd_l4
		:parameters ()
		:precondition (and
			(holding k3 ce)
			(top cd p3)
	...
	(:action observe4_put_k3_cb_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top ce p3)
