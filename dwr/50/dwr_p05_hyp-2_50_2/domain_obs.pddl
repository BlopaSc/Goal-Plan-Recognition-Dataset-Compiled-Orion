...
(define
	...
	(:action observe11_put_k4_ce_p4_cd_l6
		:parameters ()
		:precondition (and
			(holding k4 ce)
			(top cd p4)
	...
	(:action observe14_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(observed obs13)
	...
	(:action observe19_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe22_load_k4_cf_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe23_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs22)
	...
	(:action observe25_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe26_put_k2_ca_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cc p2)
