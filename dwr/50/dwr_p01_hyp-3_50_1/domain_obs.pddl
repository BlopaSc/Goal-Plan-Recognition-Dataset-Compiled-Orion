...
(define
	...
	(:action observe3_put_k2_cf_q2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet q2)
			(holding k2 cf)
	...
	(:action observe4_take_k1_cd_q1_pallet_l1
		:parameters ()
		:precondition (and
			(in cd q1)
			(on cd pallet)
	...
	(:action observe6_put_k2_ce_q2_cf_l2
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cf q2)
	...
	(:action observe13_put_k2_cb_q2_ce_l2
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top ce q2)
	...
	(:action observe15_put_k2_ca_q2_cb_l2
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cb q2)
