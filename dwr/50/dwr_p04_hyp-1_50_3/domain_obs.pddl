...
(define
	...
	(:action observe26_take_k2_ce_p2_cd_l3
		:parameters ()
		:precondition (and
			(on ce cd)
			(empty k2)
	...
	(:action observe28_put_k4_cf_p4_pallet_l6
		:parameters ()
		:precondition (and
			(top pallet p4)
			(holding k4 cf)
	...
	(:action observe29_unload_k4_ce_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe30_take_k2_cd_p2_pallet_l3
		:parameters ()
		:precondition (and
			(in cd p2)
			(empty k2)
	...
	(:action observe31_move_r1_l6_l3
		:parameters ()
		:precondition (and
			(at r1 l6)
			(observed obs30)
