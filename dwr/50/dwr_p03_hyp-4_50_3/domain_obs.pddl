...
(define
	...
	(:action observe13_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe17_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe19_unload_k2_ce_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ce)
	...
	(:action observe21_put_k2_ce_p2_cb_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top cb p2)
	...
	(:action observe23_unload_k2_ca_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ca)
	...
	(:action observe24_take_k3_cc_p3_cd_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cc p3)
	...
	(:action observe28_put_k2_cc_p2_ca_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top ca p2)
