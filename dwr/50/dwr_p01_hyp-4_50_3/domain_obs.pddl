...
(define
	...
	(:action observe0_unload_k2_cc_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe2_put_k2_cc_p2_pallet_l2
		:parameters ()
		:precondition (and
			(top pallet p2)
			(holding k2 cc)
	...
	(:action observe6_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe7_put_k1_ca_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top cf p1)
	...
	(:action observe14_unload_k2_cd_r1_l2
		:parameters ()
		:precondition (and
			(empty k2)
			(at r1 l2)
	...
	(:action observe15_put_k1_ca_q1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 ca)
			(top pallet q1)
