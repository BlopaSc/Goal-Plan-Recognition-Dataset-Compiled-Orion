...
(define
	...
	(:action observe10_put_k2_cb_p2_cd_l3
		:parameters ()
		:precondition (and
			(holding k2 cb)
			(top cd p2)
	...
	(:action observe13_take_k3_ce_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(on ce cf)
	...
	(:action observe15_put_k1_ce_p1_ca_l1
		:parameters ()
		:precondition (and
			(holding k1 ce)
			(top ca p1)
	...
	(:action observe18_unload_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe20_take_k1_cf_p1_ce_l1
		:parameters ()
		:precondition (and
			(in cf p1)
			(on cf ce)
	...
	(:action observe22_load_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe23_put_k4_cc_p4_pallet_l6
		:parameters ()
		:precondition (and
			(top pallet p4)
			(holding k4 cc)
	...
	(:action observe25_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(at r1 l4)
	...
	(:action observe26_load_k1_ce_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe28_move_r1_l4_l5
		:parameters ()
		:precondition (and
			(at r1 l4)
			(observed obs27)
	...
	(:action observe29_load_k4_cc_r1_l6
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l6)
	...
	(:action observe30_unload_k2_cc_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cc)
	...
	(:action observe32_take_k1_ca_p1_pallet_l1
		:parameters ()
		:precondition (and
			(in ca p1)
			(on ca pallet)
	...
	(:action observe33_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
	...
	(:action observe36_put_k3_ca_p3_ce_l4
		:parameters ()
		:precondition (and
			(holding k3 ca)
			(top ce p3)
