...
(define
	...
	(:action observe6_take_k1_cc_p1_cf_l1
		:parameters ()
		:precondition (and
			(on cc cf)
			(in cc p1)
	...
	(:action observe19_put_k4_cf_p4_ce_l6
		:parameters ()
		:precondition (and
			(holding k4 cf)
			(top ce p4)
	...
	(:action observe24_move_r1_l5_l6
		:parameters ()
		:precondition (and
			(at r1 l5)
			(observed obs23)
	...
	(:action observe25_unload_k4_cb_r1_l6
		:parameters ()
		:precondition (and
			(empty k4)
			(at r1 l6)
	...
	(:action observe27_load_k1_ca_r1_l1
		:parameters ()
		:precondition (and
			(unloaded r1)
			(at r1 l1)
