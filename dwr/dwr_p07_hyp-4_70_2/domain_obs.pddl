(define
	...
	(:action observe0_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(not (observation0))
			(at r1 l3)
	...
	(:action observe1_unload_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cf)
	...
	(:action observe6_take_k1_cd_p1_cc_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cd p1)
	...
	(:action observe7_load_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(holding k1 cd)
	...
	(:action observe8_take_k1_cc_p1_cb_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cc p1)
	...
	(:action observe10_put_k2_ce_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 ce)
			(top pallet p2)
	...
	(:action observe11_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe12_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe13_put_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 cd)
			(top ce p2)
	...
	(:action observe15_take_k1_cb_p1_ca_l1
		:parameters ()
		:precondition (and
			(empty k1)
			(in cb p1)
	...
	(:action observe17_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe18_unload_k3_cc_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cc)
	...
	(:action observe19_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe24_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe25_put_k3_cc_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cc)
			(top pallet p3)
	...
	(:action observe26_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cb)
	...
	(:action observe28_put_k3_cb_p3_cc_l4
		:parameters ()
		:precondition (and
			(holding k3 cb)
			(top cc p3)
	...
	(:action observe34_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe35_unload_k3_ca_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 ca)
	...
	(:action observe36_move_r1_l4_l3
		:parameters ()
		:precondition (and
			(at r1 l4)
			(not (occupied l3))
	...
	(:action observe37_load_k2_cf_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cf)
	...
	(:action observe39_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe40_unload_k1_cf_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cf)
	...
	(:action observe41_move_r1_l1_l2
		:parameters ()
		:precondition (and
			(at r1 l1)
			(not (occupied l2))
	...
	(:action observe42_move_r1_l2_l3
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l3))
	...
	(:action observe44_take_k2_cd_p2_ce_l3
		:parameters ()
		:precondition (and
			(empty k2)
			(in cd p2)
	...
	(:action observe45_load_k2_cd_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cd)
	...
	(:action observe47_unload_k1_cd_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cd)
	...
	(:action observe48_move_r1_l3_l4
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l4))
	...
	(:action observe49_unload_k2_ca_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ca)
	...
	(:action observe50_put_k2_ca_p2_ce_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top ce p2)
	...
	(:action observe51_put_k1_cd_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cd)
			(top cf p1)
