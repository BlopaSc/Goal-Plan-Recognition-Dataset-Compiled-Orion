(define
	...
	(:action observe31_put_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(holding k3 cf)
			(top pallet p3)
	...
	(:action observe32_unload_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(loaded r1 cb)
	...
	(:action observe38_put_k2_cc_p2_pallet_l3
		:parameters ()
		:precondition (and
			(holding k2 cc)
			(top pallet p2)
	...
	(:action observe39_unload_k2_ca_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 ca)
	...
	(:action observe43_take_k3_cb_p3_cf_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cb p3)
	...
	(:action observe45_load_k3_cb_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cb)
	...
	(:action observe49_put_k2_ca_p2_cc_l3
		:parameters ()
		:precondition (and
			(holding k2 ca)
			(top cc p2)
	...
	(:action observe50_unload_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(loaded r1 cb)
	...
	(:action observe51_move_r1_l3_l2
		:parameters ()
		:precondition (and
			(at r1 l3)
			(not (occupied l2))
	...
	(:action observe52_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe53_take_k3_cf_p3_pallet_l4
		:parameters ()
		:precondition (and
			(empty k3)
			(in cf p3)
	...
	(:action observe55_load_k3_cf_r1_l4
		:parameters ()
		:precondition (and
			(at r1 l4)
			(holding k3 cf)
	...
	(:action observe60_load_k2_cb_r1_l3
		:parameters ()
		:precondition (and
			(at r1 l3)
			(holding k2 cb)
	...
	(:action observe62_put_k1_cf_p1_pallet_l1
		:parameters ()
		:precondition (and
			(holding k1 cf)
			(top pallet p1)
	...
	(:action observe63_move_r1_l2_l1
		:parameters ()
		:precondition (and
			(at r1 l2)
			(not (occupied l1))
	...
	(:action observe64_unload_k1_cb_r1_l1
		:parameters ()
		:precondition (and
			(at r1 l1)
			(loaded r1 cb)
	...
	(:action observe65_put_k1_cb_p1_cf_l1
		:parameters ()
		:precondition (and
			(holding k1 cb)
			(top cf p1)
	...
	(:action observe66_put_k4_ce_p4_cd_l6
		:parameters ()
		:precondition (and
			(holding k4 ce)
			(top cd p4)
