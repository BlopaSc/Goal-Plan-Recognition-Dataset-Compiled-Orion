...
This repository provides a structured collection of datasets for **goal and plan recognition as planning**, compiled from the original source: [pucrs-automated-planning/goal-plan-recognition-dataset](https://github.com/pucrs-automated-planning/goal-plan-recognition-dataset) retrieved on: 19/08/2025.
...
`<Repo_Root>/<Domain>/<Observability>/<Problem_Name>/<Files>`
