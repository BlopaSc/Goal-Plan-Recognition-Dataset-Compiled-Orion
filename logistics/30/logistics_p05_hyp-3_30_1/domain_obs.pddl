...
(define
	...
	(:action observe2_unload-airplane_obj11_apn3_apt2
		:parameters ()
		:precondition (and
			(at apn3 apt2)
			(in obj11 apn3)
	...
	(:action observe4_unload-truck_obj22_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj22 tru2)
	...
	(:action observe6_unload-airplane_obj22_apn2_apt1
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(in obj22 apn2)
	...
	(:action observe8_load-truck_obj22_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(at obj22 pos13)
