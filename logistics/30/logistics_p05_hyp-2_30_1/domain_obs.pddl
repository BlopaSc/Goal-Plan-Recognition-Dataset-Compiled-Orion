...
(define
	...
	(:action observe2_load-truck_obj13_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj13 apt2)
	...
	(:action observe3_unload-truck_obj13_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj13 tru2)
	...
	(:action observe5_load-airplane_obj23_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj23 apt2)
			(at apn2 apt2)
	...
	(:action observe7_load-truck_obj23_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj23 apt1)
	...
	(:action observe8_load-truck_obj23_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(at obj23 pos13)
	...
	(:action observe9_unload-truck_obj23_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj23 tru4)
