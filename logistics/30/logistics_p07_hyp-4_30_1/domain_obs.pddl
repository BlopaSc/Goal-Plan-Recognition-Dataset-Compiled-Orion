...
(define
	...
	(:action observe5_load-airplane_obj12_apn3_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt1)
			(at obj12 apt1)
	...
	(:action observe6_load-airplane_obj44_apn3_apt7
		:parameters ()
		:precondition (and
			(at obj44 apt7)
			(at apn3 apt7)
	...
	(:action observe8_drive-truck_tru2_apt7_pos22_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observed obs7)
	...
	(:action observe11_load-truck_obj44_tru2_pos21
		:parameters ()
		:precondition (and
			(at obj44 pos21)
			(at tru2 pos21)
	...
	(:action observe12_load-truck_obj21_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj21 apt1)
