...
(define
	...
	(:action observe1_load-airplane_obj13_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj13 apt1)
			(at apn1 apt1)
	...
	(:action observe2_unload-truck_obj55_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(in obj55 tru1)
	...
	(:action observe3_drive-truck_tru1_pos13_pos11_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observed obs2)
	...
	(:action observe4_drive-truck_tru4_apt1_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(observed obs3)
