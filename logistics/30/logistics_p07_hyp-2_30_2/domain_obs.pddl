...
(define
	...
	(:action observe1_load-truck_obj11_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj11 apt1)
	...
	(:action observe5_fly-airplane_apn3_apt1_apt7
		:parameters ()
		:precondition (and
			(at apn3 apt1)
			(observed obs4)
	...
	(:action observe7_load-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(at obj66 apt7)
			(at apn3 apt7)
	...
	(:action observe8_unload-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(at apn3 apt7)
			(in obj66 apn3)
	...
	(:action observe9_load-truck_obj11_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj11 apt7)
