(define
	...
	(:action observe4_unload-truck_obj22_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj22 tru2)
	...
	(:action observe5_load-airplane_obj22_apn1_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn1 apt2)
	...
	(:action observe7_unload-airplane_obj22_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn1)
			(at apn1 apt1)
	...
	(:action observe9_load-truck_obj22_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj22 apt1)
	...
	(:action observe15_drive-truck_tru1_apt1_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observation14)
	...
	(:action observe16_unload-truck_obj22_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj22 tru1)
