(define
	...
	(:action observe10_load-truck_obj13_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(at obj13 pos13)
	...
	(:action observe11_drive-truck_tru1_pos13_pos11_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observation10)
	...
	(:action observe12_unload-truck_obj13_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj13 tru1)
	...
	(:action observe13_drive-truck_tru1_pos11_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation12)
	...
	(:action observe14_unload-truck_obj23_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj23 tru1)
