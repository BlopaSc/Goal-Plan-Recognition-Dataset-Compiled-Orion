(define
	...
	(:action observe0_drive-truck_tru3_pos12_apt8_cit1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru3 pos12)
	...
	(:action observe1_unload-airplane_obj22_apn8_apt8
		:parameters ()
		:precondition (and
			(in obj22 apn8)
			(at apn8 apt8)
	...
	(:action observe2_load-truck_obj44_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(at obj44 pos21)
	...
	(:action observe3_load-truck_obj22_tru3_apt8
		:parameters ()
		:precondition (and
			(at tru3 apt8)
			(at obj22 apt8)
	...
	(:action observe4_unload-truck_obj22_tru3_pos13
		:parameters ()
		:precondition (and
			(at tru3 pos13)
			(in obj22 tru3)
