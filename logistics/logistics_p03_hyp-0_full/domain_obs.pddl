(define
	...
	(:action observe6_drive-truck_tru2_pos23_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(observation5)
	...
	(:action observe7_unload-truck_obj23_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj23 tru2)
	...
	(:action observe8_load-airplane_obj23_apn1_apt2
		:parameters ()
		:precondition (and
			(at obj23 apt2)
			(at apn1 apt2)
	...
	(:action observe10_unload-airplane_obj23_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj23 apn1)
			(at apn1 apt1)
	...
	(:action observe11_load-truck_obj23_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj23 apt1)
	...
	(:action observe18_unload-truck_obj23_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj23 tru1)
