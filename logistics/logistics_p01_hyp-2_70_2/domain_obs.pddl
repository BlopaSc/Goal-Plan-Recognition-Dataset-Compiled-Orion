(define
	...
	(:action observe3_unload-airplane_obj22_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn1)
			(at apn1 apt1)
	...
	(:action observe11_unload-truck_obj22_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj22 tru1)
	...
	(:action observe12_drive-truck_tru2_apt2_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observation11)
	...
	(:action observe13_unload-truck_obj13_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj13 tru2)
