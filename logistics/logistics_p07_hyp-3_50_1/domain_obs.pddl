(define
	...
	(:action observe8_load-truck_obj44_tru3_apt1
		:parameters ()
		:precondition (and
			(at tru3 apt1)
			(at obj44 apt1)
	...
	(:action observe10_load-airplane_obj44_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj44 apt1)
			(at apn3 apt1)
	...
	(:action observe11_load-truck_obj22_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj22 apt1)
	...
	(:action observe12_unload-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj66 apn3)
			(at apn3 apt7)
	...
	(:action observe13_unload-airplane_obj44_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj44 apn3)
			(at apn3 apt7)
	...
	(:action observe15_unload-truck_obj66_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj66 tru2)
	...
	(:action observe16_drive-truck_tru2_pos22_apt7_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(observation15)
