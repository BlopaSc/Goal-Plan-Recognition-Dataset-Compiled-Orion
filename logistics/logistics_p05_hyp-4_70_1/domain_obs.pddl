(define
	...
	(:action observe10_unload-truck_obj12_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj12 tru2)
	...
	(:action observe11_load-truck_obj12_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(at obj12 pos22)
	...
	(:action observe13_drive-truck_tru2_pos22_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(observation12)
	...
	(:action observe19_drive-truck_tru4_pos12_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru4 pos12)
			(observation18)
