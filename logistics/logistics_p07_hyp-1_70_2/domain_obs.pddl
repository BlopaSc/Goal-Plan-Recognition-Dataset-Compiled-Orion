(define
	...
	(:action observe18_load-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj66 apt1)
			(at apn3 apt1)
	...
	(:action observe19_load-truck_obj23_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj23 apt1)
	...
	(:action observe20_drive-truck_tru1_apt1_pos11_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observation19)
	...
	(:action observe21_unload-truck_obj23_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj23 tru1)
	...
	(:action observe22_unload-airplane_obj11_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj11 apn3)
			(at apn3 apt7)
	...
	(:action observe23_load-truck_obj11_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj11 apt7)
	...
	(:action observe24_drive-truck_tru2_apt7_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation23)
