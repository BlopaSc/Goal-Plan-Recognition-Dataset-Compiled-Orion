(define
	...
	(:action observe7_load-truck_obj22_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(at obj22 pos21)
	...
	(:action observe13_load-airplane_obj22_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn2 apt2)
	...
	(:action observe14_fly-airplane_apn2_apt2_apt1
		:parameters ()
		:precondition (and
			(at apn2 apt2)
			(observation13)
	...
	(:action observe15_unload-airplane_obj22_apn2_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn2)
			(at apn2 apt1)
