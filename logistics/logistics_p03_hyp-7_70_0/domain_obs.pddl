(define
	...
	(:action observe0_unload-truck_obj21_tru2_apt2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru2 apt2)
	...
	(:action observe1_load-airplane_obj21_apn1_apt2
		:parameters ()
		:precondition (and
			(at obj21 apt2)
			(at apn1 apt2)
	...
	(:action observe2_drive-truck_tru1_pos11_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation1)
	...
	(:action observe3_load-truck_obj12_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(at obj12 pos12)
	...
	(:action observe5_unload-airplane_obj21_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj21 apn1)
			(at apn1 apt1)
