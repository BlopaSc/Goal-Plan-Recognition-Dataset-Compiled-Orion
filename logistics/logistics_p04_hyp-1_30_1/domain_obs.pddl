(define
	...
	(:action observe9_load-airplane_obj44_apn7_apt8
		:parameters ()
		:precondition (and
			(at obj44 apt8)
			(at apn7 apt8)
	...
	(:action observe11_unload-airplane_obj21_apn8_apt8
		:parameters ()
		:precondition (and
			(in obj21 apn8)
			(at apn8 apt8)
	...
	(:action observe12_load-airplane_obj21_apn8_apt8
		:parameters ()
		:precondition (and
			(at obj21 apt8)
			(at apn8 apt8)
	...
	(:action observe13_drive-truck_tru2_apt7_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation12)
