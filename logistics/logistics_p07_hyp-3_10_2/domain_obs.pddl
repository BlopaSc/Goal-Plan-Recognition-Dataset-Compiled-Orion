(define
	...
	(:action observe0_load-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at obj66 apt1)
	...
	(:action observe1_drive-truck_tru4_apt1_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(observation0)
	...
	(:action observe2_unload-airplane_obj44_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj44 apn3)
			(at apn3 apt7)
	...
	(:action observe3_drive-truck_tru2_apt7_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation2)
