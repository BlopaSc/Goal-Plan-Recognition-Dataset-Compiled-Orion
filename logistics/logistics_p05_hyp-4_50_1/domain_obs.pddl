(define
	...
	(:action observe7_unload-airplane_obj12_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj12 apn1)
			(at apn1 apt2)
	...
	(:action observe11_unload-truck_obj12_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj12 tru2)
	...
	(:action observe14_drive-truck_tru4_pos12_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru4 pos12)
			(observation13)
	...
	(:action observe15_load-truck_obj22_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj22 apt1)
