(define
	...
	(:action observe1_drive-truck_tru2_pos21_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(observation0)
	...
	(:action observe4_drive-truck_tru1_pos11_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation3)
	...
	(:action observe5_drive-truck_tru1_pos13_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observation4)
	...
	(:action observe6_load-truck_obj22_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj22 apt1)
	...
	(:action observe8_load-airplane_obj12_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj12 apt1)
			(at apn1 apt1)
	...
	(:action observe11_unload-truck_obj22_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj22 tru1)
	...
	(:action observe12_drive-truck_tru2_apt2_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observation11)
	...
	(:action observe13_unload-truck_obj12_tru2_pos23
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(in obj12 tru2)
