(define
	...
	(:action observe4_load-airplane_obj44_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj44 apt1)
			(at apn3 apt1)
	...
	(:action observe6_unload-truck_obj22_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj22 tru4)
	...
	(:action observe7_unload-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj66 apn3)
			(at apn3 apt7)
	...
	(:action observe10_unload-truck_obj66_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj66 tru2)
