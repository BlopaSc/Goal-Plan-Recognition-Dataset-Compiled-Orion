(define
	...
	(:action observe8_load-truck_obj13_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(at obj13 pos13)
	...
	(:action observe11_unload-truck_obj13_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj13 tru1)
	...
	(:action observe12_load-airplane_obj13_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj13 apt1)
			(at apn1 apt1)
	...
	(:action observe14_unload-airplane_obj13_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj13 apn1)
			(at apn1 apt2)
	...
	(:action observe15_load-truck_obj13_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj13 apt2)
	...
	(:action observe19_unload-truck_obj13_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj13 tru2)
