(define
	...
	(:action observe5_unload-airplane_obj23_apn3_apt1
		:parameters ()
		:precondition (and
			(in obj23 apn3)
			(at apn3 apt1)
	...
	(:action observe6_load-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj66 apt1)
			(at apn3 apt1)
	...
	(:action observe7_unload-truck_obj23_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj23 tru1)
	...
	(:action observe8_load-truck_obj11_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj11 apt7)
