(define
	...
	(:action observe9_fly-airplane_apn1_apt1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt1)
			(observation8)
	...
	(:action observe10_unload-airplane_obj11_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj11 apn1)
			(at apn1 apt2)
	...
	(:action observe12_load-truck_obj21_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(at obj21 pos21)
	...
	(:action observe16_unload-truck_obj21_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj21 tru2)
	...
	(:action observe18_unload-airplane_obj21_apn2_apt2
		:parameters ()
		:precondition (and
			(in obj21 apn2)
			(at apn2 apt2)
	...
	(:action observe20_unload-airplane_obj21_apn2_apt1
		:parameters ()
		:precondition (and
			(in obj21 apn2)
			(at apn2 apt1)
	...
	(:action observe23_load-truck_obj21_tru4_pos12
		:parameters ()
		:precondition (and
			(at tru4 pos12)
			(at obj21 pos12)
