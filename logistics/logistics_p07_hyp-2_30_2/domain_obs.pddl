(define
	...
	(:action observe2_unload-truck_obj66_tru3_apt1
		:parameters ()
		:precondition (and
			(at tru3 apt1)
			(in obj66 tru3)
	...
	(:action observe5_unload-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(in obj66 apn3)
			(at apn3 apt7)
	...
	(:action observe7_drive-truck_tru2_apt7_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation6)
	...
	(:action observe11_unload-airplane_obj21_apn3_apt1
		:parameters ()
		:precondition (and
			(in obj21 apn3)
			(at apn3 apt1)
