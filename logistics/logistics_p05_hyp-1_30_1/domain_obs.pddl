(define
	...
	(:action observe7_unload-truck_obj11_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj11 tru2)
	...
	(:action observe8_drive-truck_tru4_apt1_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(observation7)
	...
	(:action observe9_load-airplane_obj21_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj21 apt2)
			(at apn2 apt2)
	...
	(:action observe10_unload-truck_obj21_tru4_pos12
		:parameters ()
		:precondition (and
			(at tru4 pos12)
			(in obj21 tru4)
