(define
	...
	(:action observe12_fly-airplane_apn3_apt2_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt2)
			(observation11)
	...
	(:action observe13_unload-airplane_obj23_apn3_apt1
		:parameters ()
		:precondition (and
			(in obj23 apn3)
			(at apn3 apt1)
	...
	(:action observe14_load-airplane_obj11_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn3 apt1)
	...
	(:action observe15_load-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj66 apt1)
			(at apn3 apt1)
