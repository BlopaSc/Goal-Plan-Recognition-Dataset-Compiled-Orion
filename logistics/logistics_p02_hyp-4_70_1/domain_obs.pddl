(define
	...
	(:action observe5_unload-airplane_obj22_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn1)
			(at apn1 apt1)
	...
	(:action observe6_drive-truck_tru1_pos11_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation5)
	...
	(:action observe7_load-truck_obj12_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(at obj12 pos13)
	...
	(:action observe8_load-truck_obj22_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj22 apt1)
	...
	(:action observe13_unload-truck_obj22_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj22 tru1)
