...
(define
	...
	(:action observe8_load-truck_obj23_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj23 apt1)
	...
	(:action observe14_drive-truck_tru1_apt1_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observed obs13)
	...
	(:action observe15_unload-truck_obj23_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj23 tru1)
	...
	(:action observe17_unload-truck_obj13_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj13 tru2)
