(define
	...
	(:action observe2_drive-truck_tru2_pos22_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(observation1)
	...
	(:action observe3_load-truck_obj23_tru2_pos23
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(at obj23 pos23)
	...
	(:action observe4_drive-truck_tru2_pos23_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(observation3)
	...
	(:action observe12_unload-truck_obj11_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj11 tru2)
	...
	(:action observe13_unload-truck_obj23_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj23 tru1)
