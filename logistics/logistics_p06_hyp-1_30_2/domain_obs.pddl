(define
	...
	(:action observe5_load-truck_obj13_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj13 apt2)
	...
	(:action observe6_fly-airplane_apn2_apt1_apt2
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(observation5)
	...
	(:action observe7_unload-truck_obj55_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(in obj55 tru4)
	...
	(:action observe8_load-airplane_obj55_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj55 apt1)
			(at apn3 apt1)
	...
	(:action observe10_load-airplane_obj22_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn2 apt2)
