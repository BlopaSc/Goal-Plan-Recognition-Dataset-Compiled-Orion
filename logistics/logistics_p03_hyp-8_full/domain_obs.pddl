(define
	...
	(:action observe11_unload-airplane_obj23_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj23 apn1)
			(at apn1 apt1)
	...
	(:action observe12_load-truck_obj23_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj23 apt1)
	...
	(:action observe18_drive-truck_tru1_apt1_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observation17)
	...
	(:action observe19_unload-truck_obj23_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(in obj23 tru1)
