(define
	...
	(:action observe4_unload-truck_obj55_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj55 tru1)
	...
	(:action observe8_unload-truck_obj23_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj23 tru2)
	...
	(:action observe9_fly-airplane_apn3_apt2_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt2)
			(observation8)
	...
	(:action observe10_load-airplane_obj23_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj23 apt1)
			(at apn3 apt1)
