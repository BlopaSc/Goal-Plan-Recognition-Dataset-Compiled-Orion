(define
	...
	(:action observe2_load-truck_obj23_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(at obj23 pos22)
	...
	(:action observe3_load-airplane_obj77_apn8_apt7
		:parameters ()
		:precondition (and
			(at obj77 apt7)
			(at apn8 apt7)
	...
	(:action observe5_drive-truck_tru1_pos11_apt8_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation4)
	...
	(:action observe8_unload-truck_obj77_tru1_apt8
		:parameters ()
		:precondition (and
			(at tru1 apt8)
			(in obj77 tru1)
	...
	(:action observe9_unload-truck_obj77_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj77 tru1)
