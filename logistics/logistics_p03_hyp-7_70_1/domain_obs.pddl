(define
	...
	(:action observe0_load-truck_obj21_tru2_pos21
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru2 pos21)
	...
	(:action observe4_unload-airplane_obj21_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj21 apn1)
			(at apn1 apt1)
	...
	(:action observe5_load-truck_obj21_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj21 apt1)
	...
	(:action observe6_unload-truck_obj12_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj12 tru1)
	...
	(:action observe11_unload-truck_obj21_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(in obj21 tru1)
