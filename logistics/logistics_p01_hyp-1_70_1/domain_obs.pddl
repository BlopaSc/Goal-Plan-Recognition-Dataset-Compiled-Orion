(define
	...
	(:action observe0_unload-truck_obj22_tru2_apt2
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru2 apt2)
	...
	(:action observe1_load-airplane_obj22_apn1_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn1 apt2)
	...
	(:action observe4_load-truck_obj12_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(at obj12 pos12)
	...
	(:action observe5_drive-truck_tru1_pos12_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(observation4)
	...
	(:action observe10_unload-airplane_obj12_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj12 apn1)
			(at apn1 apt2)
