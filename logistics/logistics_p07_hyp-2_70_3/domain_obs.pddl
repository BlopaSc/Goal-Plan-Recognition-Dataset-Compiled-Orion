(define
	...
	(:action observe10_load-truck_obj11_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj11 apt1)
	...
	(:action observe13_load-airplane_obj11_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn3 apt1)
	...
	(:action observe17_load-airplane_obj66_apn3_apt7
		:parameters ()
		:precondition (and
			(at obj66 apt7)
			(at apn3 apt7)
	...
	(:action observe23_fly-airplane_apn2_apt1_apt7
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(observation22)
