(define
	...
	(:action observe0_unload-truck_obj11_tru4_apt1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru4 apt1)
	...
	(:action observe1_unload-airplane_obj11_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj11 apn1)
			(at apn1 apt1)
	...
	(:action observe2_unload-airplane_obj11_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj11 apn1)
			(at apn1 apt2)
	...
	(:action observe3_drive-truck_tru4_pos12_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru4 pos12)
			(observation2)
