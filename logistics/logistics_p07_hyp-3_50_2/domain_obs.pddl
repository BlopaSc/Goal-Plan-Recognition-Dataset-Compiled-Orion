(define
	...
	(:action observe11_load-airplane_obj44_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj44 apt1)
			(at apn3 apt1)
	...
	(:action observe12_load-truck_obj22_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj22 apt1)
	...
	(:action observe13_unload-truck_obj22_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj22 tru4)
	...
	(:action observe15_load-truck_obj66_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj66 apt7)
