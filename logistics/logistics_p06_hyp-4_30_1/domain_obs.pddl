(define
	...
	(:action observe2_unload-truck_obj44_tru3_pos12
		:parameters ()
		:precondition (and
			(at tru3 pos12)
			(in obj44 tru3)
	...
	(:action observe3_drive-truck_tru3_pos12_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru3 pos12)
			(observation2)
	...
	(:action observe8_load-airplane_obj33_apn2_apt1
		:parameters ()
		:precondition (and
			(at obj33 apt1)
			(at apn2 apt1)
	...
	(:action observe9_drive-truck_tru2_pos23_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(observation8)
	...
	(:action observe10_unload-truck_obj33_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj33 tru2)
