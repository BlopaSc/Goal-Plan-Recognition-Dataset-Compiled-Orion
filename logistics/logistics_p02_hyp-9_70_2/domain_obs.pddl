(define
	...
	(:action observe6_load-truck_obj11_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(at obj11 pos13)
	...
	(:action observe7_drive-truck_tru1_pos13_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observation6)
	...
	(:action observe9_unload-truck_obj11_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj11 tru1)
	...
	(:action observe10_load-airplane_obj11_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn1 apt1)
	...
	(:action observe12_load-truck_obj11_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj11 apt2)
