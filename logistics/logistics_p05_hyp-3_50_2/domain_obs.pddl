(define
	...
	(:action observe2_load-airplane_obj11_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn3 apt1)
	...
	(:action observe8_drive-truck_tru2_pos23_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(observation7)
	...
	(:action observe9_unload-truck_obj22_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj22 tru2)
	...
	(:action observe12_unload-airplane_obj22_apn2_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn2)
			(at apn2 apt1)
	...
	(:action observe13_load-truck_obj22_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj22 apt1)
	...
	(:action observe14_load-truck_obj22_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(at obj22 pos13)
	...
	(:action observe15_unload-truck_obj22_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj22 tru4)
