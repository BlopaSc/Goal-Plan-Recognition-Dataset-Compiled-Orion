(define
	...
	(:action observe1_unload-truck_obj66_tru3_apt1
		:parameters ()
		:precondition (and
			(at tru3 apt1)
			(in obj66 tru3)
	...
	(:action observe2_fly-airplane_apn3_apt7_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt7)
			(observation1)
	...
	(:action observe3_drive-truck_tru2_apt7_pos22_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation2)
	...
	(:action observe4_unload-truck_obj21_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(in obj21 tru2)
