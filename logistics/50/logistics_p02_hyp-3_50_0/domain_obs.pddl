...
(define
	...
	(:action observe1_load-truck_obj22_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj22 apt1)
	...
	(:action observe2_unload-truck_obj13_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj13 tru1)
	...
	(:action observe3_load-airplane_obj13_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj13 apt1)
			(at apn1 apt1)
	...
	(:action observe5_unload-airplane_obj13_apn1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt2)
			(in obj13 apn1)
	...
	(:action observe8_unload-truck_obj22_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(in obj22 tru1)
