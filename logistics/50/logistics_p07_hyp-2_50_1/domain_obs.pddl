...
(define
	...
	(:action observe10_load-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt1)
			(at obj66 apt1)
	...
	(:action observe14_load-truck_obj11_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj11 apt7)
	...
	(:action observe15_unload-truck_obj11_tru2_pos23
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(in obj11 tru2)
	...
	(:action observe16_load-truck_obj66_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj66 apt7)
	...
	(:action observe17_unload-truck_obj66_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj66 tru2)
	...
	(:action observe20_load-truck_obj21_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj21 apt1)
