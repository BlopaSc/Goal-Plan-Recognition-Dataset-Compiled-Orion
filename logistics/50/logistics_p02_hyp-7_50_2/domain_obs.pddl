...
(define
	...
	(:action observe1_load-airplane_obj23_apn1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt2)
			(at obj23 apt2)
	...
	(:action observe2_load-truck_obj23_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj23 apt1)
	...
	(:action observe6_unload-truck_obj23_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj23 tru1)
	...
	(:action observe7_drive-truck_tru2_apt2_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observed obs6)
	...
	(:action observe8_unload-truck_obj13_tru2_pos23
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(in obj13 tru2)
