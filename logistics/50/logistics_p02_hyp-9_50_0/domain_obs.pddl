...
(define
	...
	(:action observe6_load-airplane_obj11_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn1 apt1)
	...
	(:action observe7_unload-airplane_obj11_apn1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt2)
			(in obj11 apn1)
	...
	(:action observe8_drive-truck_tru2_apt2_pos22_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observed obs7)
	...
	(:action observe9_unload-truck_obj11_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj11 tru2)
