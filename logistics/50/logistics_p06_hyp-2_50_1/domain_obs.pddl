...
(define
	...
	(:action observe7_unload-truck_obj44_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj44 tru2)
	...
	(:action observe9_load-truck_obj12_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(at obj12 pos13)
	...
	(:action observe12_load-truck_obj22_tru2_pos21
		:parameters ()
		:precondition (and
			(at obj22 pos21)
			(at tru2 pos21)
	...
	(:action observe16_load-airplane_obj22_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn2 apt2)
	...
	(:action observe19_load-truck_obj12_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(at obj12 pos22)
	...
	(:action observe20_unload-airplane_obj22_apn2_apt1
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(in obj22 apn2)
