...
(define
	...
	(:action observe0_fly-airplane_apn3_apt7_apt2
		:parameters ()
		:precondition (and
			(at apn3 apt7)
			(not (observed obs0))
	...
	(:action observe6_unload-truck_obj11_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj11 tru4)
	...
	(:action observe7_load-truck_obj66_tru3_pos12
		:parameters ()
		:precondition (and
			(at tru3 pos12)
			(at obj66 pos12)
	...
	(:action observe11_load-truck_obj66_tru3_apt1
		:parameters ()
		:precondition (and
			(at tru3 apt1)
			(at obj66 apt1)
	...
	(:action observe13_unload-airplane_obj66_apn3_apt1
		:parameters ()
		:precondition (and
			(at apn3 apt1)
			(in obj66 apn3)
	...
	(:action observe17_unload-truck_obj11_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj11 tru2)
