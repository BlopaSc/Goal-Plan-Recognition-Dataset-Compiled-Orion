...
(define
	...
	(:action observe5_load-airplane_obj12_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj12 apt1)
			(at apn1 apt1)
	...
	(:action observe6_drive-truck_tru1_apt1_pos12_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observed obs5)
	...
	(:action observe7_unload-truck_obj22_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj22 tru1)
	...
	(:action observe8_drive-truck_tru2_apt2_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observed obs7)
	...
	(:action observe9_unload-truck_obj12_tru2_pos23
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(in obj12 tru2)
