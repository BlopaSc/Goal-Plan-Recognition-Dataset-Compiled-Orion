...
(define
	...
	(:action observe6_load-truck_obj44_tru3_apt1
		:parameters ()
		:precondition (and
			(at tru3 apt1)
			(at obj44 apt1)
	...
	(:action observe9_load-truck_obj12_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj12 apt7)
	...
	(:action observe12_load-truck_obj44_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj44 apt7)
	...
	(:action observe16_unload-truck_obj44_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(in obj44 tru2)
