...
(define
	...
	(:action observe1_drive-truck_tru1_pos11_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observed obs0)
	...
	(:action observe2_load-truck_obj13_tru1_pos13
		:parameters ()
		:precondition (and
			(at obj13 pos13)
			(at tru1 pos13)
	...
	(:action observe3_drive-truck_tru1_pos13_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observed obs2)
	...
	(:action observe6_load-truck_obj13_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj13 apt2)
	...
	(:action observe7_drive-truck_tru1_apt1_pos11_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observed obs6)
