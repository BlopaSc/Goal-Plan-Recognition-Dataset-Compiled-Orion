...
(define
	...
	(:action observe2_drive-truck_tru1_pos11_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observed obs1)
	...
	(:action observe3_load-truck_obj12_tru1_pos13
		:parameters ()
		:precondition (and
			(at obj12 pos13)
			(at tru1 pos13)
	...
	(:action observe4_unload-truck_obj12_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj12 tru1)
	...
	(:action observe9_unload-truck_obj22_tru1_pos12
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(in obj22 tru1)
