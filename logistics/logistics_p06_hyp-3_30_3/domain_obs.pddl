(define
	...
	(:action observe6_drive-truck_tru2_pos21_pos22_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(observation5)
	...
	(:action observe7_load-truck_obj23_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(at obj23 pos22)
	...
	(:action observe8_load-airplane_obj23_apn3_apt2
		:parameters ()
		:precondition (and
			(at obj23 apt2)
			(at apn3 apt2)
	...
	(:action observe9_load-airplane_obj23_apn3_apt1
		:parameters ()
		:precondition (and
			(at obj23 apt1)
			(at apn3 apt1)
	...
	(:action observe11_load-truck_obj23_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj23 apt1)
