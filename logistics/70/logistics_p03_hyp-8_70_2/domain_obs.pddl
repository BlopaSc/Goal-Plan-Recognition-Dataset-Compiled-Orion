...
(define
	...
	(:action observe0_drive-truck_tru2_pos23_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(not (observed obs0))
	...
	(:action observe1_unload-truck_obj23_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj23 tru2)
	...
	(:action observe2_load-airplane_obj23_apn1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt2)
			(at obj23 apt2)
	...
	(:action observe3_load-truck_obj13_tru1_pos13
		:parameters ()
		:precondition (and
			(at obj13 pos13)
			(at tru1 pos13)
	...
	(:action observe4_drive-truck_tru1_pos13_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observed obs3)
	...
	(:action observe12_drive-truck_tru1_apt1_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observed obs11)
	...
	(:action observe13_unload-truck_obj23_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(in obj23 tru1)
