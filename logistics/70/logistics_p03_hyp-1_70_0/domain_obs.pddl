...
(define
	...
	(:action observe0_load-truck_obj12_tru1_pos12
		:parameters ()
		:precondition (and
			(at obj12 pos12)
			(at tru1 pos12)
	...
	(:action observe1_drive-truck_tru1_pos12_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos12)
			(observed obs0)
	...
	(:action observe2_unload-truck_obj12_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj12 tru1)
	...
	(:action observe3_load-airplane_obj12_apn2_apt1
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(at obj12 apt1)
	...
	(:action observe4_fly-airplane_apn2_apt1_apt2
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(observed obs3)
	...
	(:action observe5_unload-airplane_obj12_apn2_apt2
		:parameters ()
		:precondition (and
			(at apn2 apt2)
			(in obj12 apn2)
