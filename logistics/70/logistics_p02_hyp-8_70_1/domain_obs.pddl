...
(define
	...
	(:action observe3_unload-truck_obj22_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj22 tru2)
	...
	(:action observe4_load-airplane_obj22_apn1_apt2
		:parameters ()
		:precondition (and
			(at apn1 apt2)
			(at obj22 apt2)
	...
	(:action observe6_unload-airplane_obj22_apn1_apt1
		:parameters ()
		:precondition (and
			(at apn1 apt1)
			(in obj22 apn1)
	...
	(:action observe8_unload-truck_obj13_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj13 tru1)
	...
	(:action observe9_load-airplane_obj13_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj13 apt1)
			(at apn1 apt1)
