...
(define
	...
	(:action observe0_drive-truck_tru1_pos11_apt8_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(not (observed obs0))
	...
	(:action observe1_unload-airplane_obj88_apn8_apt8
		:parameters ()
		:precondition (and
			(at apn8 apt8)
			(in obj88 apn8)
	...
	(:action observe2_load-airplane_obj44_apn8_apt8
		:parameters ()
		:precondition (and
			(at obj44 apt8)
			(at apn8 apt8)
	...
	(:action observe3_load-truck_obj22_tru4_apt8
		:parameters ()
		:precondition (and
			(at tru4 apt8)
			(at obj22 apt8)
	...
	(:action observe4_load-truck_obj12_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(at obj12 apt7)
	...
	(:action observe5_load-truck_obj12_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(at obj12 pos22)
