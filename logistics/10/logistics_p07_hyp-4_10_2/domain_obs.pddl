...
(define
	...
	(:action observe0_unload-truck_obj12_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(in obj12 tru4)
	...
	(:action observe2_fly-airplane_apn2_apt1_apt2
		:parameters ()
		:precondition (and
			(at apn2 apt1)
			(observed obs1)
	...
	(:action observe3_unload-truck_obj21_tru2_apt7
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(in obj21 tru2)
	...
	(:action observe4_load-truck_obj21_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj21 apt1)
