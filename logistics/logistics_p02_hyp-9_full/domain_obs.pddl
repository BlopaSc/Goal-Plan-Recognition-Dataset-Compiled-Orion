(define
	...
	(:action observe1_load-truck_obj21_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(at obj21 pos21)
	...
	(:action observe2_drive-truck_tru2_pos21_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(observation1)
	...
	(:action observe3_unload-truck_obj21_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj21 tru2)
	...
	(:action observe4_load-airplane_obj21_apn1_apt2
		:parameters ()
		:precondition (and
			(at obj21 apt2)
			(at apn1 apt2)
	...
	(:action observe6_unload-airplane_obj21_apn1_apt1
		:parameters ()
		:precondition (and
			(in obj21 apn1)
			(at apn1 apt1)
	...
	(:action observe7_drive-truck_tru1_pos11_pos13_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(observation6)
	...
	(:action observe8_load-truck_obj11_tru1_pos13
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(at obj11 pos13)
	...
	(:action observe9_drive-truck_tru1_pos13_apt1_cit1
		:parameters ()
		:precondition (and
			(at tru1 pos13)
			(observation8)
	...
	(:action observe10_load-truck_obj21_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(at obj21 apt1)
	...
	(:action observe11_unload-truck_obj11_tru1_apt1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(in obj11 tru1)
	...
	(:action observe12_load-airplane_obj11_apn1_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn1 apt1)
	...
	(:action observe14_unload-airplane_obj11_apn1_apt2
		:parameters ()
		:precondition (and
			(in obj11 apn1)
			(at apn1 apt2)
	...
	(:action observe15_load-truck_obj11_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj11 apt2)
	...
	(:action observe16_drive-truck_tru1_apt1_pos11_cit1
		:parameters ()
		:precondition (and
			(at tru1 apt1)
			(observation15)
	...
	(:action observe17_unload-truck_obj21_tru1_pos11
		:parameters ()
		:precondition (and
			(at tru1 pos11)
			(in obj21 tru1)
	...
	(:action observe19_unload-truck_obj11_tru2_pos22
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(in obj11 tru2)
