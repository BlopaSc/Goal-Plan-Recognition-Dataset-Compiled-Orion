(define
	...
	(:action observe5_load-truck_obj11_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj11 apt2)
	...
	(:action observe7_drive-truck_tru2_pos21_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(observation6)
	...
	(:action observe9_drive-truck_tru2_pos23_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos23)
			(observation8)
	...
	(:action observe11_load-airplane_obj22_apn2_apt2
		:parameters ()
		:precondition (and
			(at obj22 apt2)
			(at apn2 apt2)
	...
	(:action observe13_unload-airplane_obj22_apn2_apt1
		:parameters ()
		:precondition (and
			(in obj22 apn2)
			(at apn2 apt1)
