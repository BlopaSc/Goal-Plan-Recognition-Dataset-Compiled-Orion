(define
	...
	(:action observe0_drive-truck_tru1_pos11_apt1_cit1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru1 pos11)
	...
	(:action observe1_load-airplane_obj11_apn2_apt1
		:parameters ()
		:precondition (and
			(at obj11 apt1)
			(at apn2 apt1)
	...
	(:action observe2_drive-truck_tru2_pos22_pos21_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos22)
			(observation1)
	...
	(:action observe3_load-truck_obj21_tru2_pos21
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(at obj21 pos21)
	...
	(:action observe4_drive-truck_tru2_pos21_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 pos21)
			(observation3)
	...
	(:action observe5_unload-truck_obj21_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(in obj21 tru2)
	...
	(:action observe9_unload-airplane_obj11_apn2_apt2
		:parameters ()
		:precondition (and
			(in obj11 apn2)
			(at apn2 apt2)
	...
	(:action observe10_drive-truck_tru2_apt2_pos23_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(observation9)
