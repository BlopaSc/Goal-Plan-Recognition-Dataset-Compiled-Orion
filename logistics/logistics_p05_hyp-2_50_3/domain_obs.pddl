(define
	...
	(:action observe4_load-truck_obj13_tru2_apt2
		:parameters ()
		:precondition (and
			(at tru2 apt2)
			(at obj13 apt2)
	...
	(:action observe12_load-truck_obj23_tru4_apt1
		:parameters ()
		:precondition (and
			(at tru4 apt1)
			(at obj23 apt1)
	...
	(:action observe14_load-truck_obj23_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(at obj23 pos13)
	...
	(:action observe15_unload-truck_obj23_tru4_pos13
		:parameters ()
		:precondition (and
			(at tru4 pos13)
			(in obj23 tru4)
