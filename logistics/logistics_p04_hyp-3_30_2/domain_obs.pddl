(define
	...
	(:action observe0_load-truck_obj77_tru2_pos22
		:parameters ()
		:precondition (and
			(not (observation0))
			(at tru2 pos22)
	...
	(:action observe1_fly-airplane_apn7_apt2_apt8
		:parameters ()
		:precondition (and
			(at apn7 apt2)
			(observation0)
	...
	(:action observe3_drive-truck_tru2_apt7_apt2_cit2
		:parameters ()
		:precondition (and
			(at tru2 apt7)
			(observation2)
	...
	(:action observe4_load-truck_obj13_tru1_apt8
		:parameters ()
		:precondition (and
			(at tru1 apt8)
			(at obj13 apt8)
	...
	(:action observe6_load-airplane_obj13_apn7_apt8
		:parameters ()
		:precondition (and
			(at obj13 apt8)
			(at apn7 apt8)
	...
	(:action observe7_fly-airplane_apn8_apt7_apt8
		:parameters ()
		:precondition (and
			(at apn8 apt7)
			(observation6)
	...
	(:action observe8_unload-airplane_obj77_apn8_apt8
		:parameters ()
		:precondition (and
			(in obj77 apn8)
			(at apn8 apt8)
	...
	(:action observe10_fly-airplane_apn7_apt8_apt2
		:parameters ()
		:precondition (and
			(at apn7 apt8)
			(observation9)
