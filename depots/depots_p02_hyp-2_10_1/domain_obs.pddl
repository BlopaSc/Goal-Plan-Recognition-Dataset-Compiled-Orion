(define
	...
	(:action observe0_load_hoist0_crate3_truck0_depot0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck0 depot0)
	...
	(:action observe1_load_hoist2_crate0_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(lifting hoist2 crate0)
	...
	(:action observe2_drop_hoist1_crate1_crate0_depot1
		:parameters ()
		:precondition (and
			(at crate0 depot1)
			(clear crate0)
