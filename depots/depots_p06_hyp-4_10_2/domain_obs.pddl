(define
	...
	(:action observe0_drop_hoist1_crate5_crate0_distributor0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at crate0 distributor0)
	...
	(:action observe1_drop_hoist1_crate0_crate5_distributor0
		:parameters ()
		:precondition (and
			(at crate5 distributor0)
			(clear crate5)
	...
	(:action observe2_drive_truck1_distributor0_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor0)
			(observation1)
