(define
	...
	(:action observe4_lift_hoist2_crate0_pallet2_depot2
		:parameters ()
		:precondition (and
			(available hoist2)
			(at crate0 depot2)
	...
	(:action observe6_unload_hoist2_crate1_truck0_depot2
		:parameters ()
		:precondition (and
			(at truck0 depot2)
			(available hoist2)
	...
	(:action observe7_drive_truck0_depot2_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot2)
			(observation6)
	...
	(:action observe8_unload_hoist1_crate0_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
	...
	(:action observe9_drop_hoist3_crate2_pallet3_distributor0
		:parameters ()
		:precondition (and
			(clear pallet3)
			(lifting hoist3 crate2)
