(define
	...
	(:action observe1_drive_truck1_distributor0_depot0
		:parameters ()
		:precondition (and
			(at truck1 distributor0)
			(observation0)
	...
	(:action observe2_unload_hoist2_crate0_truck1_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(available hoist2)
	...
	(:action observe3_lift_hoist2_crate4_pallet3_distributor1
		:parameters ()
		:precondition (and
			(available hoist2)
			(at crate4 distributor1)
	...
	(:action observe5_load_hoist1_crate5_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(lifting hoist1 crate5)
	...
	(:action observe6_drop_hoist1_crate1_crate8_distributor0
		:parameters ()
		:precondition (and
			(at crate8 distributor0)
			(clear crate8)
