(define
	...
	(:action observe2_lift_hoist0_crate2_crate1_depot0
		:parameters ()
		:precondition (and
			(available hoist0)
			(at crate2 depot0)
	...
	(:action observe7_drop_hoist2_crate2_pallet2_distributor0
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate2)
	...
	(:action observe8_unload_hoist2_crate5_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist2)
	...
	(:action observe9_drive_truck0_distributor0_depot1
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(observation8)
