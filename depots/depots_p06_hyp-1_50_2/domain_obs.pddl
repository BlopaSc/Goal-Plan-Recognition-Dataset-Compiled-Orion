(define
	...
	(:action observe0_load_hoist1_crate0_truck1_distributor0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 distributor0)
	...
	(:action observe1_lift_hoist0_crate2_pallet0_depot0
		:parameters ()
		:precondition (and
			(available hoist0)
			(at crate2 depot0)
	...
	(:action observe2_load_hoist0_crate2_truck1_depot0
		:parameters ()
		:precondition (and
			(at truck1 depot0)
			(lifting hoist0 crate2)
	...
	(:action observe3_unload_hoist2_crate0_truck1_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(available hoist2)
	...
	(:action observe4_lift_hoist2_crate7_crate4_distributor1
		:parameters ()
		:precondition (and
			(available hoist2)
			(at crate7 distributor1)
	...
	(:action observe5_drop_hoist2_crate2_crate7_distributor1
		:parameters ()
		:precondition (and
			(at crate7 distributor1)
			(clear crate7)
	...
	(:action observe7_drop_hoist0_crate4_pallet0_depot0
		:parameters ()
		:precondition (and
			(clear pallet0)
			(lifting hoist0 crate4)
	...
	(:action observe10_lift_hoist1_crate1_pallet1_distributor0
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate1 distributor0)
