(define
	...
	(:action observe1_unload_hoist2_crate1_truck0_depot2
		:parameters ()
		:precondition (and
			(at truck0 depot2)
			(available hoist2)
	...
	(:action observe2_drive_truck0_depot2_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot2)
			(observation1)
	...
	(:action observe3_drop_hoist1_crate0_pallet1_depot1
		:parameters ()
		:precondition (and
			(clear pallet1)
			(lifting hoist1 crate0)
	...
	(:action observe4_drop_hoist2_crate1_pallet2_depot2
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate1)
