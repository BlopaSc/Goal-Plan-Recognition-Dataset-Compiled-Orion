(define
	...
	(:action observe3_drop_hoist0_crate4_pallet0_depot0
		:parameters ()
		:precondition (and
			(clear pallet0)
			(lifting hoist0 crate4)
	...
	(:action observe4_unload_hoist1_crate2_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
	...
	(:action observe6_drive_truck0_depot1_distributor0
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(observation5)
	...
	(:action observe7_drop_hoist2_crate3_pallet2_distributor0
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate3)
	...
	(:action observe8_unload_hoist2_crate0_truck1_distributor0
		:parameters ()
		:precondition (and
			(at truck1 distributor0)
			(available hoist2)
