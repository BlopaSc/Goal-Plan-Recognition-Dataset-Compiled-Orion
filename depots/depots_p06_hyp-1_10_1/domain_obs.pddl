(define
	...
	(:action observe0_load_hoist0_crate2_truck1_depot0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 depot0)
	...
	(:action observe1_drop_hoist2_crate2_crate7_distributor1
		:parameters ()
		:precondition (and
			(at crate7 distributor1)
			(clear crate7)
	...
	(:action observe2_lift_hoist2_crate4_pallet3_distributor1
		:parameters ()
		:precondition (and
			(available hoist2)
			(at crate4 distributor1)
