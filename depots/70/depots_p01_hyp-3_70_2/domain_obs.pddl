...
(define
	...
	(:action observe4_drive_truck0_distributor2_distributor1
		:parameters ()
		:precondition (and
			(at truck0 distributor2)
			(observed obs3)
	...
	(:action observe5_drop_hoist4_crate1_pallet4_distributor1
		:parameters ()
		:precondition (and
			(clear pallet4)
			(lifting hoist4 crate1)
	...
	(:action observe6_drop_hoist5_crate2_pallet5_distributor2
		:parameters ()
		:precondition (and
			(clear pallet5)
			(lifting hoist5 crate2)
