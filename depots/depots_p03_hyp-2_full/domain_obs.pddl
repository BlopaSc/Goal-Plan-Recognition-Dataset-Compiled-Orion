(define
	...
	(:action observe5_drive_truck0_depot1_distributor0
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(observation4)
	...
	(:action observe6_unload_hoist2_crate1_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist2)
	...
	(:action observe7_drop_hoist2_crate1_pallet2_distributor0
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate1)
	...
	(:action observe8_unload_hoist2_crate0_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist2)
	...
	(:action observe9_drop_hoist2_crate0_crate1_distributor0
		:parameters ()
		:precondition (and
			(at crate1 distributor0)
			(clear crate1)
