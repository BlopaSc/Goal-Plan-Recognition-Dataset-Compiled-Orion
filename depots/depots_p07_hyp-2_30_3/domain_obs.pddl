(define
	...
	(:action observe0_lift_hoist1_crate1_crate0_distributor0
		:parameters ()
		:precondition (and
			(not (observation0))
			(available hoist1)
	...
	(:action observe1_load_hoist1_crate1_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(lifting hoist1 crate1)
	...
	(:action observe3_lift_hoist0_crate5_crate4_depot0
		:parameters ()
		:precondition (and
			(available hoist0)
			(at crate5 depot0)
	...
	(:action observe6_unload_hoist0_crate7_truck0_depot0
		:parameters ()
		:precondition (and
			(at truck0 depot0)
			(available hoist0)
