(define
	...
	(:action observe4_drop_hoist1_crate2_crate3_distributor0
		:parameters ()
		:precondition (and
			(at crate3 distributor0)
			(clear crate3)
	...
	(:action observe14_load_hoist2_crate9_truck1_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(lifting hoist2 crate9)
	...
	(:action observe15_unload_hoist2_crate8_truck1_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(available hoist2)
	...
	(:action observe16_drop_hoist2_crate8_pallet2_distributor1
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate8)
