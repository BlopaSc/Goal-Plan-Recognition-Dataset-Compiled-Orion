(define
	...
	(:action observe0_drive_truck1_distributor0_distributor1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 distributor0)
	...
	(:action observe2_drive_truck1_distributor1_depot0
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(observation1)
	...
	(:action observe6_lift_hoist1_crate6_crate5_distributor0
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate6 distributor0)
