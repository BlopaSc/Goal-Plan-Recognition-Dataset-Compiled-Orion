(define
	...
	(:action observe2_drive_truck0_distributor2_depot2
		:parameters ()
		:precondition (and
			(at truck0 distributor2)
			(observation1)
	...
	(:action observe3_lift_hoist2_crate2_crate0_depot2
		:parameters ()
		:precondition (and
			(available hoist2)
			(at crate2 depot2)
	...
	(:action observe5_drive_truck0_depot2_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot2)
			(observation4)
	...
	(:action observe7_drop_hoist2_crate1_pallet2_depot2
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate1)
