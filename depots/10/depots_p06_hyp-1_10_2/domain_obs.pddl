...
(define
	...
	(:action observe0_unload_hoist2_crate2_truck1_distributor1
		:parameters ()
		:precondition (and
			(available hoist2)
			(at truck1 distributor1)
	...
	(:action observe1_load_hoist2_crate4_truck1_distributor1
		:parameters ()
		:precondition (and
			(at truck1 distributor1)
			(lifting hoist2 crate4)
	...
	(:action observe2_unload_hoist0_crate4_truck1_depot0
		:parameters ()
		:precondition (and
			(available hoist0)
			(at truck1 depot0)
