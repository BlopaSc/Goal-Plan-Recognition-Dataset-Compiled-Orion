(define
	...
	(:action observe4_drive_truck0_depot1_distributor1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(observation3)
	...
	(:action observe5_drop_hoist3_crate0_pallet3_distributor1
		:parameters ()
		:precondition (and
			(clear pallet3)
			(lifting hoist3 crate0)
	...
	(:action observe6_unload_hoist3_crate1_truck0_distributor1
		:parameters ()
		:precondition (and
			(at truck0 distributor1)
			(available hoist3)
