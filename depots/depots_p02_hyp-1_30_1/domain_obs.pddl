(define
	...
	(:action observe6_unload_hoist0_crate5_truck0_depot0
		:parameters ()
		:precondition (and
			(at truck0 depot0)
			(available hoist0)
	...
	(:action observe7_drop_hoist2_crate0_crate3_distributor0
		:parameters ()
		:precondition (and
			(at crate3 distributor0)
			(clear crate3)
	...
	(:action observe8_drop_hoist1_crate1_crate2_depot1
		:parameters ()
		:precondition (and
			(at crate2 depot1)
			(clear crate2)
