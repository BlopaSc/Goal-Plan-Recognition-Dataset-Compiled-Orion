(define
	...
	(:action observe0_unload_hoist0_crate1_truck0_depot0
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck0 depot0)
	...
	(:action observe2_drop_hoist1_crate6_pallet1_distributor0
		:parameters ()
		:precondition (and
			(clear pallet1)
			(lifting hoist1 crate6)
	...
	(:action observe3_drop_hoist1_crate0_crate6_distributor0
		:parameters ()
		:precondition (and
			(at crate6 distributor0)
			(clear crate6)
