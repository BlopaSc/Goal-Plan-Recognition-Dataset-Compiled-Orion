(define
	...
	(:action observe1_unload_hoist1_crate0_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
	...
	(:action observe3_unload_hoist3_crate2_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist3)
	...
	(:action observe4_drop_hoist3_crate2_pallet3_distributor0
		:parameters ()
		:precondition (and
			(clear pallet3)
			(lifting hoist3 crate2)
