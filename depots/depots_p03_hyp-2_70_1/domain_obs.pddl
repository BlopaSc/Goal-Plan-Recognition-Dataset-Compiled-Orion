(define
	...
	(:action observe1_drive_truck0_depot0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot0)
			(observation0)
	...
	(:action observe2_load_hoist1_crate0_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(lifting hoist1 crate0)
	...
	(:action observe3_drive_truck0_depot1_distributor0
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(observation2)
	...
	(:action observe4_unload_hoist2_crate1_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist2)
	...
	(:action observe5_unload_hoist2_crate0_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(available hoist2)
	...
	(:action observe6_drop_hoist2_crate0_crate1_distributor0
		:parameters ()
		:precondition (and
			(at crate1 distributor0)
			(clear crate1)
