...
(define
	...
	(:action observe4_unload_hoist0_crate4_truck0_depot0
		:parameters ()
		:precondition (and
			(available hoist0)
			(at truck0 depot0)
	...
	(:action observe5_unload_hoist2_crate5_truck0_distributor0
		:parameters ()
		:precondition (and
			(available hoist2)
			(at truck0 distributor0)
	...
	(:action observe7_drop_hoist1_crate3_pallet1_depot1
		:parameters ()
		:precondition (and
			(clear pallet1)
			(lifting hoist1 crate3)
	...
	(:action observe8_unload_hoist1_crate1_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
