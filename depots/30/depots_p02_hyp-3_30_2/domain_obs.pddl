...
(define
	...
	(:action observe4_load_hoist2_crate0_truck0_distributor0
		:parameters ()
		:precondition (and
			(at truck0 distributor0)
			(lifting hoist2 crate0)
	...
	(:action observe5_unload_hoist1_crate3_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
	...
	(:action observe6_drop_hoist1_crate3_pallet1_depot1
		:parameters ()
		:precondition (and
			(clear pallet1)
			(lifting hoist1 crate3)
