...
(define
	...
	(:action observe5_unload_hoist1_crate4_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(available hoist1)
	...
	(:action observe6_drop_hoist1_crate4_pallet1_depot1
		:parameters ()
		:precondition (and
			(clear pallet1)
			(lifting hoist1 crate4)
	...
	(:action observe8_drop_hoist2_crate3_pallet2_distributor0
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate3)
