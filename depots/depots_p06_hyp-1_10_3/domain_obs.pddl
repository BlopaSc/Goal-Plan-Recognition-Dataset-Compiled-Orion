(define
	...
	(:action observe0_unload_hoist2_crate0_truck1_distributor1
		:parameters ()
		:precondition (and
			(not (observation0))
			(at truck1 distributor1)
	...
	(:action observe1_drop_hoist2_crate0_crate9_distributor1
		:parameters ()
		:precondition (and
			(at crate9 distributor1)
			(clear crate9)
	...
	(:action observe2_lift_hoist1_crate5_crate1_distributor0
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate5 distributor0)
