...
(define
	...
	(:action observe5_lift_hoist1_crate5_crate1_distributor0
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate5 distributor0)
	...
	(:action observe7_lift_hoist1_crate5_crate0_distributor0
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate5 distributor0)
	...
	(:action observe8_lift_hoist1_crate0_pallet4_distributor0
		:parameters ()
		:precondition (and
			(clear crate0)
			(available hoist1)
	...
	(:action observe11_drop_hoist2_crate8_pallet2_distributor1
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate8)
