...
(define
	...
	(:action observe7_load_hoist1_crate5_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(lifting hoist1 crate5)
	...
	(:action observe9_drop_hoist1_crate0_crate3_depot1
		:parameters ()
		:precondition (and
			(clear crate3)
			(at crate3 depot1)
	...
	(:action observe13_drop_hoist2_crate4_pallet2_distributor0
		:parameters ()
		:precondition (and
			(clear pallet2)
			(lifting hoist2 crate4)
