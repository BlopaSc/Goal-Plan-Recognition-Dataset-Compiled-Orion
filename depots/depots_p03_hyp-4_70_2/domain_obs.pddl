(define
	...
	(:action observe2_lift_hoist1_crate0_pallet1_depot1
		:parameters ()
		:precondition (and
			(available hoist1)
			(at crate0 depot1)
	...
	(:action observe3_load_hoist1_crate0_truck0_depot1
		:parameters ()
		:precondition (and
			(at truck0 depot1)
			(lifting hoist1 crate0)
	...
	(:action observe4_drop_hoist3_crate0_pallet3_distributor1
		:parameters ()
		:precondition (and
			(clear pallet3)
			(lifting hoist3 crate0)
	...
	(:action observe5_unload_hoist3_crate1_truck0_distributor1
		:parameters ()
		:precondition (and
			(at truck0 distributor1)
			(available hoist3)
	...
	(:action observe6_drop_hoist3_crate1_crate0_distributor1
		:parameters ()
		:precondition (and
			(at crate0 distributor1)
			(clear crate0)
