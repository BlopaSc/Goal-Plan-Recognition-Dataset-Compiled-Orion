(define
	...
	(:action observe0_break-into_libra
		:parameters ()
		:precondition (and
			(not (observation0))
			(recon-performed libra)
	...
	(:action observe1_recon_sagittarius
		:parameters ()
		:precondition (and
			(observation0)
			(not (observation1))
	...
	(:action observe2_clean_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observation1)
	...
	(:action observe3_download-files_sagittarius
		:parameters ()
		:precondition (and
			(root-access-obtained sagittarius)
			(observation2)
	...
	(:action observe4_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observation3)
	...
	(:action observe5_gain-root_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observation4)
	...
	(:action observe6_download-files_virgo
		:parameters ()
		:precondition (and
			(root-access-obtained virgo)
			(observation5)
