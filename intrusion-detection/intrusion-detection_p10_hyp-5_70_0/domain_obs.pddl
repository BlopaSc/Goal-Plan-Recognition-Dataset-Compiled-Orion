(define
	...
	(:action observe2_recon_cassiopea
		:parameters ()
		:precondition (and
			(observation1)
			(not (observation2))
	...
	(:action observe3_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observation2)
	...
	(:action observe4_gain-root_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation3)
	...
	(:action observe5_download-files_cassiopea
		:parameters ()
		:precondition (and
			(root-access-obtained cassiopea)
			(observation4)
	...
	(:action observe8_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observation7)
