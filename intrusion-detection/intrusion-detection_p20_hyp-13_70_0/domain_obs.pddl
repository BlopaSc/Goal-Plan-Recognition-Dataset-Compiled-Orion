(define
	...
	(:action observe0_break-into_scorpio
		:parameters ()
		:precondition (and
			(not (observation0))
			(recon-performed scorpio)
	...
	(:action observe1_modify-files_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observation0)
	...
	(:action observe3_gain-root_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observation2)
	...
	(:action observe6_gain-root_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observation5)
	...
	(:action observe7_download-files_virgo
		:parameters ()
		:precondition (and
			(root-access-obtained virgo)
			(observation6)
