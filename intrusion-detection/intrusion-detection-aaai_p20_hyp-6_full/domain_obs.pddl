(define
	...
	(:action observe7_gain-root_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observation6)
	...
	(:action observe8_download-files_sagittarius
		:parameters ()
		:precondition (and
			(root-access-obtained sagittarius)
			(observation7)
	...
	(:action observe10_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observation9)
	...
	(:action observe12_gain-root_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observation11)
	...
	(:action observe13_download-files_virgo
		:parameters ()
		:precondition (and
			(root-access-obtained virgo)
			(observation12)
