(define
	...
	(:action observe1_break-into_leo
		:parameters ()
		:precondition (and
			(recon-performed leo)
			(observation0)
	...
	(:action observe2_modify-files_leo
		:parameters ()
		:precondition (and
			(access-obtained leo)
			(observation1)
	...
	(:action observe5_break-into_libra
		:parameters ()
		:precondition (and
			(recon-performed libra)
			(observation4)
	...
	(:action observe7_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observation6)
	...
	(:action observe8_download-files_libra
		:parameters ()
		:precondition (and
			(root-access-obtained libra)
			(observation7)
	...
	(:action observe9_recon_andromeda
		:parameters ()
		:precondition (and
			(observation8)
			(not (observation9))
	...
	(:action observe10_break-into_andromeda
		:parameters ()
		:precondition (and
			(recon-performed andromeda)
			(observation9)
	...
	(:action observe11_clean_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observation10)
	...
	(:action observe12_gain-root_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observation11)
	...
	(:action observe13_download-files_andromeda
		:parameters ()
		:precondition (and
			(root-access-obtained andromeda)
			(observation12)
