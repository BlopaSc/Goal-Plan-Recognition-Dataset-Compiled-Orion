(define
	...
	(:action observe0_recon_andromeda
		:parameters ()
	...
	(:action observe1_break-into_andromeda
		:parameters ()
		:precondition (and
			(recon-performed andromeda)
			(observation0)
	...
	(:action observe2_clean_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observation1)
	...
	(:action observe3_gain-root_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observation2)
	...
	(:action observe4_download-files_andromeda
		:parameters ()
		:precondition (and
			(root-access-obtained andromeda)
			(observation3)
	...
	(:action observe6_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(observation5)
	...
	(:action observe8_gain-root_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observation7)
	...
	(:action observe9_download-files_aries
		:parameters ()
		:precondition (and
			(root-access-obtained aries)
			(observation8)
	...
	(:action observe11_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observation10)
	...
	(:action observe13_gain-root_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observation12)
	...
	(:action observe14_download-files_taurus
		:parameters ()
		:precondition (and
			(root-access-obtained taurus)
			(observation13)
