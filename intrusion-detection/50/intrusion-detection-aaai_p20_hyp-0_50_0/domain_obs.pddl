...
(define
	...
	(:action observe0_modify-files_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(not (observed obs0))
	...
	(:action observe4_break-into_perseus
		:parameters ()
		:precondition (and
			(recon-performed perseus)
			(observed obs3)
	...
	(:action observe5_modify-files_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observed obs4)
