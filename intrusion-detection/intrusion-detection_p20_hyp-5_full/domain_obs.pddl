(define
	...
	(:action observe6_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation5)
	...
	(:action observe7_gain-root_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation6)
	...
	(:action observe8_download-files_cassiopea
		:parameters ()
		:precondition (and
			(root-access-obtained cassiopea)
			(observation7)
	...
	(:action observe10_break-into_libra
		:parameters ()
		:precondition (and
			(recon-performed libra)
			(observation9)
	...
	(:action observe12_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observation11)
	...
	(:action observe13_download-files_libra
		:parameters ()
		:precondition (and
			(root-access-obtained libra)
			(observation12)
