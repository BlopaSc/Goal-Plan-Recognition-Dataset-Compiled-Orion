(define
	...
	(:action observe1_break-into_libra
		:parameters ()
		:precondition (and
			(recon-performed libra)
			(observation0)
	...
	(:action observe2_modify-files_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observation1)
	...
	(:action observe5_break-into_perseus
		:parameters ()
		:precondition (and
			(recon-performed perseus)
			(observation4)
	...
	(:action observe7_gain-root_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observation6)
	...
	(:action observe8_download-files_perseus
		:parameters ()
		:precondition (and
			(root-access-obtained perseus)
			(observation7)
	...
	(:action observe9_recon_cassiopea
		:parameters ()
		:precondition (and
			(observation8)
			(not (observation9))
	...
	(:action observe10_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observation9)
	...
	(:action observe11_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation10)
	...
	(:action observe12_gain-root_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation11)
	...
	(:action observe13_download-files_cassiopea
		:parameters ()
		:precondition (and
			(root-access-obtained cassiopea)
			(observation12)
