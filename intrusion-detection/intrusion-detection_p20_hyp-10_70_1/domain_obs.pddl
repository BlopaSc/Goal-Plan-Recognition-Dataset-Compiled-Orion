(define
	...
	(:action observe0_break-into_andromeda
		:parameters ()
		:precondition (and
			(not (observation0))
			(recon-performed andromeda)
	...
	(:action observe1_gain-root_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observation0)
	...
	(:action observe2_download-files_andromeda
		:parameters ()
		:precondition (and
			(root-access-obtained andromeda)
			(observation1)
	...
	(:action observe6_gain-root_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observation5)
	...
	(:action observe7_download-files_aries
		:parameters ()
		:precondition (and
			(root-access-obtained aries)
			(observation6)
	...
	(:action observe9_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observation8)
	...
	(:action observe10_download-files_taurus
		:parameters ()
		:precondition (and
			(root-access-obtained taurus)
			(observation9)
