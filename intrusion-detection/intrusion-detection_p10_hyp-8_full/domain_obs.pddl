(define
	...
	(:action observe6_modify-files_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observation5)
	...
	(:action observe7_clean_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observation6)
	...
	(:action observe9_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observation8)
	...
	(:action observe11_gain-root_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observation10)
	...
	(:action observe12_download-files_virgo
		:parameters ()
		:precondition (and
			(root-access-obtained virgo)
			(observation11)
