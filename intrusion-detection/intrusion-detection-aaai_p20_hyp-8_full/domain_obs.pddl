(define
	...
	(:action observe1_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(observation0)
	...
	(:action observe2_modify-files_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observation1)
	...
	(:action observe10_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observation9)
	...
	(:action observe12_gain-root_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observation11)
	...
	(:action observe13_download-files_taurus
		:parameters ()
		:precondition (and
			(root-access-obtained taurus)
			(observation12)
