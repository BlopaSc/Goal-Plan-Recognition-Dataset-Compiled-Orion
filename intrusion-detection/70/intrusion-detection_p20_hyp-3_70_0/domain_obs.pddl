...
(define
	...
	(:action observe0_modify-files_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(not (observed obs0))
	...
	(:action observe2_break-into_leo
		:parameters ()
		:precondition (and
			(recon-performed leo)
			(observed obs1)
	...
	(:action observe5_download-files_leo
		:parameters ()
		:precondition (and
			(root-access-obtained leo)
			(observed obs4)
	...
	(:action observe6_gain-root_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observed obs5)
