...
(define
	...
	(:action observe0_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(not (observed obs0))
	...
	(:action observe1_modify-files_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observed obs0)
	...
	(:action observe3_break-into_libra
		:parameters ()
		:precondition (and
			(recon-performed libra)
			(observed obs2)
	...
	(:action observe5_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observed obs4)
	...
	(:action observe6_download-files_libra
		:parameters ()
		:precondition (and
			(root-access-obtained libra)
			(observed obs5)
	...
	(:action observe8_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observed obs7)
	...
	(:action observe9_gain-root_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observed obs8)
