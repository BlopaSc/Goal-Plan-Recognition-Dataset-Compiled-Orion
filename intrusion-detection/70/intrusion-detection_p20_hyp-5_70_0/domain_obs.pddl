...
(define
	...
	(:action observe0_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(not (observed obs0))
	...
	(:action observe1_modify-files_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observed obs0)
	...
	(:action observe3_recon_cassiopea
		:parameters ()
		:precondition (and
			(observed obs2)
			(not (observed obs3))
	...
	(:action observe4_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observed obs3)
	...
	(:action observe5_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs4)
	...
	(:action observe6_gain-root_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs5)
	...
	(:action observe7_download-files_cassiopea
		:parameters ()
		:precondition (and
			(root-access-obtained cassiopea)
			(observed obs6)
	...
	(:action observe9_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observed obs8)
