...
(define
	...
	(:action observe0_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(not (observed obs0))
	...
	(:action observe4_modify-files_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observed obs3)
	...
	(:action observe7_break-into_scorpio
		:parameters ()
		:precondition (and
			(recon-performed scorpio)
			(observed obs6)
	...
	(:action observe8_modify-files_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs7)
