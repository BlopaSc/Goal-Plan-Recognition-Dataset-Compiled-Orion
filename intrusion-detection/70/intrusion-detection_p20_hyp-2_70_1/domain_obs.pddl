...
(define
	...
	(:action observe3_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observed obs2)
	...
	(:action observe4_modify-files_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observed obs3)
	...
	(:action observe7_break-into_perseus
		:parameters ()
		:precondition (and
			(recon-performed perseus)
			(observed obs6)
	...
	(:action observe8_modify-files_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observed obs7)
