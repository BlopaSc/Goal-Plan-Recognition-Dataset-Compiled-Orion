...
(define
	...
	(:action observe1_break-into_scorpio
		:parameters ()
		:precondition (and
			(recon-performed scorpio)
			(observed obs0)
	...
	(:action observe2_modify-files_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs1)
	...
	(:action observe3_recon_sagittarius
		:parameters ()
		:precondition (and
			(observed obs2)
			(not (observed obs3))
	...
	(:action observe4_break-into_sagittarius
		:parameters ()
		:precondition (and
			(recon-performed sagittarius)
			(observed obs3)
	...
	(:action observe5_modify-files_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observed obs4)
	...
	(:action observe6_clean_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observed obs5)
	...
	(:action observe8_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observed obs7)
	...
	(:action observe9_download-files_virgo
		:parameters ()
		:precondition (and
			(root-access-obtained virgo)
			(observed obs8)
