...
(define
	...
	(:action observe2_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs1)
	...
	(:action observe4_break-into_scorpio
		:parameters ()
		:precondition (and
			(recon-performed scorpio)
			(observed obs3)
	...
	(:action observe6_download-files_scorpio
		:parameters ()
		:precondition (and
			(root-access-obtained scorpio)
			(observed obs5)
	...
	(:action observe8_break-into_leo
		:parameters ()
		:precondition (and
			(recon-performed leo)
			(observed obs7)
	...
	(:action observe9_download-files_leo
		:parameters ()
		:precondition (and
			(root-access-obtained leo)
			(observed obs8)
