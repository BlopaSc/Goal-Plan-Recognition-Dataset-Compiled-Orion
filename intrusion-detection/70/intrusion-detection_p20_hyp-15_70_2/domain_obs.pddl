...
(define
	...
	(:action observe0_modify-files_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(not (observed obs0))
	...
	(:action observe1_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs0)
	...
	(:action observe4_gain-root_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs3)
	...
	(:action observe5_download-files_scorpio
		:parameters ()
		:precondition (and
			(root-access-obtained scorpio)
			(observed obs4)
