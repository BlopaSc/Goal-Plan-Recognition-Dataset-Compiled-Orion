...
(define
	...
	(:action observe1_modify-files_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observed obs0)
	...
	(:action observe3_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(observed obs2)
	...
	(:action observe5_download-files_aries
		:parameters ()
		:precondition (and
			(root-access-obtained aries)
			(observed obs4)
	...
	(:action observe6_break-into_andromeda
		:parameters ()
		:precondition (and
			(recon-performed andromeda)
			(observed obs5)
	...
	(:action observe7_clean_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observed obs6)
	...
	(:action observe8_gain-root_andromeda
		:parameters ()
		:precondition (and
			(access-obtained andromeda)
			(observed obs7)
	...
	(:action observe9_download-files_andromeda
		:parameters ()
		:precondition (and
			(root-access-obtained andromeda)
			(observed obs8)
