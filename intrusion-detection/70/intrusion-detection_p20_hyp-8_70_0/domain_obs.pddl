...
(define
	...
	(:action observe4_recon_sagittarius
		:parameters ()
		:precondition (and
			(observed obs3)
			(not (observed obs4))
	...
	(:action observe5_break-into_sagittarius
		:parameters ()
		:precondition (and
			(recon-performed sagittarius)
			(observed obs4)
	...
	(:action observe7_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observed obs6)
