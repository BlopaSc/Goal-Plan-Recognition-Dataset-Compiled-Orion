...
(define
	...
	(:action observe5_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observed obs4)
	...
	(:action observe6_modify-files_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observed obs5)
	...
	(:action observe9_break-into_perseus
		:parameters ()
		:precondition (and
			(recon-performed perseus)
			(observed obs8)
	...
	(:action observe10_modify-files_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observed obs9)
	...
	(:action observe11_clean_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observed obs10)
