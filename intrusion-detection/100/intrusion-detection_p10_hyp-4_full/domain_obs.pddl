...
(define
	...
	(:action observe1_break-into_virgo
		:parameters ()
		:precondition (and
			(recon-performed virgo)
			(observed obs0)
	...
	(:action observe2_modify-files_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observed obs1)
	...
	(:action observe5_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(observed obs4)
	...
	(:action observe7_gain-root_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observed obs6)
	...
	(:action observe8_download-files_aries
		:parameters ()
		:precondition (and
			(root-access-obtained aries)
			(observed obs7)
	...
	(:action observe9_recon_sagittarius
		:parameters ()
		:precondition (and
			(observed obs8)
			(not (observed obs9))
	...
	(:action observe10_break-into_sagittarius
		:parameters ()
		:precondition (and
			(recon-performed sagittarius)
			(observed obs9)
	...
	(:action observe11_clean_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observed obs10)
	...
	(:action observe12_gain-root_sagittarius
		:parameters ()
		:precondition (and
			(access-obtained sagittarius)
			(observed obs11)
	...
	(:action observe13_download-files_sagittarius
		:parameters ()
		:precondition (and
			(root-access-obtained sagittarius)
			(observed obs12)
