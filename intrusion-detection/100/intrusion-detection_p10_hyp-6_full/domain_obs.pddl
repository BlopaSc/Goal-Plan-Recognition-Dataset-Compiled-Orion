...
(define
	...
	(:action observe6_modify-files_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observed obs5)
	...
	(:action observe9_break-into_scorpio
		:parameters ()
		:precondition (and
			(recon-performed scorpio)
			(observed obs8)
	...
	(:action observe10_modify-files_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs9)
	...
	(:action observe11_clean_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs10)
