...
(define
	...
	(:action observe4_recon_cassiopea
		:parameters ()
		:precondition (and
			(observed obs3)
			(not (observed obs4))
	...
	(:action observe5_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observed obs4)
	...
	(:action observe6_modify-files_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs5)
	...
	(:action observe7_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs6)
	...
	(:action observe9_break-into_libra
		:parameters ()
		:precondition (and
			(recon-performed libra)
			(observed obs8)
	...
	(:action observe11_gain-root_libra
		:parameters ()
		:precondition (and
			(access-obtained libra)
			(observed obs10)
	...
	(:action observe12_download-files_libra
		:parameters ()
		:precondition (and
			(root-access-obtained libra)
			(observed obs11)
