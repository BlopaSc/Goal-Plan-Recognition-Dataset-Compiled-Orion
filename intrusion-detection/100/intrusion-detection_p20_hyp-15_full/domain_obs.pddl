...
(define
	...
	(:action observe0_recon_cassiopea
		:parameters ()
	...
	(:action observe1_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observed obs0)
	...
	(:action observe2_modify-files_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs1)
	...
	(:action observe3_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observed obs2)
	...
	(:action observe5_break-into_scorpio
		:parameters ()
		:precondition (and
			(recon-performed scorpio)
			(observed obs4)
	...
	(:action observe7_gain-root_scorpio
		:parameters ()
		:precondition (and
			(access-obtained scorpio)
			(observed obs6)
	...
	(:action observe8_download-files_scorpio
		:parameters ()
		:precondition (and
			(root-access-obtained scorpio)
			(observed obs7)
	...
	(:action observe10_break-into_aries
		:parameters ()
		:precondition (and
			(recon-performed aries)
			(observed obs9)
	...
	(:action observe12_gain-root_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observed obs11)
	...
	(:action observe13_download-files_aries
		:parameters ()
		:precondition (and
			(root-access-obtained aries)
			(observed obs12)
