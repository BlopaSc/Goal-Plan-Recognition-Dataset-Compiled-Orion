(define
	...
	(:action observe1_break-into_taurus
		:parameters ()
		:precondition (and
			(recon-performed taurus)
			(observation0)
	...
	(:action observe2_modify-files_taurus
		:parameters ()
		:precondition (and
			(access-obtained taurus)
			(observation1)
	...
	(:action observe6_modify-files_aries
		:parameters ()
		:precondition (and
			(access-obtained aries)
			(observation5)
	...
	(:action observe8_recon_cassiopea
		:parameters ()
		:precondition (and
			(observation7)
			(not (observation8))
	...
	(:action observe9_break-into_cassiopea
		:parameters ()
		:precondition (and
			(recon-performed cassiopea)
			(observation8)
	...
	(:action observe10_clean_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation9)
	...
	(:action observe11_gain-root_cassiopea
		:parameters ()
		:precondition (and
			(access-obtained cassiopea)
			(observation10)
	...
	(:action observe12_download-files_cassiopea
		:parameters ()
		:precondition (and
			(root-access-obtained cassiopea)
			(observation11)
