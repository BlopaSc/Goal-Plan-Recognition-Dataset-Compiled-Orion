(define
	...
	(:action observe4_modify-files_virgo
		:parameters ()
		:precondition (and
			(access-obtained virgo)
			(observation3)
	...
	(:action observe6_break-into_perseus
		:parameters ()
		:precondition (and
			(recon-performed perseus)
			(observation5)
	...
	(:action observe7_modify-files_perseus
		:parameters ()
		:precondition (and
			(access-obtained perseus)
			(observation6)
